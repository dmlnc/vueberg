import { openBlock as D, createElementBlock as H, normalizeClass as Ut, renderSlot as ds, createCommentVNode as se, resolveComponent as je, createElementVNode as I, withModifiers as Re, createVNode as st, withCtx as St, toDisplayString as He, Fragment as Le, renderList as Ye, createBlock as We, defineComponent as Rr, ref as Ir, onMounted as ho, onBeforeUnmount as Us, h as Ct, reactive as po, markRaw as Js, getCurrentInstance as Qd, watchEffect as Xd, nextTick as Zd, unref as di, Teleport as ef, customRef as tf, watch as Sc, computed as nf, TransitionGroup as rf, resolveDynamicComponent as of, mergeProps as sf, toHandlers as lf, withDirectives as af, vModelText as cf, createTextVNode as Mc, withKeys as Ll } from "vue";
const pt = (n, e) => {
...
}, df = ["data-tooltip", "innerHTML"];
function ff(n, e, t, r, i, o) {
  return D(), H("button", {
    class: Ut(["gutentap-button", t.active ? t.activeClass : ""]),
    "data-tooltip": t.label,
    innerHTML: t.content
  }, null, 10, df);
}
const Gs = /* @__PURE__ */ pt(uf, [["render", ff]]), hf = {
  data() {
    return {
      showDropdown: !1
    };
...
function pf(n, e, t, r, i, o) {
  return D(), H("div", {
    class: "gutentap-menu-item",
    onClick: e[0] || (e[0] = (...s) => o.toggleDropdown && o.toggleDropdown(...s))
  }, [
    ds(n.$slots, "default"),
    o.hasDropdown ? (D(), H("div", {
      key: 0,
      class: Ut([{
        "gutentap-menu-item-dropdown--left": t.align === "left",
        "gutentap-menu-item-dropdown--right": t.align === "right",
        "gutentap-menu-item-dropdown--open": i.showDropdown
      }, "gutentap-menu-item-dropdown"]),
      ref: "dropdown"
    }, [
      ds(n.$slots, "dropdown")
    ], 2)) : se("", !0)
...
const Cc = /* @__PURE__ */ pt(hf, [["render", pf]]);
function fe(n) {
  this.content = n;
}
fe.prototype = {
...
function Ec(n, e, t) {
  for (let r = 0; ; r++) {
    ...
    if (i.content.size || o.content.size) {
      let s = Ec(i.content, o.content, t + 1);
      if (s != null)
        return s;
    }
    t += i.nodeSize;
...
class E {
  ...
  */
  removeBetween(e, t) {
    return new E(Oc(this.content, e + this.openStart, t + this.openStart), this.openStart, this.openEnd);
  }
  /**
  ...
  */
  static fromJSON(e, t) {
    ...
    return new E(w.fromJSON(e, t.content), r, i);
  }
  /**
...
function Dc(n, e, t, r) {
  ...
  if (i == e.index(r) && r < n.depth - t.openStart) {
    ...
    if (!t.openStart && !t.openEnd && n.depth == r && e.depth == r) {
      ...
      let { start: s, end: l } = gf(t, n);
      return un(o, Lc(n, s, l, e, r));
    }
  else
...
function Lc(n, e, t, r, i) {
  let o = n.depth > i && hs(n, e, i + 1), s = r.depth > i && hs(t, r, i + 1), l = [];
  return ur(null, n, i, l), o && s && e.index(i) == t.index(i) ? (Bc(o, s), cn(un(o, Lc(n, e, t, r, i + 1)), l)) : (o && cn(un(o, wi(n, e, i + 1)), l), ur(e, t, i, l), s && cn(un(s, wi(t, r, i + 1)), l)), ur(r, null, i, l), new w(l);
}
function wi(n, e, t) {
  let r = [];
...
const vf = /* @__PURE__ */ Object.create(null);
let dn = class ps {
  /**
  @internal
  */
  ...
  */
  hasMarkup(e, t, r) {
    return this.type == e && bi(this.attrs, t || e.defaultAttrs || vf) && J.sameSet(this.marks, r || J.none);
  }
  /**
  ...
  */
  replace(e, t, r) {
    return mf(this.resolve(e), this.resolve(t), r);
  }
  /**
  ...
  */
  canReplace(e, t, r = w.empty, i = 0, o = r.childCount) {
...
let Pl = class Vc {
  ...
  */
  constructor(e, t, r) {
    this.name = e, this.schema = t, this.spec = r, this.markSet = null, this.groups = r.group ? r.group.split(" ") : [], this.attrs = Fc(r.attrs), this.defaultAttrs = Hc(this.attrs), this.contentMatch = null, this.inlineContent = null, this.isBlock = !(r.inline || e == "text"), this.isText = e == "text";
  }
  /**
  ...
  */
  create(e = null, t, r) {
    ...
    return new dn(this, this.computeAttrs(e), w.from(t), J.setFrom(r));
  }
  /**
  ...
  */
  createChecked(e = null, t, r) {
    return t = w.from(t), this.checkContent(t), new dn(this, this.computeAttrs(e), t, J.setFrom(r));
  }
  /**
...
class mo {
  ...
  */
  constructor(e, t, r, i) {
    this.name = e, this.rank = t, this.schema = r, this.spec = i, this.attrs = Fc(i.attrs), this.excluded = null;
    let o = Hc(this.attrs);
...
class Of {
  ...
  */
  constructor(e) {
    ...
    for (let i in e)
      t[i] = e[i];
    t.nodes = fe.from(e.nodes), t.marks = fe.from(e.marks || {}), this.nodes = Pl.compile(this.spec.nodes, this), this.marks = mo.compile(this.spec.marks, this);
    let r = /* @__PURE__ */ Object.create(null);
  ...
  */
  text(e, t) {
    ...
    return new Ti(r, r.defaultAttrs, e, J.setFrom(t));
  }
  /**
  ...
  */
  constructor(e, t) {
    this.schema = e, this.rules = t, this.tags = [], this.styles = [], t.forEach((r) => {
      Nf(r) ? this.tags.push(r) : Df(r) && this.styles.push(r);
  ...
  */
  matchTag(e, t, r) {
    for (let i = r ? this.tags.indexOf(r) + 1 : 0; i < this.tags.length; i++) {
      let o = this.tags[i];
      if (Rf(e, o.tag) && (o.namespace === void 0 || e.namespaceURI == o.namespace) && (!o.context || t.matchesContext(o.context))) {
        if (o.getAttrs) {
          let s = o.getAttrs(e);
          if (s === !1)
            continue;
  ...
  */
  static schemaRules(e) {
    ...
    for (let i in e.marks) {
      ...
      o && o.forEach((s) => {
        r(s = Vl(s)), s.mark || s.ignore || s.clearMark || (s.mark = i);
      });
    }
    for (let i in e.nodes) {
      let o = e.nodes[i].spec.parseDOM;
      o && o.forEach((s) => {
        r(s = Vl(s)), s.node || s.ignore || s.mark || (s.node = i);
      });
    }
    return t;
  }
...
const _c = {
  ...
  style: !0,
  title: !0
}, $c = { ol: !0, ul: !0 }, Si = 1, Mi = 2, dr = 4;
function zl(n, e, t) {
  return e != null ? (e ? Si : 0) | (e === "full" ? Mi : 0) : n && n.whitespace == "pre" ? Si | Mi : t & ~dr;
}
class ti {
  ...
  applyPending(e) {
    for (let t = 0, r = this.pendingMarks; t < r.length; t++) {
      let i = r[t];
      (this.type ? this.type.allowsMarkType(i.type) : Pf(i.type, e)) && !i.isInSet(this.activeMarks) && (this.activeMarks = i.addToSet(this.activeMarks), this.pendingMarks = i.removeFromSet(this.pendingMarks));
    }
  }
  inlineContext(e) {
...
class Fl {
  constructor(e, t, r) {
    ...
    let i = t.topNode, o, s = zl(null, t.preserveWhitespace, 0) | (r ? dr : 0);
  ...
  addTextNode(e) {
    ...
    if (r.options & Mi || r.inlineContext(e) || /[^ \t\r\n\u000c]/.test(t)) {
      if (r.options & Si)
        r.options & Mi ? t = t.replace(/\r\n?/g, `
`) : t = t.replace(/\r?\n|\r/g, " ");
...
class ms {
  ...
  */
  get deleted() {
    return (this.delInfo & Uc) > 0;
  }
  /**
  Tells you whether the token before the mapped position was deleted.
  */
  get deletedBefore() {
    return (this.delInfo & (qc | fi)) > 0;
  }
  /**
  True when the token after the mapped position was deleted.
  */
  get deletedAfter() {
    return (this.delInfo & (Kc | fi)) > 0;
  }
  /**
...
class Ie {
  ...
  _map(e, t, r) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= d) {
        ...
        if (r)
          return h;
        let p = e == (t < 0 ? a : d) ? null : zf(l / 3, e - a), m = e == a ? Kc : e == d ? qc : fi;
        return (t < 0 ? e != a : e != d) && (m |= Uc), new ms(h, m, p);
      }
      i += u - c;
    }
  ...
  */
  touches(e, t) {
    let r = 0, i = $l(t), o = this.inverted ? 2 : 1, s = this.inverted ? 1 : 2;
    for (let l = 0; l < this.ranges.length; l += 3) {
...
function Ys(n, e, t) {
  ...
  for (let i = 0; i < n.childCount; i++) {
    let o = n.child(i);
    o.content.size && (o = o.copy(Ys(o.content, e, o))), o.isInline && (o = e(o, t, i)), r.push(o);
  }
...
class zt extends ve {
  ...
  */
  ...
  apply(e) {
    let t = e.slice(this.from, this.to), r = e.resolve(this.from), i = r.node(r.sharedDepth(this.to)), o = new E(Ys(t.content, (s, l) => !s.isAtom || !l.type.allowsMarkType(this.mark.type) ? s : s.mark(this.mark.addToSet(s.marks)), i), t.openStart, t.openEnd);
...
class ct extends ve {
  ...
  */
  ...
  apply(e) {
    let t = e.slice(this.from, this.to), r = new E(Ys(t.content, (i) => i.mark(this.mark.removeFromSet(i.marks)), e), t.openStart, t.openEnd);
...
class Ft extends ve {
  ...
  */
  ...
  apply(e) {
    ...
    return ie.fromReplace(e, this.pos, this.pos + 1, new E(w.from(r), 0, t.isLeaf ? 0 : 1));
  }
  invert(e) {
    let t = e.nodeAt(this.pos);
    if (t) {
...
class oe extends ve {
  ...
  */
  ...
  apply(e) {
    return this.structure && gs(e, this.from, this.to) ? ie.fail("Structure replace would overwrite content") : ie.fromReplace(e, this.from, this.to, this.slice);
  }
  getMap() {
...
function Jc(n, e, t, r = t.contentMatch, i = !0) {
  ...
  for (let a = 0; a < o.childCount; a++) {
    ...
    if (!d)
      ...
      if (i && c.isText && t.whitespace != "pre") {
        let f, h = /\r?\n|\r/g, p;
        for (; f = h.exec(c.text); )
          p || (p = new E(w.from(t.schema.text(" ", t.allowedMarks(c.marks))), 0, 0)), s.push(new oe(l + f.index, l + f.index + f[0].length, p));
      }
    }
    l = u;
  }
...
function Zn(n) {
  ...
  for (let r = n.depth; ; --r) {
    ...
    if (r < n.depth && i.canReplace(o, s, t))
      return r;
    if (r == 0 || i.type.spec.isolating || !$f(i, o, s))
      break;
  }
  return null;
}
function jf(n, e, t) {
  let { $from: r, $to: i, depth: o } = e, s = r.before(o + 1), l = i.after(o + 1), a = s, c = l, u = w.empty, d = 0;
...
function Kf(n, e, t) {
  ...
  for (let s = t.length - 1; s >= 0; s--) {
    ...
    r = w.from(t[s].type.create(t[s].attrs, r));
  }
...
function Uf(n, e, t, r, i) {
  ...
  n.doc.nodesBetween(e, t, (s, l) => {
    if (s.isTextblock && !s.hasMarkup(r, i) && Yf(n.doc, n.mapping.slice(o).map(l), r)) {
      ...
      a === !1 && Gf(n, s, l, o), Jc(n, n.mapping.slice(o).map(l, 1), r, void 0, a === null);
      let c = n.mapping.slice(o), u = c.map(l, 1), d = c.map(l + s.nodeSize, 1);
      return n.step(new ce(u, d, u + 1, d - 1, new E(w.from(r.create(i, null, s.marks)), 0, 0), 1, !0)), a === !0 && Jf(n, s, l, o), !1;
    }
  });
}
function Jf(n, e, t, r) {
...
function Qf(n, e, t, r, i) {
  ...
  n.step(new ce(e, e + o.nodeSize, e + 1, e + o.nodeSize - 1, new E(w.from(s), 0, 0), 1, !0));
}
...
function Xf(n, e, t = 1, r) {
  let i = n.doc.resolve(e), o = w.empty, s = w.empty;
  for (let l = i.depth, a = i.depth - t, c = t - 1; l > a; l--, c--) {
    o = w.from(i.node(l).copy(o));
    let u = r && r[c];
    s = w.from(u ? u.type.create(u.attrs, s) : i.node(l).copy(s));
  }
  n.step(new oe(e, e, new E(o.append(s), t, t), !0));
}
function Jt(n, e) {
  let t = n.resolve(e), r = t.index();
  return Gc(t.nodeBefore, t.nodeAfter) && t.parent.canReplace(r, r + 1);
}
function Gc(n, e) {
...
function go(n, e, t = -1) {
  ...
  for (let i = r.depth; ; i--) {
    let o, s, l = r.index(i);
    if (i == r.depth ? (o = r.nodeBefore, s = r.nodeAfter) : t > 0 ? (o = r.node(i + 1), l++, s = r.node(i).maybeChild(l)) : (o = r.node(i).maybeChild(l - 1), s = r.node(i + 1)), o && !o.isTextblock && Gc(o, s) && r.node(i).canReplace(l, l + 1))
      return e;
    if (i == 0)
      break;
...
function yo(n, e, t = e, r = E.empty) {
  ...
  return Yc(i, o, r) ? new oe(e, t, r) : new nh(i, o, r).fit();
}
function Yc(n, e, t) {
...
class nh {
    ...
    for (let t = 1; t <= 2; t++)
      for (let r = t == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
        ...
        for (let l = this.depth; l >= 0; l--) {
          ...
          if (t == 1 && (s ? c.matchType(s.type) || (d = c.fillBefore(w.from(s), !1)) : o && a.compatibleContent(o.type)))
  ...
  placeNodes({ sliceDepth: e, frontierDepth: t, parent: r, inject: i, wrap: o }) {
    ...
    for (; c < l.childCount; ) {
      ...
      if (!g)
        break;
      c++, (c > 1 || a == 0 || m.content.size) && (d = g, u.push(Qc(m.mark(f.allowedMarks(m.marks)), c == 1 ? a : 0, c == l.childCount ? h : -1)));
    }
    let p = c == l.childCount;
    p || (h = -1), this.placed = ar(this.placed, t, w.from(u)), this.frontier[t].match = d, p && h < 0 && r && r.type == this.frontier[this.depth].type && this.frontier.length > 1 && this.closeFrontierNode();
  ...
  findCloseLevel(e) {
    e:
      for (let t = Math.min(this.depth, e.depth); t >= 0; t--) {
        let { match: r, type: i } = this.frontier[t], o = t < e.depth && e.end(t + 1) == e.pos + (e.depth - (t + 1)), s = Fo(e, t, i, r, o);
        if (s) {
          for (let l = t - 1; l >= 0; l--) {
  ...
  openFrontierNode(e, t = null, r) {
    ...
    i.match = i.match.matchType(e), this.placed = ar(this.placed, this.depth, w.from(e.create(t, r))), this.frontier.push({ type: e, match: e.contentMatch });
  }
  closeFrontierNode() {
...
function Qc(n, e, t) {
  if (e <= 0)
    return n;
  let r = n.content;
  return e > 1 && (r = r.replaceChild(0, Qc(r.firstChild, e - 1, r.childCount == 1 ? t - 1 : 0))), e > 0 && (r = n.type.contentMatch.fillBefore(r).append(r), t <= 0 && (r = r.append(n.type.contentMatch.matchFragment(r).fillBefore(w.empty, !0)))), n.copy(r);
}
function Fo(n, e, t, r, i) {
  ...
  return l && !rh(t, o.content, s) ? l : null;
}
function rh(n, e, t) {
  ...
  for (let f = r.openStart; f >= 0; f--) {
    ...
    if (p)
      for (let m = 0; m < s.length; m++) {
        ...
        g < 0 && (v = !1, g = -g);
        let x = i.node(g - 1), T = i.index(g - 1);
        if (x.canReplaceWith(T, T, p.type, p.marks))
          return n.replace(i.before(g), v ? o.after(g) : t, new E(Xc(r.content, 0, r.openStart, h), h, r.openEnd));
      }
  }
...
function Xc(n, e, t, r, i) {
  if (e < t) {
    let o = n.firstChild;
    n = n.replaceChild(0, o.copy(Xc(o.content, e + 1, t, r, o)));
  }
  if (e > r) {
    let o = i.contentMatchAt(0), s = o.fillBefore(n).append(n);
    n = s.append(o.matchFragment(s).fillBefore(w.empty, !0));
  }
  return n;
}
function sh(n, e, t, r) {
...
class Fn extends ve {
  ...
  */
  ...
  apply(e) {
    ...
    return ie.fromReplace(e, this.pos, this.pos + 1, new E(w.from(i), 0, t.isLeaf ? 0 : 1));
  }
  getMap() {
    return Ie.empty;
  }
...
class eu {
  ...
  */
  setNodeAttribute(e, t, r) {
    return this.step(new Fn(e, t, r)), this;
  }
  /**
...
class F {
  ...
  */
  constructor(e, t, r) {
    this.$anchor = e, this.$head = t, this.ranges = r || [new ah(e.min(t), e.max(t))];
  }
  /**
  ...
  */
  replace(e, t = E.empty) {
    ...
    for (let l = 0; l < s.length; l++) {
      ...
      e.replaceRange(u.map(a.pos), u.map(c.pos), l ? E.empty : t), l == 0 && Kl(e, o, (r ? r.isInline : i && i.isTextblock) ? -1 : 1);
    }
  }
  /**
  ...
  */
  replaceWith(e, t) {
    ...
    for (let o = 0; o < i.length; o++) {
      ...
      o ? e.deleteRange(c, u) : (e.replaceRangeWith(c, u, t), Kl(e, r, t.isInline ? -1 : 1));
    }
  }
  /**
  ...
  */
  static findFrom(e, t, r = !1) {
    let i = e.parent.inlineContent ? new P(e) : Dn(e.node(0), e.parent, e.pos, e.index(), t, r);
    if (i)
      return i;
...
class P extends F {
  ...
  */
  static between(e, t, r) {
    ...
    return e.parent.inlineContent || (i == 0 ? e = t : (e = (F.findFrom(e, -r, !0) || F.findFrom(e, r, !0)).$anchor, e.pos < t.pos != i < 0 && (e = t))), new P(e, t);
  }
}
F.jsonID("text", P);
class vo {
...
class Xs {
  ...
  map(e) {
    ...
    return t ? new vo(r, r) : new Xs(r);
  }
  resolve(e) {
    let t = e.resolve(this.anchor), r = t.nodeAfter;
    return r && B.isSelectable(r) ? new B(t) : F.near(t);
  }
}
class Ze extends F {
  /**
...
class uh extends eu {
  ...
  */
  setSelection(e) {
    ...
    return this.curSelection = e, this.curSelectionFor = this.steps.length, this.updated = (this.updated | Ul) & ~ni, this.storedMarks = null, this;
  }
  /**
  Whether the selection was explicitly updated by this transaction.
  */
  get selectionSet() {
    return (this.updated & Ul) > 0;
  }
  /**
  ...
  */
  insertText(e, t, r) {
      ...
      return e ? this.replaceSelectionWith(i.text(e), !0) : this.deleteSelection();
    {
      ...
      return this.replaceRangeWith(t, r, i.text(e, o)), this.selection.empty || this.setSelection(F.near(this.selection.$to)), this;
    }
  }
  /**
...
class cr {
  constructor(e, t, r) {
    this.name = e, this.init = Gl(t.init, r), this.apply = Gl(t.apply, r);
  }
}
const dh = [
  new cr("doc", {
...
class _o {
  constructor(e, t) {
    this.schema = e, this.plugins = [], this.pluginsByKey = /* @__PURE__ */ Object.create(null), this.fields = dh.slice(), t && t.forEach((r) => {
...
class In {
  ...
  */
  static create(e) {
    let t = new _o(e.doc ? e.doc.type.schema : e.schema, e.plugins), r = new In(t);
  ...
  */
  reconfigure(e) {
    let t = new _o(this.schema, e.plugins), r = t.fields, i = new In(t);
  ...
  */
  static fromJSON(e, t, r) {
    ...
    let i = new _o(e.schema, e.plugins), o = new In(i);
...
class le {
  ...
  */
  constructor(e) {
    this.spec = e, this.props = {}, e.props && tu(e.props, this, this.props), this.key = e.key ? e.key.key : nu("plugin");
  }
  /**
...
let mh = function(n, e) {
  ...
  for (let r = 0; r < n.childCount; r++)
    t.push(
      e(n.child(r), r, n instanceof w ? n : n.content)
    );
  return t;
};
const gh = function({ view: n, dir: e, currentResolved: t }) {
  if (!t)
    return !1;
  let r = n.state.tr;
  const i = e === "DOWN", o = t.node(1) || t.nodeAfter, s = 0, l = t.node(s), a = t.start(s), c = mh(l, (g) => g);
  let u = c.indexOf(o);
  if (u == -1)
    return !1;
  let d = i ? u + 1 : u - 1;
  ...
  [c[u], c[d]] = [c[d], c[u]];
  let h = a, p = t.end(s);
  const m = new E(w.fromArray(c), 0, 0);
...
const yh = {
  ...
  computed: {
    currentBlockTool() {
      return this.editor ? this.editor.storage.gutentapBlocks.currentBlockTool : null;
    },
    currentNode() {
      return this.editor ? this.editor.storage.gutentapBlocks.currentNode : null;
    },
    canBeConvertedTo() {
      var n;
      return ((n = this.currentBlockTool) == null ? void 0 : n.canBeConverted) === !1 ? [] : this.editor.storage.gutentapBlocks.getFlatBlocks().filter((e) => {
        var t;
        return ((t = this.currentBlockTool) == null ? void 0 : t.canBeConverted[e.name]) && e.convertCommand;
      });
    },
    activeAlignmentTools() {
      var e;
      if (!((e = this.currentBlockTool) != null && e.alignTools))
        return [];
      const n = (t) => {
        var r;
        return ((r = this.currentNode) == null ? void 0 : r.depth) > 1 ? t.allowNested : !0;
      };
      return this.currentBlockTool.alignTools === !0 ? this.alignmentTools.filter(n).filter(
        (t) => t.tools.find(
          (r) => r.isActiveTest(this.editor, this.currentBlockTool.name)
        )
      ) : typeof this.currentBlockTool.alignTools == "object" ? this.alignmentTools.filter(n).filter((t) => this.currentBlockTool.alignTools[t.name]).filter((t) => t.tools.length > 0) : [];
    },
    firstMenuItems() {
    ...
    menuCount() {
      var a, c, u, d, f, h;
      let n = this.gutentapWidth > 700 ? 700 : this.gutentapWidth;
      const e = parseInt(getComputedStyle(document.documentElement).getPropertyValue("--gutentap-button-size")) || 30, t = parseInt(getComputedStyle(document.documentElement).getPropertyValue("--gutentap-toolbar-gap")) || 2, r = 2 * (parseInt(getComputedStyle(document.documentElement).getPropertyValue("--gutentap-toolbar-group-margin")) || 10), i = 1;
      ...
      return this.currentBlockTool ? [
        {
          ...
          buttons: (r = (t = this.currentBlockTool) == null ? void 0 : t.tools) == null ? void 0 : r.map((s) => {
            var l, a;
            return {
              click: () => s.command.call(0, this.editor),
              icon: s.icon,
              label: s.title,
              activeClass: s.isActiveClass,
              disabled: (l = s.isDisabledTest) == null ? void 0 : l.call(0, this.editor),
              active: (a = s.isActiveTest) == null ? void 0 : a.call(0, this.editor)
            };
          })
        },
        {
          type: "inlineTools",
          condition: (i = this.currentBlockTool) == null ? void 0 : i.inlineTools,
          buttons: (() => {
            var l;
            const s = (l = this.currentBlockTool) == null ? void 0 : l.inlineTools;
            return s === !0 ? this.inlineTools.map((a) => ({
            ...
            })) : typeof s == "object" ? Object.keys(s).filter((c) => s[c]).map((c) => this.inlineTools.find((u) => u.name === c)).filter((c) => c).map((c) => ({
        ...
        {
          type: "control",
          condition: this.editor.can().deleteNode((o = this.currentBlockTool) == null ? void 0 : o.nodeType),
          buttons: [
            {
              click: () => {
                var s;
                return this.deleteNode((s = this.currentBlockTool) == null ? void 0 : s.nodeType);
              },
  ...
  methods: {
    ...
    runConvertCommand(n) {
      n.convertCommand(this.editor), this.editor.storage.gutentapBlocks.getBlockTool(this.editor.commands.getCurrentNodeName());
    },
    moveNode(n = "UP") {
      gh({
...
}, vh = { class: "gutentap-toolbar" }, bh = { class: "gutentap-button-group gutentap-button-group-separate" }, kh = { class: "gutentap-button-group gutentap-button-group-column gutentap-toolbar-order" }, wh = ["disabled", "data-tooltip"], xh = /* @__PURE__ */ I("svg", {
  ...
  /* @__PURE__ */ I("path", { d: "M6.5 12.4L12 8l5.5 4.4-.9 1.2L12 10l-4.5 3.6-1-1.2z" })
], -1), Th = [
  xh
], Sh = ["disabled", "data-tooltip"], Mh = /* @__PURE__ */ I("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  fill: "currentColor",
  "aria-hidden": "true",
  viewBox: "6.5 10.4 11 5.6"
}, [
  /* @__PURE__ */ I("path", { d: "M17.5 11.6 12 16l-5.5-4.4.9-1.2L12 14l4.5-3.6 1 1.2z" })
], -1), Ch = [
  Mh
], Eh = {
  key: 0,
  class: "gutentap-button-group gutentap-button-group-separate"
}, Ah = { class: "gutentap-toolbar-transform-to" }, Oh = {
  key: 0,
  class: "gutentap-button-group gutentap-button-group-separate"
}, Nh = {
  key: 1,
...
function Dh(n, e, t, r, i, o) {
  ...
  return D(), H("div", vh, [
    I("div", bh, [
      I("div", kh, [
        I("button", {
          onClick: e[0] || (e[0] = Re((u) => o.moveNode("UP"), ["prevent"])),
          disabled: !o.canMoveNodeUp(),
          "data-tooltip": i.upLabel,
          class: "gutentap-button--toolbar-order gutentap-button"
        }, Th, 8, wh),
        I("button", {
          onClick: e[1] || (e[1] = Re((u) => o.moveNode("DOWN"), ["prevent"])),
          disabled: !o.canMoveNodeDown(),
          "data-tooltip": i.downLabel,
          class: "gutentap-button--toolbar-order gutentap-button"
        }, Ch, 8, Sh)
      ]),
      (a = o.currentBlockTool) != null && a.icon && ((c = o.currentBlockTool) != null && c.name) ? (D(), H("div", Eh, [
        st(l, null, {
          dropdown: St(() => [
            I("div", Ah, He(i.transformToLabel), 1),
            (D(!0), H(Le, null, Ye(o.canBeConvertedTo, (u) => (D(), We(s, {
              content: u.icon + " " + u.title,
              key: u.title,
              onClick: Re((d) => o.runConvertCommand(u), ["prevent"]),
          ...
          default: St(() => {
            ...
            return [
              st(s, {
                label: (u = o.currentBlockTool) == null ? void 0 : u.title,
                content: (d = o.currentBlockTool) == null ? void 0 : d.icon,
                class: Ut((f = o.currentBlockTool) != null && f.canBeConverted && o.canBeConvertedTo.length ? "gutentap-button-secondary" : "")
    ...
    o.activeAlignmentTools.length ? (D(), H("div", Oh, [
      (D(!0), H(Le, null, Ye(o.activeAlignmentTools, (u, d) => (D(), We(l, { key: d }, {
        dropdown: St(() => [
          (D(!0), H(Le, null, Ye(u.tools, (f) => {
            var h;
            return D(), We(s, {
              class: "gutentap-button-text gutentap-button-md",
              key: f.title,
              content: f.icon + " " + f.title,
              onClick: Re((p) => f.command(t.editor), ["prevent"]),
              active: f.isActiveTest(t.editor, (h = o.currentBlockTool) == null ? void 0 : h.nodeType)
    ...
    (D(!0), H(Le, null, Ye(o.firstMenuItems, (u) => (D(), H(Le, null, [
      u.condition ? (D(), H("div", {
        key: u.type,
        class: "gutentap-button-group gutentap-button-group-separate"
      }, [
        (D(!0), H(Le, null, Ye(u.buttons, (d, f) => (D(), We(s, {
          key: f,
          content: d.icon,
          label: d.label,
          activeClass: d.activeClass,
          onClick: Re(d.click, ["prevent"]),
          disabled: d.disabled,
          active: d.active
        }, null, 8, ["content", "label", "activeClass", "onClick", "disabled", "active"]))), 128))
      ])) : se("", !0)
    ], 64))), 256)),
    t.editor && o.remainingMenuItems.length ? (D(), H("div", Nh, [
      st(l, { align: "right" }, {
        dropdown: St(() => [
          (D(!0), H(Le, null, Ye(o.remainingMenuItems, (u) => (D(), H(Le, null, [
            u.condition ? (D(!0), H(Le, { key: 0 }, Ye(u.buttons, (d, f) => (D(), We(s, {
              key: f,
        ...
        default: St(() => [
          st(s, {
            class: "gutentap-button-secondary",
            onClick: e[3] || (e[3] = Re(() => {
            }, ["prevent"])),
            label: i.moreLabel,
            content: i.moreIcon
...
const Bh = /* @__PURE__ */ pt(yh, [["render", Dh]]), he = function(n) {
  for (var e = 0; ; e++)
...
const xt = function(n, e, t) {
  ...
  return t && (Yl(n, e, t, r, -1) || Yl(n, e, t, r, 1));
...
function Yl(n, e, t, r, i) {
  for (; ; ) {
    ...
    if (e == (i < 0 ? 0 : lt(n))) {
      let o = n.parentNode;
      if (!o || o.nodeType != 1 || Pr(n) || Rh.test(n.nodeName) || n.contentEditable == "false")
        return !1;
      e = he(n) + (i < 0 ? 0 : 1), n = o;
...
const dt = typeof navigator < "u" ? navigator : null, Ql = typeof document < "u" ? document : null, Gt = dt && dt.userAgent || "", vs = /Edge\/(\d+)/.exec(Gt), iu = /MSIE \d/.exec(Gt), bs = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Gt), Ae = !!(iu || bs || vs), _t = iu ? document.documentMode : bs ? +bs[1] : vs ? +vs[1] : 0, et = !Ae && /gecko\/(\d+)/i.test(Gt);
et && +(/Firefox\/(\d+)/.exec(Gt) || [0, 0])[1];
const ks = !Ae && /Chrome\/(\d+)/.exec(Gt), we = !!ks, Vh = ks ? +ks[1] : 0, xe = !Ae && !!dt && /Apple Computer/.test(dt.vendor), Kn = xe && (/Mobile\/\w+/.test(Gt) || !!dt && dt.maxTouchPoints > 2), $e = Kn || (dt ? /Mac/.test(dt.platform) : !1), _h = dt ? /Win/.test(dt.platform) : !1, Qe = /Android \d/.test(Gt), Hr = !!Ql && "webkitFontSmoothing" in Ql.documentElement.style, $h = Hr ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function jh(n) {
...
function Xl(n, e, t) {
  ...
  for (let s = t || n.dom; s; s = xr(s)) {
    if (s.nodeType != 1)
      continue;
    let l = s, a = l == o.body, c = a ? jh(o) : Wh(l), u = 0, d = 0;
...
function qh(n) {
  ...
  return { refDOM: r, refTop: i, stack: ou(n.dom) };
}
function ou(n) {
...
function lu(n, e) {
  ...
  return !t && a && (t = a, i = c, r = 0), t && t.nodeType == 3 ? Jh(t, i) : !t || r && t.nodeType == 1 ? { node: n, offset: o } : lu(t, i);
}
function Jh(n, e) {
...
function Yh(n, e, t) {
  let { node: r, offset: i } = lu(e, t), o = -1;
...
function Xh(n, e) {
  let t = n.dom.ownerDocument, r, i = 0, o = Fh(t, e.left, e.top);
  o && ({ node: r, offset: i } = o);
  ...
  if (s = Gh(s, e), r) {
    ...
    let c;
    Hr && i && r.nodeType == 1 && (c = r.childNodes[i - 1]).nodeType == 1 && c.contentEditable == "false" && c.getBoundingClientRect().top >= e.top && i--, r == n.dom && i == r.childNodes.length - 1 && r.lastChild.nodeType == 1 && e.top > r.lastChild.getBoundingClientRect().bottom ? l = n.state.doc.content.size : (i == 0 || r.nodeType != 1 || r.childNodes[i - 1].nodeName != "BR") && (l = Qh(n, r, i, e));
  }
  l == null && (l = Yh(n, s, e));
...
const Zh = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function cu(n, e, t) {
  let { node: r, offset: i, atom: o } = n.docView.domFromPos(e, t < 0 ? -1 : 1), s = Hr || et;
  if (r.nodeType == 3)
    if (s && (Zh.test(r.nodeValue) || (t < 0 ? !i : i == r.nodeValue.length))) {
      let a = Bt(xt(r, i, i), t);
...
function np(n, e, t) {
  ...
  return !tp.test(r.parent.textContent) || !l.modify ? t == "left" || t == "backward" ? o : s : uu(n, e, () => {
...
let ea = null, ta = null, na = !1;
function rp(n, e, t) {
  return ea == e && ta == t ? na : (ea = e, ta = t, na = t == "up" || t == "down" ? ep(n, e, t) : np(n, e, t));
}
const qe = 0, ra = 1, sn = 2, ft = 3;
class zr {
  constructor(e, t, r, i) {
  ...
  domFromPos(e, t) {
    ...
    for (let o; r && !(o = this.children[r - 1]).size && o instanceof du && o.side >= 0; r--)
      ;
    if (t <= 0) {
      let o, s = !0;
  ...
  markDirty(e, t) {
    for (let r = 0, i = 0; i < this.children.length; i++) {
      ...
      if (r == s ? e <= s && t >= r : e < s && t > r) {
        ...
        if (e >= l && t <= a) {
          this.dirty = e == r || t == s ? sn : ra, e == l && t == a && (o.contentLost || o.dom.parentNode != this.contentDOM) ? o.dirty = ft : o.markDirty(e - l, t - l);
          return;
        } else
...
class vn extends zr {
  ...
  static create(e, t, r, i) {
    ...
    return (!s || !s.dom) && (s = at.renderSpec(document, t.type.spec.toDOM(t, r))), new vn(e, t, s.dom, s.contentDOM || s.dom);
  }
  parseRule() {
...
class $t extends zr {
  ...
  static create(e, t, r, i, o, s) {
    ...
    let f = u;
    return u = mu(u, r, t), c ? a = new op(e, t, r, i, u, d || null, f, c, o, s + 1) : t.isText ? new ko(e, t, r, i, u, f, o) : new $t(e, t, r, i, u, d || null, f, o, s + 1);
  }
  parseRule() {
  ...
  matchesNode(e, t, r) {
    return this.dirty == qe && e.eq(this.node) && xs(t, this.outerDeco) && r.eq(this.innerDeco);
  }
  get size() {
  ...
  // `this.children`.
  updateChildren(e, t) {
    let r = this.node.inlineContent, i = t, o = e.composing ? this.localCompositionInfo(e, t) : null, s = o && o.pos > -1 ? o : null, l = o && o.pos < 0, a = new lp(this, s && s.node, e);
    up(this.node, this.innerDeco, (c, u, d) => {
    ...
    }), a.syncToMarks([], r, e), this.node.isTextblock && a.addTextblockHacks(), a.destroyRest(), (a.changed || this.dirty == sn) && (s && this.protectLocalComposition(e, s), hu(this.contentDOM, this.children, e), Kn && dp(this.dom));
  }
  localCompositionInfo(e, t) {
    ...
    if (this.node.inlineContent) {
      let s = o.nodeValue, l = fp(this.node.content, s, r - t, i - t);
  ...
  updateOuterDeco(e) {
    if (xs(e, this.outerDeco))
      return;
    let t = this.nodeDOM.nodeType != 1, r = this.dom;
    this.dom = pu(this.dom, this.nodeDOM, ws(this.outerDeco, this.node, t), ws(e, this.node, t)), this.dom != r && (r.pmViewDesc = void 0, this.dom.pmViewDesc = this), this.outerDeco = e;
  }
...
function ia(n, e, t, r, i) {
  mu(r, e, n);
  let o = new $t(void 0, n, e, t, r, r, r, i, 0);
...
function mu(n, e, t) {
  return pu(n, n, ln, ws(e, t, n.nodeType != 1));
}
function xs(n, e) {
  if (n.length != e.length)
    return !1;
...
class lp {
  constructor(e, t, r) {
    this.lock = t, this.view = r, this.index = 0, this.stack = [], this.changed = !1, this.top = e, this.preMatch = ap(e.node.content, e);
  }
  ...
  updateNextNode(e, t, r, i, o, s) {
    for (let l = this.index; l < this.top.children.length; l++) {
      ...
      if (a instanceof $t) {
        ...
        if (c != null && c != o)
          return !1;
        let u = a.dom, d, f = this.isLocked(u) && !(e.isText && a.node && a.node.isText && a.nodeDOM.nodeValue == e.text && a.dirty != ft && xs(t, a.outerDeco));
  ...
  recreateWrapper(e, t, r, i, o, s) {
    if (e.dirty || t.isAtom || !e.children.length || !e.node.content.eq(t.content))
      return null;
    let l = $t.create(this.top, t, r, i, o, s);
    if (l.contentDOM) {
  ...
  addNode(e, t, r, i, o) {
    let s = $t.create(this.top, e, t, r, i, o);
...
function el(n, e = null) {
  ...
  if (bo(t)) {
    for (a = l; i && !i.node; )
      i = i.parent;
    let u = i.node;
    if (i && u.isAtom && B.isSelectable(u) && i.parent && !(u.isInline && Hh(t.focusNode, t.focusOffset, i.dom))) {
      let d = i.posBefore;
...
function gu(n) {
  return n.editable ? n.hasFocus() : vu(n) && document.activeElement && document.activeElement.contains(n.dom);
}
function Et(n, e = !1) {
  ...
  if (yu(n, t), !!gu(n)) {
    ...
    if (n.domObserver.disconnectSelection(), n.cursorWrapper)
      ...
      sa && !(t instanceof P) && (t.$from.parent.inlineContent || (o = la(n, t.from)), !t.empty && !t.$from.parent.inlineContent && (s = la(n, t.to))), n.docView.setSelection(r, i, n.root, e), sa && (o && aa(o), s && aa(s)), t.visible ? n.dom.classList.remove("ProseMirror-hideselection") : (n.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && hp(n));
    }
    n.domObserver.setCurSelection(), n.domObserver.connectSelection();
  }
}
const sa = xe || we && Vh < 63;
function la(n, e) {
...
function hp(n) {
  ...
  e.addEventListener("selectionchange", n.input.hideSelectionGuard = () => {
    (t.anchorNode != r || t.anchorOffset != i) && (e.removeEventListener("selectionchange", n.input.hideSelectionGuard), setTimeout(() => {
      (!gu(n) || n.state.selection.visible) && n.dom.classList.remove("ProseMirror-hideselection");
    }, 20));
  });
}
function pp(n) {
  let e = n.domSelection(), t = document.createRange(), r = n.cursorWrapper.dom, i = r.nodeName == "IMG";
  i ? t.setEnd(r.parentNode, he(r) + 1) : t.setEnd(r, 0), t.collapse(!1), e.removeAllRanges(), e.addRange(t), !i && !n.state.selection.visible && Ae && _t <= 11 && (r.disabled = !0, r.disabled = !1);
}
function yu(n, e) {
  if (e instanceof B) {
    let t = n.docView.descAt(e.from);
    t != n.lastSelectedViewDesc && (ca(n), t && t.selectNode(), n.lastSelectedViewDesc = t);
  } else
    ca(n);
}
function ca(n) {
...
function ua(n) {
  return n.editable && !n.hasFocus() ? !1 : vu(n);
}
function vu(n) {
  ...
  if (r instanceof P)
    if (t.indexOf("s") > -1) {
      ...
      if (n.endOfTextblock(e > 0 ? "forward" : "backward")) {
        ...
        return o.isAtom || (s = n.docView.descAt(l)) && !s.contentDOM ? B.isSelectable(o) ? Lt(n, new B(e < 0 ? n.state.doc.resolve(i.pos - o.nodeSize) : i)) : Hr ? Lt(n, new P(n.state.doc.resolve(e < 0 ? l : l + o.nodeSize))) : !1 : !1;
      }
    } else
      return !1;
  else {
    if (r instanceof B && r.node.isInline)
      return Lt(n, new P(e > 0 ? r.$to : r.$from));
    {
      let i = Ss(n.state, e);
      return i ? Lt(n, i) : !1;
    }
...
function gp(n) {
  ...
  if (!t)
    return;
  let i, o, s = !1;
  for (et && t.nodeType == 1 && r < Ci(t) && hr(t.childNodes[r], -1) && (s = !0); ; )
    if (r > 0) {
      if (t.nodeType != 1)
        break;
      {
...
function Ms(n, e, t) {
  if (e.nodeType != 3) {
    let o, s;
    (s = vp(e, t)) ? (e = s, t = 0) : (o = bp(e, t)) && (e = o, t = o.nodeValue.length);
  }
...
function fa(n, e) {
  ...
  if (!(we || _h) && t.parent.inlineContent) {
...
function ha(n, e, t) {
  ...
  if (!i.parent.inlineContent) {
    let s = e < 0 ? i : o, l = r instanceof Ze ? F.near(s, e) : F.findFrom(s, e);
    return l ? Lt(n, l) : !1;
  }
  return !1;
}
...
function kp(n) {
  ...
  if (e && e.nodeType == 1 && t == 0 && e.firstChild && e.firstChild.contentEditable == "false") {
    let r = e.firstChild;
    ma(n, r, "true"), setTimeout(() => ma(n, r, "false"), 20);
  }
  return !1;
}
function wp(n) {
...
function xp(n, e) {
  ...
  if (t == 37 || $e && t == 66 && r == "c") {
    ...
    return da(n, i, r) || An(n, i);
  } else if (t == 39 || $e && t == 70 && r == "c") {
    let i = t == 39 ? fa(n, n.state.selection.from) == "ltr" ? 1 : -1 : 1;
    return da(n, i, r) || An(n, i);
  } else {
    if (t == 38 || $e && t == 80 && r == "c")
      return ha(n, -1, r) || An(n, -1);
    if (t == 40 || $e && t == 78 && r == "c")
      return kp(n) || ha(n, 1, r) || An(n, 1);
...
function ku(n, e) {
  ...
  let s = n.someProp("clipboardSerializer") || at.fromSchema(n.state.schema), l = Cu(), a = l.createElement("div");
...
function wu(n, e, t, r, i) {
  ...
  if (a) {
    if (n.someProp("transformPastedText", (f) => {
      ...
      return e ? new E(w.from(n.state.schema.text(e.replace(/\r\n?/g, `
`))), 0, 0) : E.empty;
  ...
  if (l || (l = (n.someProp("clipboardParser") || n.someProp("domParser") || jn.fromSchema(n.state.schema)).parseSlice(s, {
    ...
    l = Ep(ga(l, +u[1], +u[2]), u[4]);
  else if (l = E.maxOpen(Sp(l.content, i), !0), l.openStart || l.openEnd) {
    let d = 0, f = 0;
...
function Sp(n, e) {
  ...
  for (let t = e.depth; t >= 0; t--) {
    ...
    if (n.forEach((l) => {
      ...
      if (!a)
        return s = null;
      if (c = s.length && o.length && Tu(a, o, l, s[s.length - 1], 0))
        s[s.length - 1] = c;
      else {
        s.length && (s[s.length - 1] = Su(s[s.length - 1], o.length));
        let u = xu(l, a);
...
function Tu(n, e, t, r, i) {
  if (i < n.length && i < e.length && n[i] == e[i]) {
    let o = Tu(n, e, t, r.lastChild, i + 1);
    if (o)
      return r.copy(r.content.replaceChild(r.childCount - 1, o));
    if (r.contentMatchAt(r.childCount).matchType(i == n.length - 1 ? t.type : n[i + 1]))
      return r.copy(r.content.append(w.from(xu(t, n, i + 1))));
  }
}
function Su(n, e) {
  if (e == 0)
    return n;
  let t = n.content.replaceChild(n.childCount - 1, Su(n.lastChild, e - 1)), r = n.contentMatchAt(n.childCount).fillBefore(w.empty, !0);
  return n.copy(t.append(r));
}
function Cs(n, e, t, r, i, o) {
  let s = e < 0 ? n.firstChild : n.lastChild, l = s.content;
  return n.childCount > 1 && (o = 0), i < r - 1 && (l = Cs(l, e, t, r, i + 1, o)), i >= t && (l = e < 0 ? s.contentMatchAt(0).fillBefore(l, o <= i).append(l) : l.append(s.contentMatchAt(s.childCount).fillBefore(w.empty, !0))), n.replaceChild(e < 0 ? 0 : n.childCount - 1, s.copy(l));
}
function ga(n, e, t) {
  return e < n.openStart && (n = new E(Cs(n.content, -1, e, n.openStart, 0, n.openEnd), e, n.openEnd)), t < n.openEnd && (n = new E(Cs(n.content, 1, t, n.openEnd, 0, 0), n.openStart, t)), n;
}
const Mu = {
  thead: ["table"],
  tbody: ["table"],
...
function Mp(n) {
  ...
  let t = Cu().createElement("div"), r = /<([a-z][^>\s]+)/i.exec(n), i;
  if ((i = r && Mu[r[1].toLowerCase()]) && (n = i.map((o) => "<" + o + ">").join("") + n + i.map((o) => "</" + o + ">").reverse().join("")), t.innerHTML = n, i)
    for (let o = 0; o < i.length; o++)
...
function Ep(n, e) {
  ...
  for (let l = r.length - 2; l >= 0; l -= 2) {
    ...
    if (!a || a.hasRequiredAttrs())
      break;
    i = w.from(a.create(r[l + 1], i)), o++, s++;
  }
  return new E(i, o, s);
}
const Te = {}, Se = {}, Ap = { touchstart: !0, touchmove: !0 };
class Op {
  constructor() {
...
function Np(n) {
  for (let e in Te) {
    ...
    n.dom.addEventListener(e, n.input.eventHandlers[e] = (r) => {
      Bp(n, r) && !nl(n, r) && (n.editable || !(r.type in Se)) && t(n, r);
    }, Ap[e] ? { passive: !0 } : void 0);
  }
  xe && n.dom.addEventListener("input", () => null), Es(n);
}
function Vt(n, e) {
...
function Lp(n, e) {
  !nl(n, e) && Te[e.type] && (n.editable || !(e.type in Se)) && Te[e.type](n, e);
}
Se.keydown = (n, e) => {
  let t = e;
  if (n.input.shiftKey = t.keyCode == 16 || t.shiftKey, !Au(n, t) && (n.input.lastKeyCode = t.keyCode, n.input.lastKeyCodeTime = Date.now(), !(Qe && we && t.keyCode == 13)))
    if (t.keyCode != 229 && n.domObserver.forceFlush(), Kn && t.keyCode == 13 && !t.ctrlKey && !t.altKey && !t.metaKey) {
      ...
      n.someProp("handleKeyDown", (r) => r(n, t)) || xp(n, t) ? t.preventDefault() : Vt(n, "key");
};
Se.keyup = (n, e) => {
...
Se.keypress = (n, e) => {
  let t = e;
  if (Au(n, t) || !t.charCode || t.ctrlKey && !t.altKey || $e && t.metaKey)
    return;
...
function Hp(n, e, t, r, i) {
  return rl(n, "handleClickOn", e, t, r) || n.someProp("handleClick", (o) => o(n, e, r)) || (i ? Pp(n, t) : Ip(n, t));
}
function zp(n, e, t, r) {
  return rl(n, "handleDoubleClickOn", e, t, r) || n.someProp("handleDoubleClick", (i) => i(n, e, r));
}
function Fp(n, e, t, r) {
  return rl(n, "handleTripleClickOn", e, t, r) || n.someProp("handleTripleClick", (i) => i(n, e, r)) || Vp(n, t, r);
}
function Vp(n, e, t) {
  if (t.button != 0)
    return !1;
  let r = n.state.doc;
  if (e == -1)
    return r.inlineContent ? (Vn(n, P.create(r, 0, r.content.size), "pointer"), !0) : !1;
  let i = r.resolve(e);
  for (let o = i.depth + 1; o > 0; o--) {
    let s = o > i.depth ? i.nodeAfter : i.node(o), l = i.before(o);
    if (s.inlineContent)
      Vn(n, P.create(r, l + 1, l + 1 + s.content.size), "pointer");
...
const Eu = $e ? "metaKey" : "ctrlKey";
Te.mousedown = (n, e) => {
  let t = e;
  n.input.shiftKey = t.shiftKey;
  let r = il(n), i = Date.now(), o = "singleClick";
  i - n.input.lastClick.time < 500 && Rp(t, n.input.lastClick) && !t[Eu] && (n.input.lastClick.type == "singleClick" ? o = "doubleClick" : n.input.lastClick.type == "doubleClick" && (o = "tripleClick")), n.input.lastClick = { time: i, x: t.clientX, y: t.clientY, type: o };
  let s = n.posAtCoords(wo(t));
  s && (o == "singleClick" ? (n.input.mouseDown && n.input.mouseDown.done(), n.input.mouseDown = new _p(n, s, t, !!r)) : (o == "doubleClick" ? zp : Fp)(n, s.pos, s.inside, t) ? t.preventDefault() : Vt(n, "pointer"));
};
class _p {
  constructor(e, t, r, i) {
  ...
  up(e) {
    if (this.done(), !this.view.dom.contains(e.target))
      return;
    let t = this.pos;
    this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(wo(e))), this.updateAllowDefault(e), this.allowDefault || !t ? Vt(this.view, "pointer") : Hp(this.view, t.pos, t.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || // Safari ignores clicks on draggable elements
    ...
    // works around that.
    we && !this.view.state.selection.visible && Math.min(Math.abs(t.pos - this.view.state.selection.from), Math.abs(t.pos - this.view.state.selection.to)) <= 2) ? (Vn(this.view, F.near(this.view.state.doc.resolve(t.pos)), "pointer"), e.preventDefault()) : Vt(this.view, "pointer");
  }
  move(e) {
...
Te.touchstart = (n) => {
  n.input.lastTouch = Date.now(), il(n), Vt(n, "pointer");
};
Te.touchmove = (n) => {
  n.input.lastTouch = Date.now(), Vt(n, "pointer");
};
Te.contextmenu = (n) => il(n);
function Au(n, e) {
...
Se.compositionend = (n, e) => {
  n.composing && (n.input.composing = !1, n.input.compositionEndedAt = e.timeStamp, n.input.compositionPendingChanges = n.domObserver.pendingRecords().length ? n.input.compositionID : 0, n.input.compositionNode = null, n.input.compositionPendingChanges && Promise.resolve().then(() => n.domObserver.flush()), n.input.compositionID++, Ou(n, 20));
};
function Ou(n, e) {
...
function jp(n) {
  ...
  if (!e.focusNode)
    return null;
  let t = Ih(e.focusNode, e.focusOffset), r = Ph(e.focusNode, e.focusOffset);
  if (t && r && t != r) {
    let i = r.pmViewDesc;
...
const Tr = Ae && _t < 15 || Kn && $h < 604;
Te.copy = Se.cut = (n, e) => {
  let t = e, r = n.state.selection, i = t.type == "cut";
  if (r.empty)
    return;
  let o = Tr ? null : t.clipboardData, s = r.content(), { dom: l, text: a } = ku(n, s);
  o ? (t.preventDefault(), o.clearData(), o.setData("text/html", l.innerHTML), o.setData("text/plain", a)) : qp(n, l), i && n.dispatch(n.state.tr.deleteSelection().scrollIntoView().setMeta("uiEvent", "cut"));
};
function Kp(n) {
...
function Sr(n, e, t, r, i) {
  let o = wu(n, e, t, r, n.state.selection.$from);
...
Se.paste = (n, e) => {
  ...
  r && Sr(n, Du(r), r.getData("text/html"), i, t) ? t.preventDefault() : Up(n, t);
};
class Bu {
  constructor(e, t, r) {
...
Te.dragstart = (n, e) => {
  ...
  let l = (s || n.state.selection).content(), { dom: a, text: c, slice: u } = ku(n, l);
  t.dataTransfer.clearData(), t.dataTransfer.setData(Tr ? "Text" : "text/html", a.innerHTML), t.dataTransfer.effectAllowed = "copyMove", Tr || t.dataTransfer.setData("text/plain", c), n.dragging = new Bu(u, !t[Lu], s);
};
Te.dragend = (n) => {
  let e = n.dragging;
  window.setTimeout(() => {
...
Se.drop = (n, e) => {
  ...
  s ? n.someProp("transformPasted", (p) => {
    s = p(s, n);
  }) : s = wu(n, Du(t.dataTransfer), Tr ? null : t.dataTransfer.getData("text/html"), !1, o);
  let l = !!(r && !t[Lu]);
  ...
  if (!s)
    return;
  t.preventDefault();
  let a = s ? th(n.state.doc, o.pos, s) : o.pos;
  a == null && (a = o.pos);
  let c = n.state.tr;
  if (l) {
    let { node: p } = r;
  ...
  if (d && B.isSelectable(s.content.firstChild) && h.nodeAfter && h.nodeAfter.sameMarkup(s.content.firstChild))
    ...
    c.mapping.maps[c.mapping.maps.length - 1].forEach((m, g, v, x) => p = x), c.setSelection(tl(n, h, c.doc.resolve(p)));
  }
...
class Ai {
  ...
  eq(e) {
    return this == e || e instanceof Ai && (this.spec.key && this.spec.key == e.spec.key || this.toDOM == e.toDOM && Mr(this.spec, e.spec));
  }
  destroy(e) {
...
class jt {
  ...
  eq(e) {
    return this == e || e instanceof jt && Mr(this.attrs, e.attrs) && Mr(this.spec, e.spec);
  }
  static is(e) {
...
class ol {
  ...
  eq(e) {
    return this == e || e instanceof ol && Mr(this.attrs, e.attrs) && Mr(this.spec, e.spec);
  }
  destroy() {
  }
}
...
class re {
  ...
  */
  mapInner(e, t, r, i, o) {
    ...
    return this.children.length ? Jp(this.children, s || [], e, t, r, i, o) : s ? new re(s.sort(hn), Bn) : ge;
  }
  /**
    ...
    t.maps[c].forEach((f, h, p, m) => {
      ...
      for (let v = 0; v < l.length; v += 3) {
        ...
        if (x < 0 || f > x + u - d)
          continue;
        let T = l[v] + u - d;
        h >= T ? l[v + 1] = f <= T ? -2 : -1 : f >= u && g && (l[v] += g, l[v + 1] += g);
      }
      d += g;
    }), u = t.maps[c].map(u, -1);
  }
  ...
  for (let c = 0; c < l.length; c += 3)
    if (l[c + 1] < 0) {
      ...
      if (g && m == d && m + g.nodeSize == h) {
        ...
        v != ge ? (l[c] = d, l[c + 1] = h, l[c + 2] = v) : (l[c + 1] = -2, a = !0);
      } else
        a = !0;
    }
  if (a) {
    let c = Gp(l, n, e, t, i, o, s), u = Oi(c, r, 0, s);
    e = u.local;
  ...
  for (let t = 0; t < e.length - 1; t++) {
    ...
    if (r.from != r.to)
      for (let i = t + 1; i < e.length; i++) {
        let o = e[i];
        if (o.from == r.from) {
          o.to != r.to && (e == n && (e = n.slice()), e[i] = o.copy(o.from, r.to), va(e, i + 1, o.copy(r.to, o.to)));
          continue;
        } else {
          o.from < r.to && (e == n && (e = n.slice()), e[t] = r.copy(r.from, o.from), va(e, i, r.copy(o.from, r.to)));
          break;
        }
      }
  }
...
class Zp {
  constructor(e, t) {
    this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new Xp(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.observer = window.MutationObserver && new window.MutationObserver((r) => {
      for (let i = 0; i < r.length; i++)
        this.queue.push(r[i]);
      Ae && _t <= 11 && r.some((i) => i.type == "childList" && i.removedNodes.length || i.type == "characterData" && i.oldValue.length > i.target.nodeValue.length) ? this.flushSoon() : this.flush();
  ...
  onSelectionChange() {
    if (ua(this.view)) {
      if (this.suppressingSelectionUpdates)
        return Et(this.view);
      if (Ae && _t <= 11 && !this.view.state.selection.empty) {
  ...
  flush() {
    ...
    let c = null;
    o < 0 && i && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && bo(r) && (c = el(e)) && c.eq(F.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, Et(e), this.currentSelection.set(r), e.scrollToSelection()) : (o > -1 || i) && (o > -1 && (e.docView.markDirty(o, s), em(e)), this.handleDOMChange(o, s, l, a), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(r) || Et(e), this.currentSelection.set(r));
  }
  registerMutation(e, t) {
    ...
    if (e.type == "childList") {
      ...
      if (Ae && _t <= 11 && e.addedNodes.length)
        for (let u = 0; u < e.addedNodes.length; u++) {
...
let ba = /* @__PURE__ */ new WeakMap(), ka = !1;
function em(n) {
  if (!ba.has(n) && (ba.set(n, null), ["normal", "nowrap", "pre-line"].indexOf(getComputedStyle(n.dom).whiteSpace) !== -1)) {
    if (n.requiresGeckoHackNode = et, ka)
      return;
...
function tm(n, e) {
  ...
  return n.dom.addEventListener("beforeinput", r, !0), document.execCommand("indent"), n.dom.removeEventListener("beforeinput", r, !0), t ? wa(n, t) : null;
}
function nm(n, e, t) {
  let { node: r, fromOffset: i, toOffset: o, from: s, to: l } = n.docView.parseRange(e, t), a = n.domSelectionRange(), c, u = a.anchorNode;
  if (u && n.dom.contains(u.nodeType == 1 ? u : u.parentNode) && (c = [{ node: u, offset: a.anchorOffset }], bo(a) || c.push({ node: a.focusNode, offset: a.focusOffset })), we && n.input.lastKeyCode === 8)
    for (let g = o; g > i; g--) {
...
const im = /^(a|abbr|acronym|b|bd[io]|big|br|button|cite|code|data(list)?|del|dfn|em|i|ins|kbd|label|map|mark|meter|output|q|ruby|s|samp|small|span|strong|su[bp]|time|u|tt|var)$/i;
function om(n, e, t, r, i) {
  let o = n.input.compositionPendingChanges || (n.composing ? n.input.compositionID : 0);
  if (n.input.compositionPendingChanges = 0, e < 0) {
    let M = n.input.lastSelectionTime > Date.now() - 50 ? n.input.lastSelectionOrigin : null, R = el(n, M);
    if (R && !n.state.selection.eq(R)) {
      if (we && Qe && n.input.lastKeyCode === 13 && Date.now() - 100 < n.input.lastKeyCodeTime && n.someProp("handleKeyDown", (W) => W(n, rn(13, "Enter"))))
        return;
      let $ = n.state.tr.setSelection(R);
      M == "pointer" ? $.setMeta("pointer", !0) : M == "key" && $.scrollIntoView(), o && $.setMeta("composition", o), n.dispatch($);
    }
    return;
  }
  let s = n.state.doc.resolve(e), l = s.sharedDepth(t);
  e = s.before(l + 1), t = n.state.doc.resolve(t).after(l + 1);
  let a = n.state.selection, c = nm(n, e, t), u = n.state.doc, d = u.slice(c.from, c.to), f, h;
  n.input.lastKeyCode === 8 && Date.now() - 100 < n.input.lastKeyCodeTime ? (f = n.state.selection.to, h = "end") : (f = n.state.selection.from, h = "start"), n.input.lastKeyCode = null;
  let p = am(d.content, c.doc.content, c.from, f, h);
  if ((Kn && n.input.lastIOSEnter > Date.now() - 225 || Qe) && i.some((M) => M.nodeType == 1 && !im.test(M.nodeName)) && (!p || p.endA >= p.endB) && n.someProp("handleKeyDown", (M) => M(n, rn(13, "Enter")))) {
  ...
  if (!p)
    if (r && a instanceof P && !a.empty && a.$head.sameParent(a.$anchor) && !n.composing && !(c.sel && c.sel.anchor != c.sel.head))
      ...
      if (c.sel) {
        let M = xa(n, n.state.doc, c.sel);
        if (M && !M.eq(n.state.selection)) {
          let R = n.state.tr.setSelection(M);
          o && R.setMeta("composition", o), n.dispatch(R);
        }
      }
      return;
    }
  n.input.domChangeCount++, n.state.selection.from < n.state.selection.to && p.start == p.endB && n.state.selection instanceof P && (p.start > n.state.selection.from && p.start <= n.state.selection.from + 2 && n.state.selection.from >= c.from ? p.start = n.state.selection.from : p.endA < n.state.selection.to && p.endA >= n.state.selection.to - 2 && n.state.selection.to <= c.to && (p.endB += n.state.selection.to - p.endA, p.endA = n.state.selection.to)), Ae && _t <= 11 && p.endB == p.start + 1 && p.endA == p.start && p.start > c.from && c.doc.textBetween(p.start - c.from - 1, p.start - c.from + 1) == "  " && (p.start--, p.endA--, p.endB--);
  let m = c.doc.resolveNoCache(p.start - c.from), g = c.doc.resolveNoCache(p.endB - c.from), v = u.resolve(p.start), x = m.sameParent(g) && m.parent.inlineContent && v.end() >= p.endA, T;
  if ((Kn && n.input.lastIOSEnter > Date.now() - 225 && (!x || i.some((M) => M.nodeName == "DIV" || M.nodeName == "P")) || !x && m.pos < c.doc.content.size && !m.sameParent(g) && (T = F.findFrom(c.doc.resolve(m.pos + 1), 1, !0)) && T.head == g.pos) && n.someProp("handleKeyDown", (M) => M(n, rn(13, "Enter")))) {
    n.input.lastIOSEnter = 0;
    return;
  }
  if (n.state.selection.anchor > p.start && lm(u, p.start, p.endA, m, g) && n.someProp("handleKeyDown", (M) => M(n, rn(8, "Backspace")))) {
    Qe && we && n.domObserver.suppressSelectionUpdates();
    return;
  }
  we && Qe && p.endB == p.start && (n.input.lastAndroidDelete = Date.now()), Qe && !x && m.start() != g.start() && g.parentOffset == 0 && m.depth == g.depth && c.sel && c.sel.anchor == c.sel.head && c.sel.head == p.endA && (p.endB -= 2, g = c.doc.resolveNoCache(p.endB - c.from), setTimeout(() => {
    n.someProp("handleKeyDown", function(M) {
      return M(n, rn(13, "Enter"));
    });
  }, 20));
  let y = p.start, C = p.endA, b, O, V;
  if (x) {
    if (m.pos == g.pos)
      Ae && _t <= 11 && m.parentOffset == 0 && (n.domObserver.suppressSelectionUpdates(), setTimeout(() => Et(n), 20)), b = n.state.tr.delete(y, C), O = u.resolve(p.start).marksAcross(u.resolve(p.endA));
    else if (
      // Adding or removing a mark
      p.endA == p.endB && (V = sm(m.parent.content.cut(m.parentOffset, g.parentOffset), v.parent.content.cut(v.parentOffset, p.endA - v.start())))
    )
      b = n.state.tr, V.type == "add" ? b.addMark(y, C, V.mark) : b.removeMark(y, C, V.mark);
    else if (m.parent.child(m.index()).isText && m.index() == g.index() - (g.textOffset ? 0 : 1)) {
      let M = m.parent.textBetween(m.parentOffset, g.parentOffset);
      if (n.someProp("handleTextInput", (R) => R(n, y, C, M)))
        return;
      b = n.state.tr.insertText(M, y, C);
    }
  }
  if (b || (b = n.state.tr.replace(y, C, c.doc.slice(p.start - c.from, p.endB - c.from))), c.sel) {
    let M = xa(n, b.doc, c.sel);
    M && !(we && Qe && n.composing && M.empty && (p.start != p.endB || n.input.lastAndroidDelete < Date.now() - 100) && (M.head == y || M.head == b.mapping.map(C) - 1) || Ae && M.empty && M.head == y) && b.setSelection(M);
  }
...
function am(n, e, t, r, i) {
  ...
  if (s < o && n.size < e.size) {
    let a = r <= o && r >= s ? o - r : 0;
    o -= a, o && o < e.size && Ta(e.textBetween(o - 1, o + 1)) && (o += a ? 1 : -1), l = o + (l - s), s = o;
  } else if (l < o) {
    let a = r <= o && r >= l ? o - r : 0;
    o -= a, o && o < n.size && Ta(n.textBetween(o - 1, o + 1)) && (o += a ? 1 : -1), s = o + (s - l), l = o;
  }
...
class cm {
  ...
  */
  constructor(e, t) {
    this._root = null, this.focused = !1, this.trackWrites = null, this.mounted = !1, this.markCursor = null, this.cursorWrapper = null, this.lastSelectedViewDesc = void 0, this.input = new Op(), this.prevDirectPlugins = [], this.pluginViews = [], this.requiresGeckoHackNode = !1, this.dragging = null, this._props = t, this.state = t.state, this.directPlugins = t.plugins || [], this.directPlugins.forEach(Aa), this.dispatch = this.dispatch.bind(this), this.dom = e && e.mount || document.createElement("div"), e && (e.appendChild ? e.appendChild(this.dom) : typeof e == "function" ? e(this.dom) : e.mount && (this.mounted = !0)), this.editable = Ca(this), Ma(this), this.nodeViews = Ea(this), this.docView = ia(this.state.doc, Sa(this), qo(this), this.dom, this), this.domObserver = new Zp(this, (r, i, o, s) => om(this, r, i, o, s)), this.domObserver.start(), Np(this), this.updatePluginViews();
  }
  /**
  Holds `true` when a
  ...
  */
  update(e) {
    ...
    let t = this._props;
    this._props = e, e.plugins && (e.plugins.forEach(Aa), this.directPlugins = e.plugins), this.updateStateInner(e.state, t);
  }
  /**
  ...
  */
  ...
  updateStateInner(e, t) {
    ...
    if (l || this._props.plugins != t.plugins || this._props.nodeViews != t.nodeViews) {
      let h = Ea(this);
      dm(h, this.nodeViews) && (this.nodeViews = h, o = !0);
    }
    (l || t.handleDOMEvents != this._props.handleDOMEvents) && Es(this), this.editable = Ca(this), Ma(this);
    let a = qo(this), c = Sa(this), u = i.plugins != e.plugins && !i.doc.eq(e.doc) ? "reset" : e.scrollToSelection > i.scrollToSelection ? "to selection" : "preserve", d = o || !this.docView.matchesNode(e.doc, c, a);
    (d || !e.selection.eq(i.selection)) && (s = !0);
    let f = u == "preserve" && s && this.dom.style.overflowAnchor == null && qh(this);
    if (s) {
      this.domObserver.stop();
      let h = d && (Ae || we) && !this.composing && !i.selection.empty && !e.selection.empty && um(i.selection, e.selection);
      if (d) {
        let p = we ? this.trackWrites = this.domSelectionRange().focusNode : null;
        this.composing && (this.input.compositionNode = jp(this)), (o || !this.docView.update(e.doc, c, a, this)) && (this.docView.updateOuterDeco(c), this.docView.destroy(), this.docView = ia(e.doc, c, a, this.dom, this)), p && !this.trackWrites && (h = !0);
      }
      h || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && mp(this)) ? Et(this, h) : (yu(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
    }
  ...
  */
  scrollToSelection() {
    ...
    if (!this.someProp("handleScrollToSelection", (t) => t(this)))
      if (this.state.selection instanceof B) {
        ...
        t.nodeType == 1 && Xl(this, t.getBoundingClientRect(), e);
      } else
        Xl(this, this.coordsAtPos(this.state.selection.head, 1), e);
  }
  destroyPluginViews() {
    let e;
  ...
  updateDraggedNode(e, t) {
    ...
    this.dragging = new Bu(e.slice, e.move, i < 0 ? void 0 : B.create(this.state.doc, i));
  }
  someProp(e, t) {
  ...
  */
  focus() {
    this.domObserver.stop(), this.editable && Uh(this.dom), Et(this), this.domObserver.start();
  }
  /**
  ...
  */
  destroy() {
    this.docView && (Dp(this), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], qo(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null, Lh());
  }
  /**
  ...
  */
  domSelectionRange() {
    ...
    return xe && this.root.nodeType === 11 && zh(this.dom.ownerDocument) == this.dom && tm(this, e) || e;
  }
  /**
  @internal
  */
...
var qt = {
  ...
  221: "}",
  222: '"'
}, fm = typeof navigator < "u" && /Mac/.test(navigator.platform), hm = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
...
function pm(n) {
  var e = fm && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey || hm && n.shiftKey && n.key && n.key.length == 1 || n.key == "Unidentified", t = !e && n.key || (n.shiftKey ? Ni : qt)[n.keyCode] || n.key || "Unidentified";
  return t == "Esc" && (t = "Escape"), t == "Del" && (t = "Delete"), t == "Left" && (t = "ArrowLeft"), t == "Up" && (t = "ArrowUp"), t == "Right" && (t = "ArrowRight"), t == "Down" && (t = "ArrowDown"), t;
}
const mm = typeof navigator < "u" ? /Mac|iP(hone|[oa]d)/.test(navigator.platform) : !1;
function gm(n) {
...
function vm(n) {
  return new le({ props: { handleKeyDown: Hu(n) } });
}
function Hu(n) {
  let e = ym(n);
  return function(t, r) {
    let i = pm(r), o, s = e[Jo(i, r)];
...
const bm = (n, e) => n.selection.empty ? !1 : (e && e(n.tr.deleteSelection().scrollIntoView()), !0);
function zu(n, e) {
...
const km = (n, e, t) => {
  ...
  let o = i.nodeBefore;
  if (!o.type.spec.isolating && $u(n, i, e))
    return !0;
  if (r.parent.content.size == 0 && (Un(o, "end") || B.isSelectable(o))) {
    ...
    if (s && s.slice.size < s.to - s.from) {
      if (e) {
        let l = n.tr.step(s);
        l.setSelection(Un(o, "end") ? F.findFrom(l.doc.resolve(l.mapping.map(i.pos, -1)), -1) : B.create(l.doc, i.pos - o.nodeSize)), e(l.scrollIntoView());
      }
      return !0;
    }
  }
...
function Fu(n, e, t) {
  ...
  if (t) {
    let u = n.tr.step(c);
    u.setSelection(P.create(u.doc, o)), t(u.scrollIntoView());
  }
  return !0;
}
function Un(n, e, t = !1) {
...
const Sm = (n, e, t) => {
  ...
  if (r.parent.content.size == 0 && (Un(o, "start") || B.isSelectable(o))) {
    ...
    if (s && s.slice.size < s.to - s.from) {
      if (e) {
        let l = n.tr.step(s);
        l.setSelection(Un(o, "start") ? F.findFrom(l.doc.resolve(l.mapping.map(i.pos)), 1) : B.create(l.doc, l.mapping.map(i.pos))), e(l.scrollIntoView());
      }
      return !0;
    }
  }
...
const Nm = (n, e) => {
  ...
  if (!t.parent.type.spec.code || !t.sameParent(r))
    return !1;
  let i = t.node(-1), o = t.indexAfter(-1), s = _u(i.contentMatchAt(o));
  ...
  if (t instanceof Ze || r.parent.inlineContent || i.parent.inlineContent)
    return !1;
  let o = _u(i.parent.contentMatchAt(i.indexAfter()));
  if (!o || !o.isTextblock)
    return !1;
  if (e) {
...
function $u(n, e, t) {
  ...
  if (l && (o = (s = r.contentMatchAt(r.childCount)).findWrapping(i.type)) && s.matchType(o[0] || i.type).validEnd) {
    if (t) {
      let d = e.pos + i.nodeSize, f = w.empty;
      for (let m = o.length - 1; m >= 0; m--)
        f = w.from(o[m].create(null, f));
      f = w.from(r.copy(f));
  ...
  let a = F.findFrom(e, 1), c = a && a.$from.blockRange(a.$to), u = c && Zn(c);
  if (u != null && u >= e.depth)
...
const Im = ju(-1), Pm = ju(1);
function Hm(n, e = null) {
  return function(t, r) {
    let { $from: i, $to: o } = t.selection, s = i.blockRange(o), l = s && Qs(s, n, e);
...
function Vm(n) {
  return function(e, t) {
    ...
    return o ? t ? r.node(o.depth - 1).type == n ? _m(e, t, n, o) : $m(e, t, o) : !0 : !1;
  };
}
function _m(n, e, t, r) {
  let i = n.tr, o = r.end, s = r.$to.end(r.depth);
  o < s && (i.step(new ce(o - 1, s, o, s, new E(w.from(t.create(null, r.parent.copy())), 1, 0), 1, !0)), r = new xi(i.doc.resolve(r.$from.pos), i.doc.resolve(s), r.depth));
  const l = Zn(r);
  if (l == null)
    return !1;
  i.lift(r, l);
...
function $m(n, e, t) {
  ...
  return r.step(new ce(d - (l ? 1 : 0), f + (a ? 1 : 0), d + 1, f - 1, new E((l ? w.empty : w.from(i.copy(w.empty))).append(a ? w.empty : w.from(i.copy(w.empty))), l ? 0 : 1, a ? 0 : 1), l ? 0 : 1)), e(r.scrollIntoView()), !0;
}
function jm(n) {
  return function(e, t) {
    ...
    if (a.type != n)
      return !1;
    if (t) {
      let c = a.lastChild && a.lastChild.type == l.type, u = w.from(c ? n.create() : null), d = new E(w.from(n.create(null, w.from(l.type.create(null, u)))), c ? 3 : 1, 0), f = o.start, h = o.end;
...
function Wu(n) {
  const e = [], { nodeExtensions: t, markExtensions: r } = So(n), i = [...t, ...r], o = {
    default: null,
    rendered: !0,
    renderHTML: null,
    parseHTML: null,
...
function z(n, e = void 0, ...t) {
  return qu(n) ? e ? n.bind(e)(...t) : n(...t) : n;
}
function qm(n = {}) {
  ...
  return n.style ? n : {
    ...
    getAttrs: (t) => {
      ...
      const i = e.reduce((o, s) => {
        const l = s.attribute.parseHTML ? s.attribute.parseHTML(t) : Km(t.getAttribute(s.name));
        return l == null ? o : {
          ...o,
          [s.name]: l
        };
...
function Da(n) {
  return Object.fromEntries(
    // @ts-ignore
    Object.entries(n).filter(([e, t]) => e === "attrs" && qm(t) ? !1 : t != null)
  );
}
function Um(n, e) {
  var t;
  const r = Wu(n), { nodeExtensions: i, markExtensions: o } = So(n), s = (t = i.find((c) => A(c, "topNode"))) === null || t === void 0 ? void 0 : t.name, l = Object.fromEntries(i.map((c) => {
    const u = r.filter((v) => v.type === c.name), d = {
      ...
      const T = A(x, "extendNodeSchema", d);
      return {
        ...v,
        ...T ? T(c) : {}
      };
      ...
      marks: z(A(c, "marks", d)),
      group: z(A(c, "group", d)),
      inline: z(A(c, "inline", d)),
      atom: z(A(c, "atom", d)),
      selectable: z(A(c, "selectable", d)),
      draggable: z(A(c, "draggable", d)),
      code: z(A(c, "code", d)),
    ...
    p && (h.parseDOM = p.map((v) => Na(v, u)));
    const m = A(c, "renderHTML", d);
    m && (h.toDOM = (v) => m({
      node: v,
      HTMLAttributes: As(v, u)
    }));
    ...
    const u = r.filter((g) => g.type === c.name), d = {
      ...
      const x = A(v, "extendMarkSchema", d);
      return {
        ...g,
        ...x ? x(c) : {}
      };
    ...
    p && (h.parseDOM = p.map((g) => Na(g, u)));
    const m = A(c, "renderHTML", d);
    return m && (h.toDOM = (g) => m({
      mark: g,
      HTMLAttributes: As(g, u)
    })), [c.name, h];
  }));
  return new Of({
    topNode: s,
...
function ri(n) {
  ...
  return s.forEach((f) => {
    ...
    const p = a.state.tr, m = xo({
      ...
      to: i
    }, { commands: v, chain: x, can: T } = new To({
      editor: t,
      state: m
    });
    f.handler({
...
function Zm(n) {
  const { editor: e, state: t, from: r, to: i, rule: o, pasteEvent: s, dropEvent: l } = n, { commands: a, chain: c, can: u } = new To({
    editor: e,
    state: t
  }), d = [];
  return t.doc.nodesBetween(r, i, (h, p) => {
    ...
    Xm(v, o.find, s).forEach((T) => {
      if (T.index === void 0)
        return;
      const y = m + T.index + 1, C = y + T[0].length, b = {
...
function tg(n) {
  ...
  return t.map((u) => new le({
    ...
    appendTransaction: (d, f, h) => {
      const p = d[0], m = p.getMeta("uiEvent") === "paste" && !i, g = p.getMeta("uiEvent") === "drop" && !o, v = p.getMeta("applyPasteRules"), x = !!v;
      if (!m && !g && !x)
        return;
      if (x) {
        const { from: C, text: b } = v, O = C + b.length, V = eg(b);
        return a({
          rule: u,
          state: h,
          from: C,
...
class Pn {
  constructor(e, t) {
    this.splittableMarks = [], this.editor = t, this.extensions = Pn.resolve(e), this.schema = Um(this.extensions, t), this.setupExtensions();
  }
  /**
   ...
   */
  static resolve(e) {
    const t = Pn.sort(Pn.flatten(e)), r = ng(t.map((i) => i.name));
   ...
   */
  get nodeViews() {
    const { editor: e } = this, { nodeExtensions: t } = So(this.extensions);
  ...
  setupExtensions() {
    this.extensions.forEach((e) => {
      ...
      e.type === "mark" && (!((t = z(A(e, "keepOnSplit", r))) !== null && t !== void 0) || t) && this.splittableMarks.push(e.name);
...
function Mo(n, e) {
  ...
  return Yo(n) && Yo(e) && Object.keys(e).forEach((r) => {
    Yo(e[r]) ? r in n ? t[r] = Mo(n[r], e[r]) : Object.assign(t, { [r]: e[r] }) : Object.assign(t, { [r]: e[r] });
  }), t;
}
class ee {
  constructor(e = {}) {
    this.type = "extension", this.name = "extension", this.parent = null, this.child = null, this.config = {
      ...
      ...this.config,
      ...e
    }, this.name = this.config.name, e.defaultOptions && Object.keys(e.defaultOptions).length > 0 && console.warn(`[tiptap warn]: BREAKING CHANGE: "defaultOptions" is deprecated. Please use "addOptions" instead. Found in extension: "${this.name}".`), this.options = this.config.defaultOptions, this.config.addOptions && (this.options = z(A(this, "addOptions", {
      name: this.name
    }))), this.storage = z(A(this, "addStorage", {
      name: this.name,
  ...
  configure(e = {}) {
    const t = this.extend();
    return t.parent = this.parent, t.options = Mo(this.options, e), t.storage = z(A(t, "addStorage", {
      name: t.name,
      options: t.options
    })), t;
  }
  extend(e = {}) {
    ...
    return t.parent = this, this.child = t, t.name = e.name ? e.name : t.parent.name, e.defaultOptions && console.warn(`[tiptap warn]: BREAKING CHANGE: "defaultOptions" is deprecated. Please use "addOptions" instead. Found in extension: "${t.name}".`), t.options = z(A(t, "addOptions", {
      name: t.name
    })), t.storage = z(A(t, "addStorage", {
      name: t.name,
      options: t.options
    })), t;
  }
      ...
      new le({
        ...
        props: {
          clipboardTextSerializer: () => {
            const { editor: n } = this, { state: e, schema: t } = n, { doc: r, selection: i } = e, { ranges: o } = i, s = Math.min(...o.map((u) => u.$from.pos)), l = Math.max(...o.map((u) => u.$to.pos)), a = Ju(t);
...
}), !0), sg = (n = !1) => ({ commands: e }) => e.setContent("", n), lg = () => ({ state: n, tr: e, dispatch: t }) => {
...
}, ag = (n) => (e) => n(e), cg = () => ({ state: n, dispatch: e }) => Dm(n, e), ug = (n, e) => ({ editor: t, tr: r }) => {
  const { state: i } = t, o = i.doc.slice(n.from, n.to);
  r.deleteRange(n.from, n.to);
  const s = r.mapping.map(e);
  return r.insert(s, o.content), r.setSelection(new P(r.doc.resolve(s - 1))), !0;
}, dg = () => ({ tr: n, dispatch: e }) => {
...
}, pg = () => ({ state: n, dispatch: e }) => bm(n, e), mg = () => ({ commands: n }) => n.keyboardShortcut("Enter"), gg = () => ({ state: n, dispatch: e }) => Nm(n, e);
...
function ul(n, e, t = {}) {
  ...
  for (Os([...r.node.marks], e, t); o > 0 && i.isInSet(n.parent.child(o - 1).marks); )
    o -= 1, s -= n.parent.child(o).nodeSize;
  for (; l < n.parent.childCount && yg([...n.parent.child(l).marks], e, t); )
...
const vg = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
  const o = Yt(n, r.schema), { doc: s, selection: l } = t, { $from: a, from: c, to: u } = l;
  if (i) {
    const d = ul(a, o, e);
    if (d && d.from <= c && d.to >= u) {
      const f = P.create(s, d.from, d.to);
      t.setSelection(f);
    }
  }
  return !0;
...
function Gu(n, e = null) {
  ...
  return e === "all" ? P.create(n, Mt(0, i, o), Mt(n.content.size, i, o)) : P.create(n, Mt(e, i, o), Mt(e, i, o));
}
function fl() {
  return [
    "iPad Simulator",
...
const kg = (n = null, e = {}) => ({ editor: t, view: r, tr: i, dispatch: o }) => {
  e = {
    scrollIntoView: !0,
    ...e
  };
  ...
  if (r.hasFocus() && n === null || n === !1)
    return !0;
  if (o && n === null && !dl(t.state.selection))
    return s(), !0;
  const l = Gu(i.doc, n) || t.state.selection, a = t.state.selection.eq(l);
  return o && (a || i.setSelection(l), a && i.storedMarks && i.setStoredMarks(i.storedMarks), s()), !0;
}, wg = (n, e) => (t) => n.every((r, i) => e(r, { ...t, index: i })), xg = (n, e) => ({ tr: t, commands: r }) => r.insertContentAt({ from: t.selection.from, to: t.selection.to }, n, e), Yu = (n) => {
  const e = n.childNodes;
  for (let t = e.length - 1; t >= 0; t -= 1) {
    const r = e[t];
    r.nodeType === 3 && r.nodeValue && /^(\n\s\s|\n)$/.test(r.nodeValue) ? n.removeChild(r) : r.nodeType === 1 && Yu(r);
  }
  return n;
};
function La(n) {
...
function Bi(n, e, t) {
  ...
  if (r)
    try {
      return Array.isArray(n) && n.length > 0 ? w.fromArray(n.map((s) => e.nodeFromJSON(s))) : e.nodeFromJSON(n);
    } catch (o) {
      return console.warn("[tiptap warn]: Invalid content.", "Passed value:", n, "Error:", o), Bi("", e, t);
    }
  if (i) {
    const o = jn.fromSchema(e);
    return t.slice ? o.parseSlice(La(n), t.parseOptions).content : o.parse(La(n), t.parseOptions);
  }
  return Bi("", e, t);
}
function Tg(n, e, t) {
...
const Sg = (n) => n.toString().startsWith("<"), Mg = (n, e, t) => ({ tr: r, dispatch: i, editor: o }) => {
  if (i) {
    t = {
      parseOptions: {},
      updateSelection: !0,
    ...
    let f;
    c ? (Array.isArray(e) ? f = e.map((h) => h.text || "").join("") : typeof e == "object" && e && e.text ? f = e.text : f = e, r.insertText(f, l, a)) : (f = s, r.replaceWith(l, a, f)), t.updateSelection && Tg(r, r.steps.length - 1, -1), t.applyInputRules && r.setMeta("applyInputRules", { from: l, text: f }), t.applyPasteRules && r.setMeta("applyPasteRules", { from: l, text: f });
  }
  return !0;
}, Cg = () => ({ state: n, dispatch: e }) => Cm(n, e), Eg = () => ({ state: n, dispatch: e }) => Em(n, e), Ag = () => ({ state: n, dispatch: e }) => km(n, e), Og = () => ({ state: n, dispatch: e }) => Sm(n, e), Ng = () => ({ tr: n, state: e, dispatch: t }) => {
  try {
...
}, Bg = () => ({ state: n, dispatch: e }) => wm(n, e), Lg = () => ({ state: n, dispatch: e }) => xm(n, e);
function Qu() {
...
const Ig = (n) => ({ editor: e, view: t, tr: r, dispatch: i }) => {
  const o = Rg(n).split(/-(?!$)/), s = o.find((c) => !["Alt", "Ctrl", "Meta", "Shift"].includes(c)), l = new KeyboardEvent("keydown", {
    key: s === "Space" ? " " : s,
...
const Pg = (n, e = {}) => ({ state: t, dispatch: r }) => {
  const i = de(n, t.schema);
  return Cr(t, i, e) ? Am(t, r) : !1;
}, Hg = () => ({ state: n, dispatch: e }) => Bm(n, e), zg = (n) => ({ state: e, dispatch: t }) => {
  const r = de(n, e.schema);
  return Vm(r)(e, t);
}, Fg = () => ({ state: n, dispatch: e }) => Om(n, e);
function Co(n, e) {
...
const Vg = (n, e) => ({ tr: t, state: r, dispatch: i }) => {
  let o = null, s = null;
  const l = Co(typeof n == "string" ? n : n.name, r.schema);
  return l ? (l === "node" && (o = de(n, r.schema)), l === "mark" && (s = Yt(n, r.schema)), i && t.selection.ranges.forEach((a) => {
    r.doc.nodesBetween(a.$from.pos, a.$to.pos, (c, u) => {
      o && o === c.type && t.setNodeMarkup(u, void 0, Ra(c.attrs, e)), s && c.marks.length && c.marks.forEach((d) => {
        s === d.type && t.addMark(u, u + c.nodeSize, s.create(Ra(d.attrs, e)));
      });
    });
  }), !0) : !1;
}, _g = () => ({ tr: n, dispatch: e }) => (e && n.scrollIntoView(), !0), $g = () => ({ tr: n, commands: e }) => e.setTextSelection({
  from: 0,
  to: n.doc.content.size
}), jg = () => ({ state: n, dispatch: e }) => Tm(n, e), Wg = () => ({ state: n, dispatch: e }) => Mm(n, e), qg = () => ({ state: n, dispatch: e }) => Lm(n, e), Kg = () => ({ state: n, dispatch: e }) => Pm(n, e), Ug = () => ({ state: n, dispatch: e }) => Im(n, e);
function Xu(n, e, t = {}) {
  return Bi(n, e, { slice: !1, parseOptions: t });
}
const Jg = (n, e = !1, t = {}) => ({ tr: r, editor: i, dispatch: o }) => {
  const { doc: s } = r, l = Xu(n, i.schema, t);
...
function Zu(n, e) {
  ...
  return t === "node" ? ty(n, e) : t === "mark" ? Eo(n, e) : {};
}
  ...
  if (i.forEach(({ $from: d, $to: f }) => {
    ...
    n.doc.nodesBetween(h, p, (m, g) => {
      if (!m.isText && !m.marks.length)
        return;
      const v = Math.max(h, g), x = Math.min(p, g + m.nodeSize), T = x - v;
      s += T, l.push(...m.marks.map((y) => ({
        mark: y,
        from: v,
        to: x
      })));
...
function oy(n, e, t = {}) {
  if (!e)
    return Cr(n, null, t) || Ns(n, null, t);
  const r = Co(e, n.schema);
  return r === "node" ? Cr(n, e, t) : r === "mark" ? Ns(n, e, t) : !1;
}
function Ia(n, e) {
  const { nodeExtensions: t } = So(e), r = t.find((s) => s.name === n);
  if (!r)
    return !1;
  const i = {
    name: r.name,
...
const cy = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
  ...
  return ay(r, t, a);
}, uy = (n, e) => ({ tr: t }) => (t.setMeta(n, e), !0), dy = (n, e = {}) => ({ state: t, dispatch: r, chain: i }) => {
  const o = de(n, t.schema);
  return o.isTextblock ? i().command(({ commands: s }) => Oa(o, e)(t) ? !0 : s.clearNodes()).command(({ state: s }) => Oa(o, e)(s, r)).run() : (console.warn('[tiptap warn]: Currently "setNode()" only supports text block nodes.'), !1);
  ...
  return !0;
}, hy = (n) => ({ tr: e, dispatch: t }) => {
  if (t) {
    const { doc: r } = e, { from: i, to: o } = typeof n == "number" ? { from: n, to: n } : n, s = P.atStart(r).from, l = P.atEnd(r).to, a = Mt(i, s, l), c = Mt(o, s, l), u = P.create(r, a, c);
    e.setSelection(u);
  }
  return !0;
}, py = (n) => ({ state: e, dispatch: t }) => {
  const r = de(n, e.schema);
  return jm(r)(e, t);
};
function Pa(n, e) {
...
const my = ({ keepMarks: n = !0 } = {}) => ({ tr: e, state: t, dispatch: r, editor: i }) => {
  ...
  if (o instanceof B && o.node.isBlock)
    return !l.parentOffset || !zn(s, l.pos) ? !1 : (r && (n && Pa(t, i.extensionManager.splittableMarks), e.split(l.pos).scrollIntoView()), !0);
  if (!l.parent.isBlock)
    return !1;
  if (r) {
    ...
    n && Pa(t, i.extensionManager.splittableMarks), e.scrollIntoView();
  }
  return !0;
}, gy = (n) => ({ tr: e, state: t, dispatch: r, editor: i }) => {
  var o;
  ...
  if (l.parent.content.size === 0 && l.node(-1).childCount === l.indexAfter(-1)) {
    ...
    if (r) {
      ...
      for (let O = l.depth - v; O >= l.depth - 3; O -= 1)
        g = w.from(l.node(O).copy(g));
      const x = l.indexAfter(-1) < l.node(-2).childCount ? 1 : l.indexAfter(-2) < l.node(-3).childCount ? 2 : 3, T = hi(d, l.node().type.name, l.node().attrs), y = ((o = s.contentMatch.defaultType) === null || o === void 0 ? void 0 : o.createAndFill(T)) || void 0;
      g = g.append(w.from(s.createAndFill(null, y) || void 0));
      const C = l.before(l.depth - (v - 1));
      e.replace(C, l.after(-x), new E(g, 4 - v, 0));
      let b = -1;
      e.doc.nodesBetween(C, e.doc.content.size, (O, V) => {
        if (b > -1)
          return !1;
        O.isTextblock && O.content.size === 0 && (b = V + 1);
  ...
  if (!zn(e.doc, l.pos, 2))
    return !1;
  if (r) {
    const { selection: g, storedMarks: v } = t, { splittableMarks: x } = i.extensionManager, T = v || g.$to.parentOffset && g.$from.marks();
    if (e.split(l.pos, 2, m).scrollIntoView(), !T || !r)
      return !0;
    const y = T.filter((C) => x.includes(C.type.name));
    e.ensureMarks(y);
  }
  return !0;
}, Qo = (n, e) => {
...
}, yy = (n, e, t, r = {}) => ({ editor: i, tr: o, state: s, dispatch: l, chain: a, commands: c, can: u }) => {
  const { extensions: d, splittableMarks: f } = i.extensionManager, h = de(n, s.schema), p = de(e, s.schema), { selection: m, storedMarks: g } = s, { $from: v, $to: x } = m, T = v.blockRange(x), y = g || m.$to.parentOffset && m.$from.marks();
  if (!T)
    return !1;
  const C = hl((b) => Ia(b.type.name, d))(m);
  if (T.depth >= 1 && C && T.depth - C.depth <= 1) {
    if (C.node.type === h)
      return c.liftListItem(p);
    if (Ia(C.node.type.name, d) && h.validContent(C.node.content) && l)
      return a().command(() => (o.setNodeMarkup(C.pos, h), !0)).command(() => Qo(o, h)).command(() => Xo(o, h)).run();
  }
  return !t || !y || !l ? a().command(() => u().wrapInList(h, r) ? !0 : c.clearNodes()).wrapInList(h, r).command(() => Qo(o, h)).command(() => Xo(o, h)).run() : a().command(() => {
    const b = u().wrapInList(h, r), O = y.filter((V) => f.includes(V.type.name));
    return o.ensureMarks(O), b ? !0 : c.clearNodes();
  }).wrapInList(h, r).command(() => Qo(o, h)).command(() => Xo(o, h)).run();
}, vy = (n, e = {}, t = {}) => ({ state: r, commands: i }) => {
  const { extendEmptyMarkRange: o = !1 } = t, s = Yt(n, r.schema);
  return Ns(r, s, e) ? i.unsetMark(s, { extendEmptyMarkRange: o }) : i.setMark(s, e);
}, by = (n, e, t = {}) => ({ state: r, commands: i }) => {
  const o = de(n, r.schema), s = de(e, r.schema);
  return Cr(r, o, t) ? i.setNode(s) : i.setNode(o, t);
}, ky = (n, e = {}) => ({ state: t, commands: r }) => {
  const i = de(n, t.schema);
  return Cr(t, i, e) ? r.lift(i) : r.wrapIn(i, e);
}, wy = () => ({ state: n, dispatch: e }) => {
  const t = n.plugins;
  for (let r = 0; r < t.length; r += 1) {
    const i = t[r];
    let o;
...
}, Ty = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
  var o;
  ...
  if (u && s) {
    let { from: f, to: h } = l;
    const p = (o = c.marks().find((g) => g.type === a)) === null || o === void 0 ? void 0 : o.attrs, m = ul(c, a, p);
...
}, Sy = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
  let o = null, s = null;
  const l = Co(typeof n == "string" ? n : n.name, r.schema);
  return l ? (l === "node" && (o = de(n, r.schema)), l === "mark" && (s = Yt(n, r.schema)), i && t.selection.ranges.forEach((a) => {
...
var Ey = /* @__PURE__ */ Object.freeze({
  ...
  clearNodes: lg,
  command: ag,
  createParagraphNear: cg,
  cut: ug,
  deleteCurrentNode: dg,
  deleteNode: fg,
  deleteRange: hg,
  deleteSelection: pg,
  enter: mg,
  ...
  scrollIntoView: _g,
  selectAll: $g,
  selectNodeBackward: jg,
  selectNodeForward: Wg,
  selectParentNode: qg,
  selectTextblockEnd: Kg,
...
const Ay = ee.create({
  ...
  addKeyboardShortcuts() {
    const n = () => this.editor.commands.first(({ commands: s }) => [
      ...
      () => s.command(({ tr: l }) => {
        const { selection: a, doc: c } = l, { empty: u, $anchor: d } = a, { pos: f, parent: h } = d, p = d.parent.isTextblock && f > 0 ? l.doc.resolve(f - 1) : d, m = p.parent.type.spec.isolating, g = d.pos - d.parentOffset, v = m && p.parent.childCount === 1 ? g === d.pos : F.atStart(c).from === f;
      ...
      new le({
        ...
        appendTransaction: (n, e, t) => {
          if (!(n.some((p) => p.docChanged) && !e.doc.eq(t.doc)))
            return;
          const { empty: i, from: o, to: s } = e.selection, l = F.atStart(e.doc).from, a = F.atEnd(e.doc).to;
...
let Iy = class extends Wm {
   ...
   */
  injectCSS() {
    this.options.injectCSS && document && (this.css = Ry(Ly, this.options.injectNonce));
  }
  /**
   ...
   */
  registerPlugin(e, t) {
    const r = qu(t) ? t(e, [...this.state.plugins]) : [...this.state.plugins, e], i = this.state.reconfigure({ plugins: r });
   ...
   */
  createView() {
    const e = Xu(this.options.content, this.schema, this.options.parseOptions), t = Gu(e, this.options.autofocus);
    this.view = new cm(this.options.element, {
   ...
   */
  getHTML() {
    return Zg(this.state.doc.content, this.schema);
  }
  /**
...
function Li(n) {
  return new Fr({
    ...
    handler: ({ state: e, range: t, match: r, chain: i }) => {
      const o = z(n.getAttributes, void 0, r) || {}, s = e.tr.delete(t.from, t.to), a = s.doc.resolve(t.from).blockRange(), c = a && Qs(a, n.type, o);
      if (!c)
        return null;
...
class De {
  ...
  configure(e = {}) {
    const t = this.extend();
    return t.options = Mo(this.options, e), t.storage = z(A(t, "addStorage", {
      name: t.name,
      options: t.options
    })), t;
  }
  ...
  return new Ku({
    ...
    handler: ({ state: e, range: t, match: r, pasteEvent: i }) => {
      ...
      if (l) {
        ...
        if (pl(t.from, t.to, e.doc).filter((p) => p.mark.type.excluded.find((g) => g === n.type && g !== p.mark.type)).filter((p) => p.to > d).length)
          return null;
...
var Oe = "top", Ue = "bottom", Je = "right", Ne = "left", ml = "auto", Vr = [Oe, Ue, Je, Ne], Jn = "start", Er = "end", Fy = "clippingParents", td = "viewport", sr = "popper", Vy = "reference", Ha = /* @__PURE__ */ Vr.reduce(function(n, e) {
  return n.concat([e + "-" + Jn, e + "-" + Er]);
}, []), nd = /* @__PURE__ */ [].concat(Vr, [ml]).reduce(function(n, e) {
  return n.concat([e, e + "-" + Jn, e + "-" + Er]);
}, []), _y = "beforeRead", $y = "read", jy = "afterRead", Wy = "beforeMain", qy = "main", Ky = "afterMain", Uy = "beforeWrite", Jy = "write", Gy = "afterWrite", Yy = [_y, $y, jy, Wy, qy, Ky, Uy, Jy, Gy];
function ht(n) {
...
var pn = Math.max, Ri = Math.min, Gn = Math.round;
function Bs() {
...
function Yn(n, e, t) {
  ...
  var s = kn(n) ? ze(n) : window, l = s.visualViewport, a = !id() && t, c = (r.left + (a && l ? l.offsetLeft : 0)) / i, u = (r.top + (a && l ? l.offsetTop : 0)) / o, d = r.width / i, f = r.height / o;
  return {
    width: d,
    height: f,
    top: u,
...
function e0(n) {
  ...
  var i = Ao(n);
  for (gl(i) && (i = i.host); Ke(i) && ["html", "body"].indexOf(ht(i)) < 0; ) {
    var o = At(i);
...
function _r(n) {
  for (var e = ze(n), t = za(n); t && Zy(t) && At(t).position === "static"; )
    t = za(t);
  return t && (ht(t) === "html" || ht(t) === "body" && At(t).position === "static") ? e : t || e0(n) || e;
}
function vl(n) {
...
var n0 = function(e, t) {
  ...
  })) : e, ld(typeof e != "number" ? e : ad(e, Vr));
};
function r0(n) {
  var e, t = n.state, r = n.name, i = n.options, o = t.elements.arrow, s = t.modifiersData.popperOffsets, l = ut(t.placement), a = vl(l), c = [Ne, Je].indexOf(l) >= 0, u = c ? "height" : "width";
  if (!(!o || !s)) {
    var d = n0(i.padding, t), f = yl(o), h = a === "y" ? Oe : Ne, p = a === "y" ? Ue : Je, m = t.rects.reference[u] + t.rects.reference[a] - s[a] - t.rects.popper[u], g = s[a] - t.rects.reference[a], v = _r(o), x = v ? a === "y" ? v.clientHeight || 0 : v.clientWidth || 0 : 0, T = m / 2 - g / 2, y = d[h], C = x - f[u] - d[p], b = x / 2 - f[u] / 2 + T, O = pr(y, b, C), V = a;
    t.modifiersData[r] = (e = {}, e[V] = O, e.centerOffset = O - b, e);
  }
}
function i0(n) {
...
function Fa(n) {
  ...
  h = g.x, m = g.y;
  var v = s.hasOwnProperty("x"), x = s.hasOwnProperty("y"), T = Ne, y = Oe, C = window;
  if (c) {
    var b = _r(t), O = "clientHeight", V = "clientWidth";
    if (b === ze(t) && (b = Qt(t), At(b).position !== "static" && l === "absolute" && (O = "scrollHeight", V = "scrollWidth")), b = b, i === Oe || (i === Ne || i === Je) && o === Er) {
      y = Ue;
      var M = d && b === C && C.visualViewport ? C.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        b[O]
      );
      m -= M - r.height, m *= a ? 1 : -1;
    }
    if (i === Ne || (i === Oe || i === Ue) && o === Er) {
      T = Je;
      var R = d && b === C && C.visualViewport ? C.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        b[V]
      );
      h -= R - r.width, h *= a ? 1 : -1;
  ...
  if (h = W.x, m = W.y, a) {
    var q;
    return Object.assign({}, $, (q = {}, q[y] = x ? "0" : "", q[T] = v ? "0" : "", q.transform = (C.devicePixelRatio || 1) <= 1 ? "translate(" + h + "px, " + m + "px)" : "translate3d(" + h + "px, " + m + "px, 0)", q));
  }
  return Object.assign({}, $, (e = {}, e[y] = x ? m + "px" : "", e[T] = v ? h + "px" : "", e.transform = "", e));
}
function a0(n) {
...
function kl(n) {
  return Yn(Qt(n)).left + bl(n).scrollLeft;
}
function p0(n, e) {
...
function m0(n) {
  var e, t = Qt(n), r = bl(n), i = (e = n.ownerDocument) == null ? void 0 : e.body, o = pn(t.scrollWidth, t.clientWidth, i ? i.scrollWidth : 0, i ? i.clientWidth : 0), s = pn(t.scrollHeight, t.clientHeight, i ? i.scrollHeight : 0, i ? i.clientHeight : 0), l = -r.scrollLeft + kl(n), a = -r.scrollTop;
...
function cd(n) {
  return ["html", "body", "#document"].indexOf(ht(n)) >= 0 ? n.ownerDocument.body : Ke(n) && wl(n) ? n : cd(Ao(n));
}
function mr(n, e) {
  var t;
  e === void 0 && (e = []);
  var r = cd(n), i = r === ((t = n.ownerDocument) == null ? void 0 : t.body), o = ze(r), s = i ? [o].concat(o.visualViewport || [], wl(r) ? r : []) : r, l = e.concat(s);
  return i ? l : (
...
function _a(n, e, t) {
  return e === td ? Ls(p0(n, t)) : kn(e) ? g0(e, t) : Ls(m0(Qt(n)));
}
function y0(n) {
  var e = mr(Ao(n)), t = ["absolute", "fixed"].indexOf(At(n).position) >= 0, r = t && Ke(n) ? _r(n) : n;
  return kn(r) ? e.filter(function(i) {
    return kn(i) && od(i, r) && ht(i) !== "body";
  }) : [];
}
function v0(n, e, t, r) {
  var i = e === "clippingParents" ? y0(n) : [].concat(e), o = [].concat(i, [t]), s = o[0], l = o.reduce(function(a, c) {
    var u = _a(n, c, r);
    return a.top = pn(u.top, a.top), a.right = Ri(u.right, a.right), a.bottom = Ri(u.bottom, a.bottom), a.left = pn(u.left, a.left), a;
  }, _a(n, s, r));
...
function Ar(n, e) {
  e === void 0 && (e = {});
  var t = e, r = t.placement, i = r === void 0 ? n.placement : r, o = t.strategy, s = o === void 0 ? n.strategy : o, l = t.boundary, a = l === void 0 ? Fy : l, c = t.rootBoundary, u = c === void 0 ? td : c, d = t.elementContext, f = d === void 0 ? sr : d, h = t.altBoundary, p = h === void 0 ? !1 : h, m = t.padding, g = m === void 0 ? 0 : m, v = ld(typeof g != "number" ? g : ad(g, Vr)), x = f === sr ? Vy : sr, T = n.rects.popper, y = n.elements[p ? x : f], C = v0(kn(y) ? y : y.contextElement || Qt(n.elements.popper), a, u, s), b = Yn(n.elements.reference), O = ud({
    reference: b,
    element: T,
    strategy: "absolute",
    placement: i
  }), V = Ls(Object.assign({}, T, O)), M = f === sr ? V : b, R = {
...
function b0(n, e) {
  e === void 0 && (e = {});
  var t = e, r = t.placement, i = t.boundary, o = t.rootBoundary, s = t.padding, l = t.flipVariations, a = t.allowedAutoPlacements, c = a === void 0 ? nd : a, u = Qn(r), d = u ? l ? Ha : Ha.filter(function(p) {
    return Qn(p) === u;
...
function w0(n) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !0 : s, a = t.fallbackPlacements, c = t.padding, u = t.boundary, d = t.rootBoundary, f = t.altBoundary, h = t.flipVariations, p = h === void 0 ? !0 : h, m = t.allowedAutoPlacements, g = e.options.placement, v = ut(g), x = v === g, T = a || (x || !p ? [pi(g)] : k0(g)), y = [g].concat(T).reduce(function(gt, Ge) {
      return gt.concat(ut(Ge) === ml ? b0(e, {
        placement: Ge,
        boundary: u,
        rootBoundary: d,
        padding: c,
    ...
    }, []), C = e.rects.reference, b = e.rects.popper, O = /* @__PURE__ */ new Map(), V = !0, M = y[0], R = 0; R < y.length; R++) {
      var $ = y[R], W = ut($), q = Qn($) === Jn, ae = [Oe, Ue].indexOf(W) >= 0, X = ae ? "width" : "height", Y = Ar(e, {
        placement: $,
        boundary: u,
        rootBoundary: d,
        altBoundary: f,
    ...
    if (V)
      for (var me = p ? 3 : 1, mt = function(Ge) {
        var yt = y.find(function(xn) {
          var vt = O.get(xn);
          if (vt)
            return vt.slice(0, Ge).every(function(Tn) {
              return Tn;
            });
        });
        if (yt)
...
function T0(n) {
  var e = n.state, t = n.name, r = e.rects.reference, i = e.rects.popper, o = e.modifiersData.preventOverflow, s = Ar(e, {
    ...
    altBoundary: !0
  }), a = $a(s, r), c = $a(l, i, o), u = ja(a), d = ja(c);
  e.modifiersData[t] = {
...
function C0(n) {
  var e = n.state, t = n.options, r = n.name, i = t.offset, o = i === void 0 ? [0, 0] : i, s = nd.reduce(function(u, d) {
    return u[d] = M0(d, e.rects, o), u;
...
function D0(n) {
  var e = n.state, t = n.options, r = n.name, i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !1 : s, a = t.boundary, c = t.rootBoundary, u = t.altBoundary, d = t.padding, f = t.tether, h = f === void 0 ? !0 : f, p = t.tetherOffset, m = p === void 0 ? 0 : p, g = Ar(e, {
    ...
    padding: d,
    altBoundary: u
  }), v = ut(e.placement), x = Qn(e.placement), T = !x, y = vl(v), C = N0(y), b = e.modifiersData.popperOffsets, O = e.rects.reference, V = e.rects.popper, M = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, R = typeof M == "number" ? {
    mainAxis: M,
    altAxis: M
    ...
    mainAxis: 0,
    altAxis: 0
  }, M), $ = e.modifiersData.offset ? e.modifiersData.offset[e.placement] : null, W = {
    x: 0,
    y: 0
  };
  if (b) {
    if (o) {
      var q, ae = y === "y" ? Oe : Ne, X = y === "y" ? Ue : Je, Y = y === "y" ? "height" : "width", G = b[y], K = G + g[ae], Be = G - g[X], me = h ? -V[Y] / 2 : 0, mt = x === Jn ? O[Y] : V[Y], Me = x === Jn ? -V[Y] : -O[Y], Zt = e.elements.arrow, gt = h && Zt ? yl(Zt) : {
        width: 0,
        height: 0
      }, Ge = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : sd(), yt = Ge[ae], xn = Ge[X], vt = pr(0, O[Y], gt[Y]), Tn = T ? O[Y] / 2 - me - vt - yt - R.mainAxis : mt - vt - yt - R.mainAxis, Ot = T ? -O[Y] / 2 + me + vt + xn + R.mainAxis : Me + vt + xn + R.mainAxis, Sn = e.elements.arrow && _r(e.elements.arrow), jr = Sn ? y === "y" ? Sn.clientTop || 0 : Sn.clientLeft || 0 : 0, er = (q = $ == null ? void 0 : $[y]) != null ? q : 0, Wr = G + Tn - er - jr, qr = G + Ot - er, tr = pr(h ? Ri(K, Wr) : K, G, h ? pn(Be, qr) : Be);
      b[y] = tr, W[y] = tr - G;
    }
    if (l) {
      var nr, Kr = y === "x" ? Oe : Ne, Ur = y === "x" ? Ue : Je, bt = b[C], Nt = C === "y" ? "height" : "width", rr = bt + g[Kr], en = bt - g[Ur], ir = [Oe, Ne].indexOf(v) !== -1, Jr = (nr = $ == null ? void 0 : $[C]) != null ? nr : 0, Gr = ir ? rr : bt - O[Nt] - V[Nt] - Jr + R.altAxis, Yr = ir ? bt + O[Nt] + V[Nt] - Jr - R.altAxis : en, Qr = h && ir ? t0(Gr, bt, Yr) : pr(h ? Gr : rr, bt, h ? Yr : en);
      b[C] = Qr, W[C] = Qr - bt;
    }
    e.modifiersData[r] = W;
  }
...
function P0(n, e, t) {
  t === void 0 && (t = !1);
  var r = Ke(e), i = Ke(e) && I0(e), o = Qt(e), s = Yn(n, i, t), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, a = {
    x: 0,
  ...
  wl(o)) && (l = R0(e)), Ke(e) ? (a = Yn(e, !0), a.x += e.clientLeft, a.y += e.clientTop) : o && (a.x = kl(o))), {
...
function _0(n) {
  n === void 0 && (n = {});
  var e = n, t = e.defaultModifiers, r = t === void 0 ? [] : t, i = e.defaultOptions, o = i === void 0 ? Wa : i;
  return function(l, a, c) {
    ...
    var u = {
      ...
      setOptions: function(v) {
        ...
        m(), u.options = Object.assign({}, o, u.options, x), u.scrollParents = {
          reference: kn(l) ? mr(l) : l.contextElement ? mr(l.contextElement) : [],
          popper: mr(a)
        };
        var T = z0(V0([].concat(r, u.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!f) {
          var v = u.elements, x = v.reference, T = v.popper;
          if (qa(x, T)) {
            u.rects = {
              reference: P0(x, _r(T), u.options.strategy === "fixed"),
              popper: yl(T)
            ...
            for (var y = 0; y < u.orderedModifiers.length; y++) {
              ...
              var C = u.orderedModifiers[y], b = C.fn, O = C.options, V = O === void 0 ? {} : O, M = C.name;
    ...
    function p() {
      u.orderedModifiers.forEach(function(g) {
        var v = g.name, x = g.options, T = x === void 0 ? {} : x, y = g.effect;
...
var $0 = [d0, O0, c0, rd, E0, x0, B0, o0, S0], j0 = /* @__PURE__ */ _0({
  defaultModifiers: $0
}), W0 = "tippy-box", dd = "tippy-content", q0 = "tippy-backdrop", fd = "tippy-arrow", hd = "tippy-svg-arrow", nn = {
  passive: !0,
  capture: !0
}, pd = function() {
...
function e1(n) {
  return Or(n) ? [n] : Q0(n) ? Ii(n) : Array.isArray(n) ? n : Ii(document.querySelectorAll(n));
}
function es(n, e) {
...
function n1(n, e) {
  ...
  return n.every(function(i) {
    var o = i.popperRect, s = i.popperState, l = i.props, a = l.interactiveBorder, c = Y0(s.placement), u = s.modifiersData.offset;
    if (!u)
      return !0;
    var d = c === "bottom" ? u.top.y : 0, f = c === "top" ? u.bottom.y : 0, h = c === "right" ? u.left.x : 0, p = c === "left" ? u.right.x : 0, m = o.top - r + d > a, g = r - o.bottom - f > a, v = o.left - t + h > a, x = t - o.right - p > a;
    return m || g || v || x;
  });
}
function ts(n, e, t) {
...
function r1() {
  ot.isTouch || (ot.isTouch = !0, window.performance && document.addEventListener("mousemove", gd));
}
function gd() {
  var n = performance.now();
  n - Qa < 20 && (ot.isTouch = !1, document.removeEventListener("mousemove", gd)), Qa = n;
}
function i1() {
...
function o1() {
  document.addEventListener("touchstart", r1, nn), window.addEventListener("blur", i1);
}
var s1 = typeof window < "u" && typeof document < "u", l1 = s1 ? (
  // @ts-ignore
  !!window.msCrypto
) : !1;
function On(n) {
...
function Tt(n, e) {
  if (n && !Nr.has(e)) {
    var t;
    Nr.add(e), (t = console).warn.apply(t, yd(e));
  }
}
function Rs(n, e) {
  if (n && !Nr.has(e)) {
    var t;
    Nr.add(e), (t = console).error.apply(t, yd(e));
  }
}
function u1(n) {
...
var vd = {
  ...
  triggerTarget: null
}, vd, d1), f1 = Object.keys(Pe), h1 = function(e) {
...
function p1(n, e) {
  var t = e ? Object.keys(bd(Object.assign({}, Pe, {
    plugins: e
...
function Za(n, e) {
  var t = Object.assign({}, e, {
    content: md(e.content, [n])
  }, e.ignoreAttributes ? {} : p1(n, e.plugins));
...
function kd(n, e) {
  ...
  var t = Object.keys(n);
  t.forEach(function(r) {
    var i = U0(Pe, Object.keys(vd)), o = !K0(i, r);
...
function ec(n) {
  var e = gr();
  return n === !0 ? e.className = fd : (e.className = hd, Or(n) ? e.appendChild(n) : Is(e, n)), e;
}
function tc(n, e) {
  Or(e.content) ? (Is(n, ""), n.appendChild(e.content)) : typeof e.content != "function" && (e.allowHTML ? Is(n, e.content) : n.textContent = e.content);
}
function Ps(n) {
  var e = n.firstElementChild, t = Ii(e.children);
  return {
    box: e,
    content: t.find(function(r) {
      return r.classList.contains(dd);
    }),
    arrow: t.find(function(r) {
      return r.classList.contains(fd) || r.classList.contains(hd);
    }),
    backdrop: t.find(function(r) {
      return r.classList.contains(q0);
    })
  };
}
function wd(n) {
  var e = gr(), t = gr();
  t.className = W0, t.setAttribute("data-state", "hidden"), t.setAttribute("tabindex", "-1");
  var r = gr();
  r.className = dd, r.setAttribute("data-state", "hidden"), tc(r, n.props), e.appendChild(t), t.appendChild(r), i(n.props, n.props);
  function i(o, s) {
    var l = Ps(e), a = l.box, c = l.content, u = l.arrow;
    s.theme ? a.setAttribute("data-theme", s.theme) : a.removeAttribute("data-theme"), typeof s.animation == "string" ? a.setAttribute("data-animation", s.animation) : a.removeAttribute("data-animation"), s.inertia ? a.setAttribute("data-inertia", "") : a.removeAttribute("data-inertia"), a.style.maxWidth = typeof s.maxWidth == "number" ? s.maxWidth + "px" : s.maxWidth, s.role ? a.setAttribute("role", s.role) : a.removeAttribute("role"), (o.content !== s.content || o.allowHTML !== s.allowHTML) && tc(c, n.props), s.arrow ? u ? o.arrow !== s.arrow && (a.removeChild(u), a.appendChild(ec(s.arrow))) : a.appendChild(ec(s.arrow)) : u && a.removeChild(u);
  }
  return {
    popper: e,
    onUpdate: i
...
var g1 = 1, oi = [], ns = [];
function y1(n, e) {
  var t = Za(n, Object.assign({}, Pe, bd(Ja(e)))), r, i, o, s = !1, l = !1, a = !1, c = !1, u, d, f, h = [], p = Ka(Wr, t.interactiveDebounce), m, g = g1++, v = null, x = G0(t.plugins), T = {
  ...
  var C = t.render(y), b = C.popper, O = C.onUpdate;
  b.setAttribute("data-tippy-root", ""), b.id = "tippy-" + y.id, y.popper = b, n._tippy = y, b._tippy = y;
  var V = x.map(function(k) {
    return k.fn(y);
  }), M = n.hasAttribute("aria-expanded");
  return Sn(), me(), G(), K("onCreate", [y]), t.showOnCreate && rr(), b.addEventListener("mouseenter", function() {
  ...
  function K(k, N, L) {
    if (L === void 0 && (L = !0), V.forEach(function(j) {
      j[k] && j[k].apply(j, N);
    }), L) {
      var U;
  ...
  function Be() {
    var k = y.props.aria;
    if (k.content) {
      var N = "aria-" + k.content, L = b.id, U = Ln(y.props.triggerTarget || n);
      U.forEach(function(j) {
        var ke = j.getAttribute(N);
        if (y.state.isVisible)
          j.setAttribute(N, ke ? ke + " " + L : L);
        else {
          var Fe = ke && ke.replace(L, "").trim();
          Fe ? j.setAttribute(N, Fe) : j.removeAttribute(N);
        }
      });
    }
  }
  ...
  function Ge() {
    var k = ae();
    k.addEventListener("mousedown", Me, !0), k.addEventListener("touchend", Me, nn), k.addEventListener("touchstart", gt, nn), k.addEventListener("touchmove", Zt, nn);
  }
  function yt() {
    var k = ae();
    k.removeEventListener("mousedown", Me, !0), k.removeEventListener("touchend", Me, nn), k.removeEventListener("touchstart", gt, nn), k.removeEventListener("touchmove", Zt, nn);
  }
  function xn(k, N) {
    Tn(k, function() {
  ...
  function Sn() {
    $() && (Ot("touchstart", er, {
      ...
      passive: !0
    })), J0(y.props.trigger).forEach(function(k) {
      if (k !== "manual")
        switch (Ot(k, er), k) {
          case "mouseenter":
            Ot("mouseleave", qr);
  ...
  function er(k) {
    ...
    if (!(!y.state.isEnabled || nr(k) || l)) {
      ...
      u = k, m = k.currentTarget, me(), !y.state.isVisible && X0(k) && oi.forEach(function(j) {
        return j(k);
  ...
  function Wr(k) {
    var N = k.target, L = q().contains(N) || b.contains(N);
    if (!(k.type === "mousemove" && L)) {
      var U = Nt().concat(b).map(function(j) {
        var ke, Fe = j._tippy, Mn = (ke = Fe.popperInstance) == null ? void 0 : ke.state;
        return Mn ? {
  ...
  function tr(k) {
    y.props.trigger.indexOf("focusin") < 0 && k.target !== q() || y.props.interactive && k.relatedTarget && b.contains(k.relatedTarget) || en(k);
  }
  function nr(k) {
    return ot.isTouch ? $() !== k.type.indexOf("touch") >= 0 : !1;
  }
  function Kr() {
    Ur();
    var k = y.props, N = k.popperOptions, L = k.placement, U = k.offset, j = k.getReferenceClientRect, ke = k.moveTransition, Fe = W() ? Ps(b).arrow : null, Mn = j ? {
      ...
      fn: function(Xr) {
        ...
        if (W()) {
          ...
          ["placement", "reference-hidden", "escaped"].forEach(function(Zr) {
            Zr === "placement" ? Bo.setAttribute("data-placement", Cn.placement) : Cn.attributes.popper["data-popper-" + Zr] ? Bo.setAttribute("data-" + Zr, "") : Bo.removeAttribute("data-" + Zr);
    ...
    }), tn.push.apply(tn, (N == null ? void 0 : N.modifiers) || []), y.popperInstance = j0(Mn, b, Object.assign({}, N, {
      placement: L,
      onFirstUpdate: f,
      modifiers: tn
    }));
  ...
  function bt() {
    ...
    y.props.interactive && k === pd || k === "parent" ? N = L.parentNode : N = md(k, [L]), N.contains(b) || N.appendChild(b), y.state.isMounted = !0, Kr(), process.env.NODE_ENV !== "production" && Tt(y.props.interactive && k === Pe.appendTo && L.nextElementSibling !== b, ["Interactive tippy element may not be accessible via keyboard", "navigation because it is not directly after the reference element", "in the DOM source order.", `
...
`, "See: https://atomiks.github.io/tippyjs/v6/accessibility/#interactivity"].join(" "));
  ...
  function Nt() {
    return Ii(b.querySelectorAll("[data-tippy-root]"));
  }
  function rr(k) {
    y.clearDelayTimeouts(), k && K("onTrigger", [y, k]), Ge();
    var N = Y(!0), L = R(), U = L[0], j = L[1];
  ...
  function Yr(k) {
    if (process.env.NODE_ENV !== "production" && Tt(y.state.isDestroyed, On("setProps")), !y.state.isDestroyed) {
      K("onBeforeUpdate", [y, k]), jr();
      var N = y.props, L = Za(n, Object.assign({}, N, Ja(k), {
        ignoreAttributes: !0
      }));
      y.props = L, Sn(), N.interactiveDebounce !== L.interactiveDebounce && (mt(), p = Ka(Wr, L.interactiveDebounce)), N.triggerTarget && !L.triggerTarget ? Ln(N.triggerTarget).forEach(function(U) {
        U.removeAttribute("aria-expanded");
      }) : L.triggerTarget && n.removeAttribute("aria-expanded"), me(), G(), O && O(N, L), y.popperInstance && (Kr(), Nt().forEach(function(U) {
  ...
  function qd() {
    process.env.NODE_ENV !== "production" && Tt(y.state.isDestroyed, On("show"));
    ...
    if (!(k || N || L || U) && !q().hasAttribute("disabled") && (K("onShow", [y], !1), y.props.onShow(y) !== !1)) {
      if (y.state.isVisible = !0, W() && (b.style.visibility = "visible"), G(), Ge(), y.state.isMounted || (b.style.transition = "none"), W()) {
        var ke = X(), Fe = ke.box, Mn = ke.content;
        es([Fe, Mn], 0);
      }
      f = function() {
        var tn;
        if (!(!y.state.isVisible || c)) {
          if (c = !0, b.offsetHeight, b.style.transition = y.props.moveTransition, W() && y.props.animation) {
            var Do = X(), Xr = Do.box, Cn = Do.content;
            es([Xr, Cn], j), Ga([Xr, Cn], "visible");
          }
          Be(), me(), Ua(ns, y), (tn = y.popperInstance) == null || tn.forceUpdate(), K("onMount", [y]), y.props.animation && W() && vt(j, function() {
  ...
  function Kd() {
    process.env.NODE_ENV !== "production" && Tt(y.state.isDestroyed, On("hide"));
    ...
    if (!(k || N || L) && (K("onHide", [y], !1), y.props.onHide(y) !== !1)) {
      if (y.state.isVisible = !1, y.state.isShown = !1, c = !1, s = !1, W() && (b.style.visibility = "hidden"), mt(), yt(), G(!0), W()) {
        var j = X(), ke = j.box, Fe = j.content;
        y.props.animation && (es([ke, Fe], U), Ga([ke, Fe], "hidden"));
      }
      Be(), me(), y.props.animation ? W() && xn(U, y.unmount) : y.unmount();
    }
  }
  function Ud(k) {
    process.env.NODE_ENV !== "production" && Tt(y.state.isDestroyed, On("hideWithInteractivity")), ae().addEventListener("mousemove", p), Ua(oi, p), p(k);
  }
  function Jd() {
    process.env.NODE_ENV !== "production" && Tt(y.state.isDestroyed, On("unmount")), y.state.isVisible && y.hide(), y.state.isMounted && (Ur(), Nt().forEach(function(k) {
      k._tippy.unmount();
    }), b.parentNode && b.parentNode.removeChild(b), ns = ns.filter(function(k) {
      return k !== y;
    }), y.state.isMounted = !1, K("onHidden", [y]));
  }
  function Gd() {
    process.env.NODE_ENV !== "production" && Tt(y.state.isDestroyed, On("destroy")), !y.state.isDestroyed && (y.clearDelayTimeouts(), y.unmount(), jr(), delete n._tippy, y.state.isDestroyed = !0, K("onDestroy", [y]));
  }
}
function wn(n, e) {
  e === void 0 && (e = {});
  var t = Pe.plugins.concat(e.plugins || []);
  process.env.NODE_ENV !== "production" && (u1(n), kd(e, t)), o1();
...
class v1 {
  constructor({ editor: e, element: t, view: r, tippyOptions: i = {}, updateDelay: o = 250, shouldShow: s }) {
    this.preventHide = !1, this.shouldShow = ({ view: l, state: a, from: c, to: u }) => {
      const { doc: d, selection: f } = a, { empty: h } = f, p = !d.textBetween(c, u).length && dl(a.selection), m = this.element.contains(document.activeElement);
      ...
      if (m || !a && !c)
        return;
      this.createTooltip();
      const { ranges: x } = g, T = Math.min(...x.map((b) => b.$from.pos)), y = Math.max(...x.map((b) => b.$to.pos));
...
const xd = (n) => new le({
  key: typeof n.pluginKey == "string" ? new be(n.pluginKey) : n.pluginKey,
  view: (e) => new v1({ view: e, ...n })
});
ee.create({
  name: "bubbleMenu",
  addOptions() {
...
class b1 {
  ...
  update(e, t) {
    ...
    (i = this.tippy) === null || i === void 0 || i.setProps({
      getReferenceClientRect: ((o = this.tippyOptions) === null || o === void 0 ? void 0 : o.getReferenceClientRect) || (() => ed(e, c, u))
    }), this.show();
  }
  show() {
    var e;
...
const k1 = Rr({
  ...
  setup(n, { slots: e }) {
    ...
    return ho(() => {
      ...
      var r;
      return Ct("div", { ref: t }, (r = e.default) === null || r === void 0 ? void 0 : r.call(e));
    };
  }
});
function nc(n) {
...
class w1 extends Iy {
  constructor(e = {}) {
    return super(e), this.vueRenderers = po(/* @__PURE__ */ new Map()), this.contentComponent = null, this.reactiveState = nc(this.view.state), this.reactiveExtensionStorage = nc(this.extensionStorage), this.on("transaction", () => {
...
const x1 = Rr({
  ...
  setup(n) {
    ...
    return Xd(() => {
      const r = n.editor;
      r && r.options.element && e.value && Zd(() => {
...
class M1 {
  constructor(e, { props: t = {}, editor: r }) {
    if (this.id = Math.floor(Math.random() * 4294967295).toString(), this.editor = r, this.component = Js(e), this.teleportElement = document.createElement("div"), this.element = this.teleportElement, this.props = po(t), this.editor.vueRenderers.set(this.id, this), this.editor.contentComponent) {
...
/*!
  ...
  */
var Hs = function(n, e) {
  return Hs = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(t, r) {
    t.__proto__ = r;
  } || function(t, r) {
    for (var i in r)
...
function Xt(n) {
  return Sd.namespaceStore.getByName(n);
}
var Dr = Sd.configuration;
function Md(n) {
  var e = {
    backgroundClose: Dr.backgroundClose,
    isRoute: !1,
    namespace: _n.DEFAULT_NAMESPACE,
...
var $r = (
  ...
  function() {
    function n(e, t, r) {
      var i = this;
      this.events = po({}), this.backgroundClose = !0, this.isRoute = !1, this.id = n.modalId++, this.component = e, this.props = Ir(t), this.closed = nf(function() {
...
function D1(n, e, t) {
  return function() {
    return new Promise(function(r, i) {
      ...
      Promise.resolve(n.call((o = Ed(e)) === null || o === void 0 ? void 0 : o.instance, t)).then(s).catch(function(l) {
        return i(l);
      });
    });
  };
...
function Od(n) {
  return n = Cd(n), Ad(Xt(n.namespace).queue.map(function(e) {
    return function() {
      return e.close();
    };
  }));
...
function Oo(n) {
  n = Cd(n);
  var e = Nd(n.namespace);
  return e ? e.close() : Promise.resolve();
}
function B1(n, e, t) {
  var r = Md(t), i = Xt(r.namespace);
  if (r.namespace === _n.DEFAULT_NAMESPACE && !i.initialized && !Dr.skipInitCheck)
...
function L1(n, e, t) {
  return e === void 0 && (e = {}), t === void 0 && (t = {}), Od({
...
function R1(n, e, t) {
  return e === void 0 && (e = {}), t === void 0 && (t = {}), rc(this, void 0, void 0, function() {
    var r, i, o = this;
    return ic(this, function(s) {
      switch (s.label) {
        case 0:
          return [4, Dd(n, e, t)];
        case 1:
          return r = s.sent(), i = !1, [2, new Promise(function(l) {
            r.on($r.EVENT_PROMPT, function(a) {
              return rc(o, void 0, void 0, function() {
...
const P1 = ["onPointerdown"], sc = {
  __name: "WidgetModalContainerItem",
  props: {
    id: Number
  },
  setup(n) {
    const e = Ir(null), t = n, r = Ed(t.id);
    function i() {
      if (r.backgroundClose)
        return Tl(r.id, { background: !0 }).catch(() => {
        });
    }
    Sc(() => e.value, (s) => {
      r.instance = s;
      ...
      r.draggable && o(
        document.querySelector(
          typeof r.draggable == "string" ? r.draggable : `[modalid=_modal_${t.id}]`
        )
      );
    });
    function o(s) {
      if (!s)
        return;
      const l = document.querySelector(`[modalid=_modal_${t.id}]`);
      s.addEventListener("pointerdown", (a) => {
        var c;
        const u = (c = l.getAttribute("style")) == null ? void 0 : c.match(/transform: translate\((.*)px,\s*(.*)px\)/);
        let d = u == null ? void 0 : u[1], f = u == null ? void 0 : u[2];
        d = typeof d == "string" ? Number.parseInt(d) : 0, f = typeof f == "string" ? Number.parseInt(f) : 0;
        const { clientX: h, clientY: p } = a, m = h, g = p;
        document.addEventListener("pointermove", v, { passive: !0 }), document.addEventListener("pointerup", x, { once: !0 });
        function v(T) {
          const { clientX: y, clientY: C } = T, b = d + y - m, O = f + C - g;
          l.style.transform = `translate(${b}px,${O}px)`;
        }
        function x(T) {
          document.removeEventListener("pointermove", v), T.preventDefault();
        }
      });
    }
    return (s, l) => (D(), H("div", {
      class: "widget__modal-container__item modal-container",
      onPointerdown: Re(i, ["self", "stop"])
    }, [
      (D(), We(of(di(r).component), sf(di(r).props.value, {
        class: "modal-item widget__modal-wrap",
        modalId: `_modal_${n.id}`,
        ref_key: "modalRef",
        ref: e
      }, lf(di(r).events)), null, 16, ["modalId"]))
    ], 40, P1));
  }
};
function H1(n) {
  n === void 0 && (n = _n.DEFAULT_NAMESPACE);
  var e = _n.instance.getByName(n);
  e.initialized = !0, n === _n.DEFAULT_NAMESPACE && document.addEventListener("keyup", function(t) {
    if (t.key === "Escape" || t.code === "Escape") {
      var r = Nd(n);
      if (!r)
        return;
      Tl(r.id, { esc: !0 }).catch(function() {
      });
    }
  });
}
const z1 = {
  ...
  setup(n) {
    return ho(() => {
      ...
      return Ct(rf, { name: Dr.animation, tag: "div" }, {
        default: () => e.queue.map((t) => Ct(sc, {
          key: t.id,
          id: t.id
        }))
      });
  ...
  components: { WidgetContainerModalItem: sc }
};
Xt().queue;
function rs(n) {
...
function Bd(n, e) {
  if (rs(n) && rs(e))
    for (const t in e)
      rs(e[t]) ? (n[t] || Object.assign(n, { [t]: {} }), Bd(n[t], e[t])) : F1(e[t]) ? (n[t] || (n[t] = []), mi(n[t], e[t])) : Object.assign(n, { [t]: e[t] });
  return n;
}
const mi = function(n, e) {
  return e === !1 ? [] : (e.forEach((t, r) => {
    !n || !n.find((i) => i.name == t.name) ? n.push(t) : Bd(
  ...
  addCommands() {
    return {
      setBlockWidth: (n) => ({ commands: e, view: t }) => this.options.alignments.includes(n) ? (e.updateAttributes(ph(t).type.name, {
        blockWidth: n
      }), !0) : !1,
  ...
  onCreate() {
    ...
    e.length > 0 && console.warn(`[GutentapBlocks]: Duplicate block names found: ${[...new Set(e)].join(", ")}`);
  },
  addStorage() {
    return {
      ...
      getAllowedBlocks(n, e) {
        ...
        if (t) {
          if (t.allowedBlocks === !1)
            return [];
          typeof t.allowedBlocks == "object" && (e = e.filter((i) => t.allowedBlocks[i.name]));
        }
        if (r === "block+" || r.includes("block"))
          return e;
        if (r.includes("text") || r.includes("inline"))
          return n.depth === 1 && ((t == null ? void 0 : t.allowedBlocks) === !0 || typeof (t == null ? void 0 : t.allowedBlocks) == "object") ? e : [];
        if (!r.includes("text") && !r.includes("inline")) {
          const i = r.match(/[\w]+/g) || [];
          e = e.filter((o) => i.includes(o.name));
        }
...
}, j1 = { class: "gutentap-modal-layout" }, W1 = {
  key: 0,
  class: "gutentap-modal-header"
}, q1 = { class: "gutentap-modal-header-title" }, K1 = /* @__PURE__ */ I("svg", {
  width: "24px",
  height: "24px",
  viewBox: "0 0 24 24",
  fill: "none",
  ...
  K1
], J1 = { class: "gutentap-modal-body" }, G1 = { class: "gutentap-form" }, Y1 = ["for"], Q1 = ["id", "placeholder", "autofocus", "onUpdate:modelValue"], X1 = ["innerHTML"], Z1 = { class: "gutentap-form-buttons" };
function ev(n, e, t, r, i, o) {
  const s = je("menu-button");
  return D(), H("div", j1, [
    I("div", {
      class: "gutentap-modal-backdrop",
      onClick: e[0] || (e[0] = (...l) => o.clickBackdrop && o.clickBackdrop(...l))
    }),
    I("div", {
      class: Ut(["gutentap-modal", `gutentap-modal-${t.size}`])
    }, [
      t.showHeader ? (D(), H("div", W1, [
        I("div", q1, He(t.title), 1),
        t.closable ? (D(), H("div", {
          key: 0,
          class: "gutentap-modal-header-close",
          onClick: e[1] || (e[1] = (...l) => o.hideModal && o.hideModal(...l))
        }, U1)) : se("", !0)
      ])) : se("", !0),
      I("div", J1, [
        I("div", G1, [
          (D(!0), H(Le, null, Ye(t.form, (l, a) => (D(), H("div", {
            class: "gutentap-form-item",
            key: a
          }, [
            I("label", {
              for: `gutentap-modal-input-${l.name}-${a}`
            }, He(l.label), 9, Y1),
            af(I("input", {
              id: `gutentap-modal-input-${l.name}-${a}`,
              placeholder: l.placeholder,
              autofocus: a == 0,
              class: "gutentap-form-control",
              type: "text",
          ...
          I("div", Z1, [
            st(s, {
              class: "gutentap-button-lg gutentap-button-secondary gutentap-button-text gutentap-button-text-only",
              onClick: Re(o.hideModal, ["prevent"]),
              content: t.cancelButton
            }, null, 8, ["onClick", "content"]),
            st(s, {
              class: "gutentap-button-lg gutentap-button-primary gutentap-button-text gutentap-button-text-only",
              onClick: Re(o.okHandler, ["prevent"]),
              content: t.okButton
            }, null, 8, ["onClick", "content"])
          ])
        ])
...
const tv = /* @__PURE__ */ pt($1, [["render", ev]]), nv = {
...
}, rv = { class: "gutentap-modal-layout" }, iv = {
  key: 0,
  class: "gutentap-modal-header"
}, ov = { class: "gutentap-modal-header-title" }, sv = /* @__PURE__ */ I("svg", {
  width: "24px",
  height: "24px",
  viewBox: "0 0 24 24",
  fill: "none",
...
function cv(n, e, t, r, i, o) {
  return D(), H("div", rv, [
    ...
    I("div", {
      ...
      t.showHeader ? (D(), H("div", iv, [
        I("div", ov, He(t.title), 1),
        t.closable ? (D(), H("div", {
          key: 0,
          class: "gutentap-modal-header-close",
      ...
      t.content ? (D(), H("div", {
        key: 1,
        class: "gutentap-modal-body",
        innerHTML: t.content
      }, null, 8, av)) : se("", !0)
    ], 2)
  ]);
}
const uv = /* @__PURE__ */ pt(nv, [["render", cv]]), dv = ee.create({
  name: "modal",
  addOptions() {
    return {
      formModal: tv,
...
function hv(n) {
  var e;
  const { char: t, allowSpaces: r, allowedPrefixes: i, startOfLine: o, $position: s } = n, l = Hy(t), a = new RegExp(`\\s${l}$`), c = o ? "^" : "", u = r ? new RegExp(`${c}${l}.*?(?=\\s${l}|$)`, "gm") : new RegExp(`${c}(?:^)?${l}[^\\s${l}]*`, "gm"), d = ((e = s.nodeBefore) === null || e === void 0 ? void 0 : e.isText) && s.nodeBefore.text;
  if (!d)
    return null;
  ...
  const g = f + h.index;
  let v = g + h[0].length;
  return r && a.test(d.slice(v - 1, v + 1)) && (h[0] += " ", v += 1), g < s.pos && v >= s.pos ? {
    range: {
      from: g,
      to: v
    },
...
const pv = new be("suggestion");
function mv({ pluginKey: n = pv, editor: e, char: t = "@", allowSpaces: r = !1, allowedPrefixes: i = [" "], startOfLine: o = !1, decorationTag: s = "span", decorationClass: l = "suggestion", command: a = () => null, items: c = () => [], render: u = () => ({}), allow: d = () => !0, findSuggestionMatch: f = hv }) {
  let h;
  const p = u == null ? void 0 : u(), m = new le({
    ...
    view() {
      return {
        update: async (g, v) => {
          var x, T, y, C, b, O, V;
          const M = (x = this.key) === null || x === void 0 ? void 0 : x.getState(v), R = (T = this.key) === null || T === void 0 ? void 0 : T.getState(g.state), $ = M.active && R.active && M.range.from !== R.range.from, W = !M.active && R.active, q = M.active && !R.active, ae = !W && !q && M.query !== R.query, X = W || $, Y = ae && !$, G = q || $;
          if (!X && !Y && !G)
            return;
          const K = G && !X ? M : R, Be = g.dom.querySelector(`[data-decoration-id="${K.decorationId}"]`);
          h = {
            editor: e,
            range: K.range,
            query: K.query,
            ...
            clientRect: Be ? () => {
              var me;
              const { decorationId: mt } = (me = this.key) === null || me === void 0 ? void 0 : me.getState(e.state), Me = g.dom.querySelector(`[data-decoration-id="${mt}"]`);
              return (Me == null ? void 0 : Me.getBoundingClientRect()) || null;
            } : null
          }, X && ((y = p == null ? void 0 : p.onBeforeStart) === null || y === void 0 || y.call(p, h)), Y && ((C = p == null ? void 0 : p.onBeforeUpdate) === null || C === void 0 || C.call(p, h)), (Y || X) && (h.items = await c({
            editor: e,
            query: K.query
          })), G && ((b = p == null ? void 0 : p.onExit) === null || b === void 0 || b.call(p, h)), Y && ((O = p == null ? void 0 : p.onUpdate) === null || O === void 0 || O.call(p, h)), X && ((V = p == null ? void 0 : p.onStart) === null || V === void 0 || V.call(p, h));
        },
        destroy: () => {
          var g;
    ...
    state: {
      ...
      apply(g, v, x, T) {
        const { isEditable: y } = e, { composing: C } = e.view, { selection: b } = g, { empty: O, from: V } = b, M = { ...v };
        if (M.composing = C, y && (O || e.view.composing)) {
          (V < v.range.from || V > v.range.to) && !C && !v.composing && (M.active = !1);
          const R = f({
            char: t,
            allowSpaces: r,
            allowedPrefixes: i,
          ...
          R && d({ editor: e, state: T, range: R.range }) ? (M.active = !0, M.decorationId = v.decorationId ? v.decorationId : $, M.range = R.range, M.query = R.query, M.text = R.text) : M.active = !1;
        } else
          M.active = !1;
    ...
    props: {
      ...
      handleKeyDown(g, v) {
        var x;
        const { active: T, range: y } = m.getState(g.state);
        return T && ((x = p == null ? void 0 : p.onKeyDown) === null || x === void 0 ? void 0 : x.call(p, { view: g, event: v, range: y })) || !1;
      },
      // Setup decorator on the currently active suggestion.
      decorations(g) {
        const { active: v, range: x, decorationId: T } = m.getState(g);
        return v ? re.create(g.doc, [
          Ee.inline(x.from, x.to, {
            nodeName: s,
            class: l,
...
}, vv = { class: "gutentap-block-item" }, bv = ["innerHTML"], kv = { class: "gutentap-block-item-info" }, wv = { class: "gutentap-block-item-info-title" }, xv = {
  key: 0,
  class: "gutentap-block-item-info-description"
};
function Tv(n, e, t, r, i, o) {
  return D(), H("div", vv, [
    I("div", {
      class: "gutentap-block-item-icon",
      innerHTML: t.icon
    }, null, 8, bv),
    I("div", kv, [
      I("div", wv, He(t.title), 1),
      t.description ? (D(), H("div", xv, He(t.description), 1)) : se("", !0)
    ])
  ]);
}
const Ld = /* @__PURE__ */ pt(yv, [["render", Tv]]);
const Sv = {
  name: "BlocksModal",
  props: {
    removeFirstSymbol: {
...
}, Mv = { class: "gutentap-modal-layout" }, Cv = { class: "gutentap-modal gutentap-modal-md gutentap-blocks-modal" }, Ev = { class: "gutentap-modal-header" }, Av = { class: "gutentap-modal-header-title" }, Ov = /* @__PURE__ */ I("svg", {
  width: "24px",
  height: "24px",
  viewBox: "0 0 24 24",
  fill: "none",
  ...
  Ov
], Dv = { class: "gutentap-modal-body" }, Bv = { class: "gutentap-blocks-modal-group" }, Lv = { class: "gutentap-blocks-modal-group-title" }, Rv = { class: "gutentap-blocks-modal-group-blocks" };
function Iv(n, e, t, r, i, o) {
  ...
  return D(), H("div", Mv, [
    ...
    I("div", Cv, [
      ...
      I("div", Dv, [
        (D(!0), H(Le, null, Ye(i.blocks, (l, a) => (D(), H("div", Bv, [
          I("div", Lv, He(l.title), 1),
          I("div", Rv, [
            (D(!0), H(Le, null, Ye(l.blocks, (c, u) => (D(), We(s, {
              class: "gutentap-block-item--modal gutentap-block-item--clickable",
              onClick: Re((d) => o.selectBlock(c), ["prevent"]),
              icon: c.icon,
              title: c.title,
...
const zs = /* @__PURE__ */ pt(Sv, [["render", Iv]]), Pv = {
  components: {
    BlockItem: Ld
  },
  props: {
  ...
  methods: {
    showAll() {
      this.onCloseMenu && this.onCloseMenu(), this.editor.commands.blur(), this.editor.commands.openModal({ removeFirstSymbol: !0 }, zs);
    },
    onKeyDown({ event: n }) {
...
}, Hv = { class: "gutentap-slash-menu" }, zv = {
  key: 0,
  class: "gutentap-slash-menu-body gutentap-block-item--column"
}, Fv = {
  key: 1,
  class: "gutentap-slash-menu-empty"
};
function Vv(n, e, t, r, i, o) {
  const s = je("BlockItem");
  return D(), H("div", Hv, [
    t.items.length ? (D(), H("div", zv, [
      (D(!0), H(Le, null, Ye(t.items, (l, a) => (D(), We(s, {
        class: Ut(["gutentap-block-item--clickable", i.selectedIndex == a ? "gutentap-block-item--selected" : ""]),
        onClick: Re((c) => o.selectItem(a), ["prevent"]),
        icon: l.icon,
        title: l.title,
        description: l.description
      }, null, 8, ["class", "onClick", "icon", "title", "description"]))), 256))
    ])) : (D(), H("div", Fv, He(i.nothingFoundLabel), 1)),
    o.hiddenItems > 0 ? (D(), H("div", {
      key: 2,
      class: "gutentap-slash-menu-show-all",
      onClick: e[0] || (e[0] = (...l) => o.showAll && o.showAll(...l))
    }, [
      Mc(He(i.showAllLabel) + " ", 1),
      I("small", null, "(+" + He(o.hiddenItems) + ")", 1)
    ])) : se("", !0)
  ]);
}
const _v = /* @__PURE__ */ pt(Pv, [["render", Vv]]);
function $v(n) {
  return {
    items: ({ query: e, editor: t }) => {
      const r = t.storage.gutentapBlocks.getAllowedBlocks(
        t.storage.gutentapBlocks.currentNode,
        t.storage.gutentapBlocks.getFlatBlocks()
      );
      return r.filter((i) => {
        if (e) {
          const o = e.toLowerCase(), s = i.title.toLowerCase().startsWith(o), l = i.keywords && i.keywords.some((a) => a.toLowerCase().startsWith(o));
          return (s || l) && !(i != null && i.hideCommand);
        } else
          return r.length > n ? (i == null ? void 0 : i.isDefaultCommand) && !(i != null && i.hideCommand) : !(i != null && i.hideCommand);
      }).slice(0, n);
    },
    render: () => {
      let e, t;
      return {
        onStart: (r) => {
          if (!r.editor.storage.gutentapBlocks.hasAllowedBlocks(r.editor.storage.gutentapBlocks.currentNode))
            return !1;
          e = new M1(_v, {
            // using vue 2:
            // parent: this,
            ...
            onCreate: (o) => o.popper.classList.add("gutentap-slash-menu-wrapper")
          }));
        },
        onUpdate(r) {
...
const jv = /^(https?:\/\/)?(www\.|music\.)?(youtube\.com|youtu\.be)(?!.*\/channel\/)(?!\/@)(.+)?$/, Wv = /^(https?:\/\/)?(www\.|music\.)?(youtube\.com|youtu\.be)(?!.*\/channel\/)(?!\/@)(.+)?$/g, Fs = (n) => n.match(jv), lc = (n) => n ? "https://www.youtube-nocookie.com/embed/" : "https://www.youtube.com/embed/", qv = (n) => {
  const {
    url: e,
    allowFullscreen: t,
    autoplay: r,
  ...
  let C = `${lc(p)}${y[1]}`;
  const b = [];
  return t === !1 && b.push("fs=0"), r && b.push("autoplay=1"), i && b.push(`cc_lang_pref=${i}`), o && b.push("cc_load_policy=1"), s || b.push("controls=0"), l && b.push("disablekb=1"), a && b.push("enablejsapi=1"), c && b.push(`end=${c}`), u && b.push(`hl=${u}`), d && b.push(`iv_load_policy=${d}`), f && b.push("loop=1"), h && b.push("modestbranding=1"), m && b.push(`origin=${m}`), g && b.push(`playlist=${g}`), x && b.push(`start=${x}`), v && b.push(`color=${v}`), b.length && (C += `?${b.join("&")}`), C;
};
function Kv() {
  return [
          ...
          insertCommand: async ({ editor: n, range: e }) => {
            ...
            for (; !t; ) {
              ...
              if (s == null || (o = s[0].value, o == null))
                return;
              Fs(o) ? t = !0 : (r = o, i = n.commands.getTranslation("blockTools.youtube.form.error"));
            }
              ...
              command: async (n) => {
                ...
                for (; !e; ) {
                  ...
                  if (o == null || (i = o[0].value, i == null))
                    return;
                  Fs(i) ? e = !0 : (t = i, r = n.commands.getTranslation("blockTools.youtube.form.error"));
                }
...
const Uv = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/, Jv = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g, Gv = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/, Yv = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g, Qv = De.create({
  name: "bold",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addCommands() {
    return {
      toggleBulletList: () => ({ commands: n, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(Xv.name, this.editor.getAttributes(ac.name)).run() : n.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
  ...
  addInputRules() {
    ...
    return (this.options.keepMarks || this.options.keepAttributes) && (n = Li({
      ...
      getAttributes: () => this.editor.getAttributes(ac.name),
      editor: this.editor
    })), [
      n
    ];
  }
}), eb = /(?:^|\s)(`(?!\s+`)((?:[^`]+))`(?!\s+`))$/, tb = /(?:^|\s)(`(?!\s+`)((?:[^`]+))`(?!\s+`))/g, nb = De.create({
  name: "code",
  addOptions() {
    return {
      HTMLAttributes: {}
        ...
        props: {
          handlePaste: (n, e) => {
            ...
            if (!t || !o)
              return !1;
            const { tr: s } = n.state;
            return n.state.selection.from === n.state.doc.nodeSize - (1 + n.state.selection.$to.depth * 2) ? s.insert(n.state.selection.from - 1, this.type.create({ language: o })) : s.replaceSelectionWith(this.type.create({ language: o })), s.setSelection(P.near(s.doc.resolve(Math.max(0, s.selection.from - 2)))), s.insertText(t.replace(/\r\n?/g, `
...
class te extends F {
  ...
  */
  ...
  map(e, t) {
    let r = e.resolve(t.map(this.head));
    return te.valid(r) ? new te(r) : F.near(r);
  }
  content() {
    return E.empty;
  }
...
class Sl {
  ...
  resolve(e) {
    ...
    return te.valid(t) ? new te(t) : F.near(t);
  }
}
function lb(n) {
...
function cb() {
  return new le({
    props: {
      ...
      handleClick: db,
      handleKeyDown: ub,
      handleDOMEvents: { beforeinput: fb }
    }
  });
}
const ub = Hu({
...
const pb = ee.create({
  ...
  extendNodeSchema(n) {
    ...
    return {
      allowGapCursor: (e = z(A(n, "allowGapCursor", t))) !== null && e !== void 0 ? e : null
    };
  }
}), mb = ye.create({
  name: "hardBreak",
...
ue.from = function(e) {
  return e instanceof ue ? e : e && e.length ? new Rd(e) : ue.empty;
};
...
class Xe {
  ...
  addTransform(e, t, r, i) {
    ...
    let c = s - r.depth;
    return c > kb && (l = bb(l, c), s -= c), new Xe(l.append(o), s);
  }
  remapping(e, t) {
    let r = new Hn();
  ...
  rebased(e, t) {
    ...
    return d.emptyItemCount() > vb && (d = d.compress(this.items.length - r.length)), d;
  }
  emptyItemCount() {
    let e = 0;
...
function wb(n, e, t, r) {
  ...
  t.getMeta(Sb) && (n = new Rt(n.done, n.undone, null, 0, -1));
  let s = t.getMeta("appendedTransaction");
  if (t.steps.length == 0)
    return n;
  if (s && s.getMeta(mn))
    return s.getMeta(mn).redo ? new Rt(n.done.addTransform(t, void 0, r, gi(e)), n.undone, uc(t.mapping.maps[t.steps.length - 1]), n.prevTime, n.prevComposition) : new Rt(n.done, n.undone.addTransform(t, void 0, r, gi(e)), null, n.prevTime, n.prevComposition);
  if (t.getMeta("addToHistory") !== !1 && !(s && s.getMeta("addToHistory") === !1)) {
    let l = t.getMeta("composition"), a = n.prevTime == 0 || !s && n.prevComposition != l && (n.prevTime < (t.time || 0) - r.newGroupDelay || !xb(t, n.prevRanges)), c = s ? is(n.prevRanges, t.mapping) : uc(t.mapping.maps[t.steps.length - 1]);
    return new Rt(n.done.addTransform(t, a ? e.selection.getBookmark() : void 0, r, gi(e)), Xe.empty, c, t.time, l ?? n.prevComposition);
  } else
    return (o = t.getMeta("rebased")) ? new Rt(n.done.rebased(t, o), n.undone.rebased(t, o), is(n.prevRanges, t.mapping), n.prevTime, n.prevComposition) : new Rt(n.done.addMaps(t.mapping.maps), n.undone.addMaps(t.mapping.maps), is(n.prevRanges, t.mapping), n.prevTime, n.prevComposition);
}
function xb(n, e) {
  if (!e)
    return !1;
...
function Tb(n, e, t) {
  ...
  if (!o)
    return null;
  let s = o.selection.resolve(o.transform.doc), l = (t ? n.done : n.undone).addTransform(o.transform, e.selection.getBookmark(), i, r), a = new Rt(t ? l : o.remaining, t ? o.remaining : l, null, 0, -1);
...
const mn = new be("history"), Sb = new be("closeHistory");
function Mb(n = {}) {
  return n = {
    depth: n.depth || 100,
    ...
    state: {
      init() {
        return new Rt(Xe.empty, Xe.empty, null, 0, -1);
      },
      apply(e, t, r) {
        return wb(t, r, e, n);
      }
    ...
    props: {
      handleDOMEvents: {
        beforeinput(e, t) {
          let r = t.inputType, i = r == "historyUndo" ? Pd : r == "historyRedo" ? Hd : null;
...
const Pd = Id(!1, !0), Hd = Id(!0, !0), Cb = ee.create({
  name: "history",
  addOptions() {
    return {
      depth: 100,
      ...
      setHorizontalRule: () => ({ chain: n, state: e }) => {
        ...
        return t.parentOffset === 0 ? r.insertContentAt(Math.max(t.pos - 2, 0), { type: this.name }) : r.insertContent({ type: this.name }), r.command(({ tr: i, dispatch: o }) => {
          ...
          if (o) {
            ...
            if (l.nodeAfter)
              l.nodeAfter.isTextblock ? i.setSelection(P.create(i.doc, l.pos + 1)) : l.nodeAfter.isBlock ? i.setSelection(B.create(i.doc, l.pos)) : i.setSelection(P.create(i.doc, l.pos));
            else {
              const c = (s = l.parent.type.contentMatch.defaultType) === null || s === void 0 ? void 0 : s.create();
              c && (i.insert(a, c), i.setSelection(P.create(i.doc, a + 1)));
            }
            i.scrollIntoView();
          }
          return !0;
...
}), Ab = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/, Ob = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g, Nb = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/, Db = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g, Bb = De.create({
  name: "italic",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addCommands() {
    return {
      toggleOrderedList: () => ({ commands: n, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(Rb.name, this.editor.getAttributes(fc.name)).run() : n.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
  ...
  addInputRules() {
    ...
    return (this.options.keepMarks || this.options.keepAttributes) && (n = Li({
      ...
      keepMarks: this.options.keepMarks,
      keepAttributes: this.options.keepAttributes,
      getAttributes: (e) => ({ start: +e[1], ...this.editor.getAttributes(fc.name) }),
      joinPredicate: (e, t) => t.childCount + t.attrs.start === +e[1],
      editor: this.editor
    })), [
      n
...
}), Hb = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/, zb = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))/g, Fb = De.create({
  name: "strike",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  name: "text",
  group: "inline"
}), _b = "ö", $b = "ελ1υ2бг1ел3дети4ею2католик6ом3мкд2он1сква6онлайн5рг3рус2ф2сайт3рб3укр3қаз3հայ3ישראל5קום3ابوظبي5رامكو5لاردن4بحرين5جزائر5سعودية6عليان5مغرب5مارات5یران5بارت2زار4يتك3ھارت5تونس4سودان3رية5شبكة4عراق2ب2مان4فلسطين6قطر3كاثوليك6وم3مصر2ليسيا5وريتانيا7قع4همراه5پاکستان7ڀارت4कॉम3नेट3भारत0म्3ोत5संगठन5বাংলা5ভারত2ৰত4ਭਾਰਤ4ભારત4ଭାରତ4இந்தியா6லங்கை6சிங்கப்பூர்11భారత్5ಭಾರತ4ഭാരതം5ලංකා4คอม3ไทย3ລາວ3გე2みんな3アマゾン4クラウド4グーグル4コム2ストア3セール3ファッション6ポイント4世界2中信1国1國1文网3亚马逊3企业2佛山2信息2健康2八卦2公司1益2台湾1灣2商城1店1标2嘉里0大酒店5在线2大拿2天主教3娱乐2家電2广东2微博2慈善2我爱你3手机2招聘2政务1府2新加坡2闻2时尚2書籍2机构2淡马锡3游戏2澳門2点看2移动2组织机构4网址1店1站1络2联通2谷歌2购物2通販2集团2電訊盈科4飞利浦3食品2餐厅2香格里拉3港2닷넷1컴2삼성2한국2", Xn = (n, e) => {
  for (const t in e)
    n[t] = e[t];
  return n;
}, Vs = "numeric", _s = "ascii", $s = "alpha", yi = "asciinumeric", li = "alphanumeric", js = "domain", zd = "emoji", jb = "scheme", Wb = "slashscheme", pc = "whitespace";
function qb(n, e) {
  return n in e || (e[n] = []), e[n];
}
function an(n, e, t) {
  e[Vs] && (e[yi] = !0, e[li] = !0), e[_s] && (e[yi] = !0, e[$s] = !0), e[yi] && (e[li] = !0), e[$s] && (e[li] = !0), e[li] && (e[js] = !0), e[zd] && (e[js] = !0);
  for (const r in e) {
    const i = qb(r, t);
...
Ce.prototype = {
  ...
  tr(n, e, t, r) {
    r = r || Ce.groups;
    let i;
    return e && e.j ? i = e : (i = new Ce(e), t && r && an(e, t, r)), this.jr.push([n, i]), i;
  },
  /**
  ...
  tt(n, e, t, r) {
    ...
    const o = e;
    let s, l = i.go(n);
    if (l ? (s = new Ce(), Xn(s.j, l.j), s.jr.push.apply(s.jr, l.jr), s.jd = l.jd, s.t = l.t) : s = new Ce(), o) {
      if (r)
        if (s.t && typeof s.t == "string") {
          const a = Xn(Kb(s.t, r), t);
          an(o, a, r);
        } else
          t && an(o, t, r);
      s.t = o;
...
const _ = (n, e, t, r, i) => n.ta(e, t, r, i), Ve = (n, e, t, r, i) => n.tr(e, t, r, i), mc = (n, e, t, r, i) => n.ts(e, t, r, i), S = (n, e, t, r, i) => n.tt(e, t, r, i), wt = "WORD", Ws = "UWORD", Br = "LOCALHOST", qs = "TLD", Ks = "UTLD", vi = "SCHEME", Rn = "SLASH_SCHEME", Ml = "NUM", Fd = "WS", Cl = "NL", yr = "OPENBRACE", vr = "CLOSEBRACE", Hi = "OPENBRACKET", zi = "CLOSEBRACKET", Fi = "OPENPAREN", Vi = "CLOSEPAREN", _i = "OPENANGLEBRACKET", $i = "CLOSEANGLEBRACKET", ji = "FULLWIDTHLEFTPAREN", Wi = "FULLWIDTHRIGHTPAREN", qi = "LEFTCORNERBRACKET", Ki = "RIGHTCORNERBRACKET", Ui = "LEFTWHITECORNERBRACKET", Ji = "RIGHTWHITECORNERBRACKET", Gi = "FULLWIDTHLESSTHAN", Yi = "FULLWIDTHGREATERTHAN", Qi = "AMPERSAND", Xi = "APOSTROPHE", Zi = "ASTERISK", It = "AT", eo = "BACKSLASH", to = "BACKTICK", no = "CARET", Ht = "COLON", El = "COMMA", ro = "DOLLAR", nt = "DOT", io = "EQUALS", Al = "EXCLAMATION", rt = "HYPHEN", oo = "PERCENT", so = "PIPE", lo = "PLUS", ao = "POUND", co = "QUERY", Ol = "QUOTE", Nl = "SEMI", it = "SLASH", br = "TILDE", uo = "UNDERSCORE", Vd = "EMOJI", fo = "SYM";
...
const Nn = /[a-z]/, ls = /\p{L}/u, as = /\p{Emoji}/u, cs = /\d/, gc = /\s/, yc = `
`, Ub = "️", Jb = "‍";
let ai = null, ci = null;
function Gb(n) {
  n === void 0 && (n = []);
  ...
  Ce.groups = e;
  const t = new Ce();
  ai == null && (ai = vc(_b)), ci == null && (ci = vc($b)), S(t, "'", Xi), S(t, "{", yr), S(t, "}", vr), S(t, "[", Hi), S(t, "]", zi), S(t, "(", Fi), S(t, ")", Vi), S(t, "<", _i), S(t, ">", $i), S(t, "（", ji), S(t, "）", Wi), S(t, "「", qi), S(t, "」", Ki), S(t, "『", Ui), S(t, "』", Ji), S(t, "＜", Gi), S(t, "＞", Yi), S(t, "&", Qi), S(t, "*", Zi), S(t, "@", It), S(t, "`", to), S(t, "^", no), S(t, ":", Ht), S(t, ",", El), S(t, "$", ro), S(t, ".", nt), S(t, "=", io), S(t, "!", Al), S(t, "-", rt), S(t, "%", oo), S(t, "|", so), S(t, "+", lo), S(t, "#", ao), S(t, "?", co), S(t, '"', Ol), S(t, "/", it), S(t, ";", Nl), S(t, "~", br), S(t, "_", uo), S(t, "\\", eo);
  const r = Ve(t, cs, Ml, {
    [Vs]: !0
  });
  Ve(r, cs, r);
  ...
  an(qs, {
    ...
    utld: !0,
    alpha: !0
  }, e), Dt(t, "file", vi, wt, c), Dt(t, "mailto", vi, wt, c), Dt(t, "http", Rn, wt, c), Dt(t, "https", Rn, wt, c), Dt(t, "ftp", Rn, wt, c), Dt(t, "ftps", Rn, wt, c), an(vi, {
    scheme: !0,
    ascii: !0
  }, e), an(Rn, {
    slashscheme: !0,
  ...
  for (let d = 0; d < n.length; d++) {
    ...
    f.indexOf("-") >= 0 ? p[js] = !0 : Nn.test(f) ? cs.test(f) ? p[yi] = !0 : p[_s] = !0 : p[Vs] = !0, mc(t, f, f, p);
  }
  return mc(t, "localhost", Br, {
    ascii: !0
  }), t.jd = new Ce(fo), {
    start: t,
    tokens: Xn({
...
function Dt(n, e, t, r, i) {
  ...
  for (let l = 0; l < s - 1; l++) {
    const a = e[l];
    n.j[a] ? o = n.j[a] : (o = new Ce(r), o.jr = i.slice(), n.j[a] = o), n = o;
  }
  return o = new Ce(t), o.jr = i.slice(), n.j[e[s - 1]] = o, o;
}
function vc(n) {
  const e = [], t = [];
...
function Dl(n, e) {
  e === void 0 && (e = null);
  let t = Xn({}, Lr);
  n && (t = Xn(t, n instanceof Dl ? n.o : n));
...
const kc = No("email", {
  ...
  */
  ...
  hasProtocol() {
    const n = this.tk;
    return n.length >= 2 && n[0].t !== Br && n[1].t === Ht;
  }
}), _e = (n) => new Ce(n);
function Zb(n) {
  let {
  ...
  const t = e.domain.concat([Qi, Zi, It, eo, to, no, ro, io, rt, Ml, oo, so, lo, ao, it, fo, br, uo]), r = [Xi, Ht, El, nt, Al, co, Ol, Nl, _i, $i, yr, vr, zi, Hi, Fi, Vi, ji, Wi, qi, Ki, Ui, Ji, Gi, Yi], i = [Qi, Xi, Zi, eo, to, no, ro, io, rt, yr, vr, oo, so, lo, ao, co, it, fo, br, uo], o = _e(), s = S(o, br);
  _(s, i, s), _(s, e.domain, s);
  const l = _e(), a = _e(), c = _e();
  _(o, e.domain, l), _(o, e.scheme, a), _(o, e.slashscheme, c), _(l, i, s), _(l, e.domain, l);
  const u = S(l, It);
  S(s, It, u), S(a, It, u), S(c, It, u);
  const d = S(s, nt);
  ...
  _(h, e.domain, f);
  const p = _e(kc);
  _(h, e.tld, p), _(h, e.utld, p), S(u, Br, p);
  const m = S(f, rt);
  _(m, e.domain, f), _(p, e.domain, f), S(p, nt, h), S(p, rt, m);
  const g = S(p, Ht);
  _(g, e.numeric, kc);
  const v = S(l, rt), x = S(l, nt);
  _(v, e.domain, l), _(x, i, s), _(x, e.domain, l);
  const T = _e(ui);
  _(x, e.tld, T), _(x, e.utld, T), _(T, e.domain, l), _(T, i, s), S(T, nt, x), S(T, rt, v), S(T, It, u);
  const y = S(T, Ht), C = _e(ui);
  _(y, e.numeric, C);
  const b = _e(ui), O = _e();
  _(b, t, b), _(b, r, O), _(O, t, b), _(O, r, O), S(T, it, b), S(C, it, b);
  const V = S(a, Ht), M = S(c, Ht), R = S(M, it), $ = S(R, it);
  _(a, e.domain, l), S(a, nt, x), S(a, rt, v), _(c, e.domain, l), S(c, nt, x), S(c, rt, v), _(V, e.domain, b), S(V, it, b), _($, e.domain, b), _($, t, b), S($, it, b);
  const W = [
    [yr, vr],
    // {}
    [Hi, zi],
  ...
  for (let q = 0; q < W.length; q++) {
    const [ae, X] = W[q], Y = S(b, ae);
    S(O, ae, Y), S(Y, X, b);
    const G = _e(ui);
    _(Y, t, G);
    const K = _e();
    _(Y, r), _(G, t, G), _(G, r, K), _(K, t, G), _(K, r, K), S(G, X, b), S(K, X, b);
  }
  return S(o, Br, T), S(o, Cl, Xb), {
    start: o,
    tokens: _d
  };
}
function ek(n, e, t) {
  ...
  for (; i < r; ) {
    ...
    if (f < 0)
      ...
      s.length > 0 && (o.push(us(wc, e, s)), s = []), i -= f, u -= f;
      const h = d.t, p = t.slice(i - u, i);
      o.push(us(h, e, p));
    }
  }
  return s.length > 0 && o.push(us(wc, e, s)), o;
}
function us(n, e, t) {
  const r = t[0].s, i = t[t.length - 1].e, o = e.slice(r, i);
  return new n(o, t);
}
const tk = typeof console < "u" && console && console.warn || (() => {
}), nk = "until manual call of linkify.init(). Register all schemes and plugins before invoking linkify the first time.", Z = {
  scanner: null,
  parser: null,
  tokenQueue: [],
  pluginQueue: [],
...
function rk() {
  Ce.groups = {}, Z.scanner = null, Z.parser = null, Z.tokenQueue = [], Z.pluginQueue = [], Z.customSchemes = [], Z.initialized = !1;
}
function xc(n, e) {
  if (e === void 0 && (e = !1), Z.initialized && tk(`linkifyjs: already initialized - will not register custom scheme "${n}" ${nk}`), !/^[0-9a-z]+(-[0-9a-z]+)*$/.test(n))
...
function ik() {
  Z.scanner = Gb(Z.customSchemes);
  for (let n = 0; n < Z.tokenQueue.length; n++)
    Z.tokenQueue[n][1]({
      scanner: Z.scanner
    });
  Z.parser = Zb(Z.scanner.tokens);
...
function jd(n) {
  return Z.initialized || ik(), ek(Z.parser.start, n, Yb(Z.scanner.start, n));
}
function Wd(n, e, t) {
...
function sk(n) {
  return new le({
    ...
    appendTransaction: (e, t, r) => {
      ...
      if (!i || o)
        return;
      const { tr: s } = r, l = Gg(t.doc, [...e]);
      if (iy(l).forEach(({ newRange: c }) => {
        const u = Qg(r.doc, c, (h) => h.isTextblock);
        let d, f;
        if (u.length > 1 ? (d = u[0], f = r.doc.textBetween(d.pos, d.pos + d.node.nodeSize, void 0, " ")) : u.length && r.doc.textBetween(c.from, c.to, " ", " ").endsWith(" ") && (d = u[0], f = r.doc.textBetween(d.pos, c.to, void 0, " ")), d && f) {
          ...
          g.filter((v) => v.isLink).map((v) => ({
            ...
            pl(v.from, v.to, r.doc).some((x) => x.mark.type === n.type) || s.addMark(v.from, v.to, n.type.create({
              href: v.href
            }));
          });
        }
    ...
    props: {
      handleClick: (e, t, r) => {
        ...
        if (!l.find((f) => f.nodeName === "A"))
          return !1;
        const a = Zu(e.state, n.type.name), c = r.target, u = (i = c == null ? void 0 : c.href) !== null && i !== void 0 ? i : a.href, d = (o = c == null ? void 0 : c.target) !== null && o !== void 0 ? o : a.target;
  ...
  return new le({
    ...
    props: {
      handlePaste: (e, t, r) => {
        ...
        const a = Wd(l).find((c) => c.isLink && c.value === l);
...
const ck = De.create({
    ...
    return [
      Kt({
        find: (n) => {
          const e = [];
          if (n) {
            const t = Wd(n).filter((r) => r.isLink);
  ...
  addProseMirrorPlugins() {
    const n = [];
    return this.options.autolink && n.push(sk({
      type: this.type,
      validate: this.options.validate
    })), this.options.openOnClick && n.push(lk({
      type: this.type,
      whenNotEditable: this.options.openOnClick === "whenNotEditable"
    })), this.options.linkOnPaste && n.push(ak({
      editor: this.editor,
      type: this.type
    })), n;
  }
...
}), fk = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))$/, hk = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))/g, pk = De.create({
  name: "highlight",
  addOptions() {
    return {
      multicolor: !1,
  ...
  addInputRules() {
    const n = [];
    return this.options.emDash !== !1 && n.push(mk(this.options.emDash)), this.options.ellipsis !== !1 && n.push(gk(this.options.ellipsis)), this.options.openDoubleQuote !== !1 && n.push(yk(this.options.openDoubleQuote)), this.options.closeDoubleQuote !== !1 && n.push(vk(this.options.closeDoubleQuote)), this.options.openSingleQuote !== !1 && n.push(bk(this.options.openSingleQuote)), this.options.closeSingleQuote !== !1 && n.push(kk(this.options.closeSingleQuote)), this.options.leftArrow !== !1 && n.push(wk(this.options.leftArrow)), this.options.rightArrow !== !1 && n.push(xk(this.options.rightArrow)), this.options.copyright !== !1 && n.push(Tk(this.options.copyright)), this.options.trademark !== !1 && n.push(Sk(this.options.trademark)), this.options.servicemark !== !1 && n.push(Mk(this.options.servicemark)), this.options.registeredTrademark !== !1 && n.push(Ck(this.options.registeredTrademark)), this.options.oneHalf !== !1 && n.push(Ek(this.options.oneHalf)), this.options.plusMinus !== !1 && n.push(Ak(this.options.plusMinus)), this.options.notEqual !== !1 && n.push(Ok(this.options.notEqual)), this.options.laquo !== !1 && n.push(Nk(this.options.laquo)), this.options.raquo !== !1 && n.push(Dk(this.options.raquo)), this.options.multiplication !== !1 && n.push(Bk(this.options.multiplication)), this.options.superscriptTwo !== !1 && n.push(Lk(this.options.superscriptTwo)), this.options.superscriptThree !== !1 && n.push(Rk(this.options.superscriptThree)), this.options.oneQuarter !== !1 && n.push(Ik(this.options.oneQuarter)), this.options.threeQuarters !== !1 && n.push(Pk(this.options.threeQuarters)), n;
  }
}), zk = ye.create({
  name: "youtube",
  addOptions() {
  ...
  addCommands() {
    return {
      setYoutubeVideo: (n) => ({ commands: e }) => Fs(n.src) ? e.insertContent({
        type: this.name,
        attrs: n
      }) : !1
    };
...
const Fk = ee.create({
  ...
  addProseMirrorPlugins() {
    const n = new be(this.name), e = Object.entries(this.editor.schema.nodes).map(([, t]) => t).filter((t) => this.options.notAfter.includes(t.name));
    return [
      new le({
        key: n,
...
function _k() {
  return [
    { name: "Bold", extension: Qv },
    { name: "BulletList", extension: Zv },
    { name: "Code", extension: nb },
    { name: "CodeBlock", extension: ob },
    { name: "Document", extension: sb },
    // { name: 'Dropcursor', extension: Dropcursor },
    { name: "Gapcursor", extension: pb },
    { name: "HardBreak", extension: mb },
    { name: "Heading", extension: gb },
    { name: "History", extension: Cb },
    { name: "HorizontalRule", extension: Eb },
    { name: "Italic", extension: Bb },
    { name: "ListItem", extension: Lb },
    { name: "OrderedList", extension: Ib },
    { name: "Paragraph", extension: Pb },
    { name: "Strike", extension: Fb },
    { name: "Text", extension: Vb },
    // {
    //   name: 'Blockquote',
    //   extension: Blockquote.extend({ content: "paragraph" }),
    // },
    { name: "TrailingNode", extension: Fk },
    { name: "Subscript", extension: uk },
    { name: "Superscript", extension: dk },
    { name: "Highlight", extension: pk },
    {
      name: "Link",
      extension: ck.configure({ openOnClick: !1 })
    },
    { name: "Typography", extension: Hk },
    {
      name: "Youtube",
      extension: zk.configure(
        {
          inline: !1
        }
      )
  ...
  return [
    ...
    },
    {
      ...
      tools: [
        ...
        // {
        //   title: "Sidebar",
        //   icon: '<svg  xmlns="http://www.w3.org/2000/svg" xml:space="preserve" x="0" y="0" enable-background="new 0 0 24 24" version="1.1" viewBox="0 0 24 24"><path  fill="currentColor" d="M14.7 9v6h5.9V9h-5.9zm2.6-2.9H5.1v1.5h12.3V6.1zM5.1 17.9h11.7v-1.5H5.1v1.5zm8-6.6h-8v1.5h8v-1.5z"/></svg>',
        //   command: (editor) => {
...
const Wk = {
  ...
  data() {
    return {
      ...
      allDefaultExtensions: _k(),
      allBlockTools: mi(Kv(), this.blockTools),
      allInlineTools: mi($k(), this.inlineTools),
      allAlignmentTools: mi(jk(), this.alignmentTools),
      isTyping: !1,
      showMainToolbar: !1,
      // EventListners
  ...
  created() {
    this.handleMouseMove = this.cancelTyping.bind(this), this.handleResize = this.updateGutentapWidth.bind(this), window.addEventListener("mousemove", this.handleMouseMove), window.addEventListener("resize", this.handleResize);
  },
  unmounted() {
    window.removeEventListener("mousemove", this.handleMouseMove), window.removeEventListener("resize", this.handleResize);
  },
  mounted() {
    this.updateGutentapWidth(), this.initializeEditor();
  },
  beforeUnmount() {
    this.editor.destroy();
  },
  ...
  computed: {
    ...
    blocksWithVariant() {
      return this.filterBlocks((n) => n == null ? void 0 : n.variants);
    },
    blocksWithBlockWidth() {
      return this.filterBlocks((n) => typeof n.alignTools == "object" && n.alignTools.blockWidth || n.alignTools);
    },
    blocksWithTextAlign() {
      return this.filterBlocks((n) => typeof n.alignTools == "object" && n.alignTools.textAlign || n.alignTools);
    }
  },
  methods: {
    openBlocksModal() {
      this.editor.commands.openModal({}, zs);
    },
    filterBlocks(n) {
    ...
    initializeEditor() {
      ...
      this.editor = new w1({
        extensions: [
          ...n,
          _1.configure({ blocks: e }),
          E1.configure({ considerAnyAsEmpty: !0, placeholder: this.placeholder }),
          V1.configure({ types: this.blocksWithBlockWidth }),
          fv.configure({ types: this.blocksWithVariant }),
          A1.configure({ types: this.blocksWithTextAlign }),
          dv,
          ...this.extensions
        ],
    ...
    getEnabledExtensions() {
      ...
      }), this.slashMenu !== !1 && n.push(gv.configure({
        suggestion: $v(5)
      })), n;
    },
    updateGutentapWidth() {
      const n = this.$refs.gutentap;
      n && (this.gutentapWidth = n.clientWidth);
    },
    cancelTyping() {
      this.$nextTick(() => {
        this.isTyping = !1;
    ...
    shouldShowFloatingMenu({ editor: n, state: e, view: t }) {
      ...
      if (!t.hasFocus() || !o || !s || !this.editor.isEditable)
        return !1;
      const l = ru(n);
      return n.storage.gutentapBlocks.hasAllowedBlocks(l);
    },
...
function Kk(n, e, t, r, i, o) {
  ...
  return D(), H("div", qk, [
    ...
    i.editor ? (D(), We(a, {
      ...
      editor: i.editor,
      class: Ut([{
        "gutentap-bubble-menu-hidden": i.isTyping
      }, "gutentap-bubble-menu"]),
      "tippy-options": {
        delay: [0, 300],
        duration: [300, 400],
        maxWidth: "none",
        ...
        onCreate: (f) => f.popper.classList.add("gutentap-toolbar-wrapper")
      }
    }, {
      default: St(() => {
        var f;
        return [
          ((f = o.currentBlockTool) == null ? void 0 : f.nodeType) !== void 0 ? (D(), We(l, {
            key: 0,
            editor: i.editor,
            settings: o.mergedSettings,
            inlineTools: i.allInlineTools,
            alignmentTools: i.allAlignmentTools,
            gutentapWidth: i.gutentapWidth
          }, null, 8, ["editor", "settings", "inlineTools", "alignmentTools", "gutentapWidth"])) : se("", !0)
        ];
      }),
      _: 1
    }, 8, ["should-show", "editor", "class", "tippy-options"])) : se("", !0),
    o.currentBlockTool ? (D(), We(u, {
      key: 1,
      updateDelay: 1e3,
    ...
    st(d, {
      onKeydown: [
        ...
        e[1] || (e[1] = Ll((f) => i.isTyping = !1, ["esc"]))
      ],
      onKeyup: e[2] || (e[2] = Ll((f) => i.isTyping = !1, ["esc"])),
      ref: "editor",
      editor: i.editor
    }, null, 8, ["editor"])
  ], 512);
}
const Uk = /* @__PURE__ */ pt(Wk, [["render", Kk]]);
const Jk = {
  props: C1,
  components: {
    NodeViewWrapper: S1
  ...
  data() {
    return {
      ...
      gutenTapBlock: this.editor.storage.gutentapBlocks.getBlockTool(this.node.type.name, !1)
    };
  },
  mounted() {
  },
  ...
  class: "gutentap-customblock-header"
}, Yk = { class: "gutentap-customblock-header-title" }, Qk = ["innerHTML"], Xk = {
  key: 0,
  class: "gutentap-customblock-header-mode"
}, Zk = { class: "gutentap-customblock-body" };
function ew(n, e, t, r, i, o) {
  var l;
  const s = je("node-view-wrapper");
  return D(), We(s, {
    class: Ut(["gutentap-customblock", {
      ["gutentap-customblock--" + (((l = i.gutenTapBlock) == null ? void 0 : l.name) || "")]: !0,
      "gutentap-customblock--outline": i.isEditable,
      "gutentap-customblock--has-header": i.isEditable
    }]),
    ...
    default: St(() => {
      var a, c, u, d, f;
      return [
        i.isEditable && ((a = i.gutenTapBlock) != null && a.name) ? (D(), H("div", Gk, [
          I("div", Yk, [
            I("span", {
              class: "gutentap-customblock-header-title-icon",
              innerHTML: (c = i.gutenTapBlock) == null ? void 0 : c.icon
            }, null, 8, Qk),
            Mc(" " + He((u = i.gutenTapBlock) == null ? void 0 : u.title), 1)
          ]),
          ((f = (d = i.gutenTapBlock) == null ? void 0 : d.gutenTapBlock) == null ? void 0 : f.hasPreviewMode) !== !1 ? (D(), H("div", Xk, [
            I("span", {
              onClick: e[0] || (e[0] = (...h) => o.toggleMode && o.toggleMode(...h))
            }, He(i.isPreviewMode ? "Редактировать" : "Просмотр"), 1)
          ])) : se("", !0)
        ])) : se("", !0),
        I("div", Zk, [
          ds(n.$slots, "default", {
...
const tw = /* @__PURE__ */ pt(Jk, [["render", ew], ["__scopeId", "data-v-2d10781a"]]), iw = Uk, ow = tw;
export {
  ow as BaseBlock,
  iw as GutenTap
};
