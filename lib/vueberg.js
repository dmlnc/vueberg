import { openBlock as D, createElementBlock as F, normalizeClass as Ot, renderSlot as ms, createCommentVNode as ie, resolveComponent as We, createElementVNode as P, withModifiers as Re, createVNode as lt, withCtx as St, toDisplayString as qe, Fragment as Ie, renderList as Qe, createBlock as Pe, defineComponent as Rr, ref as Pr, onMounted as mo, onBeforeUnmount as Xs, h as Et, reactive as go, markRaw as Zs, getCurrentInstance as of, watchEffect as sf, nextTick as lf, unref as hi, Teleport as af, customRef as cf, watch as Nc, computed as uf, TransitionGroup as df, resolveDynamicComponent as ff, mergeProps as hf, toHandlers as pf, withDirectives as Dc, vModelText as mf, createTextVNode as Bc, vShow as gf, withKeys as Hl } from "vue";
const mt = (n, e) => {
...
class _t extends ve {
  ...
  */
  ...
  apply(e) {
    ...
    return oe.fromReplace(e, this.pos, this.pos + 1, new E(x.from(r), 0, t.isLeaf ? 0 : 1));
  }
  invert(e) {
    let t = e.nodeAt(this.pos);
    if (t) {
...
class le extends ve {
  ...
  */
  ...
  apply(e) {
    return this.structure && ks(e, this.from, this.to) ? oe.fail("Structure replace would overwrite content") : oe.fromReplace(e, this.from, this.to, this.slice);
  }
  getMap() {
  ...
  */
  static fromJSON(e, t) {
    ...
    return new le(t.from, t.to, E.fromJSON(e, t.slice), !!t.structure);
  }
}
ve.jsonID("replace", le);
class ce extends ve {
  /**
  ...
  for (let a = 0; a < o.childCount; a++) {
    ...
    if (!d)
      ...
      if (i && c.isText && t.whitespace != "pre") {
        let f, h = /\r?\n|\r/g, p;
        for (; f = h.exec(c.text); )
          p || (p = new E(x.from(t.schema.text(" ", t.allowedMarks(c.marks))), 0, 0)), s.push(new le(l + f.index, l + f.index + f[0].length, p));
      }
    }
    l = u;
  }
...
function oh(n, e, t = 1, r) {
  ...
  n.step(new le(e, e, new E(o.append(s), t, t), !0));
}
function Gt(n, e) {
...
function sh(n, e, t) {
  let r = new le(e - t, e + t, E.empty, !0);
  n.step(r);
}
function lh(n, e, t) {
  let r = n.resolve(e);
...
function vo(n, e, t = e, r = E.empty) {
  ...
  return ru(i, o, r) ? new le(e, t, r) : new ch(i, o, r).fit();
}
function ru(n, e, t) {
...
class ch {
  ...
  fit() {
    ...
    let a = new E(o, s, l);
    return e > -1 ? new ce(r.pos, e, this.$to.pos, this.$to.end(), a, t) : a.size || r.pos != this.$to.pos ? new le(r.pos, i.pos, a) : null;
  }
...
class Vn extends ve {
  ...
  */
  ...
  apply(e) {
    ...
    return oe.fromReplace(e, this.pos, this.pos + 1, new E(x.from(i), 0, t.isLeaf ? 0 : 1));
  }
  getMap() {
    return Fe.empty;
  }
...
function Ql(n, e, t) {
  ...
  if (r < e)
    return;
  let i = n.steps[r];
  if (!(i instanceof le || i instanceof ce))
    return;
...
const Ch = function({ view: n, dir: e, currentResolved: t }) {
  ...
  r.step(new le(h, p, m, !1)), r.setSelection(
    V.near(
      r.doc.resolve(
        i ? t.pos + f : t.pos - f
      )
  ...
  computed: {
    ...
    firstMenuItems() {
      ...
      if (!this.currentBlockTool)
        return [];
      let n = this.menuCount, e = (t = this.menuItems) == null ? void 0 : t.reduce((r, i) => r + i.buttons.length, 0);
    ...
    menuCount() {
      ...
      const e = parseInt(getComputedStyle(document.documentElement).getPropertyValue("--vueberg-toolbar-padding")) || 6, t = parseInt(getComputedStyle(document.documentElement).getPropertyValue("--vueberg-button-size")) || 30, r = 2, i = 2 * (parseInt(getComputedStyle(document.documentElement).getPropertyValue("--vueberg-toolbar-group")) || 10), o = 1;
      n -= e * 2, n -= 2 * t, n -= r, n -= i + o, n -= this.activeAlignmentTools.length * t, n -= r * (this.activeAlignmentTools.length ? this.activeAlignmentTools.length - 1 : 0), n -= i + o;
      const s = (u = (c = this.currentBlockTool) == null ? void 0 : c.tools) == null ? void 0 : u.length;
      let l = 0, a = 0;
      return (f = (d = this.currentBlockTool) == null ? void 0 : d.tools) != null && f.length && (a = t * s, a += r * (s ? s - 1 : 0)), n < a + i + o ? Math.floor((n - i - o) / (t + r)) : (l = (p = (h = this.currentBlockTool) == null ? void 0 : h.tools) == null ? void 0 : p.length, n -= a, n -= i, n -= o, l == null && (l = 0), n -= i, n -= o, Math.floor(n / (r + t)) + l);
    },
    menuItems() {
      var n, e, t, r, i, o, s;
...
function Hh(n, e, t, r, i, o) {
  var a, c, u, d;
  const s = We("menu-button"), l = We("menu-item");
  return D(), F("div", Sh, [
    P("div", Mh, [
      P("div", Eh, [
        P("button", {
      ...
      (a = t.currentBlockTool) != null && a.icon && ((c = t.currentBlockTool) != null && c.name) ? (D(), F("div", Ih, [
        lt(l, {
          ...
          dropdown: St(() => [
            ...
            (D(!0), F(Ie, null, Qe(o.canBeConvertedTo, (f) => (D(), Pe(s, {
          ...
          default: St(() => {
            ...
            return [
              lt(s, {
                ...
                class: Ot((m = (p = t.currentBlockTool) == null ? void 0 : p.toolbar) != null && m.canBeConverted && o.canBeConvertedTo.length ? "vueberg-button-secondary" : "")
    ...
    o.activeAlignmentTools.length ? (D(), F("div", Ph, [
      (D(!0), F(Ie, null, Qe(o.activeAlignmentTools, (f, h) => (D(), Pe(l, {
        hasDropdown: !0,
        key: h
      }, {
        dropdown: St(() => [
          (D(!0), F(Ie, null, Qe(f.tools, (p) => {
            var m;
            return D(), Pe(s, {
              class: "vueberg-button-text vueberg-button-md",
              key: p.title,
    ...
    (D(!0), F(Ie, null, Qe(o.firstMenuItems, (f) => (D(), F(Ie, null, [
      f.condition ? (D(), F("div", {
        key: f.type,
        class: "vueberg-button-group vueberg-button-group-separate"
      }, [
        (D(!0), F(Ie, null, Qe(f.buttons, (h, p) => (D(), Pe(s, {
          key: p,
          content: h.icon,
          label: h.label,
    ...
    t.editor && o.remainingMenuItems.length ? (D(), F("div", Fh, [
      lt(l, {
        align: "right",
        hasDropdown: !0
      }, {
        dropdown: St(() => [
          (D(!0), F(Ie, null, Qe(o.remainingMenuItems, (f) => (D(), F(Ie, null, [
            f.condition ? (D(!0), F(Ie, { key: 0 }, Qe(f.buttons, (h, p) => (D(), Pe(s, {
              key: p,
              ...
              disabled: h.disabled,
              active: h.active
            }, null, 8, ["content", "activeClass", "onClick", "disabled", "active"]))), 128)) : ie("", !0)
          ], 64))), 256))
        ]),
        default: St(() => [
          lt(s, {
...
function ta(n, e, t, r, i) {
  for (; ; ) {
    ...
    if (e == (i < 0 ? 0 : at(n))) {
      let o = n.parentNode;
      if (!o || o.nodeType != 1 || Fr(n) || _h.test(n.nodeName) || n.contentEditable == "false")
        return !1;
      e = pe(n) + (i < 0 ? 0 : 1), n = o;
...
const ft = typeof navigator < "u" ? navigator : null, na = typeof document < "u" ? document : null, Yt = ft && ft.userAgent || "", xs = /Edge\/(\d+)/.exec(Yt), du = /MSIE \d/.exec(Yt), Cs = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Yt), Oe = !!(du || Cs || xs), jt = du ? document.documentMode : Cs ? +Cs[1] : xs ? +xs[1] : 0, tt = !Oe && /gecko\/(\d+)/i.test(Yt);
tt && +(/Firefox\/(\d+)/.exec(Yt) || [0, 0])[1];
const Ts = !Oe && /Chrome\/(\d+)/.exec(Yt), xe = !!Ts, Uh = Ts ? +Ts[1] : 0, Ce = !Oe && !!ft && /Apple Computer/.test(ft.vendor), Un = Ce && (/Mobile\/\w+/.test(Yt) || !!ft && ft.maxTouchPoints > 2), je = Un || (ft ? /Mac/.test(ft.platform) : !1), Jh = ft ? /Win/.test(ft.platform) : !1, Xe = /Android \d/.test(Yt), Hr = !!na && "webkitFontSmoothing" in na.documentElement.style, Gh = Hr ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function Yh(n) {
...
function gu(n, e, t) {
  ...
  if (r.nodeType == 3)
    if (s && (sp.test(r.nodeValue) || (t < 0 ? !i : i == r.nodeValue.length))) {
      ...
      if (tt && i && /\s/.test(r.nodeValue[i - 1]) && i < r.nodeValue.length) {
        let c = It(Ct(r, i - 1, i - 1), -1);
        if (c.top == a.top) {
          let u = It(Ct(r, i, i + 1), -1);
          if (u.top != a.top)
      ...
      return t < 0 && !i ? (c++, u = -1) : t >= 0 && i == r.nodeValue.length ? (a--, u = 1) : t < 0 ? a-- : c++, sr(It(Ct(r, a, c), u), u < 0);
    }
  ...
  return sr(It(r.nodeType == 3 ? Ct(r) : r, -t), t >= 0);
}
function sr(n, e) {
  if (n.width == 0)
    return n;
...
class Wt extends zr {
  ...
  static create(e, t, r, i, o, s) {
    ...
    let f = u;
    return u = xu(u, r, t), c ? a = new fp(e, t, r, i, u, d || null, f, c, o, s + 1) : t.isText ? new xo(e, t, r, i, u, f, o) : new Wt(e, t, r, i, u, d || null, f, o, s + 1);
  }
  parseRule() {
...
function At(n, e = !1) {
  ...
  if (Tu(n, t), !!Cu(n)) {
    ...
    if (n.domObserver.disconnectSelection(), n.cursorWrapper)
      ...
      da && !(t instanceof H) && (t.$from.parent.inlineContent || (o = fa(n, t.from)), !t.empty && !t.$from.parent.inlineContent && (s = fa(n, t.to))), n.docView.setSelection(r, i, n.root, e), da && (o && ha(o), s && ha(s)), t.visible ? n.dom.classList.remove("ProseMirror-hideselection") : (n.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && kp(n));
    }
...
function wp(n) {
  ...
  i ? t.setEnd(r.parentNode, pe(r) + 1) : t.setEnd(r, 0), t.collapse(!1), e.removeAllRanges(), e.addRange(t), !i && !n.state.selection.visible && Oe && jt <= 11 && (r.disabled = !0, r.disabled = !1);
}
function Tu(n, e) {
  if (e instanceof B) {
...
function ba(n, e, t) {
  let r = n.state.selection;
  if (r instanceof H && !r.empty || t.indexOf("s") > -1 || je && t.indexOf("m") > -1)
    return !1;
  let { $from: i, $to: o } = r;
...
Se.keypress = (n, e) => {
  let t = e;
  if (Ru(n, t) || !t.charCode || t.ctrlKey && !t.altKey || je && t.metaKey)
    return;
...
function Wp(n, e, t, r, i) {
  return al(n, "handleClickOn", e, t, r) || n.someProp("handleClick", (o) => o(n, e, r)) || (i ? jp(n, t) : $p(n, t));
}
function qp(n, e, t, r) {
...
const Iu = je ? "metaKey" : "ctrlKey";
Te.mousedown = (n, e) => {
  let t = e;
  n.input.shiftKey = t.shiftKey;
  let r = cl(n), i = Date.now(), o = "singleClick";
  i - n.input.lastClick.time < 500 && _p(t, n.input.lastClick) && !t[Iu] && (n.input.lastClick.type == "singleClick" ? o = "doubleClick" : n.input.lastClick.type == "doubleClick" && (o = "tripleClick")), n.input.lastClick = { time: i, x: t.clientX, y: t.clientY, type: o };
...
class Jp {
  ...
  up(e) {
    ...
    // works around that.
    xe && !this.view.state.selection.visible && Math.min(Math.abs(t.pos - this.view.state.selection.from), Math.abs(t.pos - this.view.state.selection.to)) <= 2) ? (_n(this.view, V.near(this.view.state.doc.resolve(t.pos)), "pointer"), e.preventDefault()) : $t(this.view, "pointer");
  }
  move(e) {
...
function Yp(n) {
  ...
  if (!e.focusNode)
    return null;
  let t = $h(e.focusNode, e.focusOffset), r = jh(e.focusNode, e.focusOffset);
  if (t && r && t != r) {
    let i = r.pmViewDesc;
  ...
  static from(e) {
    switch (e.length) {
      ...
      case 1:
        return e[0];
      default:
        return new Ht(e.every((t) => t instanceof re) ? e : e.reduce((t, r) => t.concat(r instanceof re ? r : r.members), []));
    }
  }
}
...
function Uo(n) {
  ...
  return n.someProp("decorations", (t) => {
    let r = t(n.state);
    r && r != ye && e.push(r);
  }), n.cursorWrapper && e.push(re.create(n.state.doc, [n.cursorWrapper.deco])), Ht.from(e);
}
const rm = {
  childList: !0,
  characterData: !0,
...
class sm {
  constructor(e, t) {
    this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new om(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.observer = window.MutationObserver && new window.MutationObserver((r) => {
      for (let i = 0; i < r.length; i++)
        this.queue.push(r[i]);
      Oe && jt <= 11 && r.some((i) => i.type == "childList" && i.removedNodes.length || i.type == "characterData" && i.oldValue.length > i.target.nodeValue.length) ? this.flushSoon() : this.flush();
  ...
  onSelectionChange() {
    if (ma(this.view)) {
      if (this.suppressingSelectionUpdates)
        return At(this.view);
      if (Oe && jt <= 11 && !this.view.state.selection.empty) {
  ...
  registerMutation(e, t) {
    ...
    if (e.type == "childList") {
      ...
      if (Oe && jt <= 11 && e.addedNodes.length)
        for (let u = 0; u < e.addedNodes.length; u++) {
...
function fm(n, e, t, r, i) {
  ...
  n.input.domChangeCount++, n.state.selection.from < n.state.selection.to && p.start == p.endB && n.state.selection instanceof H && (p.start > n.state.selection.from && p.start <= n.state.selection.from + 2 && n.state.selection.from >= c.from ? p.start = n.state.selection.from : p.endA < n.state.selection.to && p.endA >= n.state.selection.to - 2 && n.state.selection.to <= c.to && (p.endB += n.state.selection.to - p.endA, p.endA = n.state.selection.to)), Oe && jt <= 11 && p.endB == p.start + 1 && p.endA == p.start && p.start > c.from && c.doc.textBetween(p.start - c.from - 1, p.start - c.from + 1) == "  " && (p.start--, p.endA--, p.endB--);
  ...
  if (w) {
    if (m.pos == g.pos)
      Oe && jt <= 11 && m.parentOffset == 0 && (n.domObserver.suppressSelectionUpdates(), setTimeout(() => At(n), 20)), v = n.state.tr.delete(y, M), A = u.resolve(p.start).marksAcross(u.resolve(p.endA));
    else if (
...
function wm(n) {
  var e = vm && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey || km && n.shiftKey && n.key && n.key.length == 1 || n.key == "Unidentified", t = !e && n.key || (n.shiftKey ? Bi : Ut)[n.keyCode] || n.key || "Unidentified";
...
function Sm(n) {
  return new se({ props: { handleKeyDown: Wu(n) } });
}
function Wu(n) {
  let e = Tm(n);
  return function(t, r) {
...
function Ku(n, e, t) {
  ...
  if (!c || c.from != o || c instanceof le && c.slice.size >= a - o)
    return !1;
  if (t) {
    let u = n.tr.step(c);
...
const $g = (n) => ({ editor: e, view: t, tr: r, dispatch: i }) => {
  const o = _g(n).split(/-(?!$)/), s = o.find((c) => !["Alt", "Ctrl", "Meta", "Shift"].includes(c)), l = new KeyboardEvent("keydown", {
    key: s === "Space" ? " " : s,
...
}), Yg = () => ({ state: n, dispatch: e }) => Nm(n, e), Qg = () => ({ state: n, dispatch: e }) => Bm(n, e), Xg = () => ({ state: n, dispatch: e }) => Vm(n, e), Zg = () => ({ state: n, dispatch: e }) => jm(n, e), e0 = () => ({ state: n, dispatch: e }) => $m(n, e);
function od(n, e, t = {}) {
...
let $0 = class extends Qm {
   ...
   */
  injectCSS() {
    this.options.injectCSS && document && (this.css = _0(V0, this.options.injectNonce));
  }
  /**
...
var Ne = "top", Je = "bottom", Ge = "right", De = "left", kl = "auto", _r = [Ne, Je, Ge, De], Gn = "start", Ar = "end", K0 = "clippingParents", ad = "viewport", lr = "popper", U0 = "reference", $a = /* @__PURE__ */ _r.reduce(function(n, e) {
...
function $r(n) {
  for (var e = ze(n), t = ja(n); t && sy(t) && Nt(t).position === "static"; )
    t = ja(t);
  return t && (pt(t) === "html" || pt(t) === "body" && Nt(t).position === "static") ? e : t || ly(n) || e;
}
function Cl(n) {
...
function uy(n) {
  ...
  if (!(!o || !s)) {
    var d = cy(i.padding, t), f = xl(o), h = a === "y" ? Ne : De, p = a === "y" ? Je : Ge, m = t.rects.reference[u] + t.rects.reference[a] - s[a] - t.rects.popper[u], g = s[a] - t.rects.reference[a], b = $r(o), w = b ? a === "y" ? b.clientHeight || 0 : b.clientWidth || 0 : 0, C = m / 2 - g / 2, y = d[h], M = w - f[u] - d[p], v = w / 2 - f[u] / 2 + C, A = mr(y, v, M), R = a;
...
function Wa(n) {
  ...
  if (c) {
    ...
    if (v === ze(t) && (v = Xt(t), Nt(v).position !== "static" && l === "absolute" && (A = "scrollHeight", R = "scrollWidth")), v = v, i === Ne || (i === De || i === Ge) && o === Ar) {
      y = Je;
...
function Ty(n) {
  var e = gr(No(n)), t = ["absolute", "fixed"].indexOf(Nt(n).position) >= 0, r = t && Ue(n) ? $r(n) : n;
...
function My(n, e) {
  e === void 0 && (e = {});
  var t = e, r = t.placement, i = t.boundary, o = t.rootBoundary, s = t.padding, l = t.flipVariations, a = t.allowedAutoPlacements, c = a === void 0 ? cd : a, u = Xn(r), d = u ? l ? $a : $a.filter(function(p) {
    return Xn(p) === u;
  ...
  if (v) {
    if (o) {
      var q, ae = y === "y" ? Ne : De, Z = y === "y" ? Je : Ge, Y = y === "y" ? "height" : "width", G = v[y], K = G + g[ae], Le = G - g[Z], ge = h ? -R[Y] / 2 : 0, gt = w === Gn ? A[Y] : R[Y], Me = w === Gn ? -R[Y] : -A[Y], en = e.elements.arrow, yt = h && en ? xl(en) : {
        width: 0,
        height: 0
      }, Ye = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : hd(), bt = Ye[ae], Cn = Ye[Z], vt = mr(0, A[Y], yt[Y]), Tn = C ? A[Y] / 2 - ge - vt - bt - I.mainAxis : gt - vt - bt - I.mainAxis, Dt = C ? -A[Y] / 2 + ge + vt + Cn + I.mainAxis : Me + vt + Cn + I.mainAxis, Sn = e.elements.arrow && $r(e.elements.arrow), Wr = Sn ? y === "y" ? Sn.clientTop || 0 : Sn.clientLeft || 0 : 0, tr = (q = $ == null ? void 0 : $[y]) != null ? q : 0, qr = G + Tn - tr - Wr, Kr = G + Dt - tr, nr = mr(h ? Pi(K, qr) : K, G, h ? mn(Le, Kr) : Le);
      v[y] = nr, W[y] = nr - G;
    }
    if (l) {
      var rr, Ur = y === "x" ? Ne : De, Jr = y === "x" ? Je : Ge, kt = v[M], Bt = M === "y" ? "height" : "width", ir = kt + g[Ur], tn = kt - g[Jr], or = [Ne, De].indexOf(b) !== -1, Gr = (rr = $ == null ? void 0 : $[M]) != null ? rr : 0, Yr = or ? ir : kt - A[Bt] - R[Bt] - Gr + I.altAxis, Qr = or ? kt + A[Bt] + R[Bt] - Gr - I.altAxis : tn, Xr = h && or ? ay(Yr, kt, Qr) : mr(h ? Yr : ir, kt, h ? Qr : tn);
      v[M] = Xr, W[M] = Xr - kt;
    }
    e.modifiersData[r] = W;
  }
...
function jy(n, e, t) {
  ...
  Ml(o)) && (l = _y(e)), Ue(e) ? (a = Qn(e, !0), a.x += e.clientLeft, a.y += e.clientTop) : o && (a.x = Sl(o))), {
    ...
    var u = {
      ...
      forceUpdate: function() {
        if (!f) {
          ...
          if (Ya(w, C)) {
            u.rects = {
              reference: jy(w, $r(C), u.options.strategy === "fixed"),
              popper: xl(C)
...
var Sd = {
  ...
  triggerTarget: null
}, Sd, bb), vb = Object.keys(He), kb = function(e) {
...
function Ed(n, e) {
  ...
  var t = Object.keys(n);
  t.forEach(function(r) {
    var i = eb(He, Object.keys(Sd)), o = !Zy(i, r);
...
var Cb = 1, si = [], is = [];
function Tb(n, e) {
  var t = ic(n, Object.assign({}, He, Md(Za(e)))), r, i, o, s = !1, l = !1, a = !1, c = !1, u, d, f, h = [], p = Qa(qr, t.interactiveDebounce), m, g = Cb++, b = null, w = nb(t.plugins), C = {
  ...
  function Y(k) {
    return y.state.isMounted && !y.state.isVisible || st.isTouch || u && u.type === "focus" ? 0 : ts(y.props.delay, k ? 0 : 1, He.delay);
  }
  function G(k) {
    ...
    if (k.content) {
      ...
      U.forEach(function(j) {
        ...
        if (y.state.isVisible)
          ...
          var Ve = we && we.replace(L, "").trim();
          Ve ? j.setAttribute(N, Ve) : j.removeAttribute(N);
        }
      });
    }
  }
  ...
  function qr(k) {
    ...
    if (!(k.type === "mousemove" && L)) {
      var U = Bt().concat(v).map(function(j) {
        var we, Ve = j._tippy, Mn = (we = Ve.popperInstance) == null ? void 0 : we.state;
        return Mn ? {
  ...
  function Ur() {
    Jr();
    var k = y.props, N = k.popperOptions, L = k.placement, U = k.offset, j = k.getReferenceClientRect, we = k.moveTransition, Ve = W() ? Vs(v).arrow : null, Mn = j ? {
...
`, "See: https://atomiks.github.io/tippyjs/v6/accessibility/#interactivity"].join(" "));
  ...
  function Qr(k) {
    if (process.env.NODE_ENV !== "production" && Tt(y.state.isDestroyed, Nn("setProps")), !y.state.isDestroyed) {
      ...
      }) : L.triggerTarget && n.removeAttribute("aria-expanded"), ge(), G(), A && A(N, L), y.popperInstance && (Ur(), Bt().forEach(function(U) {
  ...
  function Xd() {
    ...
    var k = y.state.isVisible, N = y.state.isDestroyed, L = !y.state.isEnabled, U = st.isTouch && !y.props.touch, j = ts(y.props.duration, 0, He.duration);
    if (!(k || N || L || U) && !q().hasAttribute("disabled") && (K("onShow", [y], !1), y.props.onShow(y) !== !1)) {
      if (y.state.isVisible = !0, W() && (v.style.visibility = "visible"), G(), Ye(), y.state.isMounted || (v.style.transition = "none"), W()) {
        var we = Z(), Ve = we.box, Mn = we.content;
        ns([Ve, Mn], 0);
      }
      f = function() {
        var nn;
  ...
  function Zd() {
    ...
    var k = !y.state.isVisible, N = y.state.isDestroyed, L = !y.state.isEnabled, U = ts(y.props.duration, 1, He.duration);
    if (!(k || N || L) && (K("onHide", [y], !1), y.props.onHide(y) !== !1)) {
      if (y.state.isVisible = !1, y.state.isShown = !1, c = !1, s = !1, W() && (v.style.visibility = "hidden"), gt(), bt(), G(!0), W()) {
        var j = Z(), we = j.box, Ve = j.content;
        y.props.animation && (ns([we, Ve], U), ec([we, Ve], "hidden"));
      }
  ...
  function tf() {
    process.env.NODE_ENV !== "production" && Tt(y.state.isDestroyed, Nn("unmount")), y.state.isVisible && y.hide(), y.state.isMounted && (Jr(), Bt().forEach(function(k) {
      k._tippy.unmount();
...
const Gb = ["onPointerdown"], fc = {
  ...
  setup(n) {
    ...
    return (l, a) => (D(), F("div", {
      ...
      (D(), Pe(ff(hi(i).component), hf(hi(i).props.value, {
...
const yi = function(n, e) {
...
}, iv = { class: "vueberg-modal-header-title" }, ov = /* @__PURE__ */ P("svg", {
  width: "24px",
  height: "24px",
  viewBox: "0 0 24 24",
  fill: "none",
  ...
  ov
], lv = { class: "vueberg-modal-body" }, av = { class: "vueberg-form" }, cv = ["for"], uv = ["id", "placeholder", "autofocus", "onUpdate:modelValue"], dv = ["innerHTML"], fv = { class: "vueberg-form-buttons" };
function hv(n, e, t, r, i, o) {
  const s = We("menu-button");
  return D(), F("div", nv, [
    P("div", {
    ...
    P("div", {
      ...
      t.showHeader ? (D(), F("div", rv, [
        P("div", iv, qe(t.title), 1),
        t.closable ? (D(), F("div", {
          key: 0,
      ...
      P("div", lv, [
        P("div", av, [
          (D(!0), F(Ie, null, Qe(t.form, (l, a) => (D(), F("div", {
...
const pv = /* @__PURE__ */ mt(tv, [["render", hv]]), mv = {
...
}, gv = { class: "vueberg-modal-layout" }, yv = {
  key: 0,
  class: "vueberg-modal-header"
}, bv = { class: "vueberg-modal-header-title" }, vv = /* @__PURE__ */ P("svg", {
  width: "24px",
  height: "24px",
  viewBox: "0 0 24 24",
  fill: "none",
...
function xv(n, e, t, r, i, o) {
  return D(), F("div", gv, [
    ...
    P("div", {
      ...
      t.showHeader ? (D(), F("div", yv, [
        P("div", bv, qe(t.title), 1),
        t.closable ? (D(), F("div", {
          key: 0,
          class: "vueberg-modal-header-close",
...
const Cv = /* @__PURE__ */ mt(mv, [["render", xv]]), Tv = X.create({
  name: "modal",
  addOptions() {
    return {
      formModal: pv,
...
}), Mv = /^(https?:\/\/)?(www\.|music\.)?(youtube\.com|youtu\.be)(?!.*\/channel\/)(?!\/@)(.+)?$/, Ev = /^(https?:\/\/)?(www\.|music\.)?(youtube\.com|youtu\.be)(?!.*\/channel\/)(?!\/@)(.+)?$/g, js = (n) => n.match(Mv), hc = (n) => n ? "https://www.youtube-nocookie.com/embed/" : "https://www.youtube.com/embed/", Av = (n) => {
  const {
    url: e,
    allowFullscreen: t,
    autoplay: r,
...
const Nv = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/, Dv = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g, Bv = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/, Lv = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g, Iv = Be.create({
  name: "bold",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addCommands() {
    return {
      toggleBulletList: () => ({ commands: n, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(Rv.name, this.editor.getAttributes(pc.name)).run() : n.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
...
}), Fv = /(?:^|\s)(`(?!\s+`)((?:[^`]+))`(?!\s+`))$/, Hv = /(?:^|\s)(`(?!\s+`)((?:[^`]+))`(?!\s+`))/g, zv = Be.create({
  name: "code",
  addOptions() {
    return {
      HTMLAttributes: {}
...
function Kv() {
  return new se({
    props: {
      ...
      handleClick: Jv,
      handleKeyDown: Uv,
      handleDOMEvents: { beforeinput: Gv }
    }
  });
}
const Uv = Wu({
...
class Ze {
  ...
  addTransform(e, t, r, i) {
    ...
    let c = s - r.depth;
    return c > r1 && (l = n1(l, c), s -= c), new Ze(l.append(o), s);
  }
  remapping(e, t) {
    let r = new Hn();
  ...
  rebased(e, t) {
    ...
    return d.emptyItemCount() > t1 && (d = d.compress(this.items.length - r.length)), d;
  }
  emptyItemCount() {
    let e = 0;
...
function i1(n, e, t, r) {
  ...
  t.getMeta(l1) && (n = new Pt(n.done, n.undone, null, 0, -1));
  ...
  if (t.getMeta("addToHistory") !== !1 && !(s && s.getMeta("addToHistory") === !1)) {
    let l = t.getMeta("composition"), a = n.prevTime == 0 || !s && n.prevComposition != l && (n.prevTime < (t.time || 0) - r.newGroupDelay || !o1(t, n.prevRanges)), c = s ? as(n.prevRanges, t.mapping) : gc(t.mapping.maps[t.steps.length - 1]);
...
const gn = new ke("history"), l1 = new ke("closeHistory");
function a1(n = {}) {
  return n = {
    depth: n.depth || 100,
    ...
    props: {
      handleDOMEvents: {
        beforeinput(e, t) {
          let r = t.inputType, i = r == "historyUndo" ? $d : r == "historyRedo" ? jd : null;
...
const $d = _d(!1, !0), jd = _d(!0, !0), c1 = X.create({
  name: "history",
  addOptions() {
    return {
      depth: 100,
...
}), d1 = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/, f1 = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g, h1 = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/, p1 = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g, m1 = Be.create({
  name: "italic",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addCommands() {
    return {
      toggleOrderedList: () => ({ commands: n, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(y1.name, this.editor.getAttributes(bc.name)).run() : n.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
...
}), k1 = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/, w1 = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))/g, x1 = Be.create({
  name: "strike",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  name: "text",
  group: "inline"
}), T1 = "ö", S1 = "ελ1υ2бг1ел3дети4ею2католик6ом3мкд2он1сква6онлайн5рг3рус2ф2сайт3рб3укр3қаз3հայ3ישראל5קום3ابوظبي5رامكو5لاردن4بحرين5جزائر5سعودية6عليان5مغرب5مارات5یران5بارت2زار4يتك3ھارت5تونس4سودان3رية5شبكة4عراق2ب2مان4فلسطين6قطر3كاثوليك6وم3مصر2ليسيا5وريتانيا7قع4همراه5پاکستان7ڀارت4कॉम3नेट3भारत0म्3ोत5संगठन5বাংলা5ভারত2ৰত4ਭਾਰਤ4ભારત4ଭାରତ4இந்தியா6லங்கை6சிங்கப்பூர்11భారత్5ಭಾರತ4ഭാരതം5ලංකා4คอม3ไทย3ລາວ3გე2みんな3アマゾン4クラウド4グーグル4コム2ストア3セール3ファッション6ポイント4世界2中信1国1國1文网3亚马逊3企业2佛山2信息2健康2八卦2公司1益2台湾1灣2商城1店1标2嘉里0大酒店5在线2大拿2天主教3娱乐2家電2广东2微博2慈善2我爱你3手机2招聘2政务1府2新加坡2闻2时尚2書籍2机构2淡马锡3游戏2澳門2点看2移动2组织机构4网址1店1站1络2联通2谷歌2购物2通販2集团2電訊盈科4飞利浦3食品2餐厅2香格里拉3港2닷넷1컴2삼성2한국2", Zn = (n, e) => {
  for (const t in e)
    n[t] = e[t];
  return n;
}, Ws = "numeric", qs = "ascii", Ks = "alpha", vi = "asciinumeric", ai = "alphanumeric", Us = "domain", Wd = "emoji", M1 = "scheme", E1 = "slashscheme", kc = "whitespace";
function A1(n, e) {
...
function B1(n) {
  ...
  Ee.groups = e;
  const t = new Ee();
  ci == null && (ci = Tc(T1)), ui == null && (ui = Tc(S1)), T(t, "'", eo), T(t, "{", br), T(t, "}", vr), T(t, "[", zi), T(t, "]", Vi), T(t, "(", _i), T(t, ")", $i), T(t, "<", ji), T(t, ">", Wi), T(t, "（", qi), T(t, "）", Ki), T(t, "「", Ui), T(t, "」", Ji), T(t, "『", Gi), T(t, "』", Yi), T(t, "＜", Qi), T(t, "＞", Xi), T(t, "&", Zi), T(t, "*", to), T(t, "@", Ft), T(t, "`", ro), T(t, "^", io), T(t, ":", zt), T(t, ",", Bl), T(t, "$", oo), T(t, ".", rt), T(t, "=", so), T(t, "!", Ll), T(t, "-", it), T(t, "%", lo), T(t, "|", ao), T(t, "+", co), T(t, "#", uo), T(t, "?", fo), T(t, '"', Il), T(t, "/", ot), T(t, ";", Rl), T(t, "~", kr), T(t, "_", ho), T(t, "\\", no);
  const r = _e(t, fs, Nl, {
    [Ws]: !0
  });
  _e(r, fs, r);
  ...
  cn(Gs, {
    ...
    utld: !0,
    alpha: !0
  }, e), Lt(t, "file", ki, xt, c), Lt(t, "mailto", ki, xt, c), Lt(t, "http", Rn, xt, c), Lt(t, "https", Rn, xt, c), Lt(t, "ftp", Rn, xt, c), Lt(t, "ftps", Rn, xt, c), cn(ki, {
    scheme: !0,
    ascii: !0
  }, e), cn(Rn, {
    slashscheme: !0,
...
function L1(n, e) {
  const t = I1(e.replace(/[A-Z]/g, (l) => l.toLowerCase())), r = t.length, i = [];
  let o = 0, s = 0;
  for (; s < r; ) {
...
function P1(n) {
  ...
  const t = e.domain.concat([Zi, to, Ft, no, ro, io, oo, so, it, Nl, lo, ao, co, uo, ot, po, kr, ho]), r = [eo, zt, Bl, rt, Ll, fo, Il, Rl, ji, Wi, br, vr, Vi, zi, _i, $i, qi, Ki, Ui, Ji, Gi, Yi, Qi, Xi], i = [Zi, eo, to, no, ro, io, oo, so, it, br, vr, lo, ao, co, uo, fo, ot, po, kr, ho], o = $e(), s = T(o, kr);
  _(s, i, s), _(s, e.domain, s);
  const l = $e(), a = $e(), c = $e();
  _(o, e.domain, l), _(o, e.scheme, a), _(o, e.slashscheme, c), _(l, i, s), _(l, e.domain, l);
  const u = T(l, Ft);
  T(s, Ft, u), T(a, Ft, u), T(c, Ft, u);
  const d = T(s, rt);
  ...
  const C = $e(di);
  _(w, e.tld, C), _(w, e.utld, C), _(C, e.domain, l), _(C, i, s), T(C, rt, w), T(C, it, b), T(C, Ft, u);
  const y = T(C, zt), M = $e(di);
  _(y, e.numeric, M);
  const v = $e(di), A = $e();
  _(v, t, v), _(v, r, A), _(A, t, v), _(A, r, A), T(C, ot, v), T(M, ot, v);
  const R = T(a, zt), S = T(c, zt), I = T(S, ot), $ = T(I, ot);
...
const H1 = typeof console < "u" && console && console.warn || (() => {
}), z1 = "until manual call of linkify.init(). Register all schemes and plugins before invoking linkify the first time.", ee = {
  scanner: null,
  parser: null,
  tokenQueue: [],
  pluginQueue: [],
...
function Ac(n, e) {
  if (e === void 0 && (e = !1), ee.initialized && H1(`linkifyjs: already initialized - will not register custom scheme "${n}" ${z1}`), !/^[0-9a-z]+(-[0-9a-z]+)*$/.test(n))
...
function _1() {
  ee.scanner = B1(ee.customSchemes);
  for (let n = 0; n < ee.tokenQueue.length; n++)
    ee.tokenQueue[n][1]({
      scanner: ee.scanner
    });
  ee.parser = P1(ee.scanner.tokens);
...
function Gd(n) {
  return ee.initialized || _1(), F1(ee.parser.start, n, L1(ee.scanner.start, n));
}
function Yd(n, e, t) {
...
const K1 = Be.create({
  ...
  addProseMirrorPlugins() {
    const n = [];
    return this.options.autolink && n.push(j1({
      type: this.type,
      validate: this.options.validate
    })), this.options.openOnClick && n.push(W1({
      type: this.type,
      whenNotEditable: this.options.openOnClick === "whenNotEditable"
    })), this.options.linkOnPaste && n.push(q1({
      editor: this.editor,
      type: this.type
    })), n;
  }
...
}), Y1 = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))$/, Q1 = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))/g, X1 = Be.create({
  name: "highlight",
  addOptions() {
    return {
      multicolor: !1,
...
function Ek({ pluginKey: n = Mk, editor: e, char: t = "@", allowSpaces: r = !1, allowedPrefixes: i = [" "], startOfLine: o = !1, decorationTag: s = "span", decorationClass: l = "suggestion", command: a = () => null, items: c = () => [], render: u = () => ({}), allow: d = () => !0, findSuggestionMatch: f = Sk }) {
  let h;
  const p = u == null ? void 0 : u(), m = new se({
    key: n,
    view() {
      return {
        update: async (g, b) => {
...
function Rk(n, e, t, r, i, o) {
  return D(), F("div", Nk, [
    ...
    P("div", Bk, [
      ...
      t.description ? (D(), F("div", Ik, qe(t.description), 1)) : ie("", !0)
    ])
  ]);
}
...
}, Fk = { class: "vueberg-modal-layout" }, Hk = { class: "vueberg-modal vueberg-modal-md vueberg-blocks-modal" }, zk = { class: "vueberg-modal-header" }, Vk = { class: "vueberg-modal-header-title" }, _k = /* @__PURE__ */ P("svg", {
  width: "24px",
  height: "24px",
  viewBox: "0 0 24 24",
  fill: "none",
...
function Uk(n, e, t, r, i, o) {
  ...
  return D(), F("div", Fk, [
    ...
    P("div", Hk, [
      ...
      P("div", jk, [
        (D(!0), F(Ie, null, Qe(i.blocks, (l, a) => (D(), F("div", Wk, [
          P("div", qk, qe(l.title), 1),
          P("div", Kk, [
            (D(!0), F(Ie, null, Qe(l.blocks, (c, u) => (D(), Pe(s, {
...
function Xk(n, e, t, r, i, o) {
  const s = We("BlockItem");
  return D(), F("div", Gk, [
    t.items.length ? (D(), F("div", Yk, [
      (D(!0), F(Ie, null, Qe(t.items, (l, a) => (D(), Pe(s, {
    ...
    ])) : (D(), F("div", Qk, qe(i.nothingFoundLabel), 1)),
    o.hiddenItems > 0 ? (D(), F("div", {
      key: 2,
...
function tw() {
  return [
    { name: "Placeholder", extension: U1.configure({ considerAnyAsEmpty: !0, placeholder: "Начните писать" }) },
    { name: "Bold", extension: Iv },
    { name: "BulletList", extension: Pv },
    { name: "Code", extension: zv },
    { name: "CodeBlock", extension: $v },
    { name: "Document", extension: jv },
    // { name: 'Dropcursor', extension: Dropcursor },
    { name: "Gapcursor", extension: Qv },
    { name: "HardBreak", extension: Xv },
    { name: "Heading", extension: Zv },
    { name: "History", extension: c1 },
    { name: "HorizontalRule", extension: u1 },
    { name: "Italic", extension: m1 },
    { name: "ListItem", extension: g1 },
    { name: "OrderedList", extension: b1 },
    { name: "Paragraph", extension: v1 },
    { name: "Strike", extension: x1 },
    { name: "Text", extension: C1 },
    // {
    //   name: 'Blockquote',
    //   extension: Blockquote.extend({ content: "paragraph" }),
    // },
    { name: "TrailingNode", extension: Ck },
    { name: "Subscript", extension: J1 },
    { name: "Superscript", extension: G1 },
    { name: "Highlight", extension: X1 },
    {
      name: "Link",
      extension: K1.configure({ openOnClick: !1 })
    },
    {
      name: "slashMenu",
...
const uw = X.create({
  ...
  data() {
    return {
      ...
      allBlockTools: yi(Ov(), this.blockTools),
...
function pw(n, e, t, r, i, o) {
  var f, h, p, m, g, b, w;
  const s = We("widget-container-modal"), l = We("Toolbar"), a = We("bubble-menu"), c = We("menu-button"), u = We("floating-menu"), d = We("editor-content");
  return D(), F("div", fw, [
    lt(s),
    t.editable && i.loaded && ((h = (f = o.mergedSettings) == null ? void 0 : f.toolbar) == null ? void 0 : h.style) == "default" ? Dc((D(), Pe(a, {
      key: 0,
      pluginKey: "mainMenu",
      ...
      "tippy-options": {
        ...
        onCreate: (C) => C.popper.classList.add("vueberg-toolbar-wrapper")
      }
    }, {
      default: St(() => {
        var C;
        return [
          ((C = i.currentBlockTool) == null ? void 0 : C.nodeType) !== void 0 ? (D(), Pe(l, {
            key: 0,
            editor: i.editor,
          ...
          }, null, 8, ["editor", "currentBlockTool", "settings", "inlineTools", "alignmentTools", "vuebergWidth"])) : ie("", !0)
        ];
      }),
      _: 1
    ...
    t.editable && i.loaded && ((m = (p = o.mergedSettings) == null ? void 0 : p.toolbar) == null ? void 0 : m.style) == "sticky" ? (D(), F("div", hw, [
      ((g = i.currentBlockTool) == null ? void 0 : g.nodeType) !== void 0 ? (D(), Pe(l, {
        key: 0,
        editor: i.editor,
        currentBlockTool: i.currentBlockTool,
        settings: o.mergedSettings,
    ...
    t.editable && i.currentBlockTool && i.editor ? (D(), Pe(u, {
      key: 2,
      updateDelay: 1e3,
      ...
      _: 1
    }, 8, ["should-show", "editor", "tippy-options"])) : ie("", !0),
    lt(d, {
      class: Ot(["vueberg-editor", {
        "vueberg-editor--sticky-menu": ((w = (b = o.mergedSettings) == null ? void 0 : b.toolbar) == null ? void 0 : w.style) == "sticky"
      }]),
      onKeydown: [
        e[0] || (e[0] = (C) => i.isTyping = !0),
        e[1] || (e[1] = Hl((C) => i.isTyping = !1, ["esc"]))
      ],
      onKeyup: e[2] || (e[2] = Hl((C) => i.isTyping = !1, ["esc"])),
      ref: "editor",
      editor: i.editor
    }, null, 8, ["class", "editor"])
  ], 512);
}
const mw = /* @__PURE__ */ mt(dw, [["render", pw]]), gw = {
  props: Lb,
  components: {
    NodeViewWrapper: Db
  },
...
}, bw = { class: "vueberg-customblock-header-title" }, vw = ["innerHTML"], kw = ["innerHTML"], ww = { class: "vueberg-customblock-body" };
function xw(n, e, t, r, i, o) {
  var l;
  const s = We("node-view-wrapper");
  return D(), Pe(s, {
    ...
    default: St(() => {
      var a, c, u, d, f;
      return [
        i.isEditable && ((a = i.vueBergBlock) != null && a.name) ? (D(), F("div", yw, [
          P("div", bw, [
            P("span", {
          ...
          ((f = (d = i.vueBergBlock) == null ? void 0 : d.vueBergBlock) == null ? void 0 : f.hasPreviewMode) !== !1 ? (D(), F("div", {
            key: 0,
...
const Cw = /* @__PURE__ */ mt(gw, [["render", xw]]), Mw = mw, Ew = Cw;
export {
  Ew as BaseVueBergBlock,
  Mw as VueBerg
};
