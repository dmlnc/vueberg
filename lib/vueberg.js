...
class _t extends ke {
  ...
  */
  ...
  apply(e) {
    ...
    return oe.fromReplace(e, this.pos, this.pos + 1, new A(C.from(r), 0, t.isLeaf ? 0 : 1));
  }
  invert(e) {
    let t = e.nodeAt(this.pos);
    if (t) {
...
class le extends ke {
  ...
  */
  static fromJSON(e, t) {
    ...
    return new le(t.from, t.to, A.fromJSON(e, t.slice), !!t.structure);
  }
}
ke.jsonID("replace", le);
class ce extends ke {
  /**
  ...
  for (let a = 0; a < o.childCount; a++) {
    ...
    if (!d)
      ...
      if (i && c.isText && t.whitespace != "pre") {
        let f, h = /\r?\n|\r/g, p;
        for (; f = h.exec(c.text); )
          p || (p = new A(C.from(t.schema.text(" ", t.allowedMarks(c.marks))), 0, 0)), s.push(new le(l + f.index, l + f.index + f[0].length, p));
      }
    }
    l = u;
  }
...
function oh(n, e, t = 1, r) {
  ...
  n.step(new le(e, e, new A(o.append(s), t, t), !0));
}
function Gt(n, e) {
...
function sh(n, e, t) {
  let r = new le(e - t, e + t, A.empty, !0);
  n.step(r);
}
function lh(n, e, t) {
  let r = n.resolve(e);
...
class Vn extends ke {
  ...
  */
  ...
  apply(e) {
    ...
    return oe.fromReplace(e, this.pos, this.pos + 1, new A(C.from(i), 0, t.isLeaf ? 0 : 1));
  }
  getMap() {
    return Fe.empty;
  }
...
const Ch = function({ view: n, dir: e, currentResolved: t }) {
  ...
  r.step(new le(h, p, g, !1)), r.setSelection(
    V.near(
      r.doc.resolve(
        i ? t.pos + f : t.pos - f
      )
...
const Th = {
  ...
  computed: {
    ...
    menuCount() {
      var u, d, f, h, p, g, y, b, x, T, m, w, v, E, L, S, I, j, $, W;
      let n = 700;
      ...
      e -= t * 2, ((h = (f = this.settings) == null ? void 0 : f.toolbar) == null ? void 0 : h.showOrder) !== !1 && (e -= r), ((g = (p = this.settings) == null ? void 0 : p.toolbar) == null ? void 0 : g.showCurrentBlock) !== !1 && (e -= r), ((b = (y = this.settings) == null ? void 0 : y.toolbar) == null ? void 0 : b.showOrder) !== !1 && ((T = (x = this.settings) == null ? void 0 : x.toolbar) == null ? void 0 : T.showCurrentBlock) !== !1 && (e -= i), (((w = (m = this.settings) == null ? void 0 : m.toolbar) == null ? void 0 : w.showOrder) !== !1 || ((E = (v = this.settings) == null ? void 0 : v.toolbar) == null ? void 0 : E.showCurrentBlock) !== !1) && (e -= i, e -= o + s), this.activeAlignmentTools.length && (e -= this.activeAlignmentTools.length * r, e -= i * (this.activeAlignmentTools.length ? this.activeAlignmentTools.length - 1 : 0), e -= o + s), this.customTools && this.customTools.length > 0 && (e -= this.customTools.length * r, e -= (this.customTools.length - 1) * i, e -= o + s);
      const l = (S = (L = this.currentBlockTool) == null ? void 0 : L.tools) == null ? void 0 : S.length;
      let a = 0, c = 0;
      return (j = (I = this.currentBlockTool) == null ? void 0 : I.tools) != null && j.length && (c = r * l, c += i * (l ? l - 1 : 0)), e < c + o + s ? Math.floor((e - o - s) / (r + i)) : (a = (W = ($ = this.currentBlockTool) == null ? void 0 : $.tools) == null ? void 0 : W.length, e -= c, e -= o, e -= s, a == null && (a = 0), e -= o, e -= s, Math.floor(e / (i + r)) + a);
    },
    menuItems() {
      var n, e, t, r, i, o, s;
      return this.currentBlockTool ? [
        ...
        },
        {
          ...
          buttons: (() => {
            var l, a;
            return ((a = (l = this.settings) == null ? void 0 : l.toolbar) == null ? void 0 : a.showDeleteButton) !== !1 ? [
              {
                click: () => {
                  var c;
                  return this.deleteNode((c = this.currentBlockTool) == null ? void 0 : c.nodeType);
                },
        ...
        dropdown: st(() => [
          (O(!0), P(Ae, null, $e(o.remainingMenuItems, (m) => (O(), P(Ae, null, [
            m.condition ? (O(!0), P(Ae, { key: 0 }, $e(m.buttons, (w, v) => (O(), be(s, {
              ...
              disabled: w.disabled,
              active: w.active
            }, null, 8, ["content", "activeClass", "onClick", "disabled", "active"]))), 128)) : Q("", !0)
          ], 64))), 256))
        ]),
        default: st(() => [
          at(s, {
...
function Or(n, e) {
  ...
  if (f === lr && j) {
    ...
    Object.keys(I).forEach(function(W) {
      var ae = [Ye, Ge].indexOf(W) >= 0 ? 1 : -1, ee = [Le, Ge].indexOf(W) >= 0 ? "y" : "x";
      I[W] += $[ee] * ae;
    });
  }
  return I;
...
function Oy(n) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !0 : s, a = t.fallbackPlacements, c = t.padding, u = t.boundary, d = t.rootBoundary, f = t.altBoundary, h = t.flipVariations, p = h === void 0 ? !0 : h, g = t.allowedAutoPlacements, y = e.options.placement, b = ft(y), x = b === y, T = a || (x || !p ? [gi(y)] : Ay(y)), m = [y].concat(T).reduce(function(bt, Qe) {
      ...
      var j = m[I], $ = ft(j), W = Xn(j) === Gn, ae = [Le, Ge].indexOf($) >= 0, ee = ae ? "width" : "height", Y = Or(e, {
        placement: j,
        boundary: u,
        rootBoundary: d,
        altBoundary: f,
        padding: c
      }), G = ae ? W ? Ye : Ie : W ? Ge : Le;
      w[ee] > v[ee] && (G = gi(G));
      var K = gi(G), Pe = [];
      if (o && Pe.push(Y[$] <= 0), l && Pe.push(Y[G] <= 0, Y[K] <= 0), Pe.every(function(bt) {
        return bt;
      })) {
        S = j, L = !1;
        break;
...
function zy(n) {
  ...
  if (v) {
    if (o) {
      var W, ae = m === "y" ? Le : Ie, ee = m === "y" ? Ge : Ye, Y = m === "y" ? "height" : "width", G = v[m], K = G + y[ae], Pe = G - y[ee], ge = h ? -L[Y] / 2 : 0, yt = x === Gn ? E[Y] : L[Y], Ee = x === Gn ? -L[Y] : -E[Y], en = e.elements.arrow, bt = h && en ? xl(en) : {
        width: 0,
        height: 0
      }, Qe = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : hd(), vt = Qe[ae], Cn = Qe[ee], kt = mr(0, E[Y], bt[Y]), Tn = T ? E[Y] / 2 - ge - kt - vt - I.mainAxis : yt - kt - vt - I.mainAxis, Dt = T ? -E[Y] / 2 + ge + kt + Cn + I.mainAxis : Ee + kt + Cn + I.mainAxis, Sn = e.elements.arrow && jr(e.elements.arrow), Wr = Sn ? m === "y" ? Sn.clientTop || 0 : Sn.clientLeft || 0 : 0, tr = (W = j == null ? void 0 : j[m]) != null ? W : 0, qr = G + Tn - tr - Wr, Kr = G + Dt - tr, nr = mr(h ? Pi(K, qr) : K, G, h ? mn(Pe, Kr) : Pe);
      v[m] = nr, $[m] = nr - G;
    }
    if (l) {
...
function Sb(n, e) {
  ...
  return Sn(), ge(), G(), K("onCreate", [m]), t.showOnCreate && ir(), v.addEventListener("mouseenter", function() {
    ...
    m.props.interactive && m.props.trigger.indexOf("mouseenter") >= 0 && ae().addEventListener("mousemove", p);
  }), m;
  function I() {
    var k = m.props.touch;
...
`, "See: https://atomiks.github.io/tippyjs/v6/accessibility/#interactivity"].join(" "));
  ...
  function Xd() {
    ...
    if (!(k || D || R || U) && !W().hasAttribute("disabled") && (K("onShow", [m], !1), m.props.onShow(m) !== !1)) {
      if (m.state.isVisible = !0, $() && (v.style.visibility = "visible"), G(), Qe(), m.state.isMounted || (v.style.transition = "none"), $()) {
        var xe = ee(), Ve = xe.box, Mn = xe.content;
        ns([Ve, Mn], 0);
      }
      f = function() {
        var nn;
        if (!(!m.state.isVisible || c)) {
          if (c = !0, v.offsetHeight, v.style.transition = m.props.moveTransition, $() && m.props.animation) {
            var Lo = ee(), Zr = Lo.box, En = Lo.content;
  ...
  function Zd() {
    ...
    if (!(k || D || R) && (K("onHide", [m], !1), m.props.onHide(m) !== !1)) {
      if (m.state.isVisible = !1, m.state.isShown = !1, c = !1, s = !1, $() && (v.style.visibility = "hidden"), yt(), vt(), G(!0), $()) {
        var q = ee(), xe = q.box, Ve = q.content;
  ...
  function ef(k) {
    process.env.NODE_ENV !== "production" && St(m.state.isDestroyed, Nn("hideWithInteractivity")), ae().addEventListener("mousemove", p), Xa(si, p), p(k);
  }
  function tf() {
...
const Tv = /* @__PURE__ */ gt(gv, [["render", Cv]]), Sv = Z.create({
  name: "modal",
  addOptions() {
    return {
      formModal: mv,
...
const Dv = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/, Bv = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g, Lv = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/, Iv = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g, Rv = Re.create({
  ...
  renderHTML({ HTMLAttributes: n }) {
    return ["strong", X(this.options.HTMLAttributes, n), 0];
  },
  addCommands() {
    return {
...
const jd = _d(!1, !0), $d = _d(!0, !0), u1 = Z.create({
  name: "history",
  addOptions() {
    return {
      depth: 100,
...
function F1(n) {
  ...
  for (let W = 0; W < $.length; W++) {
    const [ae, ee] = $[W], Y = M(v, ae);
    M(E, ae, Y), M(Y, ee, v);
    const G = je(di);
    _(Y, t, G);
    const K = je();
    _(Y, r), _(G, t, G), _(G, r, K), _(K, t, G), _(K, r, K), M(G, ee, v), M(K, ee, v);
  }
...
const U1 = Re.create({
  ...
  renderHTML({ HTMLAttributes: n }) {
    var e;
    return !((e = n.href) === null || e === void 0) && e.startsWith("javascript:") ? ["a", X(this.options.HTMLAttributes, { ...n, href: "" }), 0] : ["a", X(this.options.HTMLAttributes, n), 0];
  },
  addCommands() {
    return {
  ...
  renderHTML({ HTMLAttributes: n }) {
    return ["mark", X(this.options.HTMLAttributes, n), 0];
  },
  addCommands() {
    return {
  ...
  const p = u == null ? void 0 : u(), g = new se({
    ...
    view() {
      return {
        update: async (y, b) => {
          var x, T, m, w, v, E, L;
          const S = (x = this.key) === null || x === void 0 ? void 0 : x.getState(b), I = (T = this.key) === null || T === void 0 ? void 0 : T.getState(y.state), j = S.active && I.active && S.range.from !== I.range.from, $ = !S.active && I.active, W = S.active && !I.active, ae = !$ && !W && S.query !== I.query, ee = $ || j, Y = ae && !j, G = W || j;
          if (!ee && !Y && !G)
            return;
          const K = G && !ee ? S : I, Pe = y.dom.querySelector(`[data-decoration-id="${K.decorationId}"]`);
          h = {
            editor: e,
            range: K.range,
            query: K.query,
          ...
          }, ee && ((m = p == null ? void 0 : p.onBeforeStart) === null || m === void 0 || m.call(p, h)), Y && ((w = p == null ? void 0 : p.onBeforeUpdate) === null || w === void 0 || w.call(p, h)), (Y || ee) && (h.items = await c({
            editor: e,
            query: K.query
          })), G && ((v = p == null ? void 0 : p.onExit) === null || v === void 0 || v.call(p, h)), Y && ((E = p == null ? void 0 : p.onUpdate) === null || E === void 0 || E.call(p, h)), ee && ((L = p == null ? void 0 : p.onStart) === null || L === void 0 || L.call(p, h));
        },
        destroy: () => {
          var y;
...
function Pk(n, e, t, r, i, o) {
  return O(), P("div", Dk, [
    ...
    F("div", Lk, [
      ...
      t.description ? (O(), P("div", Rk, Ke(t.description), 1)) : Q("", !0)
    ])
  ]);
}
...
function mw(n, e, t, r, i, o) {
  ...
  return O(), P("div", hw, [
    ...
    t.editable && i.loaded && ((h = (f = o.mergedSettings) == null ? void 0 : f.toolbar) == null ? void 0 : h.style) == "default" ? Dc((O(), be(a, {
      ...
      default: st(() => {
        ...
        return [
          ...
          }, null, 8, ["editor", "currentBlockTool", "settings", "inlineTools", "alignmentTools", "vuebergWidth"])) : Q("", !0)
        ];
      }),
      _: 1
    ...
    t.editable && i.loaded && ((b = (y = o.mergedSettings) == null ? void 0 : y.toolbar) == null ? void 0 : b.style) == "sticky" ? (O(), P("div", pw, [
      ...
      }, null, 8, ["editor", "currentBlockTool", "settings", "inlineTools", "alignmentTools", "vuebergWidth", "customTools"])) : Q("", !0)
    ])) : Q("", !0),
    t.editable && i.currentBlockTool && i.editor ? (O(), be(u, {
      key: 3,
      updateDelay: 1e3,
      ...
      _: 1
    }, 8, ["should-show", "editor", "tippy-options"])) : Q("", !0),
    at(d, {
