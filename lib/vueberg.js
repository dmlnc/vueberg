  ...
  */
  constructor(e) {
    ...
    for (let i in this.nodes) {
      ...
      o.markSet = l == "_" ? null : l ? $l(this, l.split(" ")) : l == "" || !o.inlineContent ? [] : null;
    }
    for (let i in this.marks) {
      let o = this.marks[i], s = o.spec.excludes;
      o.excluded = s == null ? [o] : s == "" ? [] : $l(this, s.split(" "));
    }
...
const ft = typeof navigator < "u" ? navigator : null, na = typeof document < "u" ? document : null, Yt = ft && ft.userAgent || "", xs = /Edge\/(\d+)/.exec(Yt), uu = /MSIE \d/.exec(Yt), Cs = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Yt), Oe = !!(uu || Cs || xs), $t = uu ? document.documentMode : Cs ? +Cs[1] : xs ? +xs[1] : 0, tt = !Oe && /gecko\/(\d+)/i.test(Yt);
tt && +(/Firefox\/(\d+)/.exec(Yt) || [0, 0])[1];
const Ts = !Oe && /Chrome\/(\d+)/.exec(Yt), xe = !!Ts, Kh = Ts ? +Ts[1] : 0, Ce = !Oe && !!ft && /Apple Computer/.test(ft.vendor), Un = Ce && (/Mobile\/\w+/.test(Yt) || !!ft && ft.maxTouchPoints > 2), $e = Un || (ft ? /Mac/.test(ft.platform) : !1), Uh = ft ? /Win/.test(ft.platform) : !1, Xe = /Android \d/.test(Yt), Hr = !!na && "webkitFontSmoothing" in na.documentElement.style, Jh = Hr ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function Gh(n) {
...
function kp(n) {
  ...
  i ? t.setEnd(r.parentNode, pe(r) + 1) : t.setEnd(r, 0), t.collapse(!1), e.removeAllRanges(), e.addRange(t), !i && !n.state.selection.visible && Oe && $t <= 11 && (r.disabled = !0, r.disabled = !1);
}
function Cu(n, e) {
  if (e instanceof B) {
...
function ba(n, e, t) {
  let r = n.state.selection;
  if (r instanceof F && !r.empty || t.indexOf("s") > -1 || $e && t.indexOf("m") > -1)
    return !1;
  let { $from: i, $to: o } = r;
...
Se.keydown = (n, e) => {
  ...
  if (n.input.shiftKey = t.keyCode == 16 || t.shiftKey, !Iu(n, t) && (n.input.lastKeyCode = t.keyCode, n.input.lastKeyCodeTime = Date.now(), !(Xe && xe && t.keyCode == 13)))
    if (t.keyCode != 229 && n.domObserver.forceFlush(), Un && t.keyCode == 13 && !t.ctrlKey && !t.altKey && !t.metaKey) {
      ...
      n.someProp("handleKeyDown", (r) => r(n, t)) || Ap(n, t) ? t.preventDefault() : _t(n, "key");
};
Se.keyup = (n, e) => {
...
Se.keypress = (n, e) => {
  let t = e;
  if (Iu(n, t) || !t.charCode || t.ctrlKey && !t.altKey || $e && t.metaKey)
    return;
...
function jp(n, e, t, r, i) {
  return al(n, "handleClickOn", e, t, r) || n.someProp("handleClick", (o) => o(n, e, r)) || (i ? $p(n, t) : _p(n, t));
}
function Wp(n, e, t, r) {
...
function Kp(n, e, t) {
  ...
  let r = n.state.doc;
  if (e == -1)
    return r.inlineContent ? (_n(n, F.create(r, 0, r.content.size), "pointer"), !0) : !1;
  let i = r.resolve(e);
  for (let o = i.depth + 1; o > 0; o--) {
    let s = o > i.depth ? i.nodeAfter : i.node(o), l = i.before(o);
    if (s.inlineContent)
      _n(n, F.create(r, l + 1, l + 1 + s.content.size), "pointer");
...
Te.mousedown = (n, e) => {
  ...
  s && (o == "singleClick" ? (n.input.mouseDown && n.input.mouseDown.done(), n.input.mouseDown = new Up(n, s, t, !!r)) : (o == "doubleClick" ? Wp : qp)(n, s.pos, s.inside, t) ? t.preventDefault() : _t(n, "pointer"));
};
class Up {
  constructor(e, t, r, i) {
  ...
  up(e) {
    if (this.done(), !this.view.dom.contains(e.target))
      return;
    let t = this.pos;
    this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(Co(e))), this.updateAllowDefault(e), this.allowDefault || !t ? _t(this.view, "pointer") : jp(this.view, t.pos, t.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || // Safari ignores clicks on draggable elements
    ...
    // works around that.
    xe && !this.view.state.selection.visible && Math.min(Math.abs(t.pos - this.view.state.selection.from), Math.abs(t.pos - this.view.state.selection.to)) <= 2) ? (_n(this.view, V.near(this.view.state.doc.resolve(t.pos)), "pointer"), e.preventDefault()) : _t(this.view, "pointer");
  }
  move(e) {
...
Te.touchstart = (n) => {
  n.input.lastTouch = Date.now(), cl(n), _t(n, "pointer");
};
Te.touchmove = (n) => {
...
function Gp(n) {
  ...
  if (!e.focusNode)
    return null;
  let t = _h(e.focusNode, e.focusOffset), r = $h(e.focusNode, e.focusOffset);
  if (t && r && t != r) {
    let i = r.pmViewDesc;
...
class om {
  constructor(e, t) {
    this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new im(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.observer = window.MutationObserver && new window.MutationObserver((r) => {
      for (let i = 0; i < r.length; i++)
        this.queue.push(r[i]);
      Oe && $t <= 11 && r.some((i) => i.type == "childList" && i.removedNodes.length || i.type == "characterData" && i.oldValue.length > i.target.nodeValue.length) ? this.flushSoon() : this.flush();
  ...
  onSelectionChange() {
    if (ma(this.view)) {
      if (this.suppressingSelectionUpdates)
        return At(this.view);
      if (Oe && $t <= 11 && !this.view.state.selection.empty) {
  ...
  registerMutation(e, t) {
    ...
    if (e.type == "childList") {
      ...
      if (Oe && $t <= 11 && e.addedNodes.length)
        for (let u = 0; u < e.addedNodes.length; u++) {
...
function dm(n, e, t, r, i) {
  ...
  if (n.input.compositionPendingChanges = 0, e < 0) {
    ...
    if (I && !n.state.selection.eq(I)) {
      if (xe && Xe && n.input.lastKeyCode === 13 && Date.now() - 100 < n.input.lastKeyCodeTime && n.someProp("handleKeyDown", (W) => W(n, on(13, "Enter"))))
        return;
      let $ = n.state.tr.setSelection(I);
      S == "pointer" ? $.setMeta("pointer", !0) : S == "key" && $.scrollIntoView(), o && $.setMeta("composition", o), n.dispatch($);
    }
    return;
  }
  ...
  n.input.domChangeCount++, n.state.selection.from < n.state.selection.to && p.start == p.endB && n.state.selection instanceof F && (p.start > n.state.selection.from && p.start <= n.state.selection.from + 2 && n.state.selection.from >= c.from ? p.start = n.state.selection.from : p.endA < n.state.selection.to && p.endA >= n.state.selection.to - 2 && n.state.selection.to <= c.to && (p.endB += n.state.selection.to - p.endA, p.endA = n.state.selection.to)), Oe && $t <= 11 && p.endB == p.start + 1 && p.endA == p.start && p.start > c.from && c.doc.textBetween(p.start - c.from - 1, p.start - c.from + 1) == "  " && (p.start--, p.endA--, p.endB--);
  ...
  if (w) {
    if (m.pos == g.pos)
      Oe && $t <= 11 && m.parentOffset == 0 && (n.domObserver.suppressSelectionUpdates(), setTimeout(() => At(n), 20)), v = n.state.tr.delete(y, M), A = u.resolve(p.start).marksAcross(u.resolve(p.endA));
    else if (
...
const _g = (n) => ({ editor: e, view: t, tr: r, dispatch: i }) => {
...
const $g = (n, e = {}) => ({ state: t, dispatch: r }) => {
...
}), Gg = () => ({ state: n, dispatch: e }) => Om(n, e), Yg = () => ({ state: n, dispatch: e }) => Dm(n, e), Qg = () => ({ state: n, dispatch: e }) => zm(n, e), Xg = () => ({ state: n, dispatch: e }) => $m(n, e), Zg = () => ({ state: n, dispatch: e }) => _m(n, e);
function id(n, e, t = {}) {
...
var Ne = "top", Je = "bottom", Ge = "right", De = "left", kl = "auto", _r = [Ne, Je, Ge, De], Gn = "start", Ar = "end", q0 = "clippingParents", ld = "viewport", lr = "popper", K0 = "reference", $a = /* @__PURE__ */ _r.reduce(function(n, e) {
  return n.concat([e + "-" + Gn, e + "-" + Ar]);
}, []), ad = /* @__PURE__ */ [].concat(_r, [kl]).reduce(function(n, e) {
...
var ay = function(e, t) {
  ...
  })) : e, hd(typeof e != "number" ? e : pd(e, _r));
};
function cy(n) {
  ...
  if (!(!o || !s)) {
    var d = ay(i.padding, t), f = xl(o), h = a === "y" ? Ne : De, p = a === "y" ? Je : Ge, m = t.rects.reference[u] + t.rects.reference[a] - s[a] - t.rects.popper[u], g = s[a] - t.rects.reference[a], b = $r(o), w = b ? a === "y" ? b.clientHeight || 0 : b.clientWidth || 0 : 0, C = m / 2 - g / 2, y = d[h], M = w - f[u] - d[p], v = w / 2 - f[u] / 2 + C, A = mr(y, v, M), R = a;
...
function Wa(n) {
  ...
  if (h = W.x, m = W.y, a) {
    var q;
    return Object.assign({}, $, (q = {}, q[y] = w ? "0" : "", q[C] = b ? "0" : "", q.transform = (M.devicePixelRatio || 1) <= 1 ? "translate(" + h + "px, " + m + "px)" : "translate3d(" + h + "px, " + m + "px, 0)", q));
  }
  return Object.assign({}, $, (e = {}, e[y] = w ? m + "px" : "", e[C] = b ? h + "px" : "", e.transform = "", e));
}
function py(n) {
...
function Cy(n) {
  var e = gr(No(n)), t = ["absolute", "fixed"].indexOf(Ot(n).position) >= 0, r = t && Ue(n) ? $r(n) : n;
...
function Sy(n, e) {
  e === void 0 && (e = {});
  var t = e, r = t.placement, i = t.boundary, o = t.rootBoundary, s = t.padding, l = t.flipVariations, a = t.allowedAutoPlacements, c = a === void 0 ? ad : a, u = Xn(r), d = u ? l ? $a : $a.filter(function(p) {
    return Xn(p) === u;
...
function Ey(n) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !0 : s, a = t.fallbackPlacements, c = t.padding, u = t.boundary, d = t.rootBoundary, f = t.altBoundary, h = t.flipVariations, p = h === void 0 ? !0 : h, m = t.allowedAutoPlacements, g = e.options.placement, b = dt(g), w = b === g, C = a || (w || !p ? [gi(g)] : My(g)), y = [g].concat(C).reduce(function(yt, Ye) {
      ...
      var $ = y[I], W = dt($), q = Xn($) === Gn, ae = [Ne, Je].indexOf(W) >= 0, Z = ae ? "width" : "height", Y = Or(e, {
        placement: $,
        boundary: u,
        rootBoundary: d,
        altBoundary: f,
...
function Fy(n) {
  var e = n.state, t = n.options, r = n.name, i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !1 : s, a = t.boundary, c = t.rootBoundary, u = t.altBoundary, d = t.padding, f = t.tether, h = f === void 0 ? !0 : f, p = t.tetherOffset, m = p === void 0 ? 0 : p, g = Or(e, {
    ...
    mainAxis: 0,
    altAxis: 0
  }, S), $ = e.modifiersData.offset ? e.modifiersData.offset[e.placement] : null, W = {
    x: 0,
    y: 0
  };
  if (v) {
    if (o) {
      var q, ae = y === "y" ? Ne : De, Z = y === "y" ? Je : Ge, Y = y === "y" ? "height" : "width", G = v[y], K = G + g[ae], Le = G - g[Z], ge = h ? -R[Y] / 2 : 0, gt = w === Gn ? A[Y] : R[Y], Me = w === Gn ? -R[Y] : -A[Y], en = e.elements.arrow, yt = h && en ? xl(en) : {
        width: 0,
        height: 0
      }, Ye = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : fd(), bt = Ye[ae], Cn = Ye[Z], vt = mr(0, A[Y], yt[Y]), Tn = C ? A[Y] / 2 - ge - vt - bt - I.mainAxis : gt - vt - bt - I.mainAxis, Nt = C ? -A[Y] / 2 + ge + vt + Cn + I.mainAxis : Me + vt + Cn + I.mainAxis, Sn = e.elements.arrow && $r(e.elements.arrow), Wr = Sn ? y === "y" ? Sn.clientTop || 0 : Sn.clientLeft || 0 : 0, tr = (q = $ == null ? void 0 : $[y]) != null ? q : 0, qr = G + Tn - tr - Wr, Kr = G + Nt - tr, nr = mr(h ? Pi(K, qr) : K, G, h ? mn(Le, Kr) : Le);
      v[y] = nr, W[y] = nr - G;
    }
    if (l) {
      var rr, Ur = y === "x" ? Ne : De, Jr = y === "x" ? Je : Ge, kt = v[M], Dt = M === "y" ? "height" : "width", ir = kt + g[Ur], tn = kt - g[Jr], or = [Ne, De].indexOf(b) !== -1, Gr = (rr = $ == null ? void 0 : $[M]) != null ? rr : 0, Yr = or ? ir : kt - A[Dt] - R[Dt] - Gr + I.altAxis, Qr = or ? kt + A[Dt] + R[Dt] - Gr - I.altAxis : tn, Xr = h && or ? ly(Yr, kt, Qr) : mr(h ? Yr : ir, kt, h ? Qr : tn);
      v[M] = Xr, W[M] = Xr - kt;
    }
    e.modifiersData[r] = W;
  }
...
function $y(n, e, t) {
  t === void 0 && (t = !1);
  var r = Ue(e), i = Ue(e) && _y(e), o = Xt(e), s = Qn(n, i, t), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, a = {
    x: 0,
    ...
    var u = {
      ...
      forceUpdate: function() {
        if (!f) {
          ...
          if (Ya(w, C)) {
            u.rects = {
              reference: $y(w, $r(C), u.options.strategy === "fixed"),
              popper: xl(C)
...
function Cb(n, e) {
  ...
  function rr(k) {
    return st.isTouch ? $() !== k.type.indexOf("touch") >= 0 : !1;
  }
  function Ur() {
    Jr();
...
function Hb(n, e, t) {
  ...
  if (r.namespace === $n.DEFAULT_NAMESPACE && !i.initialized && !Br.skipInitCheck)
...
function av(n = {}) {
  return n = {
    ...
    props: {
      handleDOMEvents: {
        beforeinput(e, t) {
          let r = t.inputType, i = r == "historyUndo" ? _d : r == "historyRedo" ? $d : null;
...
const _d = Vd(!1, !0), $d = Vd(!0, !0), cv = X.create({
  name: "history",
  addOptions() {
    return {
      depth: 100,
  ...
  addCommands() {
    return {
      undo: () => ({ state: n, dispatch: e }) => _d(n, e),
...
function Bv(n) {
  ...
  Ee.groups = e;
  const t = new Ee();
  ci == null && (ci = Tc(Tv)), ui == null && (ui = Tc(Sv)), T(t, "'", eo), T(t, "{", br), T(t, "}", vr), T(t, "[", zi), T(t, "]", Vi), T(t, "(", _i), T(t, ")", $i), T(t, "<", ji), T(t, ">", Wi), T(t, "（", qi), T(t, "）", Ki), T(t, "「", Ui), T(t, "」", Ji), T(t, "『", Gi), T(t, "』", Yi), T(t, "＜", Qi), T(t, "＞", Xi), T(t, "&", Zi), T(t, "*", to), T(t, "@", Pt), T(t, "`", ro), T(t, "^", io), T(t, ":", Ht), T(t, ",", Bl), T(t, "$", oo), T(t, ".", rt), T(t, "=", so), T(t, "!", Ll), T(t, "-", it), T(t, "%", lo), T(t, "|", ao), T(t, "+", co), T(t, "#", uo), T(t, "?", fo), T(t, '"', Il), T(t, "/", ot), T(t, ";", Rl), T(t, "~", kr), T(t, "_", ho), T(t, "\\", no);
  const r = Ve(t, fs, Nl, {
    [Ws]: !0
  });
  Ve(r, fs, r);
...
function Pv(n) {
  ...
  const t = e.domain.concat([Zi, to, Pt, no, ro, io, oo, so, it, Nl, lo, ao, co, uo, ot, po, kr, ho]), r = [eo, Ht, Bl, rt, Ll, fo, Il, Rl, ji, Wi, br, vr, Vi, zi, _i, $i, qi, Ki, Ui, Ji, Gi, Yi, Qi, Xi], i = [Zi, eo, to, no, ro, io, oo, so, it, br, vr, lo, ao, co, uo, fo, ot, po, kr, ho], o = _e(), s = T(o, kr);
  ...
  _(h, e.domain, f);
  const p = _e(Mc);
  _(h, e.tld, p), _(h, e.utld, p), T(u, Lr, p);
  const m = T(f, it);
  _(m, e.domain, f), _(p, e.domain, f), T(p, rt, h), T(p, it, m);
  const g = T(p, Ht);
  _(g, e.numeric, Mc);
  const b = T(l, it), w = T(l, rt);
  _(b, e.domain, l), _(w, i, s), _(w, e.domain, l);
  const C = _e(di);
  _(w, e.tld, C), _(w, e.utld, C), _(C, e.domain, l), _(C, i, s), T(C, rt, w), T(C, it, b), T(C, Pt, u);
  const y = T(C, Ht), M = _e(di);
  _(y, e.numeric, M);
  const v = _e(di), A = _e();
  _(v, t, v), _(v, r, A), _(A, t, v), _(A, r, A), T(C, ot, v), T(M, ot, v);
  const R = T(a, Ht), S = T(c, Ht), I = T(S, ot), $ = T(I, ot);
  _(a, e.domain, l), T(a, rt, w), T(a, it, b), _(c, e.domain, l), T(c, rt, w), T(c, it, b), _(R, e.domain, v), T(R, ot, v), _($, e.domain, v), _($, t, v), T($, ot, v);
  const W = [
    [br, vr],
    // {}
    [zi, Vi],
  ...
  for (let q = 0; q < W.length; q++) {
    ...
    _(Y, t, G);
    const K = _e();
    _(Y, r), _(G, t, G), _(G, r, K), _(K, t, G), _(K, r, K), T(G, Z, v), T(K, Z, v);
  }
...
function Jd(n) {
  return ee.initialized || _v(), Fv(ee.parser.start, n, Lv(ee.scanner.start, n));
}
function Gd(n, e, t) {
  ...
  const p = u == null ? void 0 : u(), m = new oe({
    ...
    view() {
      return {
        update: async (g, b) => {
          var w, C, y, M, v, A, R;
          const S = (w = this.key) === null || w === void 0 ? void 0 : w.getState(b), I = (C = this.key) === null || C === void 0 ? void 0 : C.getState(g.state), $ = S.active && I.active && S.range.from !== I.range.from, W = !S.active && I.active, q = S.active && !I.active, ae = !W && !q && S.query !== I.query, Z = W || $, Y = ae && !$, G = q || $;
          if (!Z && !Y && !G)
            return;
    ...
    state: {
      ...
      apply(g, b, w, C) {
        ...
        if (S.composing = M, y && (A || e.view.composing)) {
          ...
          I && d({ editor: e, state: C, range: I.range }) ? (S.active = !0, S.decorationId = b.decorationId ? b.decorationId : $, S.range = I.range, S.query = I.query, S.text = I.text) : S.active = !1;
        } else
          S.active = !1;
...
const Rk = {
  ...
  Vk
], $k = { class: "vueberg-modal-body" }, jk = { class: "vueberg-blocks-modal-group" }, Wk = { class: "vueberg-blocks-modal-group-title" }, qk = { class: "vueberg-blocks-modal-group-blocks" };
