import { openBlock as D, createElementBlock as H, normalizeClass as Jt, renderSlot as ms, createCommentVNode as le, resolveComponent as je, createElementVNode as P, withModifiers as Re, createVNode as lt, withCtx as St, toDisplayString as qe, Fragment as Ie, renderList as Qe, createBlock as We, defineComponent as Rr, ref as Pr, onMounted as mo, onBeforeUnmount as Xs, h as Et, reactive as go, markRaw as Zs, getCurrentInstance as rf, watchEffect as of, nextTick as sf, unref as hi, Teleport as lf, customRef as af, watch as Nc, computed as cf, TransitionGroup as uf, resolveDynamicComponent as df, mergeProps as ff, toHandlers as hf, withDirectives as pf, vModelText as mf, createTextVNode as Dc, withKeys as Hl } from "vue";
const mt = (n, e) => {
...
}, yf = ["data-tooltip", "innerHTML"];
function bf(n, e, t, r, i, o) {
  return D(), H("button", {
    class: Jt(["vueberg-button", t.active ? t.activeClass : ""]),
    "data-tooltip": t.label,
    innerHTML: t.content
  }, null, 10, yf);
}
const el = /* @__PURE__ */ mt(gf, [["render", bf]]), vf = {
  data() {
    return {
      showDropdown: !1
    };
...
const Bc = /* @__PURE__ */ mt(vf, [["render", kf]]);
function he(n) {
  this.content = n;
}
he.prototype = {
...
function Lc(n, e, t) {
  for (let r = 0; ; r++) {
    ...
    if (i.content.size || o.content.size) {
      let s = Lc(i.content, o.content, t + 1);
      if (s != null)
        return s;
    }
    t += i.nodeSize;
...
function Ic(n, e, t, r) {
  for (let i = n.childCount, o = e.childCount; ; ) {
    ...
    if (s.content.size || l.content.size) {
      let c = Ic(s.content, l.content, t - 1, r - 1);
      if (c)
        return c;
    }
    t -= a, r -= a;
...
class E {
  ...
  */
  insertAt(e, t) {
    let r = Pc(this.content, e + this.openStart, t);
  ...
  */
  removeBetween(e, t) {
    return new E(Rc(this.content, e + this.openStart, t + this.openStart), this.openStart, this.openEnd);
  }
  /**
...
function zc(n, e, t, r, i) {
  ...
  return dr(null, n, i, l), o && s && e.index(i) == t.index(i) ? (Hc(o, s), un(dn(o, zc(n, e, t, r, i + 1)), l)) : (o && un(dn(o, Ci(n, e, i + 1)), l), dr(e, t, i, l), s && un(dn(s, Ci(t, r, i + 1)), l)), dr(r, null, i, l), new x(l);
}
function Ci(n, e, t) {
  let r = [];
...
let fn = class bs {
  ...
  */
  hasMarkup(e, t, r) {
    return this.type == e && wi(this.attrs, t || e.defaultAttrs || Tf) && J.sameSet(this.marks, r || J.none);
  }
  /**
  ...
  */
  replace(e, t, r) {
    return wf(this.resolve(e), this.resolve(t), r);
  }
  /**
  ...
  */
  toString() {
    ...
    return this.content.size && (e += "(" + this.content.toStringInner() + ")"), Vc(this.marks, e);
  }
  /**
...
class Si extends fn {
  ...
  */
  ...
  toString() {
    return this.type.spec.toDebugString ? this.type.spec.toDebugString(this) : Vc(this.marks, JSON.stringify(this.text));
  }
  get textContent() {
    return this.text;
  }
...
function Nf(n) {
  if (n.eat("(")) {
    ...
    let e = Of(n, n.next).map((t) => (n.inline == null ? n.inline = t.isInline : n.inline != t.isInline && n.err("Mixing inline and block content"), { type: "name", value: t }));
...
let $l = class Kc {
  ...
  */
  constructor(e, t, r) {
    this.name = e, this.schema = t, this.spec = r, this.markSet = null, this.groups = r.group ? r.group.split(" ") : [], this.attrs = qc(r.attrs), this.defaultAttrs = jc(this.attrs), this.contentMatch = null, this.inlineContent = null, this.isBlock = !(r.inline || e == "text"), this.isText = e == "text";
  }
  /**
  ...
  */
  create(e = null, t, r) {
    ...
    return new fn(this, this.computeAttrs(e), x.from(t), J.setFrom(r));
  }
  /**
  ...
  */
  createChecked(e = null, t, r) {
    return t = x.from(t), this.checkContent(t), new fn(this, this.computeAttrs(e), t, J.setFrom(r));
  }
  /**
  ...
  */
  static compile(e, t) {
    ...
    e.forEach((o, s) => r[o] = new Kc(o, t, s));
...
class yo {
  ...
  */
  create(e = null) {
    return !e && this.instance ? this.instance : new J(this, Wc(this.attrs, e));
  }
  /**
  @internal
  */
...
class Rf {
  ...
  */
  constructor(e) {
    ...
    for (let i in e)
      t[i] = e[i];
    t.nodes = he.from(e.nodes), t.marks = he.from(e.marks || {}), this.nodes = $l.compile(this.spec.nodes, this), this.marks = yo.compile(this.spec.marks, this);
    let r = /* @__PURE__ */ Object.create(null);
    for (let i in this.nodes) {
      ...
      o.markSet = l == "_" ? null : l ? _l(this, l.split(" ")) : l == "" || !o.inlineContent ? [] : null;
    }
    for (let i in this.marks) {
      let o = this.marks[i], s = o.spec.excludes;
      o.excluded = s == null ? [o] : s == "" ? [] : _l(this, s.split(" "));
    }
  ...
  */
  constructor(e, t) {
    this.schema = e, this.rules = t, this.tags = [], this.styles = [], t.forEach((r) => {
      Pf(r) ? this.tags.push(r) : Ff(r) && this.styles.push(r);
...
class ni {
  ...
  applyPending(e) {
    for (let t = 0, r = this.pendingMarks; t < r.length; t++) {
      let i = r[t];
      (this.type ? this.type.allowsMarkType(i.type) : _f(i.type, e)) && !i.isInSet(this.activeMarks) && (this.activeMarks = i.addToSet(this.activeMarks), this.pendingMarks = i.removeFromSet(this.pendingMarks));
    }
  }
  inlineContext(e) {
    return this.type ? this.type.inlineContent : this.content.length ? this.content[0].isInline : e.parentNode && !Uc.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
  }
}
class Wl {
  constructor(e, t, r) {
    this.parser = e, this.options = t, this.isOpen = r, this.open = 0;
    let i = t.topNode, o, s = jl(null, t.preserveWhitespace, 0) | (r ? fr : 0);
...
function zf(n) {
  for (let e = n.firstChild, t = null; e; e = e.nextSibling) {
    ...
    r && Jc.hasOwnProperty(r) && t ? (t.appendChild(e), e = t) : r == "li" ? t = e : r && (t = null);
  }
}
function Vf(n, e) {
...
class ct {
  ...
  */
  serializeNodeInner(e, t) {
    let { dom: r, contentDOM: i } = ct.renderSpec(Ho(t), this.nodes[e.type.name](e));
    if (i) {
      if (e.isLeaf)
  ...
  */
  serializeMark(e, t, r = {}) {
    ...
    return i && ct.renderSpec(Ho(r), i(e, t));
  }
  /**
  ...
  static renderSpec(e, t, r = null) {
    ...
    for (let u = c; u < t.length; u++) {
      ...
      if (d === 0) {
        ...
        let { dom: f, contentDOM: h } = ct.renderSpec(e, d, r);
...
class vs {
  ...
  */
  get deleted() {
    return (this.delInfo & Zc) > 0;
  }
  /**
  Tells you whether the token before the mapped position was deleted.
  */
  get deletedBefore() {
    return (this.delInfo & (Qc | pi)) > 0;
  }
  /**
  ...
  _map(e, t, r) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= d) {
        ...
        if (r)
          return h;
        let p = e == (t < 0 ? a : d) ? null : Wf(l / 3, e - a), m = e == a ? Xc : e == d ? Qc : pi;
        return (t < 0 ? e != a : e != d) && (m |= Zc), new vs(h, m, p);
      }
      i += u - c;
    }
...
class zt extends ve {
  ...
  */
  ...
  apply(e) {
    let t = e.slice(this.from, this.to), r = e.resolve(this.from), i = r.node(r.sharedDepth(this.to)), o = new E(tl(t.content, (s, l) => !s.isAtom || !l.type.allowsMarkType(this.mark.type) ? s : s.mark(this.mark.addToSet(s.marks)), i), t.openStart, t.openEnd);
...
class ut extends ve {
  ...
  */
  ...
  apply(e) {
    let t = e.slice(this.from, this.to), r = new E(tl(t.content, (i) => i.mark(this.mark.removeFromSet(i.marks)), e), t.openStart, t.openEnd);
...
class se extends ve {
  ...
  */
  ...
  apply(e) {
    return this.structure && ks(e, this.from, this.to) ? ie.fail("Structure replace would overwrite content") : ie.fromReplace(e, this.from, this.to, this.slice);
  }
  getMap() {
  ...
  */
  static fromJSON(e, t) {
    ...
    return new se(t.from, t.to, E.fromJSON(e, t.slice), !!t.structure);
  }
}
ve.jsonID("replace", se);
class ce extends ve {
  /**
  ...
  n.doc.nodesBetween(e, t, (a, c, u) => {
    ...
    if (!r.isInSet(d) && u.type.allowsMarkType(r.type)) {
      ...
      for (let m = 0; m < d.length; m++)
        d[m].isInSet(p) || (s && s.to == f && s.mark.eq(d[m]) ? s.to = h : i.push(s = new ut(f, h, d[m])));
  ...
  for (let a = 0; a < o.childCount; a++) {
    ...
    if (!d)
      ...
      if (i && c.isText && t.whitespace != "pre") {
        let f, h = /\r?\n|\r/g, p;
        for (; f = h.exec(c.text); )
          p || (p = new E(x.from(t.schema.text(" ", t.allowedMarks(c.marks))), 0, 0)), s.push(new se(l + f.index, l + f.index + f[0].length, p));
      }
    }
    l = u;
  }
...
function Zf(n, e, t, r, i) {
  ...
  n.doc.nodesBetween(e, t, (s, l) => {
    if (s.isTextblock && !s.hasMarkup(r, i) && nh(n.doc, n.mapping.slice(o).map(l), r)) {
      let a = null;
      if (r.schema.linebreakReplacement) {
        let f = r.whitespace == "pre", h = !!r.contentMatch.matchType(r.schema.linebreakReplacement);
        f && !h ? a = !1 : !f && h && (a = !0);
      }
      a === !1 && th(n, s, l, o), eu(n, n.mapping.slice(o).map(l, 1), r, void 0, a === null);
      let c = n.mapping.slice(o), u = c.map(l, 1), d = c.map(l + s.nodeSize, 1);
      return n.step(new ce(u, d, u + 1, d - 1, new E(x.from(r.create(i, null, s.marks)), 0, 0), 1, !0)), a === !0 && eh(n, s, l, o), !1;
    }
  });
}
function eh(n, e, t, r) {
...
function ih(n, e, t = 1, r) {
  ...
  n.step(new se(e, e, new E(o.append(s), t, t), !0));
}
function Gt(n, e) {
  let t = n.resolve(e), r = t.index();
  return tu(t.nodeBefore, t.nodeAfter) && t.parent.canReplace(r, r + 1);
}
function tu(n, e) {
...
function bo(n, e, t = -1) {
  ...
  for (let i = r.depth; ; i--) {
    let o, s, l = r.index(i);
    if (i == r.depth ? (o = r.nodeBefore, s = r.nodeAfter) : t > 0 ? (o = r.node(i + 1), l++, s = r.node(i).maybeChild(l)) : (o = r.node(i).maybeChild(l - 1), s = r.node(i + 1)), o && !o.isTextblock && tu(o, s) && r.node(i).canReplace(l, l + 1))
      return e;
    if (i == 0)
      break;
...
function oh(n, e, t) {
  let r = new se(e - t, e + t, E.empty, !0);
  n.step(r);
}
function sh(n, e, t) {
  let r = n.resolve(e);
...
function vo(n, e, t = e, r = E.empty) {
  if (e == t && !r.size)
    return null;
  let i = n.resolve(e), o = n.resolve(t);
  return nu(i, o, r) ? new se(e, t, r) : new ah(i, o, r).fit();
}
function nu(n, e, t) {
...
class ah {
  ...
  fit() {
    ...
    let a = new E(o, s, l);
    return e > -1 ? new ce(r.pos, e, this.$to.pos, this.$to.end(), a, t) : a.size || r.pos != this.$to.pos ? new se(r.pos, i.pos, a) : null;
  }
  ...
  dropNode() {
    ...
    if (i.childCount <= 1 && t > 0) {
      ...
      this.unplaced = new E(ar(e, t - 1, 1), t - 1, o ? t - 1 : r);
    } else
      this.unplaced = new E(ar(e, t, 1), t, r);
  }
  ...
  placeNodes({ sliceDepth: e, frontierDepth: t, parent: r, inject: i, wrap: o }) {
    ...
    for (; c < l.childCount; ) {
      ...
      if (!g)
        break;
      c++, (c > 1 || a == 0 || m.content.size) && (d = g, u.push(ru(m.mark(f.allowedMarks(m.marks)), c == 1 ? a : 0, c == l.childCount ? h : -1)));
    }
    let p = c == l.childCount;
    p || (h = -1), this.placed = cr(this.placed, t, x.from(u)), this.frontier[t].match = d, p && h < 0 && r && r.type == this.frontier[this.depth].type && this.frontier.length > 1 && this.closeFrontierNode();
    for (let m = 0, g = l; m < h; m++) {
      let b = g.lastChild;
      this.frontier.push({ type: b.type, match: b.contentMatchAt(b.childCount) }), g = b.content;
    }
    this.unplaced = p ? e == 0 ? E.empty : new E(ar(s.content, e - 1, 1), e - 1, h < 0 ? s.openEnd : e - 1) : new E(ar(s.content, e, c), s.openStart, s.openEnd);
  }
  mustMoveInline() {
  ...
  findCloseLevel(e) {
    e:
      for (let t = Math.min(this.depth, e.depth); t >= 0; t--) {
        let { match: r, type: i } = this.frontier[t], o = t < e.depth && e.end(t + 1) == e.pos + (e.depth - (t + 1)), s = $o(e, t, i, r, o);
        if (s) {
          for (let l = t - 1; l >= 0; l--) {
            let { match: a, type: c } = this.frontier[l], u = $o(e, l, c, a, !0);
            if (!u || u.childCount)
              continue e;
          }
  ...
  openFrontierNode(e, t = null, r) {
    ...
    i.match = i.match.matchType(e), this.placed = cr(this.placed, this.depth, x.from(e.create(t, r))), this.frontier.push({ type: e, match: e.contentMatch });
  }
  closeFrontierNode() {
...
function ru(n, e, t) {
  if (e <= 0)
    return n;
  let r = n.content;
  return e > 1 && (r = r.replaceChild(0, ru(r.firstChild, e - 1, r.childCount == 1 ? t - 1 : 0))), e > 0 && (r = n.type.contentMatch.fillBefore(r).append(r), t <= 0 && (r = r.append(n.type.contentMatch.matchFragment(r).fillBefore(x.empty, !0)))), n.copy(r);
}
function $o(n, e, t, r, i) {
  ...
  return l && !ch(t, o.content, s) ? l : null;
}
function ch(n, e, t) {
    ...
    if (p)
      for (let m = 0; m < s.length; m++) {
        ...
        if (w.canReplaceWith(C, C, p.type, p.marks))
          return n.replace(i.before(g), b ? o.after(g) : t, new E(iu(r.content, 0, r.openStart, h), h, r.openEnd));
      }
  }
...
function iu(n, e, t, r, i) {
  if (e < t) {
    let o = n.firstChild;
    n = n.replaceChild(0, o.copy(iu(o.content, e + 1, t, r, o)));
  }
  if (e > r) {
...
function fh(n, e, t, r) {
  if (!r.isInline && e == t && n.doc.resolve(e).parent.content.size) {
    let i = sh(n.doc, e, r.type);
    i != null && (e = t = i);
  }
  n.replaceRange(e, t, new E(x.from(r), 0, 0));
}
function hh(n, e, t) {
  let r = n.doc.resolve(e), i = n.doc.resolve(t), o = ou(r, i);
  for (let s = 0; s < o.length; s++) {
...
class V {
  ...
  */
  constructor(e, t, r) {
    this.$anchor = e, this.$head = t, this.ranges = r || [new ph(e.min(t), e.max(t))];
  }
  /**
  ...
  */
  replace(e, t = E.empty) {
    ...
    for (let l = 0; l < s.length; l++) {
      ...
      e.replaceRange(u.map(a.pos), u.map(c.pos), l ? E.empty : t), l == 0 && Ql(e, o, (r ? r.isInline : i && i.isTextblock) ? -1 : 1);
    }
  }
  /**
  ...
  */
  static findFrom(e, t, r = !1) {
    let i = e.parent.inlineContent ? new F(e) : Bn(e.node(0), e.parent, e.pos, e.index(), t, r);
    if (i)
      return i;
...
function Ql(n, e, t) {
  ...
  if (r < e)
    return;
  let i = n.steps[r];
  if (!(i instanceof se || i instanceof ce))
    return;
...
class jo {
  constructor(e, t) {
    this.schema = e, this.plugins = [], this.pluginsByKey = /* @__PURE__ */ Object.create(null), this.fields = yh.slice(), t && t.forEach((r) => {
...
class Pn {
  ...
  */
  static create(e) {
    let t = new jo(e.doc ? e.doc.type.schema : e.schema, e.plugins), r = new Pn(t);
  ...
  */
  reconfigure(e) {
    let t = new jo(this.schema, e.plugins), r = t.fields, i = new Pn(t);
  ...
  */
  static fromJSON(e, t, r) {
    ...
    let i = new jo(e.schema, e.plugins), o = new Pn(i);
...
function lu(n, e, t) {
  for (let r in n) {
    let i = n[r];
    i instanceof Function ? i = i.bind(e) : r == "handleDOMEvents" && (i = lu(i, e, {})), t[r] = i;
  }
  return t;
}
class oe {
  ...
  */
  constructor(e) {
    this.spec = e, this.props = {}, e.props && lu(e.props, this, this.props), this.key = e.key ? e.key.key : au("plugin");
  }
  /**
...
const xh = function({ view: n, dir: e, currentResolved: t }) {
  if (!t)
    return !1;
  let r = n.state.tr;
  const i = e === "DOWN", o = t.node(1) || t.nodeAfter, s = 0, l = t.node(s), a = t.start(s), c = wh(l, (g) => g);
  let u = c.indexOf(o);
  if (u == -1)
    return !1;
  let d = i ? u + 1 : u - 1;
  ...
  r.step(new se(h, p, m, !1)), r.setSelection(
    V.near(
      r.doc.resolve(
        i ? t.pos + f : t.pos - f
      )
...
const Ch = {
    ...
    menuItems() {
      ...
      return this.currentBlockTool ? [
        ...
        },
        {
          ...
          buttons: (() => {
            var l, a;
            const s = (a = (l = this.currentBlockTool) == null ? void 0 : l.toolbar) == null ? void 0 : a.inlineTools;
            return s === !0 ? this.inlineTools.map((c) => ({
            ...
            })) : typeof s == "object" ? Object.keys(s).filter((u) => s[u]).map((u) => this.inlineTools.find((d) => d.name === u)).filter((u) => u).map((u) => ({
...
}, Th = { class: "vueberg-toolbar" }, Sh = { class: "vueberg-button-group vueberg-button-group-separate" }, Mh = { class: "vueberg-button-group vueberg-button-group-column vueberg-toolbar-order" }, Eh = ["disabled", "data-tooltip"], Ah = /* @__PURE__ */ P("svg", {
  ...
  Ah
], Nh = ["disabled", "data-tooltip"], Dh = /* @__PURE__ */ P("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  fill: "currentColor",
  "aria-hidden": "true",
...
}, Ih = { class: "vueberg-toolbar-transform-to" }, Rh = {
  key: 0,
  class: "vueberg-button-group vueberg-button-group-separate"
}, Ph = {
  key: 1,
...
function Fh(n, e, t, r, i, o) {
  ...
  return D(), H("div", Th, [
    P("div", Sh, [
      P("div", Mh, [
        P("button", {
          onClick: e[0] || (e[0] = Re((f) => o.moveNode("UP"), ["prevent"])),
          disabled: !o.canMoveNodeUp(),
          "data-tooltip": i.upLabel,
          class: "vueberg-button--toolbar-order vueberg-button"
        }, Oh, 8, Eh),
        P("button", {
          onClick: e[1] || (e[1] = Re((f) => o.moveNode("DOWN"), ["prevent"])),
          disabled: !o.canMoveNodeDown(),
          "data-tooltip": i.downLabel,
          class: "vueberg-button--toolbar-order vueberg-button"
        }, Bh, 8, Nh)
      ]),
      (a = t.currentBlockTool) != null && a.icon && ((c = t.currentBlockTool) != null && c.name) ? (D(), H("div", Lh, [
        lt(l, {
          hasDropdown: ((d = (u = t.currentBlockTool) == null ? void 0 : u.toolbar) == null ? void 0 : d.canBeConverted) && o.canBeConvertedTo.length > 0
        }, {
          dropdown: St(() => [
            P("div", Ih, qe(i.transformToLabel), 1),
            (D(!0), H(Ie, null, Qe(o.canBeConvertedTo, (f) => (D(), We(s, {
              content: f.icon + " " + f.title,
              key: f.title,
              onClick: Re((h) => o.runConvertCommand(f), ["prevent"]),
          ...
          default: St(() => {
            ...
            return [
              lt(s, {
                label: (f = t.currentBlockTool) == null ? void 0 : f.title,
                content: (h = t.currentBlockTool) == null ? void 0 : h.icon,
                class: Jt((m = (p = t.currentBlockTool) == null ? void 0 : p.toolbar) != null && m.canBeConverted && o.canBeConvertedTo.length ? "vueberg-button-secondary" : "")
    ...
    o.activeAlignmentTools.length ? (D(), H("div", Rh, [
      (D(!0), H(Ie, null, Qe(o.activeAlignmentTools, (f, h) => (D(), We(l, {
        hasDropdown: !0,
        key: h
      }, {
        dropdown: St(() => [
          (D(!0), H(Ie, null, Qe(f.tools, (p) => {
            var m;
            return D(), We(s, {
              class: "vueberg-button-text vueberg-button-md",
              key: p.title,
              content: p.icon + " " + p.title,
              onClick: Re((g) => p.command(t.editor), ["prevent"]),
              active: p.isActiveTest(t.editor, (m = t.currentBlockTool) == null ? void 0 : m.nodeType)
        ...
        default: St(() => [
          lt(s, {
            ...
            label: o.getActiveAlignmentTool(f.tools).title,
            content: o.getActiveAlignmentTool(f.tools).icon
          }, null, 8, ["label", "content"])
        ]),
        _: 2
      }, 1024))), 128))
    ])) : le("", !0),
    (D(!0), H(Ie, null, Qe(o.firstMenuItems, (f) => (D(), H(Ie, null, [
      f.condition ? (D(), H("div", {
        key: f.type,
        class: "vueberg-button-group vueberg-button-group-separate"
      }, [
        (D(!0), H(Ie, null, Qe(f.buttons, (h, p) => (D(), We(s, {
          key: p,
          content: h.icon,
          label: h.label,
          activeClass: h.activeClass,
          onClick: Re(h.click, ["prevent"]),
          disabled: h.disabled,
          active: h.active
        }, null, 8, ["content", "label", "activeClass", "onClick", "disabled", "active"]))), 128))
      ])) : le("", !0)
    ], 64))), 256)),
    t.editor && o.remainingMenuItems.length ? (D(), H("div", Ph, [
      lt(l, {
        align: "right",
        hasDropdown: !0
      }, {
        dropdown: St(() => [
          (D(!0), H(Ie, null, Qe(o.remainingMenuItems, (f) => (D(), H(Ie, null, [
            f.condition ? (D(!0), H(Ie, { key: 0 }, Qe(f.buttons, (h, p) => (D(), We(s, {
              key: p,
              class: "vueberg-button-md vueberg-button-text",
              content: h.icon + h.label,
              activeClass: h.activeClass,
              onClick: Re(h.click, ["prevent"]),
              disabled: h.disabled,
              active: h.active
            }, null, 8, ["content", "activeClass", "onClick", "disabled", "active"]))), 128)) : le("", !0)
          ], 64))), 256))
        ]),
        default: St(() => [
          lt(s, {
...
const Hh = /* @__PURE__ */ mt(Ch, [["render", Fh]]), pe = function(n) {
  for (var e = 0; ; e++)
...
function ta(n, e, t, r, i) {
  for (; ; ) {
    ...
    if (e == (i < 0 ? 0 : at(n))) {
      let o = n.parentNode;
      if (!o || o.nodeType != 1 || Fr(n) || Vh.test(n.nodeName) || n.contentEditable == "false")
        return !1;
      e = pe(n) + (i < 0 ? 0 : 1), n = o;
...
const ft = typeof navigator < "u" ? navigator : null, na = typeof document < "u" ? document : null, Yt = ft && ft.userAgent || "", xs = /Edge\/(\d+)/.exec(Yt), uu = /MSIE \d/.exec(Yt), Cs = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Yt), Oe = !!(uu || Cs || xs), _t = uu ? document.documentMode : Cs ? +Cs[1] : xs ? +xs[1] : 0, tt = !Oe && /gecko\/(\d+)/i.test(Yt);
tt && +(/Firefox\/(\d+)/.exec(Yt) || [0, 0])[1];
const Ts = !Oe && /Chrome\/(\d+)/.exec(Yt), xe = !!Ts, Kh = Ts ? +Ts[1] : 0, Ce = !Oe && !!ft && /Apple Computer/.test(ft.vendor), Un = Ce && (/Mobile\/\w+/.test(Yt) || !!ft && ft.maxTouchPoints > 2), _e = Un || (ft ? /Mac/.test(ft.platform) : !1), Uh = ft ? /Win/.test(ft.platform) : !1, Xe = /Android \d/.test(Yt), Hr = !!na && "webkitFontSmoothing" in na.documentElement.style, Jh = Hr ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function Gh(n) {
...
function ra(n, e, t) {
  ...
  for (let s = t || n.dom; s; s = Cr(s)) {
    if (s.nodeType != 1)
      continue;
    let l = s, a = l == o.body, c = a ? Gh(o) : Yh(l), u = 0, d = 0;
...
function Qh(n) {
  ...
  return { refDOM: r, refTop: i, stack: du(n.dom) };
}
function du(n) {
...
function Xh({ refDOM: n, refTop: e, stack: t }) {
...
function hu(n, e) {
  ...
  return !t && a && (t = a, i = c, r = 0), t && t.nodeType == 3 ? ep(t, i) : !t || r && t.nodeType == 1 ? { node: n, offset: o } : hu(t, i);
}
function ep(n, e) {
...
function np(n, e, t) {
  let { node: r, offset: i } = hu(e, t), o = -1;
...
function ip(n, e) {
  let t = n.dom.ownerDocument, r, i = 0, o = qh(t, e.left, e.top);
  o && ({ node: r, offset: i } = o);
  ...
  if (s = tp(s, e), r) {
    ...
    let c;
    Hr && i && r.nodeType == 1 && (c = r.childNodes[i - 1]).nodeType == 1 && c.contentEditable == "false" && c.getBoundingClientRect().top >= e.top && i--, r == n.dom && i == r.childNodes.length - 1 && r.lastChild.nodeType == 1 && e.top > r.lastChild.getBoundingClientRect().bottom ? l = n.state.doc.content.size : (i == 0 || r.nodeType != 1 || r.childNodes[i - 1].nodeName != "BR") && (l = rp(n, r, i, e));
  }
  l == null && (l = np(n, s, e));
...
function mu(n, e, t) {
  ...
  if (r.nodeType == 3)
    if (s && (op.test(r.nodeValue) || (t < 0 ? !i : i == r.nodeValue.length))) {
      let a = Lt(Ct(r, i, i), t);
      if (tt && i && /\s/.test(r.nodeValue[i - 1]) && i < r.nodeValue.length) {
        let c = Lt(Ct(r, i - 1, i - 1), -1);
        if (c.top == a.top) {
          let u = Lt(Ct(r, i, i + 1), -1);
          if (u.top != a.top)
      ...
      return t < 0 && !i ? (c++, u = -1) : t >= 0 && i == r.nodeValue.length ? (a--, u = 1) : t < 0 ? a-- : c++, sr(Lt(Ct(r, a, c), u), u < 0);
    }
  ...
  if (o == null && i && (t < 0 || i == at(r))) {
    let a = r.childNodes[i - 1], c = a.nodeType == 3 ? Ct(a, at(a) - (s ? 0 : 1)) : a.nodeType == 1 && (a.nodeName != "BR" || !a.nextSibling) ? a : null;
    if (c)
      return sr(Lt(c, 1), !1);
  }
  if (o == null && i < at(r)) {
  ...
  return sr(Lt(r.nodeType == 3 ? Ct(r) : r, -t), t >= 0);
}
function sr(n, e) {
  if (n.width == 0)
    return n;
...
function ap(n, e, t) {
  ...
  return !lp.test(r.parent.textContent) || !l.modify ? t == "left" || t == "backward" ? o : s : gu(n, e, () => {
...
function cp(n, e, t) {
  return oa == e && sa == t ? la : (oa = e, sa = t, la = t == "up" || t == "down" ? sp(n, e, t) : ap(n, e, t));
}
const Ke = 0, aa = 1, ln = 2, ht = 3;
class zr {
  constructor(e, t, r, i) {
  ...
  domFromPos(e, t) {
    ...
    for (let o; r && !(o = this.children[r - 1]).size && o instanceof yu && o.side >= 0; r--)
      ;
    if (t <= 0) {
      let o, s = !0;
...
`), u && h == f.nodeValue.length)
    ...
    if (!(i || u && Ce) && bn(l.node, l.offset, c.anchorNode, c.anchorOffset) && bn(a.node, a.offset, c.focusNode, c.focusOffset))
      return;
    let d = !1;
    if ((c.extend || e == t) && !u) {
  ...
  markDirty(e, t) {
    for (let r = 0, i = 0; i < this.children.length; i++) {
      ...
      if (r == s ? e <= s && t >= r : e < s && t > r) {
        ...
        if (e >= l && t <= a) {
          this.dirty = e == r || t == s ? ln : aa, e == l && t == a && (o.contentLost || o.dom.parentNode != this.contentDOM) ? o.dirty = ht : o.markDirty(e - l, t - l);
          return;
        } else
          o.dirty = o.dom == o.contentDOM && o.dom.parentNode == this.contentDOM && !o.children.length ? ln : ht;
      }
      r = s;
    }
    this.dirty = ln;
...
class vn extends zr {
  ...
  static create(e, t, r, i) {
    ...
    return (!s || !s.dom) && (s = ct.renderSpec(document, t.type.spec.toDOM(t, r))), new vn(e, t, s.dom, s.contentDOM || s.dom);
  }
  parseRule() {
...
class jt extends zr {
  ...
  static create(e, t, r, i, o, s) {
    ...
    if (t.isText) {
      ...
      u || ({ dom: u, contentDOM: d } = ct.renderSpec(document, t.type.spec.toDOM(t)));
    !d && !t.isText && u.nodeName != "BR" && (u.hasAttribute("contenteditable") || (u.contentEditable = "false"), t.type.spec.draggable && (u.draggable = !0));
    let f = u;
    return u = wu(u, r, t), c ? a = new dp(e, t, r, i, u, d || null, f, c, o, s + 1) : t.isText ? new xo(e, t, r, i, u, f, o) : new jt(e, t, r, i, u, d || null, f, o, s + 1);
  }
  parseRule() {
  ...
  matchesNode(e, t, r) {
    return this.dirty == Ke && e.eq(this.node) && Ms(t, this.outerDeco) && r.eq(this.innerDeco);
  }
  get size() {
  ...
  // `this.children`.
  updateChildren(e, t) {
    let r = this.node.inlineContent, i = t, o = e.composing ? this.localCompositionInfo(e, t) : null, s = o && o.pos > -1 ? o : null, l = o && o.pos < 0, a = new hp(this, s && s.node, e);
    gp(this.node, this.innerDeco, (c, u, d) => {
    ...
    }), a.syncToMarks([], r, e), this.node.isTextblock && a.addTextblockHacks(), a.destroyRest(), (a.changed || this.dirty == ln) && (s && this.protectLocalComposition(e, s), vu(this.contentDOM, this.children, e), Un && yp(this.dom));
  }
  localCompositionInfo(e, t) {
    ...
    if (this.node.inlineContent) {
      let s = o.nodeValue, l = bp(this.node.content, s, r - t, i - t);
  ...
  updateOuterDeco(e) {
    ...
    this.dom = ku(this.dom, this.nodeDOM, Ss(this.outerDeco, this.node, t), Ss(e, this.node, t)), this.dom != r && (r.pmViewDesc = void 0, this.dom.pmViewDesc = this), this.outerDeco = e;
  }
...
class xo extends jt {
  ...
  update(e, t, r, i) {
    return this.dirty == ht || this.dirty != Ke && !this.inParent() || !e.sameMarkup(this.node) ? !1 : (this.updateOuterDeco(t), (this.dirty != Ke || e.text != this.node.text) && e.text != this.nodeDOM.nodeValue && (this.nodeDOM.nodeValue = e.text, i.trackWrites == this.nodeDOM && (i.trackWrites = null)), this.node = e, this.dirty = Ke, !0);
  }
  inParent() {
...
function vu(n, e, t) {
  ...
  for (let o = 0; o < e.length; o++) {
    ...
    if (s instanceof vn) {
      ...
      vu(s.contentDOM, s.children, t), r = a ? a.nextSibling : n.firstChild;
    }
  }
  for (; r; )
    r = ua(r), i = !0;
...
function wu(n, e, t) {
  return ku(n, n, an, Ss(e, t, n.nodeType != 1));
}
function Ms(n, e) {
  if (n.length != e.length)
    return !1;
...
class hp {
  constructor(e, t, r) {
    this.lock = t, this.view = r, this.index = 0, this.stack = [], this.changed = !1, this.top = e, this.preMatch = pp(e.node.content, e);
  }
  ...
  updateNodeAt(e, t, r, i, o) {
    ...
    return s.dirty == ht && s.dom == s.contentDOM && (s.dirty = ln), s.update(e, t, r, o) ? (this.destroyBetween(this.index, i), this.index++, !0) : !1;
  }
  ...
  updateNextNode(e, t, r, i, o, s) {
    for (let l = this.index; l < this.top.children.length; l++) {
      ...
      if (a instanceof jt) {
        ...
        if (c != null && c != o)
          return !1;
        let u = a.dom, d, f = this.isLocked(u) && !(e.isText && a.node && a.node.isText && a.nodeDOM.nodeValue == e.text && a.dirty != ht && Ms(t, a.outerDeco));
        if (!f && a.update(e, t, r, i))
          return this.destroyBetween(this.index, l), a.dom != u && (this.changed = !0), this.index++, !0;
        if (!f && (d = this.recreateWrapper(a, e, t, r, i, s)))
          return this.top.children[this.index] = d, d.contentDOM && (d.dirty = ln, d.updateChildren(i, s + 1), d.dirty = Ke), this.changed = !0, this.index++, !0;
        break;
      }
    }
    return !1;
  ...
  addTextblockHacks() {
    ...
    (!e || // Empty textblock
    !(e instanceof xo) || /\n$/.test(e.node.text) || this.view.requiresGeckoHackNode && /\s$/.test(e.node.text)) && ((Ce || xe) && e && e.dom.contentEditable == "false" && this.addHackNode("IMG", t), this.addHackNode("BR", this.top));
  }
  addHackNode(e, t) {
...
function ol(n, e = null) {
  ...
  if (wo(t)) {
    for (a = l; i && !i.node; )
      i = i.parent;
    let u = i.node;
    if (i && u.isAtom && B.isSelectable(u) && i.parent && !(u.isInline && jh(t.focusNode, t.focusOffset, i.dom))) {
      let d = i.posBefore;
...
function xu(n) {
  return n.editable ? n.hasFocus() : Tu(n) && document.activeElement && document.activeElement.contains(n.dom);
}
function At(n, e = !1) {
  ...
  if (Cu(n, t), !!xu(n)) {
    ...
    if (n.domObserver.disconnectSelection(), n.cursorWrapper)
      ...
      da && !(t instanceof F) && (t.$from.parent.inlineContent || (o = fa(n, t.from)), !t.empty && !t.$from.parent.inlineContent && (s = fa(n, t.to))), n.docView.setSelection(r, i, n.root, e), da && (o && ha(o), s && ha(s)), t.visible ? n.dom.classList.remove("ProseMirror-hideselection") : (n.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && vp(n));
    }
    n.domObserver.setCurSelection(), n.domObserver.connectSelection();
  }
}
const da = Ce || xe && Kh < 63;
function fa(n, e) {
...
function vp(n) {
  ...
  e.addEventListener("selectionchange", n.input.hideSelectionGuard = () => {
    (t.anchorNode != r || t.anchorOffset != i) && (e.removeEventListener("selectionchange", n.input.hideSelectionGuard), setTimeout(() => {
      (!xu(n) || n.state.selection.visible) && n.dom.classList.remove("ProseMirror-hideselection");
    }, 20));
  });
}
function kp(n) {
  let e = n.domSelection(), t = document.createRange(), r = n.cursorWrapper.dom, i = r.nodeName == "IMG";
  i ? t.setEnd(r.parentNode, pe(r) + 1) : t.setEnd(r, 0), t.collapse(!1), e.removeAllRanges(), e.addRange(t), !i && !n.state.selection.visible && Oe && _t <= 11 && (r.disabled = !0, r.disabled = !1);
}
function Cu(n, e) {
  if (e instanceof B) {
...
function ma(n) {
  return n.editable && !n.hasFocus() ? !1 : Tu(n);
}
function Tu(n) {
...
function ga(n, e, t) {
  ...
  if (r instanceof F)
    if (t.indexOf("s") > -1) {
      ...
      return It(n, new F(r.$anchor, s));
    } else if (r.empty) {
      if (n.endOfTextblock(e > 0 ? "forward" : "backward")) {
        let i = As(n.state, e);
        return i && i instanceof B ? It(n, i) : !1;
      } else if (!(_e && t.indexOf("m") > -1)) {
        let i = r.$head, o = i.textOffset ? null : e < 0 ? i.nodeBefore : i.nodeAfter, s;
        if (!o || o.isText)
          return !1;
        let l = e < 0 ? i.pos - o.nodeSize : i.pos;
        return o.isAtom || (s = n.docView.descAt(l)) && !s.contentDOM ? B.isSelectable(o) ? It(n, new B(e < 0 ? n.state.doc.resolve(i.pos - o.nodeSize) : i)) : Hr ? It(n, new F(n.state.doc.resolve(e < 0 ? l : l + o.nodeSize))) : !1 : !1;
      }
    } else
      return !1;
  else {
    if (r instanceof B && r.node.isInline)
      return It(n, new F(e > 0 ? r.$to : r.$from));
    {
      let i = As(n.state, e);
      return i ? It(n, i) : !1;
    }
...
function Os(n, e, t) {
  if (e.nodeType != 3) {
    let o, s;
    (s = Tp(e, t)) ? (e = s, t = 0) : (o = Sp(e, t)) && (e = o, t = o.nodeValue.length);
  }
...
function ya(n, e) {
  ...
  if (!(xe || Uh) && t.parent.inlineContent) {
...
function Mu(n, e) {
  ...
  let s = n.someProp("clipboardSerializer") || ct.fromSchema(n.state.schema), l = Bu(), a = l.createElement("div");
...
`))), 0, 0) : E.empty;
  ...
  if (l || (l = (n.someProp("clipboardParser") || n.someProp("domParser") || Wn.fromSchema(n.state.schema)).parseSlice(s, {
    ...
    l = Lp(wa(l, +u[1], +u[2]), u[4]);
  else if (l = E.maxOpen(Np(l.content, i), !0), l.openStart || l.openEnd) {
    let d = 0, f = 0;
...
function Np(n, e) {
  ...
  for (let t = e.depth; t >= 0; t--) {
    ...
    if (n.forEach((l) => {
      ...
      if (!a)
        return s = null;
      if (c = s.length && o.length && Ou(a, o, l, s[s.length - 1], 0))
        s[s.length - 1] = c;
      else {
        s.length && (s[s.length - 1] = Nu(s[s.length - 1], o.length));
        let u = Au(l, a);
...
function Ou(n, e, t, r, i) {
  if (i < n.length && i < e.length && n[i] == e[i]) {
    let o = Ou(n, e, t, r.lastChild, i + 1);
    if (o)
      return r.copy(r.content.replaceChild(r.childCount - 1, o));
    if (r.contentMatchAt(r.childCount).matchType(i == n.length - 1 ? t.type : n[i + 1]))
      return r.copy(r.content.append(x.from(Au(t, n, i + 1))));
  }
}
function Nu(n, e) {
  if (e == 0)
    return n;
  let t = n.content.replaceChild(n.childCount - 1, Nu(n.lastChild, e - 1)), r = n.contentMatchAt(n.childCount).fillBefore(x.empty, !0);
  return n.copy(t.append(r));
}
function Ns(n, e, t, r, i, o) {
  let s = e < 0 ? n.firstChild : n.lastChild, l = s.content;
  return n.childCount > 1 && (o = 0), i < r - 1 && (l = Ns(l, e, t, r, i + 1, o)), i >= t && (l = e < 0 ? s.contentMatchAt(0).fillBefore(l, o <= i).append(l) : l.append(s.contentMatchAt(s.childCount).fillBefore(x.empty, !0))), n.replaceChild(e < 0 ? 0 : n.childCount - 1, s.copy(l));
}
function wa(n, e, t) {
...
function Dp(n) {
  ...
  let t = Bu().createElement("div"), r = /<([a-z][^>\s]+)/i.exec(n), i;
  if ((i = r && Du[r[1].toLowerCase()]) && (n = i.map((o) => "<" + o + ">").join("") + n + i.map((o) => "</" + o + ">").reverse().join("")), t.innerHTML = n, i)
    for (let o = 0; o < i.length; o++)
...
const Te = {}, Se = {}, Ip = { touchstart: !0, touchmove: !0 };
class Rp {
  constructor() {
...
function Pp(n) {
  for (let e in Te) {
    ...
    n.dom.addEventListener(e, n.input.eventHandlers[e] = (r) => {
      Hp(n, r) && !ll(n, r) && (n.editable || !(r.type in Se)) && t(n, r);
    }, Ip[e] ? { passive: !0 } : void 0);
  }
  Ce && n.dom.addEventListener("input", () => null), Ds(n);
}
function $t(n, e) {
...
function zp(n, e) {
  !ll(n, e) && Te[e.type] && (n.editable || !(e.type in Se)) && Te[e.type](n, e);
}
Se.keydown = (n, e) => {
  let t = e;
  if (n.input.shiftKey = t.keyCode == 16 || t.shiftKey, !Iu(n, t) && (n.input.lastKeyCode = t.keyCode, n.input.lastKeyCodeTime = Date.now(), !(Xe && xe && t.keyCode == 13)))
    if (t.keyCode != 229 && n.domObserver.forceFlush(), Un && t.keyCode == 13 && !t.ctrlKey && !t.altKey && !t.metaKey) {
      ...
      n.someProp("handleKeyDown", (r) => r(n, t)) || Ap(n, t) ? t.preventDefault() : $t(n, "key");
};
Se.keyup = (n, e) => {
...
Se.keypress = (n, e) => {
  let t = e;
  if (Iu(n, t) || !t.charCode || t.ctrlKey && !t.altKey || _e && t.metaKey)
    return;
...
function $p(n, e) {
  ...
  return r && r.isAtom && B.isSelectable(r) ? ($n(n, new B(t), "pointer"), !0) : !1;
}
function _p(n, e) {
  if (e == -1)
    return !1;
  ...
  return i != null ? ($n(n, B.create(n.state.doc, i), "pointer"), !0) : !1;
}
function jp(n, e, t, r, i) {
  return al(n, "handleClickOn", e, t, r) || n.someProp("handleClick", (o) => o(n, e, r)) || (i ? _p(n, t) : $p(n, t));
}
function Wp(n, e, t, r) {
  return al(n, "handleDoubleClickOn", e, t, r) || n.someProp("handleDoubleClick", (i) => i(n, e, r));
}
function qp(n, e, t, r) {
  return al(n, "handleTripleClickOn", e, t, r) || n.someProp("handleTripleClick", (i) => i(n, e, r)) || Kp(n, t, r);
}
function Kp(n, e, t) {
  if (t.button != 0)
    return !1;
  let r = n.state.doc;
  if (e == -1)
    return r.inlineContent ? ($n(n, F.create(r, 0, r.content.size), "pointer"), !0) : !1;
  let i = r.resolve(e);
  for (let o = i.depth + 1; o > 0; o--) {
    let s = o > i.depth ? i.nodeAfter : i.node(o), l = i.before(o);
    if (s.inlineContent)
      $n(n, F.create(r, l + 1, l + 1 + s.content.size), "pointer");
    else if (B.isSelectable(s))
      $n(n, B.create(r, l), "pointer");
    else
      continue;
    return !0;
  }
...
const Lu = _e ? "metaKey" : "ctrlKey";
Te.mousedown = (n, e) => {
  let t = e;
  n.input.shiftKey = t.shiftKey;
  let r = cl(n), i = Date.now(), o = "singleClick";
  i - n.input.lastClick.time < 500 && Vp(t, n.input.lastClick) && !t[Lu] && (n.input.lastClick.type == "singleClick" ? o = "doubleClick" : n.input.lastClick.type == "doubleClick" && (o = "tripleClick")), n.input.lastClick = { time: i, x: t.clientX, y: t.clientY, type: o };
  let s = n.posAtCoords(Co(t));
  s && (o == "singleClick" ? (n.input.mouseDown && n.input.mouseDown.done(), n.input.mouseDown = new Up(n, s, t, !!r)) : (o == "doubleClick" ? Wp : qp)(n, s.pos, s.inside, t) ? t.preventDefault() : $t(n, "pointer"));
};
class Up {
  constructor(e, t, r, i) {
    this.view = e, this.pos = t, this.event = r, this.flushed = i, this.delayedSelectionSync = !1, this.mightDrag = null, this.startDoc = e.state.doc, this.selectNode = !!r[Lu], this.allowDefault = r.shiftKey;
    let o, s;
    if (t.inside > -1)
    ...
    }, 20), this.view.domObserver.start()), e.root.addEventListener("mouseup", this.up = this.up.bind(this)), e.root.addEventListener("mousemove", this.move = this.move.bind(this)), $t(e, "pointer");
  }
  done() {
  ...
  up(e) {
    if (this.done(), !this.view.dom.contains(e.target))
      return;
    let t = this.pos;
    this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(Co(e))), this.updateAllowDefault(e), this.allowDefault || !t ? $t(this.view, "pointer") : jp(this.view, t.pos, t.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || // Safari ignores clicks on draggable elements
    ...
    // works around that.
    xe && !this.view.state.selection.visible && Math.min(Math.abs(t.pos - this.view.state.selection.from), Math.abs(t.pos - this.view.state.selection.to)) <= 2) ? ($n(this.view, V.near(this.view.state.doc.resolve(t.pos)), "pointer"), e.preventDefault()) : $t(this.view, "pointer");
  }
  move(e) {
    this.updateAllowDefault(e), $t(this.view, "pointer"), e.buttons == 0 && this.done();
  }
...
Te.touchstart = (n) => {
  n.input.lastTouch = Date.now(), cl(n), $t(n, "pointer");
};
Te.touchmove = (n) => {
  n.input.lastTouch = Date.now(), $t(n, "pointer");
};
Te.contextmenu = (n) => cl(n);
function Iu(n, e) {
...
function Pu(n) {
  for (n.composing && (n.input.composing = !1, n.input.compositionEndedAt = Yp()); n.input.compositionNodes.length > 0; )
...
function Gp(n) {
  ...
  if (!e.focusNode)
    return null;
  let t = $h(e.focusNode, e.focusOffset), r = _h(e.focusNode, e.focusOffset);
  if (t && r && t != r) {
    let i = r.pmViewDesc;
...
const Tr = Oe && _t < 15 || Un && Jh < 604;
Te.copy = Se.cut = (n, e) => {
  let t = e, r = n.state.selection, i = t.type == "cut";
  if (r.empty)
    return;
  let o = Tr ? null : t.clipboardData, s = r.content(), { dom: l, text: a } = Mu(n, s);
...
function Sr(n, e, t, r, i) {
  let o = Eu(n, e, t, r, n.state.selection.$from);
...
Se.paste = (n, e) => {
  ...
  r && Sr(n, Fu(r), r.getData("text/html"), i, t) ? t.preventDefault() : Zp(n, t);
};
class Hu {
  constructor(e, t, r) {
...
Te.dragstart = (n, e) => {
  ...
  let l = (s || n.state.selection).content(), { dom: a, text: c, slice: u } = Mu(n, l);
  t.dataTransfer.clearData(), t.dataTransfer.setData(Tr ? "Text" : "text/html", a.innerHTML), t.dataTransfer.effectAllowed = "copyMove", Tr || t.dataTransfer.setData("text/plain", c), n.dragging = new Hu(u, !t[zu], s);
};
Te.dragend = (n) => {
  let e = n.dragging;
  window.setTimeout(() => {
...
Se.drop = (n, e) => {
  ...
  s ? n.someProp("transformPasted", (p) => {
    s = p(s, n);
  }) : s = Eu(n, Fu(t.dataTransfer), Tr ? null : t.dataTransfer.getData("text/html"), !1, o);
  let l = !!(r && !t[zu]);
  ...
  if (!s)
    return;
  t.preventDefault();
  let a = s ? lh(n.state.doc, o.pos, s) : o.pos;
  a == null && (a = o.pos);
  let c = n.state.tr;
  if (l) {
    let { node: p } = r;
  ...
  if (d && B.isSelectable(s.content.firstChild) && h.nodeAfter && h.nodeAfter.sameMarkup(s.content.firstChild))
    ...
    c.mapping.maps[c.mapping.maps.length - 1].forEach((m, g, b, w) => p = w), c.setSelection(sl(n, h, c.doc.resolve(p)));
  }
...
Te.beforeinput = (n, e) => {
  if (xe && Xe && e.inputType == "deleteContentBackward") {
...
class Wt {
  ...
  eq(e) {
    return this == e || e instanceof Wt && Mr(this.attrs, e.attrs) && Mr(this.spec, e.spec);
  }
  static is(e) {
...
class re {
  ...
  */
  mapInner(e, t, r, i, o) {
    ...
    return this.children.length ? em(this.children, s || [], e, t, r, i, o) : s ? new re(s.sort(pn), Ln) : ye;
  }
  /**
  ...
  */
  add(e, t) {
    return t.length ? this == ye ? re.create(e, t) : this.addInner(e, t, 0) : this;
  }
  addInner(e, t, r) {
    let i, o = 0;
    e.forEach((l, a) => {
    ...
    return new re(s.length ? this.local.concat(s).sort(pn) : this.local, i || this.children);
  }
  /**
  ...
  */
  ...
  removeInner(e, t) {
    ...
    return r == this.children && i == this.local ? this : i.length || r.length ? new re(i, r) : ye;
  }
  forChild(e, t) {
    if (this == ye)
      return this;
    ...
    for (let l = 0; l < this.local.length; l++) {
      let a = this.local[l];
      if (a.from < s && a.to > o && a.type instanceof Wt) {
        let c = Math.max(o, a.from) - o, u = Math.min(s, a.to) - o;
        c < u && (i || (i = [])).push(a.copy(c, u));
      }
    }
    if (i) {
      let l = new re(i.sort(pn), Ln);
  ...
  */
  localsInner(e) {
    ...
    for (let r = 0; r < this.local.length; r++)
      this.local[r].type instanceof Wt || t.push(this.local[r]);
    return t;
  }
}
re.empty = new re([], []);
...
class Ft {
  ...
  forChild(e, t) {
    ...
    for (let i = 0; i < this.members.length; i++) {
      ...
      o != ye && (o instanceof Ft ? r = r.concat(o.members) : r.push(o));
    }
    return Ft.from(r);
  }
  eq(e) {
  ...
  static from(e) {
    switch (e.length) {
      ...
      case 1:
        return e[0];
      default:
        return new Ft(e.every((t) => t instanceof re) ? e : e.reduce((t, r) => t.concat(r instanceof re ? r : r.members), []));
    }
  }
}
function em(n, e, t, r, i, o, s) {
  let l = n.slice();
  ...
  if (a) {
    let c = tm(l, n, e, t, i, o, s), u = Di(c, r, 0, s);
    e = u.local;
...
function Di(n, e, t, r) {
  ...
  let s = Vu(o ? _u(n) : n, -t).sort(pn);
  for (let l = 0; l < s.length; l++)
    s[l].type.valid(e, s[l]) || (r.onRemove && r.onRemove(s[l].spec), s.splice(l--, 1));
  return s.length || i.length ? new re(s, i) : ye;
}
function pn(n, e) {
...
function Uo(n) {
  ...
  return n.someProp("decorations", (t) => {
    let r = t(n.state);
    r && r != ye && e.push(r);
  }), n.cursorWrapper && e.push(re.create(n.state.doc, [n.cursorWrapper.deco])), Ft.from(e);
}
const nm = {
  childList: !0,
  characterData: !0,
...
class om {
  constructor(e, t) {
    this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new im(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.observer = window.MutationObserver && new window.MutationObserver((r) => {
      for (let i = 0; i < r.length; i++)
        this.queue.push(r[i]);
      Oe && _t <= 11 && r.some((i) => i.type == "childList" && i.removedNodes.length || i.type == "characterData" && i.oldValue.length > i.target.nodeValue.length) ? this.flushSoon() : this.flush();
    }), rm && (this.onCharData = (r) => {
  ...
  start() {
    this.observer && (this.observer.takeRecords(), this.observer.observe(this.view.dom, nm)), this.onCharData && this.view.dom.addEventListener("DOMCharacterDataModified", this.onCharData), this.connectSelection();
  }
  stop() {
    if (this.observer) {
  ...
  onSelectionChange() {
    if (ma(this.view)) {
      if (this.suppressingSelectionUpdates)
        return At(this.view);
      if (Oe && _t <= 11 && !this.view.state.selection.empty) {
  ...
  flush() {
    ...
    let c = null;
    o < 0 && i && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && wo(r) && (c = ol(e)) && c.eq(V.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, At(e), this.currentSelection.set(r), e.scrollToSelection()) : (o > -1 || i) && (o > -1 && (e.docView.markDirty(o, s), sm(e)), this.handleDOMChange(o, s, l, a), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(r) || At(e), this.currentSelection.set(r));
  }
  registerMutation(e, t) {
    ...
    if (e.type == "childList") {
      ...
      if (Oe && _t <= 11 && e.addedNodes.length)
        for (let u = 0; u < e.addedNodes.length; u++) {
...
function am(n, e, t) {
  ...
  if (u && n.dom.contains(u.nodeType == 1 ? u : u.parentNode) && (c = [{ node: u, offset: a.anchorOffset }], wo(a) || c.push({ node: a.focusNode, offset: a.focusOffset })), xe && n.input.lastKeyCode === 8)
    for (let g = o; g > i; g--) {
  ...
  let d = n.state.doc, f = n.someProp("domParser") || Wn.fromSchema(n.state.schema), h = d.resolve(s), p = null, m = f.parse(r, {
    topNode: h.parent,
...
const um = /^(a|abbr|acronym|b|bd[io]|big|br|button|cite|code|data(list)?|del|dfn|em|i|ins|kbd|label|map|mark|meter|output|q|ruby|s|samp|small|span|strong|su[bp]|time|u|tt|var)$/i;
function dm(n, e, t, r, i) {
  ...
  if (n.input.compositionPendingChanges = 0, e < 0) {
    ...
    if (I && !n.state.selection.eq(I)) {
      if (xe && Xe && n.input.lastKeyCode === 13 && Date.now() - 100 < n.input.lastKeyCodeTime && n.someProp("handleKeyDown", (W) => W(n, on(13, "Enter"))))
        return;
  ...
  let a = n.state.selection, c = am(n, e, t), u = n.state.doc, d = u.slice(c.from, c.to), f, h;
  n.input.lastKeyCode === 8 && Date.now() - 100 < n.input.lastKeyCodeTime ? (f = n.state.selection.to, h = "end") : (f = n.state.selection.from, h = "start"), n.input.lastKeyCode = null;
  let p = pm(d.content, c.doc.content, c.from, f, h);
  if ((Un && n.input.lastIOSEnter > Date.now() - 225 || Xe) && i.some((S) => S.nodeType == 1 && !um.test(S.nodeName)) && (!p || p.endA >= p.endB) && n.someProp("handleKeyDown", (S) => S(n, on(13, "Enter")))) {
  ...
  n.input.domChangeCount++, n.state.selection.from < n.state.selection.to && p.start == p.endB && n.state.selection instanceof F && (p.start > n.state.selection.from && p.start <= n.state.selection.from + 2 && n.state.selection.from >= c.from ? p.start = n.state.selection.from : p.endA < n.state.selection.to && p.endA >= n.state.selection.to - 2 && n.state.selection.to <= c.to && (p.endB += n.state.selection.to - p.endA, p.endA = n.state.selection.to)), Oe && _t <= 11 && p.endB == p.start + 1 && p.endA == p.start && p.start > c.from && c.doc.textBetween(p.start - c.from - 1, p.start - c.from + 1) == "  " && (p.start--, p.endA--, p.endB--);
  ...
  if ((Un && n.input.lastIOSEnter > Date.now() - 225 && (!w || i.some((S) => S.nodeName == "DIV" || S.nodeName == "P")) || !w && m.pos < c.doc.content.size && !m.sameParent(g) && (C = V.findFrom(c.doc.resolve(m.pos + 1), 1, !0)) && C.head == g.pos) && n.someProp("handleKeyDown", (S) => S(n, on(13, "Enter")))) {
    n.input.lastIOSEnter = 0;
    return;
  }
  if (n.state.selection.anchor > p.start && hm(u, p.start, p.endA, m, g) && n.someProp("handleKeyDown", (S) => S(n, on(8, "Backspace")))) {
    Xe && xe && n.domObserver.suppressSelectionUpdates();
    return;
  }
  xe && Xe && p.endB == p.start && (n.input.lastAndroidDelete = Date.now()), Xe && !w && m.start() != g.start() && g.parentOffset == 0 && m.depth == g.depth && c.sel && c.sel.anchor == c.sel.head && c.sel.head == p.endA && (p.endB -= 2, g = c.doc.resolveNoCache(p.endB - c.from), setTimeout(() => {
  ...
  if (w) {
    if (m.pos == g.pos)
      Oe && _t <= 11 && m.parentOffset == 0 && (n.domObserver.suppressSelectionUpdates(), setTimeout(() => At(n), 20)), v = n.state.tr.delete(y, M), A = u.resolve(p.start).marksAcross(u.resolve(p.endA));
    else if (
      // Adding or removing a mark
      p.endA == p.endB && (R = fm(m.parent.content.cut(m.parentOffset, g.parentOffset), b.parent.content.cut(b.parentOffset, p.endA - b.start())))
    )
  ...
  if (v || (v = n.state.tr.replace(y, M, c.doc.slice(p.start - c.from, p.endB - c.from))), c.sel) {
    ...
    S && !(xe && Xe && n.composing && S.empty && (p.start != p.endB || n.input.lastAndroidDelete < Date.now() - 100) && (S.head == y || S.head == v.mapping.map(M) - 1) || Oe && S.empty && S.head == y) && v.setSelection(S);
  }
...
class mm {
  ...
  */
  ...
  updateStateInner(e, t) {
    ...
    if (l || this._props.plugins != t.plugins || this._props.nodeViews != t.nodeViews) {
      let h = Ba(this);
      ym(h, this.nodeViews) && (this.nodeViews = h, o = !0);
    }
    ...
    if (s) {
      ...
      let h = d && (Oe || xe) && !this.composing && !i.selection.empty && !e.selection.empty && gm(i.selection, e.selection);
      if (d) {
        let p = xe ? this.trackWrites = this.domSelectionRange().focusNode : null;
        this.composing && (this.input.compositionNode = Gp(this)), (o || !this.docView.update(e.doc, c, a, this)) && (this.docView.updateOuterDeco(c), this.docView.destroy(), this.docView = ca(e.doc, c, a, this.dom, this)), p && !this.trackWrites && (h = !0);
      }
      h || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && wp(this)) ? At(this, h) : (Cu(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
    }
    this.updatePluginViews(i), !((r = this.dragging) === null || r === void 0) && r.node && !i.doc.eq(e.doc) && this.updateDraggedNode(this.dragging, i), u == "reset" ? this.dom.scrollTop = 0 : u == "to selection" ? this.scrollToSelection() : f && Xh(f);
  }
  /**
  @internal
  */
  ...
  updateDraggedNode(e, t) {
    ...
    this.dragging = new Hu(e.slice, e.move, i < 0 ? void 0 : B.create(this.state.doc, i));
  }
  someProp(e, t) {
  ...
  */
  focus() {
    this.domObserver.stop(), this.editable && Zh(this.dom), At(this), this.domObserver.start();
  }
  /**
  ...
  */
  destroy() {
    this.docView && (Fp(this), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], Uo(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null, zh());
  }
  /**
  ...
  */
  domSelectionRange() {
    ...
    return Ce && this.root.nodeType === 11 && Wh(this.dom.ownerDocument) == this.dom && lm(this, e) || e;
  }
  /**
  @internal
  */
...
var Kt = {
  ...
  221: "}",
  222: '"'
}, bm = typeof navigator < "u" && /Mac/.test(navigator.platform), vm = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
for (var me = 0; me < 10; me++)
  Kt[48 + me] = Kt[96 + me] = String(me);
for (var me = 1; me <= 24; me++)
  Kt[me + 111] = "F" + me;
for (var me = 65; me <= 90; me++)
  Kt[me] = String.fromCharCode(me + 32), Bi[me] = String.fromCharCode(me);
for (var Go in Kt)
  Bi.hasOwnProperty(Go) || (Bi[Go] = Kt[Go]);
function km(n) {
  var e = bm && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey || vm && n.shiftKey && n.key && n.key.length == 1 || n.key == "Unidentified", t = !e && n.key || (n.shiftKey ? Bi : Kt)[n.keyCode] || n.key || "Unidentified";
  return t == "Esc" && (t = "Escape"), t == "Del" && (t = "Delete"), t == "Left" && (t = "ArrowLeft"), t == "Up" && (t = "ArrowUp"), t == "Right" && (t = "ArrowRight"), t == "Down" && (t = "ArrowDown"), t;
}
const wm = typeof navigator < "u" ? /Mac|iP(hone|[oa]d)/.test(navigator.platform) : !1;
function xm(n) {
...
function Tm(n) {
  return new oe({ props: { handleKeyDown: ju(n) } });
}
function ju(n) {
  let e = Cm(n);
  return function(t, r) {
    let i = km(r), o, s = e[Yo(i, r)];
...
const Mm = (n, e, t) => {
  ...
  let o = i.nodeBefore;
  if (!o.type.spec.isolating && Ju(n, i, e))
    return !0;
  if (r.parent.content.size == 0 && (Jn(o, "end") || B.isSelectable(o))) {
    let s = vo(n.doc, r.before(), r.after(), E.empty);
...
const Pm = (n, e) => {
  ...
  if (!t.parent.type.spec.code || !t.sameParent(r))
    return !1;
  let i = t.node(-1), o = t.indexAfter(-1), s = Uu(i.contentMatchAt(o));
...
function Wm(n, e = null) {
  return function(t, r) {
    ...
    let c = nl(a, n, e, s);
    return c ? (r && r(qm(t.tr, s, c, l, n).scrollIntoView()), !0) : !1;
  };
}
...
function Km(n) {
  return function(e, t) {
    ...
    return o ? t ? r.node(o.depth - 1).type == n ? Um(e, t, n, o) : Jm(e, t, o) : !0 : !1;
  };
}
function Um(n, e, t, r) {
  let i = n.tr, o = r.end, s = r.$to.end(r.depth);
  o < s && (i.step(new ce(o - 1, s, o, s, new E(x.from(t.create(null, r.parent.copy())), 1, 0), 1, !0)), r = new Ti(i.doc.resolve(r.$from.pos), i.doc.resolve(s), r.depth));
  const l = er(r);
  if (l == null)
    return !1;
  i.lift(r, l);
...
function Zm(n, e) {
  var t;
  const r = Yu(n), { nodeExtensions: i, markExtensions: o } = Mo(n), s = (t = i.find((c) => O(c, "topNode"))) === null || t === void 0 ? void 0 : t.name, l = Object.fromEntries(i.map((c) => {
    const u = r.filter((b) => b.type === c.name), d = {
      ...
      ...f,
      content: z(O(c, "content", d)),
      marks: z(O(c, "marks", d)),
      group: z(O(c, "group", d)),
      inline: z(O(c, "inline", d)),
      atom: z(O(c, "atom", d)),
      selectable: z(O(c, "selectable", d)),
      draggable: z(O(c, "draggable", d)),
      code: z(O(c, "code", d)),
      defining: z(O(c, "defining", d)),
      isolating: z(O(c, "isolating", d)),
    ...
    const u = r.filter((g) => g.type === c.name), d = {
      ...
      ...f,
      inclusive: z(O(c, "inclusive", d)),
      excludes: z(O(c, "excludes", d)),
      group: z(O(c, "group", d)),
      spanning: z(O(c, "spanning", d)),
      code: z(O(c, "code", d)),
...
function ii(n) {
  ...
  return s.forEach((f) => {
    ...
    if (!h)
      return;
    const p = a.state.tr, m = To({
      state: a.state,
      transaction: p
    }), g = {
      from: r - (h[0].length - o.length),
      to: i
    }, { commands: b, chain: w, can: C } = new So({
      editor: t,
      state: m
    });
    f.handler({
  ...
  return t.map((u) => new oe({
    ...
    appendTransaction: (d, f, h) => {
      ...
      if (!m && !g && !w)
        return;
      if (w) {
        const { from: M, text: v } = b, A = M + v.length, R = sg(v);
        return a({
          rule: u,
          state: h,
          from: M,
...
class Fn {
  constructor(e, t) {
    this.splittableMarks = [], this.editor = t, this.extensions = Fn.resolve(e), this.schema = Zm(this.extensions, t), this.setupExtensions();
  }
  /**
  ...
  get plugins() {
    const { editor: e } = this, t = Fn.sort([...this.extensions].reverse()), r = [], i = [], o = t.map((s) => {
      ...
      let u = {};
      if (s.type === "mark" && s.config.exitable && (u.ArrowRight = () => Be.handleExit({ editor: e, mark: s })), c) {
...
function Xo(n) {
  return cg(n) !== "Object" ? !1 : n.constructor === Object && Object.getPrototypeOf(n) === Object.prototype;
}
function Eo(n, e) {
  const t = { ...n };
...
class X {
  ...
  configure(e = {}) {
    const t = this.extend();
    return t.parent = this.parent, t.options = Eo(this.options, e), t.storage = z(O(t, "addStorage", {
      name: t.name,
      options: t.options
    })), t;
  }
  extend(e = {}) {
    ...
    return t.parent = this, this.child = t, t.name = e.name ? e.name : t.parent.name, e.defaultOptions && console.warn(`[tiptap warn]: BREAKING CHANGE: "defaultOptions" is deprecated. Please use "addOptions" instead. Found in extension: "${t.name}".`), t.options = z(O(t, "addOptions", {
      name: t.name
      ...
      new oe({
        ...
        props: {
          clipboardTextSerializer: () => {
            const { editor: n } = this, { state: e, schema: t } = n, { doc: r, selection: i } = e, { ranges: o } = i, s = Math.min(...o.map((u) => u.$from.pos)), l = Math.max(...o.map((u) => u.$to.pos)), a = ed(t);
            return Zu(r, { from: s, to: l }, {
...
}), !0), fg = (n = !1) => ({ commands: e }) => e.setContent("", n), hg = () => ({ state: n, tr: e, dispatch: t }) => {
...
}, pg = (n) => (e) => n(e), mg = () => ({ state: n, dispatch: e }) => Fm(n, e), gg = (n, e) => ({ editor: t, tr: r }) => {
...
}, kg = () => ({ state: n, dispatch: e }) => Sm(n, e), wg = () => ({ commands: n }) => n.keyboardShortcut("Enter"), xg = () => ({ state: n, dispatch: e }) => Pm(n, e);
...
function ml(n, e, t = {}) {
  ...
  for (; l < n.parent.childCount && Cg([...n.parent.child(l).marks], e, t); )
...
function td(n, e = null) {
  ...
  return e === "all" ? F.create(n, Mt(0, i, o), Mt(n.content.size, i, o)) : F.create(n, Mt(e, i, o), Mt(e, i, o));
}
function yl() {
  return [
    "iPad Simulator",
...
const Mg = (n = null, e = {}) => ({ editor: t, view: r, tr: i, dispatch: o }) => {
  ...
  if (o && n === null && !gl(t.state.selection))
    return s(), !0;
  const l = td(i.doc, n) || t.state.selection, a = t.state.selection.eq(l);
  return o && (a || i.setSelection(l), a && i.storedMarks && i.setStoredMarks(i.storedMarks), s()), !0;
}, Eg = (n, e) => (t) => n.every((r, i) => e(r, { ...t, index: i })), Ag = (n, e) => ({ tr: t, commands: r }) => r.insertContentAt({ from: t.selection.from, to: t.selection.to }, n, e), nd = (n) => {
  const e = n.childNodes;
  for (let t = e.length - 1; t >= 0; t -= 1) {
    const r = e[t];
    r.nodeType === 3 && r.nodeValue && /^(\n\s\s|\n)$/.test(r.nodeValue) ? n.removeChild(r) : r.nodeType === 1 && nd(r);
  }
  return n;
};
function Ha(n) {
...
const Ng = (n) => n.toString().startsWith("<"), Dg = (n, e, t) => ({ tr: r, dispatch: i, editor: o }) => {
  if (i) {
    t = {
      parseOptions: {},
      updateSelection: !0,
    ...
    let f;
    c ? (Array.isArray(e) ? f = e.map((h) => h.text || "").join("") : typeof e == "object" && e && e.text ? f = e.text : f = e, r.insertText(f, l, a)) : (f = s, r.replaceWith(l, a, f)), t.updateSelection && Og(r, r.steps.length - 1, -1), t.applyInputRules && r.setMeta("applyInputRules", { from: l, text: f }), t.applyPasteRules && r.setMeta("applyPasteRules", { from: l, text: f });
  }
  return !0;
}, Bg = () => ({ state: n, dispatch: e }) => Bm(n, e), Lg = () => ({ state: n, dispatch: e }) => Lm(n, e), Ig = () => ({ state: n, dispatch: e }) => Mm(n, e), Rg = () => ({ state: n, dispatch: e }) => Nm(n, e), Pg = () => ({ tr: n, state: e, dispatch: t }) => {
  try {
...
}, Hg = () => ({ state: n, dispatch: e }) => Em(n, e), zg = () => ({ state: n, dispatch: e }) => Am(n, e);
function rd() {
...
const $g = (n) => ({ editor: e, view: t, tr: r, dispatch: i }) => {
  const o = Vg(n).split(/-(?!$)/), s = o.find((c) => !["Alt", "Ctrl", "Meta", "Shift"].includes(c)), l = new KeyboardEvent("keydown", {
    key: s === "Space" ? " " : s,
...
const _g = (n, e = {}) => ({ state: t, dispatch: r }) => {
  const i = de(n, t.schema);
  return Er(t, i, e) ? Im(t, r) : !1;
}, jg = () => ({ state: n, dispatch: e }) => Hm(n, e), Wg = (n) => ({ state: e, dispatch: t }) => {
  const r = de(n, e.schema);
  return Km(r)(e, t);
}, qg = () => ({ state: n, dispatch: e }) => Rm(n, e);
function Ao(n, e) {
...
}, Ug = () => ({ tr: n, dispatch: e }) => (e && n.scrollIntoView(), !0), Jg = () => ({ tr: n, commands: e }) => e.setTextSelection({
  from: 0,
  to: n.doc.content.size
}), Gg = () => ({ state: n, dispatch: e }) => Om(n, e), Yg = () => ({ state: n, dispatch: e }) => Dm(n, e), Qg = () => ({ state: n, dispatch: e }) => zm(n, e), Xg = () => ({ state: n, dispatch: e }) => _m(n, e), Zg = () => ({ state: n, dispatch: e }) => $m(n, e);
function id(n, e, t = {}) {
  return Ii(n, e, { slice: !1, parseOptions: t });
}
const e0 = (n, e = !1, t = {}) => ({ tr: r, editor: i, dispatch: o }) => {
  const { doc: s } = r, l = id(n, i.schema, t);
...
function od(n, e) {
  ...
  return t === "node" ? l0(n, e) : t === "mark" ? Oo(n, e) : {};
}
function a0(n, e = JSON.stringify) {
  const t = {};
  return n.filter((r) => {
    const i = e(r);
...
const m0 = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
  ...
  return p0(r, t, a);
}, g0 = (n, e) => ({ tr: t }) => (t.setMeta(n, e), !0), y0 = (n, e = {}) => ({ state: t, dispatch: r, chain: i }) => {
  ...
  if (t) {
    const { doc: r } = e, { from: i, to: o } = typeof n == "number" ? { from: n, to: n } : n, s = F.atStart(r).from, l = F.atEnd(r).to, a = Mt(i, s, l), c = Mt(o, s, l), u = F.create(r, a, c);
    e.setSelection(u);
  }
  return !0;
}, k0 = (n) => ({ state: e, dispatch: t }) => {
  const r = de(n, e.schema);
  return Gm(r)(e, t);
};
function $a(n, e) {
...
const w0 = ({ keepMarks: n = !0 } = {}) => ({ tr: e, state: t, dispatch: r, editor: i }) => {
  ...
  if (o instanceof B && o.node.isBlock)
    return !l.parentOffset || !zn(s, l.pos) ? !1 : (r && (n && $a(t, i.extensionManager.splittableMarks), e.split(l.pos).scrollIntoView()), !0);
  if (!l.parent.isBlock)
    return !1;
  if (r) {
    const d = a.parentOffset === a.parent.content.size;
    o instanceof F && e.deleteSelection();
    const f = l.depth === 0 ? void 0 : n0(l.node(-1).contentMatchAt(l.indexAfter(-1)));
    let h = d && f ? [
      {
        type: f,
        attrs: u
    ...
    n && $a(t, i.extensionManager.splittableMarks), e.scrollIntoView();
  }
  return !0;
}, x0 = (n) => ({ tr: e, state: t, dispatch: r, editor: i }) => {
  var o;
  ...
  if (l.parent.content.size === 0 && l.node(-1).childCount === l.indexAfter(-1)) {
    ...
    if (r) {
      ...
      const w = l.indexAfter(-1) < l.node(-2).childCount ? 1 : l.indexAfter(-2) < l.node(-3).childCount ? 2 : 3, C = mi(d, l.node().type.name, l.node().attrs), y = ((o = s.contentMatch.defaultType) === null || o === void 0 ? void 0 : o.createAndFill(C)) || void 0;
  ...
  if (!C)
    return !1;
  const M = bl((v) => Va(v.type.name, d))(m);
  if (C.depth >= 1 && M && C.depth - M.depth <= 1) {
    if (M.node.type === h)
      return c.liftListItem(p);
    if (Va(M.node.type.name, d) && h.validContent(M.node.content) && l)
      return a().command(() => (o.setNodeMarkup(M.pos, h), !0)).command(() => Zo(o, h)).command(() => es(o, h)).run();
  }
  return !t || !y || !l ? a().command(() => u().wrapInList(h, r) ? !0 : c.clearNodes()).wrapInList(h, r).command(() => Zo(o, h)).command(() => es(o, h)).run() : a().command(() => {
...
}, O0 = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
  var o;
  ...
  if (u && s) {
    let { from: f, to: h } = l;
    const p = (o = c.marks().find((g) => g.type === a)) === null || o === void 0 ? void 0 : o.attrs, m = ml(c, a, p);
...
var L0 = /* @__PURE__ */ Object.freeze({
  ...
  clearNodes: hg,
  command: pg,
  createParagraphNear: mg,
  cut: gg,
  deleteCurrentNode: yg,
  deleteNode: bg,
  deleteRange: vg,
  deleteSelection: kg,
  enter: wg,
  ...
  joinItemBackward: Pg,
  joinItemForward: Fg,
  joinTextblockBackward: Hg,
  joinTextblockForward: zg,
  keyboardShortcut: $g,
  lift: _g,
  liftEmptyBlock: jg,
  liftListItem: Wg,
  ...
  scrollIntoView: Ug,
  selectAll: Jg,
  selectNodeBackward: Gg,
  selectNodeForward: Yg,
  selectParentNode: Qg,
  selectTextblockEnd: Xg,
  selectTextblockStart: Zg,
  setContent: e0,
  setMark: m0,
  setMeta: g0,
  setNode: y0,
...
let $0 = class extends Ym {
   ...
   */
  injectCSS() {
    this.options.injectCSS && document && (this.css = V0(z0, this.options.injectNonce));
  }
  /**
   ...
   */
  createView() {
    const e = id(this.options.content, this.schema, this.options.parseOptions), t = td(e, this.options.autofocus);
    this.view = new mm(this.options.element, {
   ...
   */
  getHTML() {
    return o0(this.state.doc.content, this.schema);
  }
  /**
  ...
  return new Vr({
    ...
    handler: ({ state: e, range: t, match: r }) => {
      ...
      if (s) {
        ...
        if (vl(t.from, t.to, e.doc).filter((h) => h.mark.type.excluded.find((m) => m === n.type && m !== h.mark.type)).filter((h) => h.to > c).length)
          return null;
...
class Be {
  ...
  configure(e = {}) {
    const t = this.extend();
    return t.options = Eo(this.options, e), t.storage = z(O(t, "addStorage", {
      name: t.name,
      options: t.options
    })), t;
  }
  ...
  return new Xu({
    ...
    handler: ({ state: e, range: t, match: r, pasteEvent: i }) => {
      ...
      if (l) {
        ...
        if (vl(t.from, t.to, e.doc).filter((p) => p.mark.type.excluded.find((g) => g === n.type && g !== p.mark.type)).filter((p) => p.to > d).length)
          return null;
...
var Ne = "top", Je = "bottom", Ge = "right", De = "left", kl = "auto", $r = [Ne, Je, Ge, De], Gn = "start", Ar = "end", q0 = "clippingParents", ld = "viewport", lr = "popper", K0 = "reference", _a = /* @__PURE__ */ $r.reduce(function(n, e) {
  return n.concat([e + "-" + Gn, e + "-" + Ar]);
}, []), ad = /* @__PURE__ */ [].concat($r, [kl]).reduce(function(n, e) {
  return n.concat([e, e + "-" + Gn, e + "-" + Ar]);
}, []), U0 = "beforeRead", J0 = "read", G0 = "afterRead", Y0 = "beforeMain", Q0 = "main", X0 = "afterMain", Z0 = "beforeWrite", ey = "write", ty = "afterWrite", ny = [U0, J0, G0, Y0, Q0, X0, Z0, ey, ty];
function pt(n) {
...
function ry(n) {
  ...
  Object.keys(e.elements).forEach(function(t) {
    ...
    !Ue(o) || !pt(o) || (Object.assign(o.style, r), Object.keys(i).forEach(function(s) {
      var l = i[s];
...
function iy(n) {
  ...
  return Object.assign(e.elements.popper.style, t.popper), e.styles = t, e.elements.arrow && Object.assign(e.elements.arrow.style, t.arrow), function() {
    Object.keys(e.elements).forEach(function(r) {
      ...
      !Ue(i) || !pt(i) || (Object.assign(i.style, l), Object.keys(o).forEach(function(a) {
        i.removeAttribute(a);
      }));
    });
  };
...
function Qn(n, e, t) {
  ...
  var s = wn(n) ? He(n) : window, l = s.visualViewport, a = !ud() && t, c = (r.left + (a && l ? l.offsetLeft : 0)) / i, u = (r.top + (a && l ? l.offsetTop : 0)) / o, d = r.width / i, f = r.height / o;
  return {
    width: d,
    height: f,
    top: u,
...
function sy(n) {
  ...
  var i = No(n);
  for (wl(i) && (i = i.host); Ue(i) && ["html", "body"].indexOf(pt(i)) < 0; ) {
    var o = Ot(i);
...
function _r(n) {
  for (var e = He(n), t = ja(n); t && oy(t) && Ot(t).position === "static"; )
    t = ja(t);
  return t && (pt(t) === "html" || pt(t) === "body" && Ot(t).position === "static") ? e : t || sy(n) || e;
}
function Cl(n) {
...
var ay = function(e, t) {
  ...
  })) : e, hd(typeof e != "number" ? e : pd(e, $r));
};
function cy(n) {
  var e, t = n.state, r = n.name, i = n.options, o = t.elements.arrow, s = t.modifiersData.popperOffsets, l = dt(t.placement), a = Cl(l), c = [De, Ge].indexOf(l) >= 0, u = c ? "height" : "width";
  if (!(!o || !s)) {
    var d = ay(i.padding, t), f = xl(o), h = a === "y" ? Ne : De, p = a === "y" ? Je : Ge, m = t.rects.reference[u] + t.rects.reference[a] - s[a] - t.rects.popper[u], g = s[a] - t.rects.reference[a], b = _r(o), w = b ? a === "y" ? b.clientHeight || 0 : b.clientWidth || 0 : 0, C = m / 2 - g / 2, y = d[h], M = w - f[u] - d[p], v = w / 2 - f[u] / 2 + C, A = mr(y, v, M), R = a;
    t.modifiersData[r] = (e = {}, e[R] = A, e.centerOffset = A - v, e);
  }
}
function uy(n) {
  var e = n.state, t = n.options, r = t.element, i = r === void 0 ? "[data-popper-arrow]" : r;
  i != null && (typeof i == "string" && (i = e.elements.popper.querySelector(i), !i) || dd(e.elements.popper, i) && (e.elements.arrow = i));
}
const dy = {
  name: "arrow",
  enabled: !0,
...
function Wa(n) {
  ...
  h = g.x, m = g.y;
  var b = s.hasOwnProperty("x"), w = s.hasOwnProperty("y"), C = De, y = Ne, M = window;
  if (c) {
    var v = _r(t), A = "clientHeight", R = "clientWidth";
    if (v === He(t) && (v = Xt(t), Ot(v).position !== "static" && l === "absolute" && (A = "scrollHeight", R = "scrollWidth")), v = v, i === Ne || (i === De || i === Ge) && o === Ar) {
      y = Je;
...
function ky(n, e) {
  var t = He(n), r = Xt(n), i = t.visualViewport, o = r.clientWidth, s = r.clientHeight, l = 0, a = 0;
  if (i) {
...
function md(n) {
  return ["html", "body", "#document"].indexOf(pt(n)) >= 0 ? n.ownerDocument.body : Ue(n) && Ml(n) ? n : md(No(n));
}
function gr(n, e) {
  var t;
  e === void 0 && (e = []);
  var r = md(n), i = r === ((t = n.ownerDocument) == null ? void 0 : t.body), o = He(r), s = i ? [o].concat(o.visualViewport || [], Ml(r) ? r : []) : r, l = e.concat(s);
  return i ? l : (
...
function Ka(n, e, t) {
  return e === ld ? Fs(ky(n, t)) : wn(e) ? xy(e, t) : Fs(wy(Xt(n)));
}
function Cy(n) {
  var e = gr(No(n)), t = ["absolute", "fixed"].indexOf(Ot(n).position) >= 0, r = t && Ue(n) ? _r(n) : n;
  return wn(r) ? e.filter(function(i) {
    return wn(i) && dd(i, r) && pt(i) !== "body";
  }) : [];
}
function Ty(n, e, t, r) {
  var i = e === "clippingParents" ? Cy(n) : [].concat(e), o = [].concat(i, [t]), s = o[0], l = o.reduce(function(a, c) {
    var u = Ka(n, c, r);
...
function gd(n) {
  var e = n.reference, t = n.element, r = n.placement, i = r ? dt(r) : null, o = r ? Xn(r) : null, s = e.x + e.width / 2 - t.width / 2, l = e.y + e.height / 2 - t.height / 2, a;
  switch (i) {
    case Ne:
      a = {
        x: s,
...
function Or(n, e) {
  e === void 0 && (e = {});
  var t = e, r = t.placement, i = r === void 0 ? n.placement : r, o = t.strategy, s = o === void 0 ? n.strategy : o, l = t.boundary, a = l === void 0 ? q0 : l, c = t.rootBoundary, u = c === void 0 ? ld : c, d = t.elementContext, f = d === void 0 ? lr : d, h = t.altBoundary, p = h === void 0 ? !1 : h, m = t.padding, g = m === void 0 ? 0 : m, b = hd(typeof g != "number" ? g : pd(g, $r)), w = f === lr ? K0 : lr, C = n.rects.popper, y = n.elements[p ? w : f], M = Ty(wn(y) ? y : y.contextElement || Xt(n.elements.popper), a, u, s), v = Qn(n.elements.reference), A = gd({
    reference: v,
    element: C,
    strategy: "absolute",
    placement: i
  }), R = Fs(Object.assign({}, C, A)), S = f === lr ? R : v, I = {
  ...
  if (f === lr && _) {
    ...
    Object.keys(I).forEach(function(q) {
      var ae = [Ge, Je].indexOf(q) >= 0 ? 1 : -1, Z = [Ne, Je].indexOf(q) >= 0 ? "y" : "x";
      I[q] += W[Z] * ae;
    });
  }
  return I;
...
function Sy(n, e) {
  e === void 0 && (e = {});
  var t = e, r = t.placement, i = t.boundary, o = t.rootBoundary, s = t.padding, l = t.flipVariations, a = t.allowedAutoPlacements, c = a === void 0 ? ad : a, u = Xn(r), d = u ? l ? _a : _a.filter(function(p) {
    return Xn(p) === u;
  }) : $r, f = d.filter(function(p) {
...
function Ey(n) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !0 : s, a = t.fallbackPlacements, c = t.padding, u = t.boundary, d = t.rootBoundary, f = t.altBoundary, h = t.flipVariations, p = h === void 0 ? !0 : h, m = t.allowedAutoPlacements, g = e.options.placement, b = dt(g), w = b === g, C = a || (w || !p ? [gi(g)] : My(g)), y = [g].concat(C).reduce(function(yt, Ye) {
      return yt.concat(dt(Ye) === kl ? Sy(e, {
        placement: Ye,
        boundary: u,
        rootBoundary: d,
        padding: c,
      ...
      var _ = y[I], W = dt(_), q = Xn(_) === Gn, ae = [Ne, Je].indexOf(W) >= 0, Z = ae ? "width" : "height", Y = Or(e, {
        placement: _,
        boundary: u,
        rootBoundary: d,
        altBoundary: f,
        padding: c
      }), G = ae ? q ? Ge : De : q ? Je : Ne;
      M[Z] > v[Z] && (G = gi(G));
      var K = gi(G), Le = [];
      if (o && Le.push(Y[W] <= 0), l && Le.push(Y[G] <= 0, Y[K] <= 0), Le.every(function(yt) {
        return yt;
      })) {
        S = _, R = !1;
        break;
    ...
    if (R)
      for (var ge = p ? 3 : 1, gt = function(Ye) {
        var bt = y.find(function(Cn) {
          var vt = A.get(Cn);
          if (vt)
...
function Ja(n) {
  return [Ne, Ge, Je, De].some(function(e) {
    return n[e] >= 0;
  });
}
function Oy(n) {
...
function Dy(n, e, t) {
  var r = dt(n), i = [De, Ne].indexOf(r) >= 0 ? -1 : 1, o = typeof t == "function" ? t(Object.assign({}, e, {
    placement: n
  })) : t, s = o[0], l = o[1];
  return s = s || 0, l = (l || 0) * i, [De, Ge].indexOf(r) >= 0 ? {
    x: l,
    y: s
  } : {
    x: s,
...
function By(n) {
  var e = n.state, t = n.options, r = n.name, i = t.offset, o = i === void 0 ? [0, 0] : i, s = ad.reduce(function(u, d) {
    return u[d] = Dy(d, e.rects, o), u;
...
function Fy(n) {
  var e = n.state, t = n.options, r = n.name, i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !1 : s, a = t.boundary, c = t.rootBoundary, u = t.altBoundary, d = t.padding, f = t.tether, h = f === void 0 ? !0 : f, p = t.tetherOffset, m = p === void 0 ? 0 : p, g = Or(e, {
    boundary: a,
    rootBoundary: c,
    padding: d,
    altBoundary: u
  }), b = dt(e.placement), w = Xn(e.placement), C = !w, y = Cl(b), M = Py(y), v = e.modifiersData.popperOffsets, A = e.rects.reference, R = e.rects.popper, S = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, I = typeof S == "number" ? {
    mainAxis: S,
    altAxis: S
  ...
  if (v) {
    if (o) {
      var q, ae = y === "y" ? Ne : De, Z = y === "y" ? Je : Ge, Y = y === "y" ? "height" : "width", G = v[y], K = G + g[ae], Le = G - g[Z], ge = h ? -R[Y] / 2 : 0, gt = w === Gn ? A[Y] : R[Y], Me = w === Gn ? -R[Y] : -A[Y], en = e.elements.arrow, yt = h && en ? xl(en) : {
        width: 0,
        height: 0
      }, Ye = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : fd(), bt = Ye[ae], Cn = Ye[Z], vt = mr(0, A[Y], yt[Y]), Tn = C ? A[Y] / 2 - ge - vt - bt - I.mainAxis : gt - vt - bt - I.mainAxis, Nt = C ? -A[Y] / 2 + ge + vt + Cn + I.mainAxis : Me + vt + Cn + I.mainAxis, Sn = e.elements.arrow && _r(e.elements.arrow), Wr = Sn ? y === "y" ? Sn.clientTop || 0 : Sn.clientLeft || 0 : 0, tr = (q = _ == null ? void 0 : _[y]) != null ? q : 0, qr = G + Tn - tr - Wr, Kr = G + Nt - tr, nr = mr(h ? Pi(K, qr) : K, G, h ? mn(Le, Kr) : Le);
      v[y] = nr, W[y] = nr - G;
    }
    if (l) {
      var rr, Ur = y === "x" ? Ne : De, Jr = y === "x" ? Je : Ge, kt = v[M], Dt = M === "y" ? "height" : "width", ir = kt + g[Ur], tn = kt - g[Jr], or = [Ne, De].indexOf(b) !== -1, Gr = (rr = _ == null ? void 0 : _[M]) != null ? rr : 0, Yr = or ? ir : kt - A[Dt] - R[Dt] - Gr + I.altAxis, Qr = or ? kt + A[Dt] + R[Dt] - Gr - I.altAxis : tn, Xr = h && or ? ly(Yr, kt, Qr) : mr(h ? Yr : ir, kt, h ? Qr : tn);
      v[M] = Xr, W[M] = Xr - kt;
    }
    e.modifiersData[r] = W;
  }
...
function _y(n, e, t) {
  t === void 0 && (t = !1);
  var r = Ue(e), i = Ue(e) && $y(e), o = Xt(e), s = Qn(n, i, t), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, a = {
    x: 0,
  ...
  Ml(o)) && (l = Vy(e)), Ue(e) ? (a = Qn(e, !0), a.x += e.clientLeft, a.y += e.clientTop) : o && (a.x = Sl(o))), {
  ...
  return function(l, a, c) {
    ...
    var u = {
      ...
      setOptions: function(b) {
        ...
        var C = Wy(Ky([].concat(r, u.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!f) {
          ...
          if (Ya(w, C)) {
            u.rects = {
              reference: _y(w, _r(C), u.options.strategy === "fixed"),
              popper: xl(C)
...
var Jy = [yy, Ry, my, cd, Ly, Ay, Hy, dy, Ny], Gy = /* @__PURE__ */ Uy({
  defaultModifiers: Jy
}), Yy = "tippy-box", yd = "tippy-content", Qy = "tippy-backdrop", bd = "tippy-arrow", vd = "tippy-svg-arrow", rn = {
  passive: !0,
  capture: !0
}, kd = function() {
...
function sb(n) {
  return Nr(n) ? [n] : rb(n) ? Fi(n) : Array.isArray(n) ? n : Fi(document.querySelectorAll(n));
}
function ns(n, e) {
...
function ab(n, e) {
  ...
  return n.every(function(i) {
    var o = i.popperRect, s = i.popperState, l = i.props, a = l.interactiveBorder, c = nb(s.placement), u = s.modifiersData.offset;
    if (!u)
      return !0;
...
function cb() {
  st.isTouch || (st.isTouch = !0, window.performance && document.addEventListener("mousemove", xd));
}
function xd() {
  var n = performance.now();
  n - nc < 20 && (st.isTouch = !1, document.removeEventListener("mousemove", xd)), nc = n;
}
function ub() {
...
function db() {
  document.addEventListener("touchstart", cb, rn), window.addEventListener("blur", ub);
}
var fb = typeof window < "u" && typeof document < "u", hb = fb ? (
  // @ts-ignore
  !!window.msCrypto
) : !1;
function Nn(n) {
...
var Dr;
process.env.NODE_ENV !== "production" && mb();
function mb() {
  Dr = /* @__PURE__ */ new Set();
}
function Tt(n, e) {
  if (n && !Dr.has(e)) {
    var t;
    Dr.add(e), (t = console).warn.apply(t, Cd(e));
  }
}
function Hs(n, e) {
  if (n && !Dr.has(e)) {
    var t;
    Dr.add(e), (t = console).error.apply(t, Cd(e));
  }
}
function gb(n) {
...
var Td = {
  ...
  triggerTarget: null
}, Td, yb), bb = Object.keys(Fe), vb = function(e) {
  process.env.NODE_ENV !== "production" && Md(e, []);
  var t = Object.keys(e);
...
function Sd(n) {
  var e = n.plugins || [], t = e.reduce(function(r, i) {
    ...
    if (o) {
      var l;
      r[o] = n[o] !== void 0 ? n[o] : (l = Fe[o]) != null ? l : s;
    }
    return r;
  }, {});
...
function kb(n, e) {
  var t = e ? Object.keys(Sd(Object.assign({}, Fe, {
    plugins: e
  }))) : bb, r = t.reduce(function(i, o) {
...
function ic(n, e) {
  var t = Object.assign({}, e, {
    content: wd(e.content, [n])
  }, e.ignoreAttributes ? {} : kb(n, e.plugins));
...
function Md(n, e) {
  ...
  var t = Object.keys(n);
  t.forEach(function(r) {
    var i = Zy(Fe, Object.keys(Td)), o = !Xy(i, r);
...
function oc(n) {
  var e = yr();
  return n === !0 ? e.className = bd : (e.className = vd, Nr(n) ? e.appendChild(n) : zs(e, n)), e;
}
function sc(n, e) {
...
function Vs(n) {
  ...
  return {
    ...
    content: t.find(function(r) {
      return r.classList.contains(yd);
    }),
    arrow: t.find(function(r) {
      return r.classList.contains(bd) || r.classList.contains(vd);
    }),
    backdrop: t.find(function(r) {
      return r.classList.contains(Qy);
    })
  };
}
function Ed(n) {
  var e = yr(), t = yr();
  t.className = Yy, t.setAttribute("data-state", "hidden"), t.setAttribute("tabindex", "-1");
  var r = yr();
  r.className = yd, r.setAttribute("data-state", "hidden"), sc(r, n.props), e.appendChild(t), t.appendChild(r), i(n.props, n.props);
  function i(o, s) {
...
var xb = 1, si = [], is = [];
function Cb(n, e) {
  var t = ic(n, Object.assign({}, Fe, Sd(Za(e)))), r, i, o, s = !1, l = !1, a = !1, c = !1, u, d, f, h = [], p = Qa(qr, t.interactiveDebounce), m, g = xb++, b = null, w = tb(t.plugins), C = {
  ...
  if (!t.render)
    return process.env.NODE_ENV !== "production" && Hs(!0, "render() function has not been supplied."), y;
  ...
  return Sn(), ge(), G(), K("onCreate", [y]), t.showOnCreate && ir(), v.addEventListener("mouseenter", function() {
  ...
  function ae() {
    var k = q().parentNode;
    return k ? lb(k) : document;
  }
  function Z() {
    return Vs(v);
  }
  function Y(k) {
    return y.state.isMounted && !y.state.isVisible || st.isTouch || u && u.type === "focus" ? 0 : ts(y.props.delay, k ? 0 : 1, Fe.delay);
  }
  function G(k) {
  ...
  function Le() {
    var k = y.props.aria;
    if (k.content) {
      var N = "aria-" + k.content, L = v.id, U = In(y.props.triggerTarget || n);
      U.forEach(function(j) {
        var we = j.getAttribute(N);
        if (y.state.isVisible)
          j.setAttribute(N, we ? we + " " + L : L);
        else {
          var ze = we && we.replace(L, "").trim();
          ze ? j.setAttribute(N, ze) : j.removeAttribute(N);
        }
      });
    }
  }
  function ge() {
    if (!(S || !y.props.aria.expanded)) {
      var k = In(y.props.triggerTarget || n);
  ...
  function gt() {
    ae().removeEventListener("mousemove", p), si = si.filter(function(k) {
      return k !== p;
    });
  }
  function Me(k) {
    if (!(st.isTouch && (a || k.type === "mousedown"))) {
      var N = k.composedPath && k.composedPath()[0] || k.target;
      if (!(y.props.interactive && tc(v, N))) {
        if (In(y.props.triggerTarget || n).some(function(L) {
          return tc(L, N);
        })) {
          if (st.isTouch || y.state.isVisible && y.props.trigger.indexOf("click") >= 0)
            return;
        } else
  ...
  function Ye() {
    var k = ae();
    k.addEventListener("mousedown", Me, !0), k.addEventListener("touchend", Me, rn), k.addEventListener("touchstart", yt, rn), k.addEventListener("touchmove", en, rn);
  }
  function bt() {
    var k = ae();
    k.removeEventListener("mousedown", Me, !0), k.removeEventListener("touchend", Me, rn), k.removeEventListener("touchstart", yt, rn), k.removeEventListener("touchmove", en, rn);
  }
  function Cn(k, N) {
    Tn(k, function() {
  ...
  function Tn(k, N) {
    var L = Z().box;
    function U(j) {
      j.target === L && (rs(L, "remove", U), N());
    }
    if (k === 0)
      return N();
    rs(L, "remove", d), rs(L, "add", U), d = U;
  }
  function Nt(k, N, L) {
    L === void 0 && (L = !1);
    var U = In(y.props.triggerTarget || n);
    U.forEach(function(j) {
  ...
  function Sn() {
    _() && (Nt("touchstart", tr, {
      ...
      passive: !0
    })), eb(y.props.trigger).forEach(function(k) {
      if (k !== "manual")
        switch (Nt(k, tr), k) {
          case "mouseenter":
            Nt("mouseleave", Kr);
  ...
  function tr(k) {
    var N, L = !1;
    if (!(!y.state.isEnabled || rr(k) || l)) {
      var U = ((N = u) == null ? void 0 : N.type) === "focus";
      u = k, m = k.currentTarget, ge(), !y.state.isVisible && ib(k) && si.forEach(function(j) {
        return j(k);
      }), k.type === "click" && (y.props.trigger.indexOf("mouseenter") < 0 || s) && y.props.hideOnClick !== !1 && y.state.isVisible ? L = !0 : ir(k), k.type === "click" && (s = !L), L && !U && tn(k);
    }
  }
  function qr(k) {
    var N = k.target, L = q().contains(N) || v.contains(N);
    if (!(k.type === "mousemove" && L)) {
      var U = Dt().concat(v).map(function(j) {
        var we, ze = j._tippy, Mn = (we = ze.popperInstance) == null ? void 0 : we.state;
        return Mn ? {
  ...
  function Kr(k) {
    var N = rr(k) || y.props.trigger.indexOf("click") >= 0 && s;
    if (!N) {
  ...
  function nr(k) {
    y.props.trigger.indexOf("focusin") < 0 && k.target !== q() || y.props.interactive && k.relatedTarget && v.contains(k.relatedTarget) || tn(k);
  }
  function rr(k) {
  ...
  function Ur() {
    Jr();
    var k = y.props, N = k.popperOptions, L = k.placement, U = k.offset, j = k.getReferenceClientRect, we = k.moveTransition, ze = W() ? Vs(v).arrow : null, Mn = j ? {
    ...
    }), nn.push.apply(nn, (N == null ? void 0 : N.modifiers) || []), y.popperInstance = Gy(Mn, v, Object.assign({}, N, {
      placement: L,
      onFirstUpdate: f,
      modifiers: nn
    }));
  ...
  function kt() {
    ...
    y.props.interactive && k === kd || k === "parent" ? N = L.parentNode : N = wd(k, [L]), N.contains(v) || N.appendChild(v), y.state.isMounted = !0, Ur(), process.env.NODE_ENV !== "production" && Tt(y.props.interactive && k === Fe.appendTo && L.nextElementSibling !== v, ["Interactive tippy element may not be accessible via keyboard", "navigation because it is not directly after the reference element", "in the DOM source order.", `
...
`, "See: https://atomiks.github.io/tippyjs/v6/accessibility/#interactivity"].join(" "));
  ...
  function ir(k) {
    y.clearDelayTimeouts(), k && K("onTrigger", [y, k]), Ye();
    var N = Y(!0), L = I(), U = L[0], j = L[1];
    st.isTouch && U === "hold" && j && (N = j), N ? r = setTimeout(function() {
      y.show();
    }, N) : y.show();
  }
  function tn(k) {
  ...
  function Qr(k) {
    if (process.env.NODE_ENV !== "production" && Tt(y.state.isDestroyed, Nn("setProps")), !y.state.isDestroyed) {
      K("onBeforeUpdate", [y, k]), Wr();
      var N = y.props, L = ic(n, Object.assign({}, N, Za(k), {
        ignoreAttributes: !0
      }));
      y.props = L, Sn(), N.interactiveDebounce !== L.interactiveDebounce && (gt(), p = Qa(qr, L.interactiveDebounce)), N.triggerTarget && !L.triggerTarget ? In(N.triggerTarget).forEach(function(U) {
        U.removeAttribute("aria-expanded");
      }) : L.triggerTarget && n.removeAttribute("aria-expanded"), ge(), G(), A && A(N, L), y.popperInstance && (Ur(), Dt().forEach(function(U) {
  ...
  function Qd() {
    process.env.NODE_ENV !== "production" && Tt(y.state.isDestroyed, Nn("show"));
    var k = y.state.isVisible, N = y.state.isDestroyed, L = !y.state.isEnabled, U = st.isTouch && !y.props.touch, j = ts(y.props.duration, 0, Fe.duration);
    if (!(k || N || L || U) && !q().hasAttribute("disabled") && (K("onShow", [y], !1), y.props.onShow(y) !== !1)) {
      if (y.state.isVisible = !0, W() && (v.style.visibility = "visible"), G(), Ye(), y.state.isMounted || (v.style.transition = "none"), W()) {
        var we = Z(), ze = we.box, Mn = we.content;
        ns([ze, Mn], 0);
      }
      f = function() {
        var nn;
        if (!(!y.state.isVisible || c)) {
          if (c = !0, v.offsetHeight, v.style.transition = y.props.moveTransition, W() && y.props.animation) {
            var Lo = Z(), Zr = Lo.box, En = Lo.content;
            ns([Zr, En], j), ec([Zr, En], "visible");
          }
          Le(), ge(), Xa(is, y), (nn = y.popperInstance) == null || nn.forceUpdate(), K("onMount", [y]), y.props.animation && W() && vt(j, function() {
  ...
  function Xd() {
    process.env.NODE_ENV !== "production" && Tt(y.state.isDestroyed, Nn("hide"));
    var k = !y.state.isVisible, N = y.state.isDestroyed, L = !y.state.isEnabled, U = ts(y.props.duration, 1, Fe.duration);
    if (!(k || N || L) && (K("onHide", [y], !1), y.props.onHide(y) !== !1)) {
      if (y.state.isVisible = !1, y.state.isShown = !1, c = !1, s = !1, W() && (v.style.visibility = "hidden"), gt(), bt(), G(!0), W()) {
        var j = Z(), we = j.box, ze = j.content;
        y.props.animation && (ns([we, ze], U), ec([we, ze], "hidden"));
      }
      Le(), ge(), y.props.animation ? W() && Cn(U, y.unmount) : y.unmount();
    }
  }
  function Zd(k) {
    process.env.NODE_ENV !== "production" && Tt(y.state.isDestroyed, Nn("hideWithInteractivity")), ae().addEventListener("mousemove", p), Xa(si, p), p(k);
  }
  function ef() {
    process.env.NODE_ENV !== "production" && Tt(y.state.isDestroyed, Nn("unmount")), y.state.isVisible && y.hide(), y.state.isMounted && (Jr(), Dt().forEach(function(k) {
      k._tippy.unmount();
  ...
  function tf() {
    process.env.NODE_ENV !== "production" && Tt(y.state.isDestroyed, Nn("destroy")), !y.state.isDestroyed && (y.clearDelayTimeouts(), y.unmount(), Wr(), delete n._tippy, y.state.isDestroyed = !0, K("onDestroy", [y]));
  }
}
function xn(n, e) {
  e === void 0 && (e = {});
  var t = Fe.plugins.concat(e.plugins || []);
  process.env.NODE_ENV !== "production" && (gb(n), Md(e, t)), db();
...
class Tb {
  constructor({ editor: e, element: t, view: r, tippyOptions: i = {}, updateDelay: o = 250, shouldShow: s }) {
    this.preventHide = !1, this.shouldShow = ({ view: l, state: a, from: c, to: u }) => {
      const { doc: d, selection: f } = a, { empty: h } = f, p = !d.textBetween(c, u).length && gl(a.selection), m = this.element.contains(document.activeElement);
...
const Ab = Rr({
  ...
  setup(n) {
    ...
    return of(() => {
      const r = n.editor;
      r && r.options.element && e.value && sf(() => {
          ...
          decorations: ({ doc: n, selection: e }) => {
            ...
            return n.descendants((d, f) => {
              ...
              if ((h || !this.options.showOnlyCurrent) && p) {
                ...
                const g = Ae.node(f, f + d.nodeSize, {
                  class: m.join(" "),
...
/*!
  ...
  */
var $s = function(n, e) {
  return $s = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(t, r) {
    t.__proto__ = r;
  } || function(t, r) {
    for (var i in r)
...
function Zt(n) {
  return Nd.namespaceStore.getByName(n);
}
var Br = Nd.configuration;
function Dd(n) {
  var e = {
...
function Al(n, e) {
  e === void 0 && (e = {});
  var t = jr.STORE.get(n);
  if (!t)
    return Promise.reject(qt.ModalNotFoundByID(n));
  var r = Zt(t.namespace), i = r.queue.findIndex(function(s) {
    return s.id === n;
  });
  if (i === -1)
    return Promise.reject(qt.Undefined(n));
  var o = jn.get(n, "close").map(function(s) {
    return Fb(s, n, uc(e));
  });
  return Id(o).then(function() {
    r.queue.splice(i, 1);
  }).then(function() {
    jn.get(n, "destroy").forEach(function(s) {
      return s(uc(e));
    });
  }).then(function() {
    jn.delete(n);
...
var jr = (
  ...
  function() {
    function n(e, t, r) {
      var i = this;
      this.events = go({}), this.backgroundClose = !0, this.isRoute = !1, this.id = n.modalId++, this.component = e, this.props = Pr(t), this.closed = cf(function() {
        return !Zt(r.namespace).queue.includes(i);
      }), e.beforeModalClose && jn.add(this.id, "close", e.beforeModalClose);
      var o = Dd(r);
...
var Pb = {
  ...
  add: function(n, e, t) {
    ...
    if (typeof t != "function")
      throw qt.GuardDeclarationType(t);
...
function Fb(n, e, t) {
  return function() {
    return new Promise(function(r, i) {
      var o, s = function(l) {
        l === void 0 && (l = !0), l === !1 && i(qt.NextReject(e)), r();
      };
      Promise.resolve(n.call((o = Ld(e)) === null || o === void 0 ? void 0 : o.instance, t)).then(s).catch(function(l) {
        return i(l);
      });
    });
  };
...
function Rd(n) {
  return n = Bd(n), Id(Zt(n.namespace).queue.map(function(e) {
    return function() {
      return e.close();
    };
  }));
...
function Do(n) {
  n = Bd(n);
  var e = Pd(n.namespace);
  return e ? e.close() : Promise.resolve();
}
function Hb(n, e, t) {
  var r = Dd(t), i = Zt(r.namespace);
  if (r.namespace === _n.DEFAULT_NAMESPACE && !i.initialized && !Br.skipInitCheck)
    throw qt.NotInitialized(r.namespace);
  if (typeof n == "string") {
    var o = $b(n);
    if (!o)
      throw qt.ModalNotExistsInStore(n);
    n = o;
  }
  if (!n)
    throw qt.ModalComponentNotProvided();
  var s = new jr(n, e, r);
...
function zb(n, e, t) {
  return e === void 0 && (e = {}), t === void 0 && (t = {}), Rd({
    namespace: t.namespace
  }).then(function() {
    var r = Zt(t.namespace);
    if (r.queue.length)
      throw qt.QueueNoEmpty();
  }).then(function() {
    return Fd(n, e, t);
  });
}
      ...
      switch (s.label) {
        ...
        case 1:
          return r = s.sent(), i = !1, [2, new Promise(function(l) {
            r.on(jr.EVENT_PROMPT, function(a) {
...
function Wb(n) {
  t.debug = t, t.default = t, t.coerce = a, t.disable = o, t.enable = i, t.enabled = s, t.humanize = jb(), t.destroy = c, Object.keys(n).forEach((u) => {
    t[u] = n[u];
...
var Kb = _s.exports;
const Ub = /* @__PURE__ */ _b(Kb);
function Jb(n) {
  return Ub("jenesius-vue-modal:".concat(n));
}
const Gb = ["onPointerdown"], fc = {
  __name: "WidgetModalContainerItem",
  props: {
    id: Number
  },
  setup(n) {
    const e = Pr(null), t = Jb("modal-item"), r = n, i = Ld(r.id);
    function o() {
    ...
    return (l, a) => (D(), H("div", {
      ...
      onPointerdown: Re(o, ["self", "stop"])
    }, [
      (D(), We(df(hi(i).component), ff(hi(i).props.value, {
        class: "modal-item widget__modal-wrap",
        modalId: `_modal_${n.id}`,
        ref_key: "modalRef",
        ref: e
      }, hf(hi(i).events)), null, 16, ["modalId"]))
    ], 40, Gb));
  }
};
function Yb(n) {
...
const Qb = {
  ...
  setup(n) {
    return mo(() => {
      ...
      return Et(uf, { name: Br.animation, tag: "div" }, {
...
function Hd(n, e) {
  if (ls(n) && ls(e))
    for (const t in e)
      ls(e[t]) ? (n[t] || Object.assign(n, { [t]: {} }), Hd(n[t], e[t])) : Xb(e[t]) ? (n[t] || (n[t] = []), yi(n[t], e[t])) : Object.assign(n, { [t]: e[t] });
  return n;
}
const yi = function(n, e) {
  return e === !1 ? [] : (e.forEach((t, r) => {
    !n || !n.find((i) => i.name == t.name) ? n.push(t) : Hd(
  ...
  addCommands() {
    return {
      setBlockWidth: (n) => ({ commands: e, view: t }) => this.options.alignments.includes(n) ? (e.updateAttributes(kh(t).type.name, {
        blockWidth: n
      }), !0) : !1,
  ...
  addStorage() {
    return {
      ...
      hasAllowedBlocks(n) {
        return this.getAllowedBlocks(n).length > 0;
      },
      getAllowedBlocks(n) {
        return typeof this.allowedBlocks == Object && this.allowedBlocks.currentNode.attrs.id == n.attrs.i && this.allowedBlocks.currentNode.attrs.id != n.attrs.i, this.allowedBlocks = {
          node: n,
          blocks: this.loadAllowedBlocks(n, this.getFlatBlocks())
      ...
      getAllowedBlocksByGroups(n) {
        const e = this.getAllBlocks(), t = this.getAllowedBlocks(n), r = new Set(t.map((o) => o.name)), i = [];
        return e.forEach((o) => {
  ...
  methods: {
    ...
    okHandler() {
      this.$emit(jr.EVENT_PROMPT, this.form);
    },
    handleEsc(n) {
...
}, i1 = { class: "vueberg-modal-header-title" }, o1 = /* @__PURE__ */ P("svg", {
  width: "24px",
  height: "24px",
  viewBox: "0 0 24 24",
  fill: "none",
  ...
  o1
], l1 = { class: "vueberg-modal-body" }, a1 = { class: "vueberg-form" }, c1 = ["for"], u1 = ["id", "placeholder", "autofocus", "onUpdate:modelValue"], d1 = ["innerHTML"], f1 = { class: "vueberg-form-buttons" };
function h1(n, e, t, r, i, o) {
  ...
  return D(), H("div", n1, [
    ...
    P("div", {
      class: Jt(["vueberg-modal", `vueberg-modal-${t.size}`]),
      tabindex: "0"
    }, [
      t.showHeader ? (D(), H("div", r1, [
        P("div", i1, qe(t.title), 1),
        t.closable ? (D(), H("div", {
          key: 0,
      ...
      P("div", l1, [
        P("div", a1, [
          (D(!0), H(Ie, null, Qe(t.form, (l, a) => (D(), H("div", {
...
const p1 = /* @__PURE__ */ mt(t1, [["render", h1]]), m1 = {
...
}, g1 = { class: "vueberg-modal-layout" }, y1 = {
  key: 0,
  class: "vueberg-modal-header"
}, b1 = { class: "vueberg-modal-header-title" }, v1 = /* @__PURE__ */ P("svg", {
  width: "24px",
  height: "24px",
  viewBox: "0 0 24 24",
  fill: "none",
...
function x1(n, e, t, r, i, o) {
  return D(), H("div", g1, [
    ...
    P("div", {
      ...
      t.showHeader ? (D(), H("div", y1, [
        P("div", b1, qe(t.title), 1),
        t.closable ? (D(), H("div", {
          key: 0,
          class: "vueberg-modal-header-close",
...
const C1 = /* @__PURE__ */ mt(m1, [["render", x1]]), T1 = X.create({
  name: "modal",
  addOptions() {
    return {
      formModal: p1,
...
}), M1 = /^(https?:\/\/)?(www\.|music\.)?(youtube\.com|youtu\.be)(?!.*\/channel\/)(?!\/@)(.+)?$/, E1 = /^(https?:\/\/)?(www\.|music\.)?(youtube\.com|youtu\.be)(?!.*\/channel\/)(?!\/@)(.+)?$/g, js = (n) => n.match(M1), hc = (n) => n ? "https://www.youtube-nocookie.com/embed/" : "https://www.youtube.com/embed/", A1 = (n) => {
  const {
    url: e,
    allowFullscreen: t,
    autoplay: r,
          ...
          insertCommand: async ({ editor: n, range: e }) => {
            ...
            for (; !t; ) {
              ...
              if (s == null || (o = s[0].value, o == null))
                return;
              js(o) ? t = !0 : (r = o, i = n.commands.getTranslation("blockTools.youtube.form.error"));
            }
              ...
              command: async (n) => {
                ...
                for (; !e; ) {
                  ...
                  if (o == null || (i = o[0].value, i == null))
                    return;
                  js(i) ? e = !0 : (t = i, r = n.commands.getTranslation("blockTools.youtube.form.error"));
                }
...
const N1 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/, D1 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g, B1 = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/, L1 = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g, I1 = Be.create({
  name: "bold",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addCommands() {
    return {
      toggleBulletList: () => ({ commands: n, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(R1.name, this.editor.getAttributes(pc.name)).run() : n.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
...
}), F1 = /(?:^|\s)(`(?!\s+`)((?:[^`]+))`(?!\s+`))$/, H1 = /(?:^|\s)(`(?!\s+`)((?:[^`]+))`(?!\s+`))/g, z1 = Be.create({
  name: "code",
  addOptions() {
    return {
      HTMLAttributes: {}
...
function K1() {
  return new oe({
    props: {
      ...
      handleClick: J1,
      handleKeyDown: U1,
      handleDOMEvents: { beforeinput: G1 }
    }
  });
}
const U1 = ju({
...
function Y1(n) {
  ...
  return e.className = "ProseMirror-gapcursor", re.create(n.doc, [Ae.widget(n.selection.head, e, { key: "gapcursor" })]);
}
const Q1 = X.create({
  name: "gapCursor",
  addProseMirrorPlugins() {
...
ue.from = function(e) {
  return e instanceof ue ? e : e && e.length ? new zd(e) : ue.empty;
};
...
class Ze {
  ...
  addTransform(e, t, r, i) {
    ...
    let c = s - r.depth;
    return c > rv && (l = nv(l, c), s -= c), new Ze(l.append(o), s);
  }
  remapping(e, t) {
    let r = new Hn();
  ...
  rebased(e, t) {
    ...
    return d.emptyItemCount() > tv && (d = d.compress(this.items.length - r.length)), d;
  }
  emptyItemCount() {
    let e = 0;
...
function iv(n, e, t, r) {
  ...
  t.getMeta(lv) && (n = new Rt(n.done, n.undone, null, 0, -1));
  let s = t.getMeta("appendedTransaction");
  if (t.steps.length == 0)
    return n;
  if (s && s.getMeta(gn))
    return s.getMeta(gn).redo ? new Rt(n.done.addTransform(t, void 0, r, bi(e)), n.undone, gc(t.mapping.maps[t.steps.length - 1]), n.prevTime, n.prevComposition) : new Rt(n.done, n.undone.addTransform(t, void 0, r, bi(e)), null, n.prevTime, n.prevComposition);
  if (t.getMeta("addToHistory") !== !1 && !(s && s.getMeta("addToHistory") === !1)) {
    let l = t.getMeta("composition"), a = n.prevTime == 0 || !s && n.prevComposition != l && (n.prevTime < (t.time || 0) - r.newGroupDelay || !ov(t, n.prevRanges)), c = s ? as(n.prevRanges, t.mapping) : gc(t.mapping.maps[t.steps.length - 1]);
    return new Rt(n.done.addTransform(t, a ? e.selection.getBookmark() : void 0, r, bi(e)), Ze.empty, c, t.time, l ?? n.prevComposition);
  } else
    return (o = t.getMeta("rebased")) ? new Rt(n.done.rebased(t, o), n.undone.rebased(t, o), as(n.prevRanges, t.mapping), n.prevTime, n.prevComposition) : new Rt(n.done.addMaps(t.mapping.maps), n.undone.addMaps(t.mapping.maps), as(n.prevRanges, t.mapping), n.prevTime, n.prevComposition);
}
function ov(n, e) {
  if (!e)
    return !1;
...
const gn = new ke("history"), lv = new ke("closeHistory");
function av(n = {}) {
  return n = {
    depth: n.depth || 100,
    ...
    state: {
      init() {
        return new Rt(Ze.empty, Ze.empty, null, 0, -1);
      },
      apply(e, t, r) {
        return iv(t, r, e, n);
      }
    ...
    props: {
      handleDOMEvents: {
        beforeinput(e, t) {
          let r = t.inputType, i = r == "historyUndo" ? $d : r == "historyRedo" ? _d : null;
...
const $d = Vd(!1, !0), _d = Vd(!0, !0), cv = X.create({
  name: "history",
  addOptions() {
    return {
      depth: 100,
...
}), dv = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/, fv = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g, hv = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/, pv = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g, mv = Be.create({
  name: "italic",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addCommands() {
    return {
      toggleOrderedList: () => ({ commands: n, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(yv.name, this.editor.getAttributes(bc.name)).run() : n.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
...
}), kv = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/, wv = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))/g, xv = Be.create({
  name: "strike",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  name: "text",
  group: "inline"
}), Tv = "ö", Sv = "ελ1υ2бг1ел3дети4ею2католик6ом3мкд2он1сква6онлайн5рг3рус2ф2сайт3рб3укр3қаз3հայ3ישראל5קום3ابوظبي5رامكو5لاردن4بحرين5جزائر5سعودية6عليان5مغرب5مارات5یران5بارت2زار4يتك3ھارت5تونس4سودان3رية5شبكة4عراق2ب2مان4فلسطين6قطر3كاثوليك6وم3مصر2ليسيا5وريتانيا7قع4همراه5پاکستان7ڀارت4कॉम3नेट3भारत0म्3ोत5संगठन5বাংলা5ভারত2ৰত4ਭਾਰਤ4ભારત4ଭାରତ4இந்தியா6லங்கை6சிங்கப்பூர்11భారత్5ಭಾರತ4ഭാരതം5ලංකා4คอม3ไทย3ລາວ3გე2みんな3アマゾン4クラウド4グーグル4コム2ストア3セール3ファッション6ポイント4世界2中信1国1國1文网3亚马逊3企业2佛山2信息2健康2八卦2公司1益2台湾1灣2商城1店1标2嘉里0大酒店5在线2大拿2天主教3娱乐2家電2广东2微博2慈善2我爱你3手机2招聘2政务1府2新加坡2闻2时尚2書籍2机构2淡马锡3游戏2澳門2点看2移动2组织机构4网址1店1站1络2联通2谷歌2购物2通販2集团2電訊盈科4飞利浦3食品2餐厅2香格里拉3港2닷넷1컴2삼성2한국2", Zn = (n, e) => {
  for (const t in e)
    n[t] = e[t];
  return n;
}, Ws = "numeric", qs = "ascii", Ks = "alpha", vi = "asciinumeric", ai = "alphanumeric", Us = "domain", jd = "emoji", Mv = "scheme", Ev = "slashscheme", kc = "whitespace";
function Av(n, e) {
  return n in e || (e[n] = []), e[n];
}
function cn(n, e, t) {
  e[Ws] && (e[vi] = !0, e[ai] = !0), e[qs] && (e[vi] = !0, e[Ks] = !0), e[vi] && (e[ai] = !0), e[Ks] && (e[ai] = !0), e[ai] && (e[Us] = !0), e[jd] && (e[Us] = !0);
  for (const r in e) {
    const i = Av(r, t);
...
Ee.prototype = {
  ...
  tr(n, e, t, r) {
    r = r || Ee.groups;
    let i;
    return e && e.j ? i = e : (i = new Ee(e), t && r && cn(e, t, r)), this.jr.push([n, i]), i;
  },
  /**
  ...
  tt(n, e, t, r) {
    ...
    const o = e;
    let s, l = i.go(n);
    if (l ? (s = new Ee(), Zn(s.j, l.j), s.jr.push.apply(s.jr, l.jr), s.jd = l.jd, s.t = l.t) : s = new Ee(), o) {
      if (r)
        if (s.t && typeof s.t == "string") {
          const a = Zn(Ov(s.t, r), t);
          cn(o, a, r);
        } else
          t && cn(o, t, r);
      s.t = o;
...
const $ = (n, e, t, r, i) => n.ta(e, t, r, i), Ve = (n, e, t, r, i) => n.tr(e, t, r, i), wc = (n, e, t, r, i) => n.ts(e, t, r, i), T = (n, e, t, r, i) => n.tt(e, t, r, i), xt = "WORD", Js = "UWORD", Lr = "LOCALHOST", Gs = "TLD", Ys = "UTLD", ki = "SCHEME", Rn = "SLASH_SCHEME", Nl = "NUM", Wd = "WS", Dl = "NL", br = "OPENBRACE", vr = "CLOSEBRACE", zi = "OPENBRACKET", Vi = "CLOSEBRACKET", $i = "OPENPAREN", _i = "CLOSEPAREN", ji = "OPENANGLEBRACKET", Wi = "CLOSEANGLEBRACKET", qi = "FULLWIDTHLEFTPAREN", Ki = "FULLWIDTHRIGHTPAREN", Ui = "LEFTCORNERBRACKET", Ji = "RIGHTCORNERBRACKET", Gi = "LEFTWHITECORNERBRACKET", Yi = "RIGHTWHITECORNERBRACKET", Qi = "FULLWIDTHLESSTHAN", Xi = "FULLWIDTHGREATERTHAN", Zi = "AMPERSAND", eo = "APOSTROPHE", to = "ASTERISK", Pt = "AT", no = "BACKSLASH", ro = "BACKTICK", io = "CARET", Ht = "COLON", Bl = "COMMA", oo = "DOLLAR", rt = "DOT", so = "EQUALS", Ll = "EXCLAMATION", it = "HYPHEN", lo = "PERCENT", ao = "PIPE", co = "PLUS", uo = "POUND", fo = "QUERY", Il = "QUOTE", Rl = "SEMI", ot = "SLASH", kr = "TILDE", ho = "UNDERSCORE", qd = "EMOJI", po = "SYM";
...
function Bv(n) {
  ...
  Ee.groups = e;
  const t = new Ee();
  ci == null && (ci = Tc(Tv)), ui == null && (ui = Tc(Sv)), T(t, "'", eo), T(t, "{", br), T(t, "}", vr), T(t, "[", zi), T(t, "]", Vi), T(t, "(", $i), T(t, ")", _i), T(t, "<", ji), T(t, ">", Wi), T(t, "（", qi), T(t, "）", Ki), T(t, "「", Ui), T(t, "」", Ji), T(t, "『", Gi), T(t, "』", Yi), T(t, "＜", Qi), T(t, "＞", Xi), T(t, "&", Zi), T(t, "*", to), T(t, "@", Pt), T(t, "`", ro), T(t, "^", io), T(t, ":", Ht), T(t, ",", Bl), T(t, "$", oo), T(t, ".", rt), T(t, "=", so), T(t, "!", Ll), T(t, "-", it), T(t, "%", lo), T(t, "|", ao), T(t, "+", co), T(t, "#", uo), T(t, "?", fo), T(t, '"', Il), T(t, "/", ot), T(t, ";", Rl), T(t, "~", kr), T(t, "_", ho), T(t, "\\", no);
  const r = Ve(t, fs, Nl, {
    [Ws]: !0
  });
  Ve(r, fs, r);
  ...
  cn(Gs, {
    ...
    utld: !0,
    alpha: !0
  }, e), Bt(t, "file", ki, xt, c), Bt(t, "mailto", ki, xt, c), Bt(t, "http", Rn, xt, c), Bt(t, "https", Rn, xt, c), Bt(t, "ftp", Rn, xt, c), Bt(t, "ftps", Rn, xt, c), cn(ki, {
    scheme: !0,
    ascii: !0
  }, e), cn(Rn, {
    slashscheme: !0,
...
function Lv(n, e) {
  const t = Iv(e.replace(/[A-Z]/g, (l) => l.toLowerCase())), r = t.length, i = [];
  let o = 0, s = 0;
  for (; s < r; ) {
...
const Mc = Bo("email", {
  ...
  */
  ...
  hasProtocol() {
    const n = this.tk;
    return n.length >= 2 && n[0].t !== Lr && n[1].t === Ht;
  }
}), $e = (n) => new Ee(n);
function Pv(n) {
  let {
  ...
  const t = e.domain.concat([Zi, to, Pt, no, ro, io, oo, so, it, Nl, lo, ao, co, uo, ot, po, kr, ho]), r = [eo, Ht, Bl, rt, Ll, fo, Il, Rl, ji, Wi, br, vr, Vi, zi, $i, _i, qi, Ki, Ui, Ji, Gi, Yi, Qi, Xi], i = [Zi, eo, to, no, ro, io, oo, so, it, br, vr, lo, ao, co, uo, fo, ot, po, kr, ho], o = $e(), s = T(o, kr);
  $(s, i, s), $(s, e.domain, s);
  const l = $e(), a = $e(), c = $e();
  $(o, e.domain, l), $(o, e.scheme, a), $(o, e.slashscheme, c), $(l, i, s), $(l, e.domain, l);
  const u = T(l, Pt);
  T(s, Pt, u), T(a, Pt, u), T(c, Pt, u);
  const d = T(s, rt);
  $(d, i, s), $(d, e.domain, s);
  const f = $e();
  ...
  $(h, e.domain, f);
  const p = $e(Mc);
  $(h, e.tld, p), $(h, e.utld, p), T(u, Lr, p);
  const m = T(f, it);
  $(m, e.domain, f), $(p, e.domain, f), T(p, rt, h), T(p, it, m);
  const g = T(p, Ht);
  $(g, e.numeric, Mc);
  const b = T(l, it), w = T(l, rt);
  $(b, e.domain, l), $(w, i, s), $(w, e.domain, l);
  const C = $e(di);
  $(w, e.tld, C), $(w, e.utld, C), $(C, e.domain, l), $(C, i, s), T(C, rt, w), T(C, it, b), T(C, Pt, u);
  const y = T(C, Ht), M = $e(di);
  $(y, e.numeric, M);
  const v = $e(di), A = $e();
  $(v, t, v), $(v, r, A), $(A, t, v), $(A, r, A), T(C, ot, v), T(M, ot, v);
  const R = T(a, Ht), S = T(c, Ht), I = T(S, ot), _ = T(I, ot);
  $(a, e.domain, l), T(a, rt, w), T(a, it, b), $(c, e.domain, l), T(c, rt, w), T(c, it, b), $(R, e.domain, v), T(R, ot, v), $(_, e.domain, v), $(_, t, v), T(_, ot, v);
  const W = [
    [br, vr],
    // {}
    [zi, Vi],
  ...
  for (let q = 0; q < W.length; q++) {
    const [ae, Z] = W[q], Y = T(v, ae);
    T(A, ae, Y), T(Y, Z, v);
    const G = $e(di);
    $(Y, t, G);
    const K = $e();
    $(Y, r), $(G, t, G), $(G, r, K), $(K, t, G), $(K, r, K), T(G, Z, v), T(K, Z, v);
  }
  return T(o, Lr, C), T(o, Dl, Rv), {
    start: o,
    tokens: Kd
  };
}
...
const Hv = typeof console < "u" && console && console.warn || (() => {
}), zv = "until manual call of linkify.init(). Register all schemes and plugins before invoking linkify the first time.", ee = {
  scanner: null,
  parser: null,
  tokenQueue: [],
  pluginQueue: [],
...
function Vv() {
  Ee.groups = {}, ee.scanner = null, ee.parser = null, ee.tokenQueue = [], ee.pluginQueue = [], ee.customSchemes = [], ee.initialized = !1;
}
function Ac(n, e) {
  if (e === void 0 && (e = !1), ee.initialized && Hv(`linkifyjs: already initialized - will not register custom scheme "${n}" ${zv}`), !/^[0-9a-z]+(-[0-9a-z]+)*$/.test(n))
...
function $v() {
  ee.scanner = Bv(ee.customSchemes);
  for (let n = 0; n < ee.tokenQueue.length; n++)
    ee.tokenQueue[n][1]({
      scanner: ee.scanner
    });
  ee.parser = Pv(ee.scanner.tokens);
...
function Jd(n) {
  return ee.initialized || $v(), Fv(ee.parser.start, n, Lv(ee.scanner.start, n));
}
function Gd(n, e, t) {
...
function jv(n) {
  return new oe({
    ...
    appendTransaction: (e, t, r) => {
      ...
      if (u0(l).forEach(({ newRange: c }) => {
        const u = r0(r.doc, c, (h) => h.isTextblock);
        let d, f;
        if (u.length > 1 ? (d = u[0], f = r.doc.textBetween(d.pos, d.pos + d.node.nodeSize, void 0, " ")) : u.length && r.doc.textBetween(c.from, c.to, " ", " ").endsWith(" ") && (d = u[0], f = r.doc.textBetween(d.pos, c.to, void 0, " ")), d && f) {
          ...
          g.filter((b) => b.isLink).map((b) => ({
            ...
            vl(b.from, b.to, r.doc).some((w) => w.mark.type === n.type) || s.addMark(b.from, b.to, n.type.create({
              href: b.href
            }));
          });
        }
    ...
    props: {
      handleClick: (e, t, r) => {
        ...
        if (!l.find((f) => f.nodeName === "A"))
          return !1;
        const a = od(e.state, n.type.name), c = r.target, u = (i = c == null ? void 0 : c.href) !== null && i !== void 0 ? i : a.href, d = (o = c == null ? void 0 : c.target) !== null && o !== void 0 ? o : a.target;
  ...
  return new oe({
    ...
    props: {
      handlePaste: (e, t, r) => {
        ...
        const a = Gd(l).find((c) => c.isLink && c.value === l);
...
const Kv = Be.create({
    ...
    return [
      Ut({
        find: (n) => {
          const e = [];
          if (n) {
            const t = Gd(n).filter((r) => r.isLink);
  ...
  addProseMirrorPlugins() {
    const n = [];
    return this.options.autolink && n.push(jv({
      type: this.type,
      validate: this.options.validate
    })), this.options.openOnClick && n.push(Wv({
      type: this.type,
      whenNotEditable: this.options.openOnClick === "whenNotEditable"
    })), this.options.linkOnPaste && n.push(qv({
      editor: this.editor,
      type: this.type
    })), n;
  }
...
}), Gv = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))$/, Yv = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))/g, Qv = Be.create({
  name: "highlight",
  addOptions() {
    return {
      multicolor: !1,
  ...
  addInputRules() {
    const n = [];
    return this.options.emDash !== !1 && n.push(Xv(this.options.emDash)), this.options.ellipsis !== !1 && n.push(Zv(this.options.ellipsis)), this.options.openDoubleQuote !== !1 && n.push(ek(this.options.openDoubleQuote)), this.options.closeDoubleQuote !== !1 && n.push(tk(this.options.closeDoubleQuote)), this.options.openSingleQuote !== !1 && n.push(nk(this.options.openSingleQuote)), this.options.closeSingleQuote !== !1 && n.push(rk(this.options.closeSingleQuote)), this.options.leftArrow !== !1 && n.push(ik(this.options.leftArrow)), this.options.rightArrow !== !1 && n.push(ok(this.options.rightArrow)), this.options.copyright !== !1 && n.push(sk(this.options.copyright)), this.options.trademark !== !1 && n.push(lk(this.options.trademark)), this.options.servicemark !== !1 && n.push(ak(this.options.servicemark)), this.options.registeredTrademark !== !1 && n.push(ck(this.options.registeredTrademark)), this.options.oneHalf !== !1 && n.push(uk(this.options.oneHalf)), this.options.plusMinus !== !1 && n.push(dk(this.options.plusMinus)), this.options.notEqual !== !1 && n.push(fk(this.options.notEqual)), this.options.laquo !== !1 && n.push(hk(this.options.laquo)), this.options.raquo !== !1 && n.push(pk(this.options.raquo)), this.options.multiplication !== !1 && n.push(mk(this.options.multiplication)), this.options.superscriptTwo !== !1 && n.push(gk(this.options.superscriptTwo)), this.options.superscriptThree !== !1 && n.push(yk(this.options.superscriptThree)), this.options.oneQuarter !== !1 && n.push(bk(this.options.oneQuarter)), this.options.threeQuarters !== !1 && n.push(vk(this.options.threeQuarters)), n;
  }
}), wk = be.create({
  name: "youtube",
  addOptions() {
  ...
  addCommands() {
    return {
      setYoutubeVideo: (n) => ({ commands: e }) => js(n.src) ? e.insertContent({
        type: this.name,
        attrs: n
      }) : !1
    };
...
const xk = X.create({
  ...
  addProseMirrorPlugins() {
    const n = new ke(this.name), e = Object.entries(this.editor.schema.nodes).map(([, t]) => t).filter((t) => this.options.notAfter.includes(t.name));
    return [
      new oe({
        key: n,
...
function Tk(n) {
  var e;
  const { char: t, allowSpaces: r, allowedPrefixes: i, startOfLine: o, $position: s } = n, l = j0(t), a = new RegExp(`\\s${l}$`), c = o ? "^" : "", u = r ? new RegExp(`${c}${l}.*?(?=\\s${l}|$)`, "gm") : new RegExp(`${c}(?:^)?${l}[^\\s${l}]*`, "gm"), d = ((e = s.nodeBefore) === null || e === void 0 ? void 0 : e.isText) && s.nodeBefore.text;
  if (!d)
    return null;
...
const Sk = new ke("suggestion");
function Mk({ pluginKey: n = Sk, editor: e, char: t = "@", allowSpaces: r = !1, allowedPrefixes: i = [" "], startOfLine: o = !1, decorationTag: s = "span", decorationClass: l = "suggestion", command: a = () => null, items: c = () => [], render: u = () => ({}), allow: d = () => !0, findSuggestionMatch: f = Tk }) {
  let h;
  const p = u == null ? void 0 : u(), m = new oe({
    key: n,
    view() {
      return {
        update: async (g, b) => {
          var w, C, y, M, v, A, R;
          const S = (w = this.key) === null || w === void 0 ? void 0 : w.getState(b), I = (C = this.key) === null || C === void 0 ? void 0 : C.getState(g.state), _ = S.active && I.active && S.range.from !== I.range.from, W = !S.active && I.active, q = S.active && !I.active, ae = !W && !q && S.query !== I.query, Z = W || _, Y = ae && !_, G = q || _;
          if (!Z && !Y && !G)
            return;
          const K = G && !Z ? S : I, Le = g.dom.querySelector(`[data-decoration-id="${K.decorationId}"]`);
          h = {
            editor: e,
            range: K.range,
            query: K.query,
            ...
            clientRect: Le ? () => {
              var ge;
              const { decorationId: gt } = (ge = this.key) === null || ge === void 0 ? void 0 : ge.getState(e.state), Me = g.dom.querySelector(`[data-decoration-id="${gt}"]`);
              return (Me == null ? void 0 : Me.getBoundingClientRect()) || null;
            } : null
          }, Z && ((y = p == null ? void 0 : p.onBeforeStart) === null || y === void 0 || y.call(p, h)), Y && ((M = p == null ? void 0 : p.onBeforeUpdate) === null || M === void 0 || M.call(p, h)), (Y || Z) && (h.items = await c({
            editor: e,
            query: K.query
          })), G && ((v = p == null ? void 0 : p.onExit) === null || v === void 0 || v.call(p, h)), Y && ((A = p == null ? void 0 : p.onUpdate) === null || A === void 0 || A.call(p, h)), Z && ((R = p == null ? void 0 : p.onStart) === null || R === void 0 || R.call(p, h));
        },
        destroy: () => {
          var g;
...
}, Ok = { class: "vueberg-block-item" }, Nk = ["innerHTML"], Dk = { class: "vueberg-block-item-info" }, Bk = { class: "vueberg-block-item-info-title" }, Lk = {
  key: 0,
  class: "vueberg-block-item-info-description"
};
function Ik(n, e, t, r, i, o) {
  return D(), H("div", Ok, [
    P("div", {
    ...
    P("div", Dk, [
      P("div", Bk, qe(t.title), 1),
      t.description ? (D(), H("div", Lk, qe(t.description), 1)) : le("", !0)
    ])
  ]);
}
const Yd = /* @__PURE__ */ mt(Ak, [["render", Ik]]);
const Rk = {
  name: "BlocksModal",
  props: {
    removeFirstSymbol: {
...
}, Pk = { class: "vueberg-modal-layout" }, Fk = { class: "vueberg-modal vueberg-modal-md vueberg-blocks-modal" }, Hk = { class: "vueberg-modal-header" }, zk = { class: "vueberg-modal-header-title" }, Vk = /* @__PURE__ */ P("svg", {
  width: "24px",
  height: "24px",
  viewBox: "0 0 24 24",
  fill: "none",
  ...
  Vk
], _k = { class: "vueberg-modal-body" }, jk = { class: "vueberg-blocks-modal-group" }, Wk = { class: "vueberg-blocks-modal-group-title" }, qk = { class: "vueberg-blocks-modal-group-blocks" };
function Kk(n, e, t, r, i, o) {
  ...
  return D(), H("div", Pk, [
    ...
    P("div", Fk, [
      ...
      P("div", _k, [
        (D(!0), H(Ie, null, Qe(i.blocks, (l, a) => (D(), H("div", jk, [
          P("div", Wk, qe(l.title), 1),
          P("div", qk, [
            (D(!0), H(Ie, null, Qe(l.blocks, (c, u) => (D(), We(s, {
...
const Qs = /* @__PURE__ */ mt(Rk, [["render", Kk]]), Uk = {
  components: {
    BlockItem: Yd
  },
  props: {
...
}, Jk = { class: "vueberg-slash-menu" }, Gk = {
  key: 0,
...
function Qk(n, e, t, r, i, o) {
  const s = je("BlockItem");
  return D(), H("div", Jk, [
    t.items.length ? (D(), H("div", Gk, [
      (D(!0), H(Ie, null, Qe(t.items, (l, a) => (D(), We(s, {
        class: Jt(["vueberg-block-item--clickable", i.selectedIndex == a ? "vueberg-block-item--selected" : ""]),
        onClick: Re((c) => o.selectItem(a), ["prevent"]),
        icon: l.icon,
        title: l.title,
        description: l.description
      }, null, 8, ["class", "onClick", "icon", "title", "description"]))), 256))
    ])) : (D(), H("div", Yk, qe(i.nothingFoundLabel), 1)),
    o.hiddenItems > 0 ? (D(), H("div", {
      key: 2,
      class: "vueberg-slash-menu-show-all",
      onClick: e[0] || (e[0] = (...l) => o.showAll && o.showAll(...l))
    }, [
      Dc(qe(i.showAllLabel) + " ", 1),
      P("small", null, "(+" + qe(o.hiddenItems) + ")", 1)
    ])) : le("", !0)
  ]);
}
const Xk = /* @__PURE__ */ mt(Uk, [["render", Qk]]);
function Zk(n) {
  return {
...
function ew() {
  return [
    { name: "Bold", extension: I1 },
    { name: "BulletList", extension: P1 },
    { name: "Code", extension: z1 },
    { name: "CodeBlock", extension: _1 },
    { name: "Document", extension: j1 },
    // { name: 'Dropcursor', extension: Dropcursor },
    { name: "Gapcursor", extension: Q1 },
    { name: "HardBreak", extension: X1 },
    { name: "Heading", extension: Z1 },
    { name: "History", extension: cv },
    { name: "HorizontalRule", extension: uv },
    { name: "Italic", extension: mv },
    { name: "ListItem", extension: gv },
    { name: "OrderedList", extension: bv },
    { name: "Paragraph", extension: vv },
    { name: "Strike", extension: xv },
    { name: "Text", extension: Cv },
    // {
    //   name: 'Blockquote',
    //   extension: Blockquote.extend({ content: "paragraph" }),
    // },
    { name: "TrailingNode", extension: xk },
    { name: "Subscript", extension: Uv },
    { name: "Superscript", extension: Jv },
    { name: "Highlight", extension: Qv },
    {
      name: "Link",
      extension: Kv.configure({ openOnClick: !1 })
    },
    {
      name: "slashMenu",
      extension: Ek.configure({
        suggestion: Zk(5)
      })
    },
    { name: "Typography", extension: kk },
    {
      name: "Youtube",
      extension: wk.configure(
        {
          inline: !1
        }
      )
...
const ow = /^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i;
function sw(n) {
  return typeof n == "string" && ow.test(n);
}
var fe = [];
...
const cw = X.create({
  ...
  data() {
    return {
      ...
      allDefaultExtensions: ew(),
      allBlockTools: yi(O1(), this.blockTools),
      allInlineTools: yi(tw(), this.inlineTools),
      allAlignmentTools: yi(nw(), this.alignmentTools),
      isTyping: !1,
      showMainToolbar: !1,
      // EventListners
  ...
  methods: {
    ...
    initializeEditor() {
      ...
      this.editor = new Eb({
        extensions: [
          ...n,
          e1.configure({ blocks: e }),
          Lb.configure({ considerAnyAsEmpty: !0, placeholder: this.placeholder }),
          Zb.configure({ types: this.blocksWithBlockWidth }),
          S1.configure({ types: this.blocksWithVariant }),
          Ib.configure({ types: this.blocksWithTextAlign }),
          cw.configure({ types: this.filterBlocks((t) => t) }),
          T1,
          ...this.extensions
        ],
    ...
    i.editor ? (D(), We(a, {
      ...
      default: St(() => {
        ...
        return [
          ...
          }, null, 8, ["editor", "currentBlockTool", "settings", "inlineTools", "alignmentTools", "vuebergWidth"])) : le("", !0)
        ];
      }),
      _: 1
    }, 8, ["should-show", "editor", "class", "tippy-options"])) : le("", !0),
    i.currentBlockTool && i.editor ? (D(), We(u, {
      key: 1,
      updateDelay: 1e3,
      ...
      _: 1
    }, 8, ["should-show", "editor", "tippy-options"])) : le("", !0),
    lt(d, {
      onKeydown: [
        e[0] || (e[0] = (f) => i.isTyping = !0),
        e[1] || (e[1] = Hl((f) => i.isTyping = !1, ["esc"]))
      ],
      onKeyup: e[2] || (e[2] = Hl((f) => i.isTyping = !1, ["esc"])),
      ref: "editor",
      editor: i.editor
    }, null, 8, ["editor"])
  ], 512);
}
const hw = /* @__PURE__ */ mt(uw, [["render", fw]]), pw = {
  props: Bb,
  components: {
    NodeViewWrapper: Nb
  },
...
}, gw = { class: "vueberg-customblock-header-title" }, yw = ["innerHTML"], bw = ["innerHTML"], vw = { class: "vueberg-customblock-body" };
function kw(n, e, t, r, i, o) {
  var l;
  const s = je("node-view-wrapper");
  return D(), We(s, {
    class: Jt(["vueberg-customblock", {
    ...
    default: St(() => {
      var a, c, u, d, f;
      return [
        i.isEditable && ((a = i.vueBergBlock) != null && a.name) ? (D(), H("div", mw, [
          P("div", gw, [
            P("span", {
              class: "vueberg-customblock-header-title-icon",
              innerHTML: (c = i.vueBergBlock) == null ? void 0 : c.icon
            }, null, 8, yw),
            Dc(" " + qe((u = i.vueBergBlock) == null ? void 0 : u.title), 1)
          ]),
          ((f = (d = i.vueBergBlock) == null ? void 0 : d.vueBergBlock) == null ? void 0 : f.hasPreviewMode) !== !1 ? (D(), H("div", {
            key: 0,
...
const ww = /* @__PURE__ */ mt(pw, [["render", kw]]), Tw = hw, Sw = ww;
export {
  Sw as BaseVueBergBlock,
  Tw as VueBerg
};
