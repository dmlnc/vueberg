...
const el = /* @__PURE__ */ mt(yf, [["render", vf]]), kf = {
  data() {
    return {
      showDropdown: !1
    };
...
const Lc = /* @__PURE__ */ mt(kf, [["render", wf]]);
function he(n) {
  this.content = n;
}
he.prototype = {
...
class E {
  ...
  */
  removeBetween(e, t) {
    return new E(Pc(this.content, e + this.openStart, t + this.openStart), this.openStart, this.openEnd);
  }
  /**
...
function Vc(n, e, t, r, i) {
  ...
  return dr(null, n, i, l), o && s && e.index(i) == t.index(i) ? (zc(o, s), un(dn(o, Vc(n, e, t, r, i + 1)), l)) : (o && un(dn(o, Ci(n, e, i + 1)), l), dr(e, t, i, l), s && un(dn(s, Ci(t, r, i + 1)), l)), dr(r, null, i, l), new x(l);
}
function Ci(n, e, t) {
  let r = [];
...
let fn = class bs {
  ...
  */
  toString() {
    ...
    return this.content.size && (e += "(" + this.content.toStringInner() + ")"), $c(this.marks, e);
  }
  /**
  ...
  */
  matchTag(e, t, r) {
    for (let i = r ? this.tags.indexOf(r) + 1 : 0; i < this.tags.length; i++) {
      let o = this.tags[i];
      if ($f(e, o.tag) && (o.namespace === void 0 || e.namespaceURI == o.namespace) && (!o.context || t.matchesContext(o.context))) {
        if (o.getAttrs) {
          let s = o.getAttrs(e);
          if (s === !1)
            continue;
...
class ni {
  ...
  applyPending(e) {
    for (let t = 0, r = this.pendingMarks; t < r.length; t++) {
      let i = r[t];
      (this.type ? this.type.allowsMarkType(i.type) : jf(i.type, e)) && !i.isInSet(this.activeMarks) && (this.activeMarks = i.addToSet(this.activeMarks), this.pendingMarks = i.removeFromSet(this.pendingMarks));
    }
  }
  inlineContext(e) {
  ...
  _map(e, t, r) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= d) {
        ...
        if (r)
          return h;
        let p = e == (t < 0 ? a : d) ? null : qf(l / 3, e - a), m = e == a ? Zc : e == d ? Xc : pi;
        return (t < 0 ? e != a : e != d) && (m |= eu), new vs(h, m, p);
      }
      i += u - c;
    }
...
function eh(n, e, t, r, i) {
  ...
  n.doc.nodesBetween(e, t, (s, l) => {
    if (s.isTextblock && !s.hasMarkup(r, i) && rh(n.doc, n.mapping.slice(o).map(l), r)) {
      ...
      return n.step(new ce(u, d, u + 1, d - 1, new E(x.from(r.create(i, null, s.marks)), 0, 0), 1, !0)), a === !0 && th(n, s, l, o), !1;
    }
  });
}
function th(n, e, t, r) {
...
function vo(n, e, t = e, r = E.empty) {
  ...
  return ru(i, o, r) ? new se(e, t, r) : new ch(i, o, r).fit();
}
function ru(n, e, t) {
...
class ch {
  ...
  placeNodes({ sliceDepth: e, frontierDepth: t, parent: r, inject: i, wrap: o }) {
    ...
    for (; c < l.childCount; ) {
      ...
      if (!g)
        break;
      c++, (c > 1 || a == 0 || m.content.size) && (d = g, u.push(iu(m.mark(f.allowedMarks(m.marks)), c == 1 ? a : 0, c == l.childCount ? h : -1)));
    }
...
function iu(n, e, t) {
  if (e <= 0)
    return n;
  let r = n.content;
  return e > 1 && (r = r.replaceChild(0, iu(r.firstChild, e - 1, r.childCount == 1 ? t - 1 : 0))), e > 0 && (r = n.type.contentMatch.fillBefore(r).append(r), t <= 0 && (r = r.append(n.type.contentMatch.matchFragment(r).fillBefore(x.empty, !0)))), n.copy(r);
}
    ...
    if (p)
      for (let m = 0; m < s.length; m++) {
        ...
        if (w.canReplaceWith(C, C, p.type, p.marks))
          return n.replace(i.before(g), b ? o.after(g) : t, new E(ou(r.content, 0, r.openStart, h), h, r.openEnd));
      }
  }
...
const Ch = function({ view: n, dir: e, currentResolved: t }) {
  if (!t)
    return !1;
  let r = n.state.tr;
  const i = e === "DOWN", o = t.node(1) || t.nodeAfter, s = 0, l = t.node(s), a = t.start(s), c = xh(l, (g) => g);
  let u = c.indexOf(o);
  if (u == -1)
    return !1;
  let d = i ? u + 1 : u - 1;
...
const Th = {
...
}, Sh = { class: "vueberg-toolbar" }, Mh = { class: "vueberg-button-group vueberg-button-group-separate" }, Eh = { class: "vueberg-button-group vueberg-button-group-column vueberg-toolbar-order" }, Ah = ["disabled", "data-tooltip"], Oh = /* @__PURE__ */ P("svg", {
  ...
  Oh
], Dh = ["disabled", "data-tooltip"], Bh = /* @__PURE__ */ P("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  fill: "currentColor",
  "aria-hidden": "true",
...
function Hh(n, e, t, r, i, o) {
  ...
  return D(), H("div", Sh, [
    ...
    o.activeAlignmentTools.length ? (D(), H("div", Ph, [
    ...
    t.editor && o.remainingMenuItems.length ? (D(), H("div", Fh, [
      lt(l, {
        align: "right",
        hasDropdown: !0
      }, {
...
const zh = /* @__PURE__ */ mt(Th, [["render", Hh]]), pe = function(n) {
  for (var e = 0; ; e++)
...
function ta(n, e, t, r, i) {
  for (; ; ) {
    ...
    if (e == (i < 0 ? 0 : at(n))) {
      let o = n.parentNode;
      if (!o || o.nodeType != 1 || Fr(n) || $h.test(n.nodeName) || n.contentEditable == "false")
        return !1;
      e = pe(n) + (i < 0 ? 0 : 1), n = o;
...
const ft = typeof navigator < "u" ? navigator : null, na = typeof document < "u" ? document : null, Yt = ft && ft.userAgent || "", xs = /Edge\/(\d+)/.exec(Yt), du = /MSIE \d/.exec(Yt), Cs = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Yt), Oe = !!(du || Cs || xs), _t = du ? document.documentMode : Cs ? +Cs[1] : xs ? +xs[1] : 0, tt = !Oe && /gecko\/(\d+)/i.test(Yt);
tt && +(/Firefox\/(\d+)/.exec(Yt) || [0, 0])[1];
const Ts = !Oe && /Chrome\/(\d+)/.exec(Yt), xe = !!Ts, Uh = Ts ? +Ts[1] : 0, Ce = !Oe && !!ft && /Apple Computer/.test(ft.vendor), Un = Ce && (/Mobile\/\w+/.test(Yt) || !!ft && ft.maxTouchPoints > 2), _e = Un || (ft ? /Mac/.test(ft.platform) : !1), Jh = ft ? /Win/.test(ft.platform) : !1, Xe = /Android \d/.test(Yt), Hr = !!na && "webkitFontSmoothing" in na.documentElement.style, Gh = Hr ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function Yh(n) {
...
function ra(n, e, t) {
  ...
  for (let s = t || n.dom; s; s = Cr(s)) {
    if (s.nodeType != 1)
      continue;
    let l = s, a = l == o.body, c = a ? Yh(o) : Qh(l), u = 0, d = 0;
...
function Zh({ refDOM: n, refTop: e, stack: t }) {
...
function pu(n, e) {
  ...
  return !t && a && (t = a, i = c, r = 0), t && t.nodeType == 3 ? tp(t, i) : !t || r && t.nodeType == 1 ? { node: n, offset: o } : pu(t, i);
}
function tp(n, e) {
...
function op(n, e) {
  let t = n.dom.ownerDocument, r, i = 0, o = Kh(t, e.left, e.top);
  o && ({ node: r, offset: i } = o);
  ...
  if (s = np(s, e), r) {
    ...
    let c;
    Hr && i && r.nodeType == 1 && (c = r.childNodes[i - 1]).nodeType == 1 && c.contentEditable == "false" && c.getBoundingClientRect().top >= e.top && i--, r == n.dom && i == r.childNodes.length - 1 && r.lastChild.nodeType == 1 && e.top > r.lastChild.getBoundingClientRect().bottom ? l = n.state.doc.content.size : (i == 0 || r.nodeType != 1 || r.childNodes[i - 1].nodeName != "BR") && (l = ip(n, r, i, e));
  }
  l == null && (l = rp(n, s, e));
...
function gu(n, e, t) {
  ...
  if (r.nodeType == 3)
    if (s && (sp.test(r.nodeValue) || (t < 0 ? !i : i == r.nodeValue.length))) {
      let a = Lt(Ct(r, i, i), t);
...
function cp(n, e, t) {
  ...
  return !ap.test(r.parent.textContent) || !l.modify ? t == "left" || t == "backward" ? o : s : yu(n, e, () => {
...
function up(n, e, t) {
  return oa == e && sa == t ? la : (oa = e, sa = t, la = t == "up" || t == "down" ? lp(n, e, t) : cp(n, e, t));
}
...
class jt extends zr {
  ...
  static create(e, t, r, i, o, s) {
    ...
    let f = u;
    return u = xu(u, r, t), c ? a = new fp(e, t, r, i, u, d || null, f, c, o, s + 1) : t.isText ? new xo(e, t, r, i, u, f, o) : new jt(e, t, r, i, u, d || null, f, o, s + 1);
  }
  parseRule() {
  ...
  // `this.children`.
  updateChildren(e, t) {
    let r = this.node.inlineContent, i = t, o = e.composing ? this.localCompositionInfo(e, t) : null, s = o && o.pos > -1 ? o : null, l = o && o.pos < 0, a = new pp(this, s && s.node, e);
    yp(this.node, this.innerDeco, (c, u, d) => {
    ...
    }), a.syncToMarks([], r, e), this.node.isTextblock && a.addTextblockHacks(), a.destroyRest(), (a.changed || this.dirty == ln) && (s && this.protectLocalComposition(e, s), ku(this.contentDOM, this.children, e), Un && bp(this.dom));
  }
  localCompositionInfo(e, t) {
    ...
    if (this.node.inlineContent) {
      let s = o.nodeValue, l = vp(this.node.content, s, r - t, i - t);
...
class pp {
  constructor(e, t, r) {
    this.lock = t, this.view = r, this.index = 0, this.stack = [], this.changed = !1, this.top = e, this.preMatch = mp(e.node.content, e);
  }
...
function ol(n, e = null) {
  ...
  if (wo(t)) {
    for (a = l; i && !i.node; )
      i = i.parent;
    let u = i.node;
    if (i && u.isAtom && B.isSelectable(u) && i.parent && !(u.isInline && Wh(t.focusNode, t.focusOffset, i.dom))) {
      let d = i.posBefore;
...
function At(n, e = !1) {
  ...
  if (Tu(n, t), !!Cu(n)) {
    ...
    if (n.domObserver.disconnectSelection(), n.cursorWrapper)
      ...
      da && !(t instanceof F) && (t.$from.parent.inlineContent || (o = fa(n, t.from)), !t.empty && !t.$from.parent.inlineContent && (s = fa(n, t.to))), n.docView.setSelection(r, i, n.root, e), da && (o && ha(o), s && ha(s)), t.visible ? n.dom.classList.remove("ProseMirror-hideselection") : (n.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && kp(n));
    }
    n.domObserver.setCurSelection(), n.domObserver.connectSelection();
  }
}
const da = Ce || xe && Uh < 63;
function fa(n, e) {
...
function Os(n, e, t) {
  if (e.nodeType != 3) {
    let o, s;
    (s = Sp(e, t)) ? (e = s, t = 0) : (o = Mp(e, t)) && (e = o, t = o.nodeValue.length);
  }
...
function ya(n, e) {
  ...
  if (!(xe || Jh) && t.parent.inlineContent) {
...
function Eu(n, e) {
  ...
  let s = n.someProp("clipboardSerializer") || ct.fromSchema(n.state.schema), l = Lu(), a = l.createElement("div");
...
`))), 0, 0) : E.empty;
  ...
  if (l || (l = (n.someProp("clipboardParser") || n.someProp("domParser") || Wn.fromSchema(n.state.schema)).parseSlice(s, {
    ...
    context: i,
    ruleFromNode(f) {
      return f.nodeName == "BR" && !f.nextSibling && f.parentNode && !Np.test(f.parentNode.nodeName) ? { ignore: !0 } : null;
    }
  })), u)
    l = Ip(wa(l, +u[1], +u[2]), u[4]);
  else if (l = E.maxOpen(Dp(l.content, i), !0), l.openStart || l.openEnd) {
    let d = 0, f = 0;
...
function Nu(n, e, t, r, i) {
  if (i < n.length && i < e.length && n[i] == e[i]) {
    ...
    if (r.contentMatchAt(r.childCount).matchType(i == n.length - 1 ? t.type : n[i + 1]))
      return r.copy(r.content.append(x.from(Ou(t, n, i + 1))));
  }
}
function Du(n, e) {
  if (e == 0)
...
const Te = {}, Se = {}, Rp = { touchstart: !0, touchmove: !0 };
class Pp {
  constructor() {
...
function Fp(n) {
  for (let e in Te) {
    ...
    n.dom.addEventListener(e, n.input.eventHandlers[e] = (r) => {
      zp(n, r) && !ll(n, r) && (n.editable || !(r.type in Se)) && t(n, r);
    }, Rp[e] ? { passive: !0 } : void 0);
  }
...
Se.keydown = (n, e) => {
  let t = e;
  if (n.input.shiftKey = t.keyCode == 16 || t.shiftKey, !Ru(n, t) && (n.input.lastKeyCode = t.keyCode, n.input.lastKeyCodeTime = Date.now(), !(Xe && xe && t.keyCode == 13)))
    if (t.keyCode != 229 && n.domObserver.forceFlush(), Un && t.keyCode == 13 && !t.ctrlKey && !t.altKey && !t.metaKey) {
      ...
      n.someProp("handleKeyDown", (r) => r(n, t)) || Op(n, t) ? t.preventDefault() : $t(n, "key");
};
Se.keyup = (n, e) => {
...
Se.keypress = (n, e) => {
  let t = e;
  if (Ru(n, t) || !t.charCode || t.ctrlKey && !t.altKey || _e && t.metaKey)
    return;
...
function Wp(n, e, t, r, i) {
  return al(n, "handleClickOn", e, t, r) || n.someProp("handleClick", (o) => o(n, e, r)) || (i ? jp(n, t) : _p(n, t));
}
function qp(n, e, t, r) {
  return al(n, "handleDoubleClickOn", e, t, r) || n.someProp("handleDoubleClick", (i) => i(n, e, r));
}
function Kp(n, e, t, r) {
  return al(n, "handleTripleClickOn", e, t, r) || n.someProp("handleTripleClick", (i) => i(n, e, r)) || Up(n, t, r);
}
function Up(n, e, t) {
  if (t.button != 0)
    return !1;
...
const Iu = _e ? "metaKey" : "ctrlKey";
Te.mousedown = (n, e) => {
  let t = e;
  n.input.shiftKey = t.shiftKey;
  let r = cl(n), i = Date.now(), o = "singleClick";
  i - n.input.lastClick.time < 500 && $p(t, n.input.lastClick) && !t[Iu] && (n.input.lastClick.type == "singleClick" ? o = "doubleClick" : n.input.lastClick.type == "doubleClick" && (o = "tripleClick")), n.input.lastClick = { time: i, x: t.clientX, y: t.clientY, type: o };
  let s = n.posAtCoords(Co(t));
  s && (o == "singleClick" ? (n.input.mouseDown && n.input.mouseDown.done(), n.input.mouseDown = new Jp(n, s, t, !!r)) : (o == "doubleClick" ? qp : Kp)(n, s.pos, s.inside, t) ? t.preventDefault() : $t(n, "pointer"));
};
class Jp {
  constructor(e, t, r, i) {
  ...
  up(e) {
    if (this.done(), !this.view.dom.contains(e.target))
      return;
    let t = this.pos;
    this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(Co(e))), this.updateAllowDefault(e), this.allowDefault || !t ? $t(this.view, "pointer") : Wp(this.view, t.pos, t.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || // Safari ignores clicks on draggable elements
...
function Fu(n) {
  for (n.composing && (n.input.composing = !1, n.input.compositionEndedAt = Qp()); n.input.compositionNodes.length > 0; )
...
function Yp(n) {
  ...
  if (!e.focusNode)
    return null;
  let t = _h(e.focusNode, e.focusOffset), r = jh(e.focusNode, e.focusOffset);
  if (t && r && t != r) {
    let i = r.pmViewDesc;
...
const Tr = Oe && _t < 15 || Un && Gh < 604;
Te.copy = Se.cut = (n, e) => {
  let t = e, r = n.state.selection, i = t.type == "cut";
  if (r.empty)
    return;
  let o = Tr ? null : t.clipboardData, s = r.content(), { dom: l, text: a } = Eu(n, s);
  o ? (t.preventDefault(), o.clearData(), o.setData("text/html", l.innerHTML), o.setData("text/plain", a)) : Xp(n, l), i && n.dispatch(n.state.tr.deleteSelection().scrollIntoView().setMeta("uiEvent", "cut"));
};
function Zp(n) {
...
function Sr(n, e, t, r, i) {
  ...
  if (!o)
    return !1;
  let s = Zp(o), l = s ? n.state.tr.replaceSelectionWith(s, r) : n.state.tr.replaceSelection(o);
...
Se.paste = (n, e) => {
  ...
  r && Sr(n, Hu(r), r.getData("text/html"), i, t) ? t.preventDefault() : em(n, t);
};
class zu {
  constructor(e, t, r) {
...
class re {
  ...
  */
  mapInner(e, t, r, i, o) {
    ...
    return this.children.length ? tm(this.children, s || [], e, t, r, i, o) : s ? new re(s.sort(pn), Ln) : ye;
  }
  /**
...
function tm(n, e, t, r, i, o, s) {
  ...
  if (a) {
    let c = nm(l, n, e, t, i, o, s), u = Di(c, r, 0, s);
    e = u.local;
...
class sm {
  constructor(e, t) {
    this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new om(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.observer = window.MutationObserver && new window.MutationObserver((r) => {
      for (let i = 0; i < r.length; i++)
        this.queue.push(r[i]);
  ...
  start() {
    this.observer && (this.observer.takeRecords(), this.observer.observe(this.view.dom, rm)), this.onCharData && this.view.dom.addEventListener("DOMCharacterDataModified", this.onCharData), this.connectSelection();
  }
  stop() {
    if (this.observer) {
  ...
  flush() {
    ...
    let c = null;
    o < 0 && i && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && wo(r) && (c = ol(e)) && c.eq(V.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, At(e), this.currentSelection.set(r), e.scrollToSelection()) : (o > -1 || i) && (o > -1 && (e.docView.markDirty(o, s), lm(e)), this.handleDOMChange(o, s, l, a), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(r) || At(e), this.currentSelection.set(r));
  }
...
const dm = /^(a|abbr|acronym|b|bd[io]|big|br|button|cite|code|data(list)?|del|dfn|em|i|ins|kbd|label|map|mark|meter|output|q|ruby|s|samp|small|span|strong|su[bp]|time|u|tt|var)$/i;
function fm(n, e, t, r, i) {
  ...
  let a = n.state.selection, c = cm(n, e, t), u = n.state.doc, d = u.slice(c.from, c.to), f, h;
  n.input.lastKeyCode === 8 && Date.now() - 100 < n.input.lastKeyCodeTime ? (f = n.state.selection.to, h = "end") : (f = n.state.selection.from, h = "start"), n.input.lastKeyCode = null;
  let p = mm(d.content, c.doc.content, c.from, f, h);
  if ((Un && n.input.lastIOSEnter > Date.now() - 225 || Xe) && i.some((S) => S.nodeType == 1 && !dm.test(S.nodeName)) && (!p || p.endA >= p.endB) && n.someProp("handleKeyDown", (S) => S(n, on(13, "Enter")))) {
  ...
  if (n.state.selection.anchor > p.start && pm(u, p.start, p.endA, m, g) && n.someProp("handleKeyDown", (S) => S(n, on(8, "Backspace")))) {
  ...
  if (w) {
    if (m.pos == g.pos)
      ...
      p.endA == p.endB && (R = hm(m.parent.content.cut(m.parentOffset, g.parentOffset), b.parent.content.cut(b.parentOffset, p.endA - b.start())))
    )
...
class gm {
  ...
  */
  ...
  updateStateInner(e, t) {
    ...
    if (l || this._props.plugins != t.plugins || this._props.nodeViews != t.nodeViews) {
      let h = Ba(this);
      bm(h, this.nodeViews) && (this.nodeViews = h, o = !0);
    }
    ...
    let f = u == "preserve" && s && this.dom.style.overflowAnchor == null && Xh(this);
    if (s) {
      this.domObserver.stop();
      let h = d && (Oe || xe) && !this.composing && !i.selection.empty && !e.selection.empty && ym(i.selection, e.selection);
      if (d) {
        let p = xe ? this.trackWrites = this.domSelectionRange().focusNode : null;
        this.composing && (this.input.compositionNode = Yp(this)), (o || !this.docView.update(e.doc, c, a, this)) && (this.docView.updateOuterDeco(c), this.docView.destroy(), this.docView = ca(e.doc, c, a, this.dom, this)), p && !this.trackWrites && (h = !0);
      }
      h || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && xp(this)) ? At(this, h) : (Tu(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
    }
    this.updatePluginViews(i), !((r = this.dragging) === null || r === void 0) && r.node && !i.doc.eq(e.doc) && this.updateDraggedNode(this.dragging, i), u == "reset" ? this.dom.scrollTop = 0 : u == "to selection" ? this.scrollToSelection() : f && Zh(f);
  }
  /**
  @internal
  */
  ...
  */
  focus() {
    this.domObserver.stop(), this.editable && ep(this.dom), At(this), this.domObserver.start();
  }
  /**
  ...
  */
  destroy() {
    this.docView && (Hp(this), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], Uo(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null, Vh());
  }
  /**
  ...
  */
  domSelectionRange() {
    ...
    return Ce && this.root.nodeType === 11 && qh(this.dom.ownerDocument) == this.dom && am(this, e) || e;
  }
  /**
  @internal
  */
...
var Kt = {
  ...
  221: "}",
  222: '"'
}, vm = typeof navigator < "u" && /Mac/.test(navigator.platform), km = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
...
function wm(n) {
  var e = vm && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey || km && n.shiftKey && n.key && n.key.length == 1 || n.key == "Unidentified", t = !e && n.key || (n.shiftKey ? Bi : Kt)[n.keyCode] || n.key || "Unidentified";
  return t == "Esc" && (t = "Escape"), t == "Del" && (t = "Delete"), t == "Left" && (t = "ArrowLeft"), t == "Up" && (t = "ArrowUp"), t == "Right" && (t = "ArrowRight"), t == "Down" && (t = "ArrowDown"), t;
}
const xm = typeof navigator < "u" ? /Mac|iP(hone|[oa]d)/.test(navigator.platform) : !1;
function Cm(n) {
...
function Sm(n) {
  return new oe({ props: { handleKeyDown: Wu(n) } });
}
function Wu(n) {
  let e = Tm(n);
  return function(t, r) {
    let i = wm(r), o, s = e[Yo(i, r)];
...
const Mm = (n, e) => n.selection.empty ? !1 : (e && e(n.tr.deleteSelection().scrollIntoView()), !0);
function qu(n, e) {
...
function qm(n, e = null) {
  return function(t, r) {
    ...
    let c = nl(a, n, e, s);
    return c ? (r && r(Km(t.tr, s, c, l, n).scrollIntoView()), !0) : !1;
  };
}
...
function Um(n) {
  return function(e, t) {
    ...
    return o ? t ? r.node(o.depth - 1).type == n ? Jm(e, t, n, o) : Gm(e, t, o) : !0 : !1;
  };
}
function Jm(n, e, t, r) {
  ...
  return n.style ? n : {
    ...
    getAttrs: (t) => {
      ...
      const i = e.reduce((o, s) => {
        const l = s.attribute.parseHTML ? s.attribute.parseHTML(t) : Zm(t.getAttribute(s.name));
        return l == null ? o : {
          ...o,
          [s.name]: l
        };
...
function eg(n, e) {
  var t;
  const r = Qu(n), { nodeExtensions: i, markExtensions: o } = Mo(n), s = (t = i.find((c) => O(c, "topNode"))) === null || t === void 0 ? void 0 : t.name, l = Object.fromEntries(i.map((c) => {
  ...
  return t.map((u) => new oe({
    ...
    appendTransaction: (d, f, h) => {
      ...
      if (!m && !g && !w)
        return;
      if (w) {
        const { from: M, text: v } = b, A = M + v.length, R = lg(v);
        return a({
          rule: u,
          state: h,
          from: M,
...
class Fn {
  constructor(e, t) {
    this.splittableMarks = [], this.editor = t, this.extensions = Fn.resolve(e), this.schema = eg(this.extensions, t), this.setupExtensions();
  }
  /**
   ...
   */
  static resolve(e) {
    const t = Fn.sort(Fn.flatten(e)), r = cg(t.map((i) => i.name));
...
function Xo(n) {
  return ug(n) !== "Object" ? !1 : n.constructor === Object && Object.getPrototypeOf(n) === Object.prototype;
}
function Eo(n, e) {
  const t = { ...n };
...
}), fg = () => ({ editor: n, view: e }) => (requestAnimationFrame(() => {
  var t;
  n.isDestroyed || (e.dom.blur(), (t = window == null ? void 0 : window.getSelection()) === null || t === void 0 || t.removeAllRanges());
}), !0), hg = (n = !1) => ({ commands: e }) => e.setContent("", n), pg = () => ({ state: n, tr: e, dispatch: t }) => {
...
}, mg = (n) => (e) => n(e), gg = () => ({ state: n, dispatch: e }) => Hm(n, e), yg = (n, e) => ({ editor: t, tr: r }) => {
...
}, wg = () => ({ state: n, dispatch: e }) => Mm(n, e), xg = () => ({ commands: n }) => n.keyboardShortcut("Enter"), Cg = () => ({ state: n, dispatch: e }) => Fm(n, e);
...
function ml(n, e, t = {}) {
  ...
  for (; l < n.parent.childCount && Tg([...n.parent.child(l).marks], e, t); )
...
const Sg = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
...
const Eg = (n = null, e = {}) => ({ editor: t, view: r, tr: i, dispatch: o }) => {
  e = {
    scrollIntoView: !0,
    ...e
  };
...
}, Ag = (n, e) => (t) => n.every((r, i) => e(r, { ...t, index: i })), Og = (n, e) => ({ tr: t, commands: r }) => r.insertContentAt({ from: t.selection.from, to: t.selection.to }, n, e), rd = (n) => {
...
const Dg = (n) => n.toString().startsWith("<"), Bg = (n, e, t) => ({ tr: r, dispatch: i, editor: o }) => {
  if (i) {
    t = {
      parseOptions: {},
      updateSelection: !0,
    ...
    let f;
    c ? (Array.isArray(e) ? f = e.map((h) => h.text || "").join("") : typeof e == "object" && e && e.text ? f = e.text : f = e, r.insertText(f, l, a)) : (f = s, r.replaceWith(l, a, f)), t.updateSelection && Ng(r, r.steps.length - 1, -1), t.applyInputRules && r.setMeta("applyInputRules", { from: l, text: f }), t.applyPasteRules && r.setMeta("applyPasteRules", { from: l, text: f });
  }
  return !0;
}, Lg = () => ({ state: n, dispatch: e }) => Lm(n, e), Ig = () => ({ state: n, dispatch: e }) => Im(n, e), Rg = () => ({ state: n, dispatch: e }) => Em(n, e), Pg = () => ({ state: n, dispatch: e }) => Dm(n, e), Fg = () => ({ tr: n, state: e, dispatch: t }) => {
  try {
...
}, zg = () => ({ state: n, dispatch: e }) => Am(n, e), Vg = () => ({ state: n, dispatch: e }) => Om(n, e);
function id() {
...
const _g = (n) => ({ editor: e, view: t, tr: r, dispatch: i }) => {
  const o = $g(n).split(/-(?!$)/), s = o.find((c) => !["Alt", "Ctrl", "Meta", "Shift"].includes(c)), l = new KeyboardEvent("keydown", {
    key: s === "Space" ? " " : s,
...
const jg = (n, e = {}) => ({ state: t, dispatch: r }) => {
  const i = de(n, t.schema);
  return Er(t, i, e) ? Rm(t, r) : !1;
}, Wg = () => ({ state: n, dispatch: e }) => zm(n, e), qg = (n) => ({ state: e, dispatch: t }) => {
  const r = de(n, e.schema);
  return Um(r)(e, t);
}, Kg = () => ({ state: n, dispatch: e }) => Pm(n, e);
function Ao(n, e) {
...
}, Jg = () => ({ tr: n, dispatch: e }) => (e && n.scrollIntoView(), !0), Gg = () => ({ tr: n, commands: e }) => e.setTextSelection({
  from: 0,
  to: n.doc.content.size
}), Yg = () => ({ state: n, dispatch: e }) => Nm(n, e), Qg = () => ({ state: n, dispatch: e }) => Bm(n, e), Xg = () => ({ state: n, dispatch: e }) => Vm(n, e), Zg = () => ({ state: n, dispatch: e }) => jm(n, e), e0 = () => ({ state: n, dispatch: e }) => _m(n, e);
function od(n, e, t = {}) {
  return Ii(n, e, { slice: !1, parseOptions: t });
}
const t0 = (n, e = !1, t = {}) => ({ tr: r, editor: i, dispatch: o }) => {
...
function sd(n, e) {
  ...
  return t === "node" ? a0(n, e) : t === "mark" ? Oo(n, e) : {};
}
function c0(n, e = JSON.stringify) {
  const t = {};
  return n.filter((r) => {
    const i = e(r);
...
const g0 = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
  ...
  return m0(r, t, a);
}, y0 = (n, e) => ({ tr: t }) => (t.setMeta(n, e), !0), b0 = (n, e = {}) => ({ state: t, dispatch: r, chain: i }) => {
...
const x0 = ({ keepMarks: n = !0 } = {}) => ({ tr: e, state: t, dispatch: r, editor: i }) => {
  ...
  if (r) {
    ...
    const f = l.depth === 0 ? void 0 : r0(l.node(-1).contentMatchAt(l.indexAfter(-1)));
    let h = d && f ? [
      {
        type: f,
        attrs: u
  ...
  return !0;
}, C0 = (n) => ({ tr: e, state: t, dispatch: r, editor: i }) => {
  var o;
...
}, T0 = (n, e, t, r = {}) => ({ editor: i, tr: o, state: s, dispatch: l, chain: a, commands: c, can: u }) => {
...
var I0 = /* @__PURE__ */ Object.freeze({
  ...
  scrollIntoView: Jg,
  selectAll: Gg,
  selectNodeBackward: Yg,
  selectNodeForward: Qg,
  selectParentNode: Xg,
  selectTextblockEnd: Zg,
  selectTextblockStart: e0,
  setContent: t0,
  setMark: g0,
  setMeta: y0,
  setNode: b0,
...
let _0 = class extends Qm {
   ...
   */
  injectCSS() {
    this.options.injectCSS && document && (this.css = $0(V0, this.options.injectNonce));
  }
  /**
  ...
  createView() {
    ...
    this.view = new gm(this.options.element, {
   ...
   */
  getHTML() {
    return s0(this.state.doc.content, this.schema);
  }
  /**
...
var Ne = "top", Je = "bottom", Ge = "right", De = "left", kl = "auto", $r = [Ne, Je, Ge, De], Gn = "start", Ar = "end", K0 = "clippingParents", ad = "viewport", lr = "popper", U0 = "reference", _a = /* @__PURE__ */ $r.reduce(function(n, e) {
  return n.concat([e + "-" + Gn, e + "-" + Ar]);
}, []), cd = /* @__PURE__ */ [].concat($r, [kl]).reduce(function(n, e) {
  return n.concat([e, e + "-" + Gn, e + "-" + Ar]);
}, []), J0 = "beforeRead", G0 = "read", Y0 = "afterRead", Q0 = "beforeMain", X0 = "main", Z0 = "afterMain", ey = "beforeWrite", ty = "write", ny = "afterWrite", ry = [J0, G0, Y0, Q0, X0, Z0, ey, ty, ny];
function pt(n) {
...
function Qn(n, e, t) {
  ...
  var s = wn(n) ? He(n) : window, l = s.visualViewport, a = !dd() && t, c = (r.left + (a && l ? l.offsetLeft : 0)) / i, u = (r.top + (a && l ? l.offsetTop : 0)) / o, d = r.width / i, f = r.height / o;
  return {
    width: d,
    height: f,
    top: u,
...
function _r(n) {
  for (var e = He(n), t = ja(n); t && sy(t) && Ot(t).position === "static"; )
    t = ja(t);
  return t && (pt(t) === "html" || pt(t) === "body" && Ot(t).position === "static") ? e : t || ly(n) || e;
}
function Cl(n) {
...
function uy(n) {
  ...
  if (!(!o || !s)) {
    var d = cy(i.padding, t), f = xl(o), h = a === "y" ? Ne : De, p = a === "y" ? Je : Ge, m = t.rects.reference[u] + t.rects.reference[a] - s[a] - t.rects.popper[u], g = s[a] - t.rects.reference[a], b = _r(o), w = b ? a === "y" ? b.clientHeight || 0 : b.clientWidth || 0 : 0, C = m / 2 - g / 2, y = d[h], M = w - f[u] - d[p], v = w / 2 - f[u] / 2 + C, A = mr(y, v, M), R = a;
...
function gd(n) {
  return ["html", "body", "#document"].indexOf(pt(n)) >= 0 ? n.ownerDocument.body : Ue(n) && Ml(n) ? n : gd(No(n));
}
function gr(n, e) {
  var t;
  e === void 0 && (e = []);
  var r = gd(n), i = r === ((t = n.ownerDocument) == null ? void 0 : t.body), o = He(r), s = i ? [o].concat(o.visualViewport || [], Ml(r) ? r : []) : r, l = e.concat(s);
  return i ? l : (
...
function Ka(n, e, t) {
  return e === ad ? Fs(wy(n, t)) : wn(e) ? Cy(e, t) : Fs(xy(Xt(n)));
}
function Ty(n) {
  var e = gr(No(n)), t = ["absolute", "fixed"].indexOf(Ot(n).position) >= 0, r = t && Ue(n) ? _r(n) : n;
  return wn(r) ? e.filter(function(i) {
    return wn(i) && fd(i, r) && pt(i) !== "body";
  }) : [];
}
function Sy(n, e, t, r) {
  var i = e === "clippingParents" ? Ty(n) : [].concat(e), o = [].concat(i, [t]), s = o[0], l = o.reduce(function(a, c) {
    var u = Ka(n, c, r);
...
function Or(n, e) {
  e === void 0 && (e = {});
  var t = e, r = t.placement, i = r === void 0 ? n.placement : r, o = t.strategy, s = o === void 0 ? n.strategy : o, l = t.boundary, a = l === void 0 ? K0 : l, c = t.rootBoundary, u = c === void 0 ? ad : c, d = t.elementContext, f = d === void 0 ? lr : d, h = t.altBoundary, p = h === void 0 ? !1 : h, m = t.padding, g = m === void 0 ? 0 : m, b = pd(typeof g != "number" ? g : md(g, $r)), w = f === lr ? U0 : lr, C = n.rects.popper, y = n.elements[p ? w : f], M = Sy(wn(y) ? y : y.contextElement || Xt(n.elements.popper), a, u, s), v = Qn(n.elements.reference), A = yd({
    reference: v,
    element: C,
    strategy: "absolute",
    placement: i
...
function My(n, e) {
  e === void 0 && (e = {});
  var t = e, r = t.placement, i = t.boundary, o = t.rootBoundary, s = t.padding, l = t.flipVariations, a = t.allowedAutoPlacements, c = a === void 0 ? cd : a, u = Xn(r), d = u ? l ? _a : _a.filter(function(p) {
    return Xn(p) === u;
...
function Ay(n) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !0 : s, a = t.fallbackPlacements, c = t.padding, u = t.boundary, d = t.rootBoundary, f = t.altBoundary, h = t.flipVariations, p = h === void 0 ? !0 : h, m = t.allowedAutoPlacements, g = e.options.placement, b = dt(g), w = b === g, C = a || (w || !p ? [gi(g)] : Ey(g)), y = [g].concat(C).reduce(function(yt, Ye) {
      return yt.concat(dt(Ye) === kl ? My(e, {
        placement: Ye,
        boundary: u,
        rootBoundary: d,
        padding: c,
...
function Hy(n) {
  var e = n.state, t = n.options, r = n.name, i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !1 : s, a = t.boundary, c = t.rootBoundary, u = t.altBoundary, d = t.padding, f = t.tether, h = f === void 0 ? !0 : f, p = t.tetherOffset, m = p === void 0 ? 0 : p, g = Or(e, {
    ...
    padding: d,
    altBoundary: u
  }), b = dt(e.placement), w = Xn(e.placement), C = !w, y = Cl(b), M = Fy(y), v = e.modifiersData.popperOffsets, A = e.rects.reference, R = e.rects.popper, S = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, I = typeof S == "number" ? {
    mainAxis: S,
    altAxis: S
  ...
  if (v) {
    if (o) {
      var q, ae = y === "y" ? Ne : De, Z = y === "y" ? Je : Ge, Y = y === "y" ? "height" : "width", G = v[y], K = G + g[ae], Le = G - g[Z], ge = h ? -R[Y] / 2 : 0, gt = w === Gn ? A[Y] : R[Y], Me = w === Gn ? -R[Y] : -A[Y], en = e.elements.arrow, yt = h && en ? xl(en) : {
        width: 0,
        height: 0
      }, Ye = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : hd(), bt = Ye[ae], Cn = Ye[Z], vt = mr(0, A[Y], yt[Y]), Tn = C ? A[Y] / 2 - ge - vt - bt - I.mainAxis : gt - vt - bt - I.mainAxis, Nt = C ? -A[Y] / 2 + ge + vt + Cn + I.mainAxis : Me + vt + Cn + I.mainAxis, Sn = e.elements.arrow && _r(e.elements.arrow), Wr = Sn ? y === "y" ? Sn.clientTop || 0 : Sn.clientLeft || 0 : 0, tr = (q = _ == null ? void 0 : _[y]) != null ? q : 0, qr = G + Tn - tr - Wr, Kr = G + Nt - tr, nr = mr(h ? Pi(K, qr) : K, G, h ? mn(Le, Kr) : Le);
      v[y] = nr, W[y] = nr - G;
    }
    if (l) {
      var rr, Ur = y === "x" ? Ne : De, Jr = y === "x" ? Je : Ge, kt = v[M], Dt = M === "y" ? "height" : "width", ir = kt + g[Ur], tn = kt - g[Jr], or = [Ne, De].indexOf(b) !== -1, Gr = (rr = _ == null ? void 0 : _[M]) != null ? rr : 0, Yr = or ? ir : kt - A[Dt] - R[Dt] - Gr + I.altAxis, Qr = or ? kt + A[Dt] + R[Dt] - Gr - I.altAxis : tn, Xr = h && or ? ay(Yr, kt, Qr) : mr(h ? Yr : ir, kt, h ? Qr : tn);
      v[M] = Xr, W[M] = Xr - kt;
    }
    e.modifiersData[r] = W;
  }
...
function jy(n, e, t) {
  ...
  Ml(o)) && (l = $y(e)), Ue(e) ? (a = Qn(e, !0), a.x += e.clientLeft, a.y += e.clientTop) : o && (a.x = Sl(o))), {
  ...
  return function(l, a, c) {
    ...
    var u = {
      ...
      setOptions: function(b) {
        ...
        var C = qy(Uy([].concat(r, u.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!f) {
          ...
          if (Ya(w, C)) {
            u.rects = {
              reference: jy(w, _r(C), u.options.strategy === "fixed"),
              popper: xl(C)
...
var Gy = [by, Py, gy, ud, Iy, Oy, zy, fy, Dy], Yy = /* @__PURE__ */ Jy({
  defaultModifiers: Gy
}), Qy = "tippy-box", bd = "tippy-content", Xy = "tippy-backdrop", vd = "tippy-arrow", kd = "tippy-svg-arrow", rn = {
  passive: !0,
  capture: !0
}, wd = function() {
...
function lb(n) {
  return Nr(n) ? [n] : ib(n) ? Fi(n) : Array.isArray(n) ? n : Fi(document.querySelectorAll(n));
}
function ns(n, e) {
...
function cb(n, e) {
  ...
  return n.every(function(i) {
    var o = i.popperRect, s = i.popperState, l = i.props, a = l.interactiveBorder, c = rb(s.placement), u = s.modifiersData.offset;
    if (!u)
      return !0;
...
function ub() {
  st.isTouch || (st.isTouch = !0, window.performance && document.addEventListener("mousemove", Cd));
}
function Cd() {
  var n = performance.now();
  n - nc < 20 && (st.isTouch = !1, document.removeEventListener("mousemove", Cd)), nc = n;
}
function db() {
...
function fb() {
  document.addEventListener("touchstart", ub, rn), window.addEventListener("blur", db);
}
var hb = typeof window < "u" && typeof document < "u", pb = hb ? (
  // @ts-ignore
  !!window.msCrypto
) : !1;
function Nn(n) {
...
var Sd = {
  ...
  triggerTarget: null
}, Sd, bb), vb = Object.keys(Fe), kb = function(e) {
...
function wb(n, e) {
  var t = e ? Object.keys(Md(Object.assign({}, Fe, {
    plugins: e
  }))) : vb, r = t.reduce(function(i, o) {
...
function ic(n, e) {
  ...
  }, e.ignoreAttributes ? {} : wb(n, e.plugins));
...
function Ed(n, e) {
  ...
  var t = Object.keys(n);
  t.forEach(function(r) {
    var i = eb(Fe, Object.keys(Sd)), o = !Zy(i, r);
...
function Vs(n) {
  ...
  return {
    ...
    backdrop: t.find(function(r) {
      return r.classList.contains(Xy);
    })
  };
}
function Ad(n) {
  var e = yr(), t = yr();
  t.className = Qy, t.setAttribute("data-state", "hidden"), t.setAttribute("tabindex", "-1");
  var r = yr();
...
var Cb = 1, si = [], is = [];
function Tb(n, e) {
  var t = ic(n, Object.assign({}, Fe, Md(Za(e)))), r, i, o, s = !1, l = !1, a = !1, c = !1, u, d, f, h = [], p = Qa(qr, t.interactiveDebounce), m, g = Cb++, b = null, w = nb(t.plugins), C = {
  ...
  function Sn() {
    _() && (Nt("touchstart", tr, {
      ...
      passive: !0
    })), tb(y.props.trigger).forEach(function(k) {
      if (k !== "manual")
        switch (Nt(k, tr), k) {
          case "mouseenter":
            Nt("mouseleave", Kr);
  ...
  function tr(k) {
    ...
    if (!(!y.state.isEnabled || rr(k) || l)) {
      ...
      u = k, m = k.currentTarget, ge(), !y.state.isVisible && ob(k) && si.forEach(function(j) {
        return j(k);
  ...
  function Ur() {
    ...
    }), nn.push.apply(nn, (N == null ? void 0 : N.modifiers) || []), y.popperInstance = Yy(Mn, v, Object.assign({}, N, {
      placement: L,
      onFirstUpdate: f,
      modifiers: nn
    }));
...
function xn(n, e) {
  ...
  process.env.NODE_ENV !== "production" && (yb(n), Ed(e, t)), fb();
...
const Gb = ["onPointerdown"], fc = {
  ...
  setup(n) {
    const e = Pr(null), t = Jb("modal-item"), r = n, i = Id(r.id);
    function o() {
    ...
    return (l, a) => (D(), H("div", {
      ...
      (D(), We(ff(hi(i).component), hf(hi(i).props.value, {
...
function zd(n, e) {
  if (ls(n) && ls(e))
    for (const t in e)
      ls(e[t]) ? (n[t] || Object.assign(n, { [t]: {} }), zd(n[t], e[t])) : Xb(e[t]) ? (n[t] || (n[t] = []), yi(n[t], e[t])) : Object.assign(n, { [t]: e[t] });
  return n;
}
...
function av(n = {}) {
  return n = {
    ...
    props: {
      handleDOMEvents: {
        beforeinput(e, t) {
          let r = t.inputType, i = r == "historyUndo" ? _d : r == "historyRedo" ? jd : null;
...
const _d = $d(!1, !0), jd = $d(!0, !0), cv = X.create({
  name: "history",
  addOptions() {
    return {
      depth: 100,
  ...
  addCommands() {
    return {
      ...
      redo: () => ({ state: n, dispatch: e }) => jd(n, e)
    };
  },
  addProseMirrorPlugins() {
    return [
  ...
  for (const t in e)
    n[t] = e[t];
  return n;
}, Ws = "numeric", qs = "ascii", Ks = "alpha", vi = "asciinumeric", ai = "alphanumeric", Us = "domain", Wd = "emoji", Mv = "scheme", Ev = "slashscheme", kc = "whitespace";
function Av(n, e) {
...
function jv(n) {
  return new oe({
    ...
    appendTransaction: (e, t, r) => {
      ...
      if (!i || o)
        return;
      const { tr: s } = r, l = n0(t.doc, [...e]);
      if (d0(l).forEach(({ newRange: c }) => {
        const u = i0(r.doc, c, (h) => h.isTextblock);
        let d, f;
...
const Kv = Be.create({
...
}), Yv = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))$/, Qv = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))/g, Xv = Be.create({
  name: "highlight",
  addOptions() {
    return {
      multicolor: !1,
  ...
  addInputRules() {
    const n = [];
    return this.options.emDash !== !1 && n.push(Zv(this.options.emDash)), this.options.ellipsis !== !1 && n.push(ek(this.options.ellipsis)), this.options.openDoubleQuote !== !1 && n.push(tk(this.options.openDoubleQuote)), this.options.closeDoubleQuote !== !1 && n.push(nk(this.options.closeDoubleQuote)), this.options.openSingleQuote !== !1 && n.push(rk(this.options.openSingleQuote)), this.options.closeSingleQuote !== !1 && n.push(ik(this.options.closeSingleQuote)), this.options.leftArrow !== !1 && n.push(ok(this.options.leftArrow)), this.options.rightArrow !== !1 && n.push(sk(this.options.rightArrow)), this.options.copyright !== !1 && n.push(lk(this.options.copyright)), this.options.trademark !== !1 && n.push(ak(this.options.trademark)), this.options.servicemark !== !1 && n.push(ck(this.options.servicemark)), this.options.registeredTrademark !== !1 && n.push(uk(this.options.registeredTrademark)), this.options.oneHalf !== !1 && n.push(dk(this.options.oneHalf)), this.options.plusMinus !== !1 && n.push(fk(this.options.plusMinus)), this.options.notEqual !== !1 && n.push(hk(this.options.notEqual)), this.options.laquo !== !1 && n.push(pk(this.options.laquo)), this.options.raquo !== !1 && n.push(mk(this.options.raquo)), this.options.multiplication !== !1 && n.push(gk(this.options.multiplication)), this.options.superscriptTwo !== !1 && n.push(yk(this.options.superscriptTwo)), this.options.superscriptThree !== !1 && n.push(bk(this.options.superscriptThree)), this.options.oneQuarter !== !1 && n.push(vk(this.options.oneQuarter)), this.options.threeQuarters !== !1 && n.push(kk(this.options.threeQuarters)), n;
  }
}), xk = be.create({
  name: "youtube",
  addOptions() {
...
function Sk(n) {
  var e;
  const { char: t, allowSpaces: r, allowedPrefixes: i, startOfLine: o, $position: s } = n, l = W0(t), a = new RegExp(`\\s${l}$`), c = o ? "^" : "", u = r ? new RegExp(`${c}${l}.*?(?=\\s${l}|$)`, "gm") : new RegExp(`${c}(?:^)?${l}[^\\s${l}]*`, "gm"), d = ((e = s.nodeBefore) === null || e === void 0 ? void 0 : e.isText) && s.nodeBefore.text;
  if (!d)
    return null;
...
const Mk = new ke("suggestion");
function Ek({ pluginKey: n = Mk, editor: e, char: t = "@", allowSpaces: r = !1, allowedPrefixes: i = [" "], startOfLine: o = !1, decorationTag: s = "span", decorationClass: l = "suggestion", command: a = () => null, items: c = () => [], render: u = () => ({}), allow: d = () => !0, findSuggestionMatch: f = Sk }) {
  let h;
...
}, Nk = { class: "vueberg-block-item" }, Dk = ["innerHTML"], Bk = { class: "vueberg-block-item-info" }, Lk = { class: "vueberg-block-item-info-title" }, Ik = {
  key: 0,
  class: "vueberg-block-item-info-description"
};
function Rk(n, e, t, r, i, o) {
  return D(), H("div", Nk, [
    P("div", {
    ...
    P("div", Bk, [
      P("div", Lk, qe(t.title), 1),
      t.description ? (D(), H("div", Ik, qe(t.description), 1)) : le("", !0)
    ])
  ]);
}
const Qd = /* @__PURE__ */ mt(Ok, [["render", Rk]]);
const Pk = {
  name: "BlocksModal",
  props: {
    removeFirstSymbol: {
...
}, Fk = { class: "vueberg-modal-layout" }, Hk = { class: "vueberg-modal vueberg-modal-md vueberg-blocks-modal" }, zk = { class: "vueberg-modal-header" }, Vk = { class: "vueberg-modal-header-title" }, $k = /* @__PURE__ */ P("svg", {
  width: "24px",
  height: "24px",
  viewBox: "0 0 24 24",
  fill: "none",
  ...
  $k
], jk = { class: "vueberg-modal-body" }, Wk = { class: "vueberg-blocks-modal-group" }, qk = { class: "vueberg-blocks-modal-group-title" }, Kk = { class: "vueberg-blocks-modal-group-blocks" };
function Uk(n, e, t, r, i, o) {
  ...
  return D(), H("div", Fk, [
    ...
    P("div", Hk, [
      ...
      P("div", jk, [
        (D(!0), H(Ie, null, Qe(i.blocks, (l, a) => (D(), H("div", Wk, [
          P("div", qk, qe(l.title), 1),
          P("div", Kk, [
...
const Qs = /* @__PURE__ */ mt(Pk, [["render", Uk]]), Jk = {
  components: {
    BlockItem: Qd
  },
  props: {
...
}, Gk = { class: "vueberg-slash-menu" }, Yk = {
  key: 0,
...
function Xk(n, e, t, r, i, o) {
  const s = je("BlockItem");
  return D(), H("div", Gk, [
    t.items.length ? (D(), H("div", Yk, [
...
function tw() {
  return [
    { name: "Placeholder", extension: Uv.configure({ considerAnyAsEmpty: !0, placeholder: "Начните писать" }) },
    ...
    // },
    { name: "TrailingNode", extension: Ck },
    { name: "Subscript", extension: Jv },
    { name: "Superscript", extension: Gv },
    { name: "Highlight", extension: Xv },
    {
      name: "Link",
    ...
    {
      name: "slashMenu",
      extension: Ak.configure({
        suggestion: ew(5)
      })
    },
    { name: "Typography", extension: wk },
    {
      name: "Youtube",
      extension: xk.configure(
        {
          inline: !1
        }
      )
...
function lw(n) {
  return typeof n == "string" && sw.test(n);
}
var fe = [];
...
const uw = X.create({
  ...
  data() {
    return {
      ...
      loaded: !1,
      allDefaultExtensions: tw(),
      allBlockTools: yi(O1(), this.blockTools),
      allInlineTools: yi(nw(), this.inlineTools),
      allAlignmentTools: yi(rw(), this.alignmentTools),
      isTyping: !1,
      showMainToolbar: !1,
      // EventListners
    ...
    initializeEditor() {
      ...
      this.editor = new Ab({
        extensions: [
          ...
          uw.configure({ types: this.filterBlocks((t) => t) }),
          T1,
          ...this.extensions
        ],
...
const pw = /* @__PURE__ */ mt(dw, [["render", hw]]), mw = {
  props: Lb,
  components: {
    NodeViewWrapper: Db
  },
...
}, yw = { class: "vueberg-customblock-header-title" }, bw = ["innerHTML"], vw = ["innerHTML"], kw = { class: "vueberg-customblock-body" };
function ww(n, e, t, r, i, o) {
  ...
  return D(), We(s, {
    ...
    default: St(() => {
      var a, c, u, d, f;
      return [
        i.isEditable && ((a = i.vueBergBlock) != null && a.name) ? (D(), H("div", gw, [
          P("div", yw, [
            P("span", {
              class: "vueberg-customblock-header-title-icon",
              innerHTML: (c = i.vueBergBlock) == null ? void 0 : c.icon
            }, null, 8, bw),
            Bc(" " + qe((u = i.vueBergBlock) == null ? void 0 : u.title), 1)
          ]),
...
const xw = /* @__PURE__ */ mt(mw, [["render", ww]]), Sw = pw, Mw = xw;
export {
