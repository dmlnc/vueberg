import { openBlock as D, createElementBlock as P, normalizeClass as Ot, renderSlot as ms, createCommentVNode as ne, resolveComponent as qe, createElementVNode as F, withModifiers as Ae, createVNode as lt, withCtx as St, toDisplayString as Ke, Fragment as Ee, renderList as je, createBlock as Oe, defineComponent as Rr, ref as Pr, onMounted as mo, onBeforeUnmount as Xs, h as Et, reactive as go, markRaw as Zs, getCurrentInstance as of, watchEffect as sf, nextTick as lf, unref as hi, Teleport as af, customRef as cf, watch as Nc, computed as uf, TransitionGroup as df, resolveDynamicComponent as ff, mergeProps as hf, toHandlers as pf, withDirectives as Dc, vModelText as mf, createTextVNode as Bc, vShow as gf, withKeys as Hl } from "vue";
const mt = (n, e) => {
...
const Th = {
  ...
  computed: {
    ...
    menuCount() {
      ...
      this.customTools && this.customTools.length > 0 && (n -= this.customTools.length * t, n -= (this.customTools.length - 1) * r, n -= i + o), n -= e * 2, n -= 2 * t, n -= r, n -= i + o, n -= this.activeAlignmentTools.length * t, n -= r * (this.activeAlignmentTools.length ? this.activeAlignmentTools.length - 1 : 0), n -= i + o;
...
}, Sh = { class: "vueberg-toolbar" }, Mh = { class: "vueberg-button-group vueberg-button-group-separate" }, Eh = { class: "vueberg-button-group vueberg-button-group-column vueberg-toolbar-order" }, Ah = ["disabled", "data-tooltip"], Oh = /* @__PURE__ */ F("svg", {
...
function zh(n, e, t, r, i, o) {
  ...
  return D(), P("div", Sh, [
    F("div", Mh, [
      F("div", Eh, [
        F("button", {
          onClick: e[0] || (e[0] = Ae((f) => o.moveNode("UP"), ["prevent"])),
          disabled: !o.canMoveNodeUp(),
          "data-tooltip": i.upLabel,
          class: "vueberg-button--toolbar-order vueberg-button"
        }, Nh, 8, Ah),
        F("button", {
          onClick: e[1] || (e[1] = Ae((f) => o.moveNode("DOWN"), ["prevent"])),
          disabled: !o.canMoveNodeDown(),
          "data-tooltip": i.downLabel,
          class: "vueberg-button--toolbar-order vueberg-button"
        }, Lh, 8, Dh)
      ]),
      (a = t.currentBlockTool) != null && a.icon && ((c = t.currentBlockTool) != null && c.name) ? (D(), P("div", Ih, [
        lt(l, {
          ...
          dropdown: St(() => [
            ...
            (D(!0), P(Ee, null, je(o.canBeConvertedTo, (f) => (D(), Oe(s, {
              content: f.icon + " " + f.title,
              key: f.title,
              onClick: Ae((h) => o.runConvertCommand(f), ["prevent"]),
    ...
    o.activeAlignmentTools.length ? (D(), P("div", Ph, [
      (D(!0), P(Ee, null, je(o.activeAlignmentTools, (f, h) => (D(), Oe(l, {
        hasDropdown: !0,
        key: h
      }, {
        dropdown: St(() => [
          (D(!0), P(Ee, null, je(f.tools, (p) => {
            var m;
            return D(), Oe(s, {
              class: "vueberg-button-text vueberg-button-md",
              key: p.title,
              content: p.icon + " " + p.title,
              onClick: Ae((g) => p.command(t.editor), ["prevent"]),
    ...
    (D(!0), P(Ee, null, je(o.firstMenuItems, (f) => (D(), P(Ee, null, [
      f.condition ? (D(), P("div", {
        key: f.type,
        class: "vueberg-button-group vueberg-button-group-separate"
      }, [
        (D(!0), P(Ee, null, je(f.buttons, (h, p) => (D(), Oe(s, {
          key: p,
          content: h.icon,
          label: h.label,
          activeClass: h.activeClass,
          onClick: Ae(h.click, ["prevent"]),
          disabled: h.disabled,
          active: h.active
        }, null, 8, ["content", "label", "activeClass", "onClick", "disabled", "active"]))), 128))
      ])) : ne("", !0)
    ], 64))), 256)),
    t.editor && o.remainingMenuItems.length ? (D(), P("div", Fh, [
      lt(l, {
        align: "right",
        hasDropdown: !0
      }, {
        dropdown: St(() => [
          (D(!0), P(Ee, null, je(o.remainingMenuItems, (f) => (D(), P(Ee, null, [
            f.condition ? (D(!0), P(Ee, { key: 0 }, je(f.buttons, (h, p) => (D(), Oe(s, {
              key: p,
              ...
              disabled: h.disabled,
              active: h.active
            }, null, 8, ["content", "activeClass", "onClick", "disabled", "active"]))), 128)) : ne("", !0)
          ], 64))), 256))
        ]),
        default: St(() => [
          lt(s, {
    ...
    t.customTools.length ? (D(), P("div", Hh, [
      (D(!0), P(Ee, null, je(t.customTools, (f, h) => (D(), Oe(s, {
        key: h,
        content: f.icon,
        label: f.title,
        activeClass: f == null ? void 0 : f.activeClass,
        onClick: Ae(f == null ? void 0 : f.click, ["prevent"]),
        disabled: f == null ? void 0 : f.disabled,
        active: f == null ? void 0 : f.isActiveTest
      }, null, 8, ["content", "label", "activeClass", "onClick", "disabled", "active"]))), 128))
    ])) : ne("", !0)
  ]);
}
const Vh = /* @__PURE__ */ mt(Th, [["render", zh]]), pe = function(n) {
  for (var e = 0; ; e++)
...
const ft = typeof navigator < "u" ? navigator : null, na = typeof document < "u" ? document : null, Yt = ft && ft.userAgent || "", xs = /Edge\/(\d+)/.exec(Yt), du = /MSIE \d/.exec(Yt), Cs = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Yt), Be = !!(du || Cs || xs), jt = du ? document.documentMode : Cs ? +Cs[1] : xs ? +xs[1] : 0, tt = !Be && /gecko\/(\d+)/i.test(Yt);
tt && +(/Firefox\/(\d+)/.exec(Yt) || [0, 0])[1];
const Ts = !Be && /Chrome\/(\d+)/.exec(Yt), xe = !!Ts, Jh = Ts ? +Ts[1] : 0, Ce = !Be && !!ft && /Apple Computer/.test(ft.vendor), Un = Ce && (/Mobile\/\w+/.test(Yt) || !!ft && ft.maxTouchPoints > 2), We = Un || (ft ? /Mac/.test(ft.platform) : !1), Gh = ft ? /Win/.test(ft.platform) : !1, Xe = /Android \d/.test(Yt), Hr = !!na && "webkitFontSmoothing" in na.documentElement.style, Yh = Hr ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function Qh(n) {
...
function xp(n) {
  ...
  i ? t.setEnd(r.parentNode, pe(r) + 1) : t.setEnd(r, 0), t.collapse(!1), e.removeAllRanges(), e.addRange(t), !i && !n.state.selection.visible && Be && jt <= 11 && (r.disabled = !0, r.disabled = !1);
}
function Tu(n, e) {
  if (e instanceof B) {
...
function ya(n, e) {
  ...
  if (!(xe || Gh) && t.parent.inlineContent) {
...
`))), 0, 0) : E.empty;
  ...
  else if (l = E.maxOpen(Bp(l.content, i), !0), l.openStart || l.openEnd) {
    let d = 0, f = 0;
...
const Te = {}, Se = {}, Pp = { touchstart: !0, touchmove: !0 };
class Fp {
  constructor() {
...
function Hp(n) {
  for (let e in Te) {
    ...
    n.dom.addEventListener(e, n.input.eventHandlers[e] = (r) => {
      Vp(n, r) && !ll(n, r) && (n.editable || !(r.type in Se)) && t(n, r);
...
Se.keydown = (n, e) => {
  ...
  if (n.input.shiftKey = t.keyCode == 16 || t.shiftKey, !Ru(n, t) && (n.input.lastKeyCode = t.keyCode, n.input.lastKeyCodeTime = Date.now(), !(Xe && xe && t.keyCode == 13)))
    if (t.keyCode != 229 && n.domObserver.forceFlush(), Un && t.keyCode == 13 && !t.ctrlKey && !t.altKey && !t.metaKey) {
      ...
      n.someProp("handleKeyDown", (r) => r(n, t)) || Np(n, t) ? t.preventDefault() : $t(n, "key");
};
Se.keyup = (n, e) => {
...
function qp(n, e, t, r, i) {
  return al(n, "handleClickOn", e, t, r) || n.someProp("handleClick", (o) => o(n, e, r)) || (i ? Wp(n, t) : jp(n, t));
}
function Kp(n, e, t, r) {
...
Te.mousedown = (n, e) => {
  ...
  s && (o == "singleClick" ? (n.input.mouseDown && n.input.mouseDown.done(), n.input.mouseDown = new Gp(n, s, t, !!r)) : (o == "doubleClick" ? Kp : Up)(n, s.pos, s.inside, t) ? t.preventDefault() : $t(n, "pointer"));
};
class Gp {
  constructor(e, t, r, i) {
  ...
  up(e) {
    if (this.done(), !this.view.dom.contains(e.target))
      return;
    let t = this.pos;
    this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(Co(e))), this.updateAllowDefault(e), this.allowDefault || !t ? $t(this.view, "pointer") : qp(this.view, t.pos, t.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || // Safari ignores clicks on draggable elements
...
function Qp(n) {
  ...
  if (!e.focusNode)
    return null;
  let t = jh(e.focusNode, e.focusOffset), r = Wh(e.focusNode, e.focusOffset);
  if (t && r && t != r) {
    let i = r.pmViewDesc;
...
class ie {
  ...
  */
  mapInner(e, t, r, i, o) {
    ...
    return this.children.length ? nm(this.children, s || [], e, t, r, i, o) : s ? new ie(s.sort(pn), Ln) : ye;
  }
  /**
  ...
  */
  add(e, t) {
    return t.length ? this == ye ? ie.create(e, t) : this.addInner(e, t, 0) : this;
  }
  addInner(e, t, r) {
    let i, o = 0;
    e.forEach((l, a) => {
    ...
    return new ie(s.length ? this.local.concat(s).sort(pn) : this.local, i || this.children);
  }
  /**
  ...
  */
  ...
  removeInner(e, t) {
    ...
    return r == this.children && i == this.local ? this : i.length || r.length ? new ie(i, r) : ye;
  }
  forChild(e, t) {
    if (this == ye)
      return this;
  ...
  static from(e) {
    switch (e.length) {
      ...
      case 1:
        return e[0];
      default:
        return new Ht(e.every((t) => t instanceof ie) ? e : e.reduce((t, r) => t.concat(r instanceof ie ? r : r.members), []));
    }
  }
}
...
function Di(n, e, t, r) {
  ...
  return s.length || i.length ? new ie(s, i) : ye;
}
function pn(n, e) {
...
function Uo(n) {
  ...
  return n.someProp("decorations", (t) => {
    let r = t(n.state);
    r && r != ye && e.push(r);
  }), n.cursorWrapper && e.push(ie.create(n.state.doc, [n.cursorWrapper.deco])), Ht.from(e);
}
const im = {
  childList: !0,
  characterData: !0,
...
class lm {
  constructor(e, t) {
    this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new sm(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.observer = window.MutationObserver && new window.MutationObserver((r) => {
      for (let i = 0; i < r.length; i++)
        this.queue.push(r[i]);
      Be && jt <= 11 && r.some((i) => i.type == "childList" && i.removedNodes.length || i.type == "characterData" && i.oldValue.length > i.target.nodeValue.length) ? this.flushSoon() : this.flush();
  ...
  onSelectionChange() {
    if (ma(this.view)) {
      if (this.suppressingSelectionUpdates)
        return At(this.view);
      if (Be && jt <= 11 && !this.view.state.selection.empty) {
  ...
  registerMutation(e, t) {
    ...
    if (e.type == "childList") {
      ...
      if (Be && jt <= 11 && e.addedNodes.length)
        for (let u = 0; u < e.addedNodes.length; u++) {
...
function hm(n, e, t, r, i) {
  ...
  n.input.domChangeCount++, n.state.selection.from < n.state.selection.to && p.start == p.endB && n.state.selection instanceof H && (p.start > n.state.selection.from && p.start <= n.state.selection.from + 2 && n.state.selection.from >= c.from ? p.start = n.state.selection.from : p.endA < n.state.selection.to && p.endA >= n.state.selection.to - 2 && n.state.selection.to <= c.to && (p.endB += n.state.selection.to - p.endA, p.endA = n.state.selection.to)), Be && jt <= 11 && p.endB == p.start + 1 && p.endA == p.start && p.start > c.from && c.doc.textBetween(p.start - c.from - 1, p.start - c.from + 1) == "  " && (p.start--, p.endA--, p.endB--);
  ...
  if (n.state.selection.anchor > p.start && mm(u, p.start, p.endA, m, g) && n.someProp("handleKeyDown", (S) => S(n, on(8, "Backspace")))) {
  ...
  if (w) {
    if (m.pos == g.pos)
      Be && jt <= 11 && m.parentOffset == 0 && (n.domObserver.suppressSelectionUpdates(), setTimeout(() => At(n), 20)), v = n.state.tr.delete(y, M), A = u.resolve(p.start).marksAcross(u.resolve(p.endA));
    else if (
      // Adding or removing a mark
      p.endA == p.endB && (R = pm(m.parent.content.cut(m.parentOffset, g.parentOffset), b.parent.content.cut(b.parentOffset, p.endA - b.start())))
    )
  ...
  if (v || (v = n.state.tr.replace(y, M, c.doc.slice(p.start - c.from, p.endB - c.from))), c.sel) {
    ...
    S && !(xe && Xe && n.composing && S.empty && (p.start != p.endB || n.input.lastAndroidDelete < Date.now() - 100) && (S.head == y || S.head == v.mapping.map(M) - 1) || Be && S.empty && S.head == y) && v.setSelection(S);
  }
...
class ym {
  ...
  */
  ...
  updateStateInner(e, t) {
    ...
    if (s) {
      ...
      let h = d && (Be || xe) && !this.composing && !i.selection.empty && !e.selection.empty && bm(i.selection, e.selection);
      if (d) {
  ...
  */
  domSelectionRange() {
    ...
    return Ce && this.root.nodeType === 11 && Kh(this.dom.ownerDocument) == this.dom && cm(this, e) || e;
  }
  /**
  @internal
  */
  ...
  return t.map((u) => new se({
    ...
    appendTransaction: (d, f, h) => {
      ...
      if (!m && !g && !w)
        return;
      if (w) {
        const { from: M, text: v } = b, A = M + v.length, R = ag(v);
        return a({
          rule: u,
          state: h,
          from: M,
...
}), Qg = () => ({ state: n, dispatch: e }) => Dm(n, e), Xg = () => ({ state: n, dispatch: e }) => Lm(n, e), Zg = () => ({ state: n, dispatch: e }) => _m(n, e), e0 = () => ({ state: n, dispatch: e }) => Wm(n, e), t0 = () => ({ state: n, dispatch: e }) => jm(n, e);
function od(n, e, t = {}) {
...
let j0 = class extends Xm {
   ...
   */
  injectCSS() {
    this.options.injectCSS && document && (this.css = $0(_0, this.options.injectNonce));
  }
  /**
...
var Le = "top", Ge = "bottom", Ye = "right", Ie = "left", kl = "auto", _r = [Le, Ge, Ye, Ie], Gn = "start", Ar = "end", U0 = "clippingParents", ad = "viewport", lr = "popper", J0 = "reference", $a = /* @__PURE__ */ _r.reduce(function(n, e) {
...
function oy(n) {
  ...
  Object.keys(e.elements).forEach(function(t) {
    ...
    !Je(o) || !pt(o) || (Object.assign(o.style, r), Object.keys(i).forEach(function(s) {
      var l = i[s];
...
function sy(n) {
  ...
  return Object.assign(e.elements.popper.style, t.popper), e.styles = t, e.elements.arrow && Object.assign(e.elements.arrow.style, t.arrow), function() {
    Object.keys(e.elements).forEach(function(r) {
      ...
      !Je(i) || !pt(i) || (Object.assign(i.style, l), Object.keys(o).forEach(function(a) {
        i.removeAttribute(a);
      }));
    });
  };
...
function ay(n) {
  ...
  var i = No(n);
  for (wl(i) && (i = i.host); Je(i) && ["html", "body"].indexOf(pt(i)) < 0; ) {
    var o = Nt(i);
...
function $r(n) {
  for (var e = ze(n), t = ja(n); t && ly(t) && Nt(t).position === "static"; )
    t = ja(t);
  return t && (pt(t) === "html" || pt(t) === "body" && Nt(t).position === "static") ? e : t || ay(n) || e;
}
function Cl(n) {
...
function dy(n) {
  var e, t = n.state, r = n.name, i = n.options, o = t.elements.arrow, s = t.modifiersData.popperOffsets, l = dt(t.placement), a = Cl(l), c = [Ie, Ye].indexOf(l) >= 0, u = c ? "height" : "width";
  if (!(!o || !s)) {
    var d = uy(i.padding, t), f = xl(o), h = a === "y" ? Le : Ie, p = a === "y" ? Ge : Ye, m = t.rects.reference[u] + t.rects.reference[a] - s[a] - t.rects.popper[u], g = s[a] - t.rects.reference[a], b = $r(o), w = b ? a === "y" ? b.clientHeight || 0 : b.clientWidth || 0 : 0, C = m / 2 - g / 2, y = d[h], M = w - f[u] - d[p], v = w / 2 - f[u] / 2 + C, A = mr(y, v, M), R = a;
...
function Wa(n) {
  ...
  h = g.x, m = g.y;
  var b = s.hasOwnProperty("x"), w = s.hasOwnProperty("y"), C = Ie, y = Le, M = window;
  if (c) {
    var v = $r(t), A = "clientHeight", R = "clientWidth";
    if (v === ze(t) && (v = Xt(t), Nt(v).position !== "static" && l === "absolute" && (A = "scrollHeight", R = "scrollWidth")), v = v, i === Le || (i === Ie || i === Ye) && o === Ar) {
      y = Ge;
...
function gd(n) {
  return ["html", "body", "#document"].indexOf(pt(n)) >= 0 ? n.ownerDocument.body : Je(n) && Ml(n) ? n : gd(No(n));
}
function gr(n, e) {
  var t;
  e === void 0 && (e = []);
...
function Sy(n) {
  var e = gr(No(n)), t = ["absolute", "fixed"].indexOf(Nt(n).position) >= 0, r = t && Je(n) ? $r(n) : n;
...
function Or(n, e) {
  e === void 0 && (e = {});
  var t = e, r = t.placement, i = r === void 0 ? n.placement : r, o = t.strategy, s = o === void 0 ? n.strategy : o, l = t.boundary, a = l === void 0 ? U0 : l, c = t.rootBoundary, u = c === void 0 ? ad : c, d = t.elementContext, f = d === void 0 ? lr : d, h = t.altBoundary, p = h === void 0 ? !1 : h, m = t.padding, g = m === void 0 ? 0 : m, b = pd(typeof g != "number" ? g : md(g, _r)), w = f === lr ? J0 : lr, C = n.rects.popper, y = n.elements[p ? w : f], M = My(wn(y) ? y : y.contextElement || Xt(n.elements.popper), a, u, s), v = Qn(n.elements.reference), A = yd({
    reference: v,
    element: C,
    strategy: "absolute",
    placement: i
  ...
  if (f === lr && $) {
    ...
    Object.keys(I).forEach(function(q) {
      var ae = [Ye, Ge].indexOf(q) >= 0 ? 1 : -1, Z = [Le, Ge].indexOf(q) >= 0 ? "y" : "x";
      I[q] += W[Z] * ae;
    });
  }
  return I;
...
function Oy(n) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !0 : s, a = t.fallbackPlacements, c = t.padding, u = t.boundary, d = t.rootBoundary, f = t.altBoundary, h = t.flipVariations, p = h === void 0 ? !0 : h, m = t.allowedAutoPlacements, g = e.options.placement, b = dt(g), w = b === g, C = a || (w || !p ? [gi(g)] : Ay(g)), y = [g].concat(C).reduce(function(yt, Qe) {
      return yt.concat(dt(Qe) === kl ? Ey(e, {
        placement: Qe,
        boundary: u,
        rootBoundary: d,
        padding: c,
      ...
      var $ = y[I], W = dt($), q = Xn($) === Gn, ae = [Le, Ge].indexOf(W) >= 0, Z = ae ? "width" : "height", Y = Or(e, {
        placement: $,
        boundary: u,
        rootBoundary: d,
        altBoundary: f,
        padding: c
      }), G = ae ? q ? Ye : Ie : q ? Ge : Le;
      M[Z] > v[Z] && (G = gi(G));
      var K = gi(G), Pe = [];
      if (o && Pe.push(Y[W] <= 0), l && Pe.push(Y[G] <= 0, Y[K] <= 0), Pe.every(function(yt) {
        return yt;
      })) {
        S = $, R = !1;
        break;
    ...
    if (R)
      for (var ge = p ? 3 : 1, gt = function(Qe) {
        var bt = y.find(function(Cn) {
          var vt = A.get(Cn);
          if (vt)
            return vt.slice(0, Qe).every(function(Tn) {
              return Tn;
            });
        });
        if (bt)
...
function Ly(n, e, t) {
  var r = dt(n), i = [Ie, Le].indexOf(r) >= 0 ? -1 : 1, o = typeof t == "function" ? t(Object.assign({}, e, {
    placement: n
  })) : t, s = o[0], l = o[1];
...
function zy(n) {
  var e = n.state, t = n.options, r = n.name, i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !1 : s, a = t.boundary, c = t.rootBoundary, u = t.altBoundary, d = t.padding, f = t.tether, h = f === void 0 ? !0 : f, p = t.tetherOffset, m = p === void 0 ? 0 : p, g = Or(e, {
    ...
    padding: d,
    altBoundary: u
  }), b = dt(e.placement), w = Xn(e.placement), C = !w, y = Cl(b), M = Hy(y), v = e.modifiersData.popperOffsets, A = e.rects.reference, R = e.rects.popper, S = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, I = typeof S == "number" ? {
    mainAxis: S,
    altAxis: S
  ...
  if (v) {
    if (o) {
      var q, ae = y === "y" ? Le : Ie, Z = y === "y" ? Ge : Ye, Y = y === "y" ? "height" : "width", G = v[y], K = G + g[ae], Pe = G - g[Z], ge = h ? -R[Y] / 2 : 0, gt = w === Gn ? A[Y] : R[Y], Me = w === Gn ? -R[Y] : -A[Y], en = e.elements.arrow, yt = h && en ? xl(en) : {
        width: 0,
        height: 0
      }, Qe = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : hd(), bt = Qe[ae], Cn = Qe[Z], vt = mr(0, A[Y], yt[Y]), Tn = C ? A[Y] / 2 - ge - vt - bt - I.mainAxis : gt - vt - bt - I.mainAxis, Dt = C ? -A[Y] / 2 + ge + vt + Cn + I.mainAxis : Me + vt + Cn + I.mainAxis, Sn = e.elements.arrow && $r(e.elements.arrow), Wr = Sn ? y === "y" ? Sn.clientTop || 0 : Sn.clientLeft || 0 : 0, tr = (q = $ == null ? void 0 : $[y]) != null ? q : 0, qr = G + Tn - tr - Wr, Kr = G + Dt - tr, nr = mr(h ? Pi(K, qr) : K, G, h ? mn(Pe, Kr) : Pe);
      v[y] = nr, W[y] = nr - G;
    }
    if (l) {
      var rr, Ur = y === "x" ? Le : Ie, Jr = y === "x" ? Ge : Ye, kt = v[M], Bt = M === "y" ? "height" : "width", ir = kt + g[Ur], tn = kt - g[Jr], or = [Le, Ie].indexOf(b) !== -1, Gr = (rr = $ == null ? void 0 : $[M]) != null ? rr : 0, Yr = or ? ir : kt - A[Bt] - R[Bt] - Gr + I.altAxis, Qr = or ? kt + A[Bt] + R[Bt] - Gr - I.altAxis : tn, Xr = h && or ? cy(Yr, kt, Qr) : mr(h ? Yr : ir, kt, h ? Qr : tn);
      v[M] = Xr, W[M] = Xr - kt;
    }
    e.modifiersData[r] = W;
  }
...
function Wy(n, e, t) {
  t === void 0 && (t = !1);
  var r = Je(e), i = Je(e) && jy(e), o = Xt(e), s = Qn(n, i, t), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, a = {
    x: 0,
  ...
  Ml(o)) && (l = $y(e)), Je(e) ? (a = Qn(e, !0), a.x += e.clientLeft, a.y += e.clientTop) : o && (a.x = Sl(o))), {
  ...
  return function(l, a, c) {
    ...
    var u = {
      ...
      setOptions: function(b) {
        ...
        var C = Ky(Jy([].concat(r, u.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!f) {
          ...
          if (Ya(w, C)) {
            u.rects = {
              reference: Wy(w, $r(C), u.options.strategy === "fixed"),
              popper: xl(C)
...
var Tb = 1, si = [], is = [];
function Sb(n, e) {
  var t = ic(n, Object.assign({}, He, Md(Za(e)))), r, i, o, s = !1, l = !1, a = !1, c = !1, u, d, f, h = [], p = Qa(qr, t.interactiveDebounce), m, g = Tb++, b = null, w = rb(t.plugins), C = {
  ...
  function Sn() {
    $() && (Dt("touchstart", tr, {
      ...
      passive: !0
    })), nb(y.props.trigger).forEach(function(k) {
      if (k !== "manual")
        switch (Dt(k, tr), k) {
          case "mouseenter":
            Dt("mouseleave", Kr);
  ...
  function tr(k) {
    ...
    if (!(!y.state.isEnabled || rr(k) || l)) {
      ...
      u = k, m = k.currentTarget, ge(), !y.state.isVisible && sb(k) && si.forEach(function(j) {
        return j(k);
  ...
  function Ur() {
    ...
    }), nn.push.apply(nn, (N == null ? void 0 : N.modifiers) || []), y.popperInstance = Qy(Mn, v, Object.assign({}, N, {
      placement: L,
      onFirstUpdate: f,
      modifiers: nn
    }));
...
`, "See: https://atomiks.github.io/tippyjs/v6/accessibility/#interactivity"].join(" "));
  ...
  function ir(k) {
    y.clearDelayTimeouts(), k && K("onTrigger", [y, k]), Qe();
  ...
  function Xd() {
    ...
    if (!(k || N || L || U) && !q().hasAttribute("disabled") && (K("onShow", [y], !1), y.props.onShow(y) !== !1)) {
      if (y.state.isVisible = !0, W() && (v.style.visibility = "visible"), G(), Qe(), y.state.isMounted || (v.style.transition = "none"), W()) {
      ...
      f = function() {
        ...
        if (!(!y.state.isVisible || c)) {
          ...
          Pe(), ge(), Xa(is, y), (nn = y.popperInstance) == null || nn.forceUpdate(), K("onMount", [y]), y.props.animation && W() && vt(j, function() {
  ...
  function Zd() {
    ...
    if (!(k || N || L) && (K("onHide", [y], !1), y.props.onHide(y) !== !1)) {
      ...
      Pe(), ge(), y.props.animation ? W() && Cn(U, y.unmount) : y.unmount();
    }
  }
  function ef(k) {
...
const Yb = ["onPointerdown"], fc = {
  ...
  setup(n) {
    ...
    return (l, a) => (D(), P("div", {
      ...
      onPointerdown: Ae(o, ["self", "stop"])
    }, [
      (D(), Oe(ff(hi(i).component), hf(hi(i).props.value, {
...
function pv(n, e, t, r, i, o) {
  ...
  return D(), P("div", rv, [
    ...
    F("div", {
      ...
      F("div", av, [
        F("div", cv, [
          (D(!0), P(Ee, null, je(t.form, (l, a) => (D(), P("div", {
          ...
          F("div", hv, [
            lt(s, {
              ...
              onClick: Ae(o.hideModal, ["prevent"]),
            ...
            lt(s, {
              ...
              onClick: Ae(o.okHandler, ["prevent"]),
              content: t.okButton
            }, null, 8, ["onClick", "content"])
          ])
        ])
...
const mv = /* @__PURE__ */ mt(nv, [["render", pv]]), gv = {
...
const Tv = /* @__PURE__ */ mt(gv, [["render", Cv]]), Sv = X.create({
  name: "modal",
  addOptions() {
    return {
      formModal: mv,
...
}), Ev = /^(https?:\/\/)?(www\.|music\.)?(youtube\.com|youtu\.be)(?!.*\/channel\/)(?!\/@)(.+)?$/, Av = /^(https?:\/\/)?(www\.|music\.)?(youtube\.com|youtu\.be)(?!.*\/channel\/)(?!\/@)(.+)?$/g, js = (n) => n.match(Ev), hc = (n) => n ? "https://www.youtube-nocookie.com/embed/" : "https://www.youtube.com/embed/", Ov = (n) => {
  const {
    url: e,
    allowFullscreen: t,
    autoplay: r,
...
function Qv(n) {
  ...
  return e.className = "ProseMirror-gapcursor", ie.create(n.doc, [De.widget(n.selection.head, e, { key: "gapcursor" })]);
}
const Xv = X.create({
  name: "gapCursor",
  addProseMirrorPlugins() {
...
const gn = new ke("history"), a1 = new ke("closeHistory");
function c1(n = {}) {
  return n = {
    depth: n.depth || 100,
...
const $d = _d(!1, !0), jd = _d(!0, !0), u1 = X.create({
  name: "history",
  addOptions() {
    return {
      depth: 100,
...
function L1(n) {
  ...
  Ne.groups = e;
  const t = new Ne();
  ci == null && (ci = Tc(S1)), ui == null && (ui = Tc(M1)), T(t, "'", eo), T(t, "{", br), T(t, "}", vr), T(t, "[", zi), T(t, "]", Vi), T(t, "(", _i), T(t, ")", $i), T(t, "<", ji), T(t, ">", Wi), T(t, "（", qi), T(t, "）", Ki), T(t, "「", Ui), T(t, "」", Ji), T(t, "『", Gi), T(t, "』", Yi), T(t, "＜", Qi), T(t, "＞", Xi), T(t, "&", Zi), T(t, "*", to), T(t, "@", Ft), T(t, "`", ro), T(t, "^", io), T(t, ":", zt), T(t, ",", Bl), T(t, "$", oo), T(t, ".", rt), T(t, "=", so), T(t, "!", Ll), T(t, "-", it), T(t, "%", lo), T(t, "|", ao), T(t, "+", co), T(t, "#", uo), T(t, "?", fo), T(t, '"', Il), T(t, "/", ot), T(t, ";", Rl), T(t, "~", kr), T(t, "_", ho), T(t, "\\", no);
  const r = _e(t, fs, Nl, {
    [Ws]: !0
  });
  _e(r, fs, r);
...
}), V1 = "until manual call of linkify.init(). Register all schemes and plugins before invoking linkify the first time.", ee = {
  scanner: null,
  parser: null,
  tokenQueue: [],
  pluginQueue: [],
...
function _1() {
  Ne.groups = {}, ee.scanner = null, ee.parser = null, ee.tokenQueue = [], ee.pluginQueue = [], ee.customSchemes = [], ee.initialized = !1;
}
function Ac(n, e) {
  if (e === void 0 && (e = !1), ee.initialized && z1(`linkifyjs: already initialized - will not register custom scheme "${n}" ${V1}`), !/^[0-9a-z]+(-[0-9a-z]+)*$/.test(n))
...
function $1() {
  ee.scanner = L1(ee.customSchemes);
  for (let n = 0; n < ee.tokenQueue.length; n++)
    ee.tokenQueue[n][1]({
      scanner: ee.scanner
    });
  ee.parser = F1(ee.scanner.tokens);
...
function Gd(n) {
  return ee.initialized || $1(), H1(ee.parser.start, n, I1(ee.scanner.start, n));
}
function Yd(n, e, t) {
          ...
          decorations: ({ doc: n, selection: e }) => {
            ...
            return n.descendants((d, f) => {
              ...
              if ((h || !this.options.showOnlyCurrent) && p) {
                ...
                const g = De.node(f, f + d.nodeSize, {
                  class: m.join(" "),
  ...
  const p = u == null ? void 0 : u(), m = new se({
    ...
    view() {
      return {
        update: async (g, b) => {
          ...
          if (!Z && !Y && !G)
            return;
          const K = G && !Z ? S : I, Pe = g.dom.querySelector(`[data-decoration-id="${K.decorationId}"]`);
          h = {
            editor: e,
            range: K.range,
            query: K.query,
    ...
    props: {
      ...
      decorations(g) {
        ...
        return b ? ie.create(g.doc, [
          De.inline(w.from, w.to, {
            nodeName: s,
            class: l,
...
function Pk(n, e, t, r, i, o) {
  return D(), P("div", Dk, [
    ...
    F("div", Lk, [
      ...
      t.description ? (D(), P("div", Rk, Ke(t.description), 1)) : ne("", !0)
    ])
  ]);
}
const Qd = /* @__PURE__ */ mt(Nk, [["render", Pk]]);
const Fk = {
  name: "BlocksModal",
  props: {
    removeFirstSymbol: {
...
}, Hk = { class: "vueberg-modal-layout" }, zk = { class: "vueberg-modal vueberg-modal-md vueberg-blocks-modal" }, Vk = { class: "vueberg-modal-header" }, _k = { class: "vueberg-modal-header-title" }, $k = /* @__PURE__ */ F("svg", {
  width: "24px",
  height: "24px",
  viewBox: "0 0 24 24",
  fill: "none",
...
function Jk(n, e, t, r, i, o) {
  ...
  return D(), P("div", Hk, [
    ...
    F("div", zk, [
      ...
      F("div", Wk, [
        (D(!0), P(Ee, null, je(i.blocks, (l, a) => (D(), P("div", qk, [
          F("div", Kk, Ke(l.title), 1),
          F("div", Uk, [
            (D(!0), P(Ee, null, je(l.blocks, (c, u) => (D(), Oe(s, {
              class: "vueberg-block-item--modal vueberg-block-item--clickable",
              onClick: Ae((d) => o.selectBlock(c), ["prevent"]),
              icon: c.icon,
              title: c.title,
...
const Qs = /* @__PURE__ */ mt(Fk, [["render", Jk]]), Gk = {
  components: {
    BlockItem: Qd
  },
  props: {
...
function Zk(n, e, t, r, i, o) {
  const s = qe("BlockItem");
  return D(), P("div", Yk, [
    t.items.length ? (D(), P("div", Qk, [
      (D(!0), P(Ee, null, je(t.items, (l, a) => (D(), Oe(s, {
        class: Ot(["vueberg-block-item--clickable", i.selectedIndex == a ? "vueberg-block-item--selected" : ""]),
        onClick: Ae((c) => o.selectItem(a), ["prevent"]),
        icon: l.icon,
        title: l.title,
        description: l.description
      }, null, 8, ["class", "onClick", "icon", "title", "description"]))), 256))
    ])) : (D(), P("div", Xk, Ke(i.nothingFoundLabel), 1)),
    o.hiddenItems > 0 ? (D(), P("div", {
      key: 2,
...
const ew = /* @__PURE__ */ mt(Gk, [["render", Zk]]);
function tw(n) {
  return {
...
function mw(n, e, t, r, i, o) {
  ...
  return D(), P("div", hw, [
    lt(s),
    t.editable && i.loaded && ((h = (f = o.mergedSettings) == null ? void 0 : f.toolbar) == null ? void 0 : h.style) == "default" ? Dc((D(), Oe(a, {
      key: 0,
      pluginKey: "mainMenu",
      ...
      default: St(() => {
        var C;
        return [
          ((C = i.currentBlockTool) == null ? void 0 : C.nodeType) !== void 0 ? (D(), Oe(l, {
            key: 0,
            editor: i.editor,
          ...
          }, null, 8, ["editor", "currentBlockTool", "settings", "inlineTools", "alignmentTools", "vuebergWidth"])) : ne("", !0)
        ];
      }),
      _: 1
    ...
    t.editable && i.loaded && ((m = (p = o.mergedSettings) == null ? void 0 : p.toolbar) == null ? void 0 : m.style) == "sticky" ? (D(), P("div", pw, [
      ((g = i.currentBlockTool) == null ? void 0 : g.nodeType) !== void 0 ? (D(), Oe(l, {
        key: 0,
        editor: i.editor,
        currentBlockTool: i.currentBlockTool,
        settings: o.mergedSettings,
      ...
      }, null, 8, ["editor", "currentBlockTool", "settings", "inlineTools", "alignmentTools", "vuebergWidth", "customTools"])) : ne("", !0)
    ])) : ne("", !0),
    t.editable && i.currentBlockTool && i.editor ? (D(), Oe(u, {
      key: 2,
      updateDelay: 1e3,
      ...
      _: 1
    }, 8, ["should-show", "editor", "tippy-options"])) : ne("", !0),
    lt(d, {
...
const gw = /* @__PURE__ */ mt(fw, [["render", mw]]), yw = {
  props: Ib,
  components: {
    NodeViewWrapper: Bb
  },
...
function Cw(n, e, t, r, i, o) {
  ...
  return D(), Oe(s, {
    ...
    default: St(() => {
      var a, c, u, d, f;
      return [
        i.isEditable && ((a = i.vueBergBlock) != null && a.name) ? (D(), P("div", bw, [
          F("div", vw, [
            F("span", {
          ...
          ((f = (d = i.vueBergBlock) == null ? void 0 : d.vueBergBlock) == null ? void 0 : f.hasPreviewMode) !== !1 ? (D(), P("div", {
            key: 0,
...
const Tw = /* @__PURE__ */ mt(yw, [["render", Cw]]), Ew = gw, Aw = Tw;
export {
