    ...
    },
    {
      ...
      command: async (editor) => {
        ...
        let form = await editor.commands.promptModal(
          { 
            title: editor.commands.getTranslation('inlineTools.link.modal.title'),
            form: [
              {
                label: editor.commands.getTranslation('inlineTools.link.form.label'),
                name: 'url',
                value: value,
                placeholder: editor.commands.getTranslation('inlineTools.link.form.placeholder'),
              }
            ],
